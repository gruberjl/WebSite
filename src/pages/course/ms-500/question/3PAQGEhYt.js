...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"From the Azure Active Directory admin center, create a new certificate"},{"value":"Enable Application Proxy in Azure AD","isCorrectAnswer":false},{"value":"From Active Directory Administrative Center, create a Dynamic Access Control policy","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, configure authentication methods"}],"question":{"blocks":[{"type":"unstyled","entityRanges":[],"key":"9lhm","text":"You have a hybrid Microsoft 365 environment. All computers run Windows 10 and are managed by using Microsoft Intune.","data":{},"depth":0,"inlineStyleRanges":[]},{"key":"8o0i7","text":"You need to create a Microsoft Azure Active Directory (Azure AD) conditional access policy that will allow only Windows 10 computers marked as compliant to establish a VPN connection to the on-premises network.","entityRanges":[],"depth":0,"inlineStyleRanges":[],"data":{},"type":"unstyled"},{"data":{},"depth":0,"type":"unstyled","key":"74po4","inlineStyleRanges":[],"text":"What should you do first?","entityRanges":[]}],"entityMap":{}},"references":{"blocks":[{"type":"unstyled","entityRanges":[],"depth":0,"text":"https://docs.microsoft.com/en-us/windows-server/remote/remote-access/vpn/ad-ca-vpn-connectivity-windows10","key":"br3cc","data":{},"inlineStyleRanges":[]}],"entityMap":{}},"id":"3PAQGEhYt"},
      previousQuestionId: '',
      nextQuestionId: '',
