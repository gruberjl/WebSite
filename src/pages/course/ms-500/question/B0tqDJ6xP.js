...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"inlineStyleRanges":[],"text":"","depth":0,"data":{},"key":"alqe8","type":"unstyled","entityRanges":[]}],"entityMap":{}},"question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"width":"auto","alt":"Condition chart","height":"auto","alignment":"left","src":"https://i.ibb.co/Hz0XgJn/condition-chart.png"},"type":"IMAGE"},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"src":"https://i.ibb.co/L05svw0/label-chart.png","height":"auto","alt":"Label chart","width":"auto","alignment":"left"}},"2":{"mutability":"MUTABLE","type":"IMAGE","data":{"alt":"Policy Chart","src":"https://i.ibb.co/H7SJhBG/policy-chart2.png","height":"auto","alignment":"left","width":"auto"}}},"blocks":[{"inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"arbvt","depth":0,"type":"unstyled","text":"You have the Microsoft Azure Information Protection conditions shown in the following table."},{"entityRanges":[{"length":1,"offset":0,"key":0}],"key":"8a52q","inlineStyleRanges":[],"text":" ","data":{},"depth":0,"type":"atomic"},{"data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","key":"culrr","text":"You have the Azure Information Protection labels shown in the following table."},{"key":"1g4oi","type":"atomic","data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[{"key":1,"offset":0,"length":1}],"text":" "},{"depth":0,"text":"You have the Azure Information Protection policies shown in the following table.","entityRanges":[],"type":"unstyled","key":"6nhjl","data":{},"inlineStyleRanges":[]},{"entityRanges":[{"length":1,"key":2,"offset":0}],"type":"atomic","text":" ","key":"9i63c","inlineStyleRanges":[],"depth":0,"data":{}},{"text":"For each of the following statements, check the box if the statement is true.","key":"3ebb3","entityRanges":[],"depth":0,"inlineStyleRanges":[],"data":{},"type":"unstyled"}]},"id":"B0tqDJ6xP","answers":[{"isCorrectAnswer":false,"value":"If User1 types \"Product1 and Product2\" in a document and saves the document in Microsoft Word, the document will be assigned Label1 sensitivity automatically."},{"value":"If User1 types \"Product2 and Product1\" in a document and saves the document in Microsoft Word, the document will be assigned Label2 sensitivity automatically.","isCorrectAnswer":true},{"value":"If User1 types \"product2\" in a document and saves the document in Microsoft Word, the document will be assigned Label2 sensitivity automatically.","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
