...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"If User1 types \"Product1 and Product2\" in a document and saves the document in Microsoft Word, the document will be assigned Label1 sensitivity automatically."},{"value":"If User1 types \"Product2 and Product1\" in a document and saves the document in Microsoft Word, the document will be assigned Label2 sensitivity automatically.","isCorrectAnswer":true},{"value":"If User1 types \"product2\" in a document and saves the document in Microsoft Word, the document will be assigned Label2 sensitivity automatically.","isCorrectAnswer":false}],"question":{"blocks":[{"depth":0,"text":"You have the Microsoft Azure Information Protection conditions shown in the following table.","data":{},"type":"unstyled","inlineStyleRanges":[],"key":"arbvt","entityRanges":[]},{"type":"atomic","depth":0,"data":{},"key":"8a52q","inlineStyleRanges":[],"text":" ","entityRanges":[{"key":0,"length":1,"offset":0}]},{"inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0,"type":"unstyled","key":"culrr","text":"You have the Azure Information Protection labels shown in the following table."},{"entityRanges":[{"key":1,"length":1,"offset":0}],"type":"atomic","key":"1g4oi","text":" ","data":{},"depth":0,"inlineStyleRanges":[]},{"key":"6nhjl","depth":0,"entityRanges":[],"data":{},"type":"unstyled","text":"You have the Azure Information Protection policies shown in the following table.","inlineStyleRanges":[]},{"type":"atomic","inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[{"offset":0,"key":2,"length":1}],"text":" ","key":"9i63c"},{"type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"For each of the following statements, check the box if the statement is true.","key":"3ebb3","depth":0}],"entityMap":{"0":{"type":"IMAGE","data":{"height":"auto","alignment":"left","src":"https://i.ibb.co/Hz0XgJn/condition-chart.png","width":"auto","alt":"Condition chart"},"mutability":"MUTABLE"},"1":{"data":{"src":"https://i.ibb.co/L05svw0/label-chart.png","width":"auto","alt":"Label chart","height":"auto","alignment":"left"},"mutability":"MUTABLE","type":"IMAGE"},"2":{"type":"IMAGE","mutability":"MUTABLE","data":{"src":"https://i.ibb.co/H7SJhBG/policy-chart2.png","alignment":"left","width":"auto","height":"auto","alt":"Policy Chart"}}}},"id":"B0tqDJ6xP","references":{"blocks":[{"depth":0,"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"","key":"alqe8"}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
