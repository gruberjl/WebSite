...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"entityRanges":[],"text":"You have the Microsoft Azure Information Protection conditions shown in the following table.","inlineStyleRanges":[],"type":"unstyled","key":"arbvt","data":{},"depth":0},{"inlineStyleRanges":[],"depth":0,"entityRanges":[{"length":1,"key":0,"offset":0}],"key":"8a52q","text":" ","data":{},"type":"atomic"},{"key":"culrr","inlineStyleRanges":[],"depth":0,"data":{},"text":"You have the Azure Information Protection labels shown in the following table.","type":"unstyled","entityRanges":[]},{"entityRanges":[{"key":1,"length":1,"offset":0}],"depth":0,"data":{},"inlineStyleRanges":[],"key":"1g4oi","text":" ","type":"atomic"},{"entityRanges":[],"text":"You have the Azure Information Protection policies shown in the following table.","inlineStyleRanges":[],"data":{},"depth":0,"type":"unstyled","key":"6nhjl"},{"key":"9i63c","data":{},"depth":0,"text":" ","type":"atomic","inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":2,"length":1}]},{"key":"3ebb3","depth":0,"data":{},"text":"For each of the following statements, check the box if the statement is true.","entityRanges":[],"type":"unstyled","inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"alt":"Condition chart","width":"auto","alignment":"left","src":"https://i.ibb.co/Hz0XgJn/condition-chart.png","height":"auto"},"type":"IMAGE"},"1":{"mutability":"MUTABLE","data":{"alignment":"left","height":"auto","src":"https://i.ibb.co/L05svw0/label-chart.png","alt":"Label chart","width":"auto"},"type":"IMAGE"},"2":{"mutability":"MUTABLE","type":"IMAGE","data":{"width":"auto","height":"auto","alt":"Policy Chart","alignment":"left","src":"https://i.ibb.co/H7SJhBG/policy-chart2.png"}}}},"answers":[{"isCorrectAnswer":false,"value":"If User1 types \"Product1 and Product2\" in a document and saves the document in Microsoft Word, the document will be assigned Label1 sensitivity automatically."},{"value":"If User1 types \"Product2 and Product1\" in a document and saves the document in Microsoft Word, the document will be assigned Label2 sensitivity automatically.","isCorrectAnswer":true},{"value":"If User1 types \"product2\" in a document and saves the document in Microsoft Word, the document will be assigned Label2 sensitivity automatically.","isCorrectAnswer":false}],"references":{"blocks":[{"depth":0,"text":"","type":"unstyled","entityRanges":[],"data":{},"key":"alqe8","inlineStyleRanges":[]}],"entityMap":{}},"id":"B0tqDJ6xP"},
      previousQuestionId: '',
      nextQuestionId: '',
