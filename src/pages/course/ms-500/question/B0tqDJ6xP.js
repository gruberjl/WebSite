...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"key":"alqe8","data":{},"type":"unstyled","text":"","depth":0,"inlineStyleRanges":[],"entityRanges":[]}],"entityMap":{}},"id":"B0tqDJ6xP","answers":[{"isCorrectAnswer":false,"value":"If User1 types \"Product1 and Product2\" in a document and saves the document in Microsoft Word, the document will be assigned Label1 sensitivity automatically."},{"value":"If User1 types \"Product2 and Product1\" in a document and saves the document in Microsoft Word, the document will be assigned Label2 sensitivity automatically.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"If User1 types \"product2\" in a document and saves the document in Microsoft Word, the document will be assigned Label2 sensitivity automatically."}],"question":{"blocks":[{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0,"data":{},"text":"You have the Microsoft Azure Information Protection conditions shown in the following table.","key":"arbvt"},{"data":{},"inlineStyleRanges":[],"key":"8a52q","type":"atomic","text":" ","entityRanges":[{"offset":0,"key":0,"length":1}],"depth":0},{"entityRanges":[],"key":"culrr","depth":0,"data":{},"text":"You have the Azure Information Protection labels shown in the following table.","inlineStyleRanges":[],"type":"unstyled"},{"entityRanges":[{"length":1,"key":1,"offset":0}],"depth":0,"inlineStyleRanges":[],"key":"1g4oi","type":"atomic","text":" ","data":{}},{"entityRanges":[],"key":"6nhjl","data":{},"depth":0,"inlineStyleRanges":[],"text":"You have the Azure Information Protection policies shown in the following table.","type":"unstyled"},{"text":" ","data":{},"type":"atomic","inlineStyleRanges":[],"key":"9i63c","depth":0,"entityRanges":[{"length":1,"offset":0,"key":2}]},{"key":"3ebb3","text":"For each of the following statements, check the box if the statement is true.","type":"unstyled","entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"alignment":"left","alt":"Condition chart","src":"https://i.ibb.co/Hz0XgJn/condition-chart.png","height":"auto","width":"auto"},"type":"IMAGE"},"1":{"data":{"alignment":"left","width":"auto","height":"auto","src":"https://i.ibb.co/L05svw0/label-chart.png","alt":"Label chart"},"mutability":"MUTABLE","type":"IMAGE"},"2":{"type":"IMAGE","data":{"height":"auto","alignment":"left","width":"auto","alt":"Policy Chart","src":"https://i.ibb.co/H7SJhBG/policy-chart2.png"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
