...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{},"blocks":[{"data":{},"inlineStyleRanges":[],"text":"","depth":0,"type":"unstyled","entityRanges":[],"key":"alqe8"}]},"answers":[{"value":"If User1 types \"Product1 and Product2\" in a document and saves the document in Microsoft Word, the document will be assigned Label1 sensitivity automatically.","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"If User1 types \"Product2 and Product1\" in a document and saves the document in Microsoft Word, the document will be assigned Label2 sensitivity automatically."},{"value":"If User1 types \"product2\" in a document and saves the document in Microsoft Word, the document will be assigned Label2 sensitivity automatically.","isCorrectAnswer":false}],"id":"B0tqDJ6xP","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"alt":"Condition chart","src":"https://i.ibb.co/Hz0XgJn/condition-chart.png","height":"auto","alignment":"left","width":"auto"},"type":"IMAGE"},"1":{"mutability":"MUTABLE","data":{"alt":"Label Conditions","alignment":"left","width":"auto","height":"auto","src":"https://i.ibb.co/xYd5gCX/label-conditions.png"},"type":"IMAGE"},"2":{"type":"IMAGE","mutability":"MUTABLE","data":{"width":"auto","height":"auto","alignment":"left","src":"https://i.ibb.co/H7SJhBG/policy-chart2.png","alt":"Policy Chart"}}},"blocks":[{"key":"arbvt","text":"You have the Microsoft Azure Information Protection conditions shown in the following table.","depth":0,"entityRanges":[],"type":"unstyled","data":{},"inlineStyleRanges":[]},{"data":{},"text":" ","depth":0,"type":"atomic","entityRanges":[{"key":0,"offset":0,"length":1}],"key":"8a52q","inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"key":"culrr","type":"unstyled","text":"You have the Azure Information Protection labels shown in the following table.","data":{},"inlineStyleRanges":[]},{"data":{},"entityRanges":[{"offset":0,"key":1,"length":1}],"type":"atomic","key":"19tkh","depth":0,"text":" ","inlineStyleRanges":[]},{"key":"71qem","depth":0,"inlineStyleRanges":[],"data":{},"text":"You have the Azure Information Protection policies shown in the following table.","entityRanges":[],"type":"unstyled"},{"type":"atomic","entityRanges":[{"length":1,"offset":0,"key":2}],"text":" ","depth":0,"key":"9i63c","inlineStyleRanges":[],"data":{}},{"depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"For each of the following statements, check the box if the statement is true.","data":{},"key":"3ebb3"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
