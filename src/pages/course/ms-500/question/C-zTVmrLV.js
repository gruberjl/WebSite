...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"2cl7a","text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/app-based-conditional-access"}],"entityMap":{}},"id":"C-zTVmrLV","question":{"blocks":[{"text":"You have a Microsoft 365 E5 subscription.","depth":0,"key":"b9tm7","inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unstyled"},{"text":"From Microsoft Azure Active Directory (Azure AD), you create a security group named Group1. You add 10 users to Group1.","entityRanges":[],"type":"unstyled","depth":0,"key":"bi0g3","data":{},"inlineStyleRanges":[]},{"depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[],"text":"You need to apply app-enforced restrictions to the members of Group1 when they connect to Microsoft Exchange Online from non-compliant devices, regardless of their location.","key":"fn1r0"},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"What should you do?","type":"unstyled","depth":0,"key":"4ttei"},{"depth":0,"text":"NOTE: Each correct selection is worth one point.","data":{},"inlineStyleRanges":[],"key":"cve9q","entityRanges":[],"type":"unstyled"}],"entityMap":{}},"answers":[{"value":"From the Azure portal, create a conditional access policy and configure: Users and groups, Cloud apps, and Sessions settings","isCorrectAnswer":false},{"value":"From the Azure portal, create a conditional access policy and configure: Users and groups, Cloud apps, and Conditions settings","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Azure portal, create a conditional access policy and configure: Users and groups, Conditions, and Session settings"},{"isCorrectAnswer":true,"value":"From an Exchange Online Remote PowerShell session run: New-OwaMailbox Policy and Set-OwaMailboxPolicy"},{"isCorrectAnswer":false,"value":"From an Exchange Online Remote PowerShell session run: New-ClientAccessRule and Test-ClientAccessRule"},{"value":"From an Exchange Online Remote PowerShell session run: Get-CASMailbox and Set-CASMailbox","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
