...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"From the Azure AD admin center, create a conditional access policy and configure the group, the cloud app, and enable app enforced restrictions"},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, create a conditional access policy and configure the group, the cloud app, and set the conditions settings"},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, create a conditional access policy and configure the group, the conditions settings, and enable app enforced restrictions"},{"value":"From PowerShell connect to Exchange Online and run New-OwaMailboxPolicy and Set-OwaMailboxPolicy","isCorrectAnswer":true},{"value":"From PowerShell connect to Exchange Online and run New-ClientAccessRule and Test-ClientAccessRule","isCorrectAnswer":false},{"value":"From PowerShell connect to Exchange Online and run Get-CASMailbox and Set-CASMailbox","isCorrectAnswer":false}],"id":"C-zTVmrLV","question":{"blocks":[{"entityRanges":[],"text":"Your organization has a Microsoft 365 tenant. Your manager has asked you to set up app-enforced restrictions for 20 users so they can't download attachments unless they are on a compliant device. From the Azure AD admin center, you create a security group called GroupA.","type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"b9tm7","data":{}},{"data":{},"depth":0,"text":"What are the next two steps you need to take?","type":"unstyled","key":"4ttei","inlineStyleRanges":[],"entityRanges":[]}],"entityMap":{}},"references":{"blocks":[{"text":"First, you need to create a conditional access policy that will set app-enforced restrictions in the sessions section. Then create an OWA Mailbox Policy and set the OWA Mailbox Policy. Finally, you assign the OWA Mailbox Policy to users.","key":"2cl7a","depth":0,"type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Restricting-and-managing-apps-on-user-devices-62t_7oiZx","data":{},"type":"unstyled","key":"8ravp","entityRanges":[{"key":0,"length":98,"offset":0}],"inlineStyleRanges":[]},{"text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/app-based-conditional-access","depth":0,"key":"70gts","type":"unstyled","entityRanges":[{"key":1,"length":103,"offset":0}],"data":{},"inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Restricting-and-managing-apps-on-user-devices-62t_7oiZx"}},"1":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/app-based-conditional-access"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
