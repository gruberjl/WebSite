...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Change the Assignment Type for Admin2 to Permanent"},{"value":" From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Change the Assignment Type for Admin1 to Eligible"}],"id":"nem2vQvYa","question":{"blocks":[{"key":"39hpc","type":"unstyled","data":{},"text":"Security Requirements","entityRanges":[],"depth":0,"inlineStyleRanges":[{"length":21,"offset":0,"style":"BOLD"}]},{"entityRanges":[],"inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","key":"4uds1","data":{},"depth":0},{"data":{},"type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"7sb4h"},{"inlineStyleRanges":[],"type":"unordered-list-item","key":"bvsrl","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","depth":0,"data":{},"entityRanges":[]},{"data":{},"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[],"type":"unordered-list-item","depth":0,"entityRanges":[],"key":"4e8ef"},{"depth":0,"key":"6586j","entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location"},{"depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"7hq3i"},{"type":"unordered-list-item","entityRanges":[],"key":"66mb6","depth":0,"inlineStyleRanges":[],"data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"key":"egt36","data":{},"type":"unordered-list-item","inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","depth":0,"entityRanges":[]},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit.","type":"unstyled","depth":0,"key":"f8uih"},{"depth":0,"inlineStyleRanges":[],"entityRanges":[{"length":1,"key":0,"offset":0}],"text":" ","data":{},"type":"atomic","key":"faafp"},{"key":"c4u9i","type":"unstyled","text":"What should you do to meet the security requirements?","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","alt":"PIM Role Assignments","alignment":"left","width":"auto","src":"https://i.ibb.co/jTttwqF/PIM.png"}}}},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Time-limited-admin-roles-in-Microsoft-365-rZzausKJ1"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"Admin1 has an End time of permanent which means \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time\" is not being performed.","depth":0,"entityRanges":[],"key":"4v7ki"},{"inlineStyleRanges":[],"type":"unstyled","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Time-limited-admin-roles-in-Microsoft-365-rZzausKJ1","key":"c2sh1","depth":0,"entityRanges":[{"offset":0,"key":0,"length":94}]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
