...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Change the Assignment Type for Admin2 to Permanent","isCorrectAnswer":false},{"value":" From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1","isCorrectAnswer":false},{"value":"Change the Assignment Type for Admin1 to Eligible","isCorrectAnswer":true}],"id":"nem2vQvYa","question":{"entityMap":{"0":{"type":"IMAGE","data":{"alignment":"left","width":"auto","height":"auto","src":"https://i.ibb.co/jTttwqF/PIM.png","alt":"PIM Role Assignments"},"mutability":"MUTABLE"}},"blocks":[{"entityRanges":[],"depth":0,"key":"39hpc","type":"unstyled","inlineStyleRanges":[{"length":21,"offset":0,"style":"BOLD"}],"data":{},"text":"Security Requirements"},{"depth":0,"key":"4uds1","data":{},"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","depth":0,"key":"7sb4h"},{"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","key":"bvsrl"},{"type":"unordered-list-item","entityRanges":[],"depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"key":"4e8ef","inlineStyleRanges":[]},{"data":{},"entityRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"6586j","depth":0,"type":"unordered-list-item","inlineStyleRanges":[]},{"type":"unordered-list-item","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{},"key":"7hq3i"},{"data":{},"entityRanges":[],"key":"66mb6","inlineStyleRanges":[],"type":"unordered-list-item","depth":0,"text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"text":"The principle of least privilege must be used whenever possible","entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unordered-list-item","depth":0,"key":"egt36"},{"type":"unstyled","depth":0,"text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit.","inlineStyleRanges":[],"data":{},"key":"f8uih","entityRanges":[]},{"data":{},"text":" ","type":"atomic","key":"faafp","inlineStyleRanges":[],"depth":0,"entityRanges":[{"offset":0,"key":0,"length":1}]},{"depth":0,"key":"c4u9i","inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"data":{},"text":"What should you do to meet the security requirements?"}]},"references":{"blocks":[{"entityRanges":[],"key":"4v7ki","text":"Admin1 has an End time of permanent which means \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time\" is not being performed.","type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{}},{"inlineStyleRanges":[],"key":"c2sh1","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Time-limited-admin-roles-in-Microsoft-365-rZzausKJ1","type":"unstyled","entityRanges":[{"key":0,"offset":0,"length":94}],"depth":0}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Time-limited-admin-roles-in-Microsoft-365-rZzausKJ1","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
