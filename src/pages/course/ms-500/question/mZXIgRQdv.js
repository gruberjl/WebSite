...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"text":"https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-anti-phishing-policies","key":"39d3s","entityRanges":[],"depth":0,"data":{},"type":"unstyled","inlineStyleRanges":[]}],"entityMap":{}},"id":"mZXIgRQdv","question":{"entityMap":{},"blocks":[{"depth":0,"data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"key":"6h19c","text":"You have a hybrid Microsoft Exchange Server organization. All users have Microsoft 365 E5 licenses."},{"key":"4mfqg","type":"unstyled","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"You plan to implement an Advanced Threat Protection (ATP) anti-phishing policy."},{"depth":0,"key":"337al","type":"unstyled","text":"You need to enable mailbox intelligence for all users.","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"key":"455vc","type":"unstyled","entityRanges":[],"data":{},"text":"What should you do first?","inlineStyleRanges":[],"depth":0}]},"answers":[{"value":"Configure attribute filtering in Microsoft Azure Active Directory Connect (Azure AD Connect)","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Purchase the ATP add-on"},{"isCorrectAnswer":false,"value":"Select Directory extension attribute sync in Microsoft Azure Active Directory Connect (Azure AD Connect)"},{"value":"Migrate the on-premises mailboxes to Exchange Online","isCorrectAnswer":true}]},
      previousQuestionId: '',
      nextQuestionId: '',
