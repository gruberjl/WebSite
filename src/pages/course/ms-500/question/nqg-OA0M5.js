...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Users should be automatically added to the security group corresponding to their department: dynamic groups"},{"value":"Users should be automatically added to the security group corresponding to their department: Access packages","isCorrectAnswer":false},{"value":"Users should be automatically added to the security group corresponding to their department: Conditional access policies","isCorrectAnswer":false},{"value":"Users should be automatically added to the security group corresponding to their department: Assigned groups","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"All group owners must verify their group membership: Access reviews"},{"isCorrectAnswer":false,"value":"All group owners must verify their group membership: Access packages"},{"isCorrectAnswer":false,"value":"All group owners must verify their group membership: Dynamic groups"},{"value":"All group owners must verify their group membership: Data loss prevention policies","isCorrectAnswer":false}],"id":"nqg-OA0M5","question":{"entityMap":{},"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"Your organization has a Microsoft 365 tenant. User accounts are synced from your organization's human resources system to Azure AD.","type":"unstyled","key":"3v3m9","depth":0},{"key":"62b11","type":"unstyled","text":"Your organization has five departments that each have there own Microsoft SharePoint Online site. Every user must be granted access to their own department's site. No users should be able to access a site that is not a member of the site's respective department.","inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[]},{"depth":0,"key":"a1nta","type":"unstyled","entityRanges":[],"text":"Your manager has asked you to configure the security of the SharePoint sites. He's given you the following requirements:","inlineStyleRanges":[],"data":{}},{"key":"7l3dd","depth":0,"entityRanges":[],"data":{},"type":"unordered-list-item","inlineStyleRanges":[],"text":"Users should be automatically added to the security group corresponding to their department."},{"key":"5pl79","type":"unordered-list-item","depth":0,"text":"All group owners must verify their group membership only contains their department's users once a month.","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"depth":0,"data":{},"text":"How do you configure Microsoft 365 to meet the security requirements?","type":"unstyled","key":"fospn"}]},"references":{"blocks":[{"depth":0,"type":"unstyled","text":"To automatically add users to groups the group type must be dynamic.","entityRanges":[],"data":{},"key":"3gl08","inlineStyleRanges":[]},{"text":"To have owners verify group members' monthly access reviews must be used.","type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"7habk","depth":0},{"data":{},"depth":0,"entityRanges":[{"length":95,"offset":0,"key":0}],"type":"unstyled","inlineStyleRanges":[],"key":"ao7qg","text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-users-through-groups-S1hQgFOMV"}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-users-through-groups-S1hQgFOMV"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
