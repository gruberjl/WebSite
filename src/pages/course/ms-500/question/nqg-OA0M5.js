...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"nqg-OA0M5","question":{"blocks":[{"depth":0,"key":"3v3m9","text":"You have a Microsoft 365 tenant.","data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[]},{"text":"User attributes are synced from your companies human resources (HR) system to Azure Active Directory (Azure AD).","data":{},"entityRanges":[],"key":"cph5f","depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"62b11","text":"The company has four departments that each has its own Microsoft SharePoint Online site. Each site must be accessed only by the users from its respective department.","entityRanges":[],"data":{}},{"key":"a1nta","type":"unstyled","inlineStyleRanges":[],"text":"You are designing an access management solution that has the following requirements:","data":{},"depth":0,"entityRanges":[]},{"data":{},"inlineStyleRanges":[],"text":"Users must be added automatically to the security group of their department.","entityRanges":[],"key":"7l3dd","type":"unordered-list-item","depth":0},{"depth":0,"text":"All security group owners must verify once quarterly that only the users in their department belong to their group.","type":"unordered-list-item","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"5pl79"},{"key":"3rtu","depth":0,"data":{},"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"Which components should you recommend to meet the requirements?"}],"entityMap":{}},"answers":[{"isCorrectAnswer":true,"value":"Users must be automatically added to the security group for their department: dynamic groups"},{"isCorrectAnswer":false,"value":"Users must be automatically added to the security group for their department: Access packages"},{"isCorrectAnswer":false,"value":"Users must be automatically added to the security group for their department: Conditional access policies"},{"value":"Users must be automatically added to the security group for their department: Assigned groups","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Group owners must verify membership of department groups: Access reviews"},{"value":"Group owners must verify membership of department groups: Access packages","isCorrectAnswer":false},{"value":"Group owners must verify membership of department groups: Dynamic groups","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Group owners must verify membership of department groups: Data loss prevention (DLP) policies"}],"references":{"entityMap":{},"blocks":[{"type":"unstyled","depth":0,"entityRanges":[],"data":{},"text":"","inlineStyleRanges":[],"key":"3gl08"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
