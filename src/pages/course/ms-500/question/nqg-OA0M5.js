...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"nqg-OA0M5","references":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"type":"unstyled","key":"3gl08","depth":0,"entityRanges":[],"data":{},"text":""}]},"answers":[{"value":"Users must be automatically added to the security group for their department: dynamic groups","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Users must be automatically added to the security group for their department: Access packages"},{"value":"Users must be automatically added to the security group for their department: Conditional access policies","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Users must be automatically added to the security group for their department: Assigned groups"},{"value":"Group owners must verify membership of department groups: Access reviews","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Group owners must verify membership of department groups: Access packages"},{"isCorrectAnswer":false,"value":"Group owners must verify membership of department groups: Dynamic groups"},{"value":"Group owners must verify membership of department groups: Data loss prevention (DLP) policies","isCorrectAnswer":false}],"question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"text":"You have a Microsoft 365 tenant.","entityRanges":[],"type":"unstyled","data":{},"key":"3v3m9","depth":0},{"key":"cph5f","text":"User attributes are synced from your companies human resources (HR) system to Azure Active Directory (Azure AD).","data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0},{"data":{},"depth":0,"entityRanges":[],"type":"unstyled","key":"62b11","inlineStyleRanges":[],"text":"The company has four departments that each has its own Microsoft SharePoint Online site. Each site must be accessed only by the users from its respective department."},{"depth":0,"text":"You are designing an access management solution that has the following requirements:","data":{},"key":"a1nta","entityRanges":[],"type":"unstyled","inlineStyleRanges":[]},{"key":"7l3dd","text":"Users must be added automatically to the security group of their department.","depth":0,"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"data":{}},{"type":"unordered-list-item","inlineStyleRanges":[],"data":{},"depth":0,"key":"5pl79","entityRanges":[],"text":"All security group owners must verify once quarterly that only the users in their department belong to their group."},{"inlineStyleRanges":[],"key":"3rtu","entityRanges":[],"text":"Which components should you recommend to meet the requirements?","data":{},"depth":0,"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
