...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"In the compliance admin center create a Data Loss Prevention Policy that blocks users from sending information covered under the U.K. Data Protection Act with an exception for gitbit.org"},{"isCorrectAnswer":false,"value":"In the Exchange Admin center create a mail flow rule to block inbound emails that contain information covered in the U.K. Data Protection Act with an exception for gitbit.org"},{"isCorrectAnswer":false,"value":"In the Azure Active Ad admin center create a label that marks emails that contain information covered in the U.K. Data Protection Actwith an exception for gitbit.org"}],"id":"4_zZu6GYm","question":{"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{},"key":"2mndm","depth":0,"text":"You need to prevent any emails that contain information covered by the U.K. Data Protection Act from being sent to people outside of your organization unless the messages are sent to an external domain named gitbit.org."},{"text":"What should you do to set it up?","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":32,"offset":0},{"length":32,"style":"bgcolor-rgb(255,255,255)","offset":0},{"style":"fontsize-16","offset":0,"length":32},{"length":32,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":0}],"depth":0,"type":"unstyled","key":"a99n8","entityRanges":[],"data":{}}],"entityMap":{}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","targetOption":"_blank"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.iorad.com/player/1801811/MS-500---Prevent-any-email-messages-that-contain-data-covered-by-the-U-K--Data-Protection-Act"}}},"blocks":[{"text":"A Data loss prevention (DLP) policy would prevent data from leaving the company that is covered under the U.K. Data Protection Act.","depth":0,"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":5,"offset":24},{"length":5,"offset":24,"style":"bgcolor-rgb(255,255,255)"},{"style":"fontsize-16","offset":24,"length":5},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":5,"offset":24}],"entityRanges":[],"key":"efejo","data":{},"type":"unstyled"},{"entityRanges":[{"key":0,"length":116,"offset":0}],"depth":0,"type":"unstyled","data":{},"key":"67ehb","text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w ","inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[{"length":130,"offset":0,"key":1}],"key":"9uen4","data":{},"depth":0,"type":"unstyled","text":"https://www.iorad.com/player/1801811/MS-500---Prevent-any-email-messages-that-contain-data-covered-by-the-U-K--Data-Protection-Act"},{"entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[],"text":"Open the Microsoft 365 Compliance admin center > Policies > Data loss prevention > Policies > Create policy > Privacy > U.K. Data Protection Act > Next > Disable all locations except Exchange email > Create or customize advanced DLP rules > add an exception and block emails from going outbound > Save your new policy.","type":"ordered-list-item","key":"3ekuh"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
