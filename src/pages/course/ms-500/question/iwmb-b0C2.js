...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{},"blocks":[{"entityRanges":[],"depth":0,"type":"unstyled","inlineStyleRanges":[],"data":{},"key":"68vch","text":"https://www.iorad.com/player/1797275/MS-500---How-to-enable-MFA-for-a-single-user"},{"key":"8hnp0","text":"Open the Microsoft 365 admin center","entityRanges":[],"depth":0,"type":"ordered-list-item","inlineStyleRanges":[],"data":{}},{"data":{},"entityRanges":[],"text":"Go to Users > Active Users > Multi-factor authentication.","key":"c1782","depth":0,"type":"ordered-list-item","inlineStyleRanges":[]},{"type":"ordered-list-item","text":"Click the user.","entityRanges":[],"key":"63mac","data":{},"depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"type":"ordered-list-item","depth":0,"key":"fc25c","inlineStyleRanges":[],"text":"Click Enable."}]},"question":{"entityMap":{},"blocks":[{"depth":0,"entityRanges":[],"key":"aa2i5","type":"unstyled","text":"You need to ensure that a user named John uses multi-factor authentication (MFA) for all authentication requests.","inlineStyleRanges":[],"data":{}},{"text":"What steps should you take to complete the task?","data":{},"entityRanges":[],"inlineStyleRanges":[{"length":48,"offset":0,"style":"color-rgb(33,37,41)"},{"style":"bgcolor-rgb(255,255,255)","offset":0,"length":48},{"style":"fontsize-16","length":48,"offset":0},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":0,"length":48}],"type":"unstyled","depth":0,"key":"11aed"}]},"id":"iwmb-b0C2","answers":[{"value":"Open Microsoft 365 admin center. Go to Users > Active Users > Multi-factor authentication. Click the user. Click Enable.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Open Azure AD admin center. Go to Users > Active Users > Multi-factor authentication. Click the user. Click Enable."},{"isCorrectAnswer":false,"value":"Open Endpoint admin center. Go to Users > Active Users > Multi-factor authentication. Click the user. Click Enable."}]},
      previousQuestionId: '',
      nextQuestionId: '',
