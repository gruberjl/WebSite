...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"When UserB submits a request to activate the role, User1 can approve the request."},{"value":"When UserB submits a request to activate the role, User2 can approve the request.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"When UserC submits a request to activate the role, User3 can approve the request."}],"id":"i2EPEDfe7","question":{"blocks":[{"depth":0,"entityRanges":[],"type":"unstyled","text":"your organization has a Microsoft 365 tenant with the following users.","key":"2u085","inlineStyleRanges":[],"data":{}},{"text":" ","key":"7nj32","data":{},"type":"atomic","entityRanges":[{"key":0,"offset":0,"length":1}],"depth":0,"inlineStyleRanges":[]},{"depth":0,"type":"unstyled","key":"q8g8","entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"Your organization has implemented Azure Active Directory (Azure AD) Privileged Identity Management (PIM)."},{"type":"unstyled","depth":0,"data":{},"text":"From PIM, you see the Application Administrator role has the following users.","key":"9t9i0","entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[{"key":1,"length":1,"offset":0}],"inlineStyleRanges":[],"text":" ","data":{},"key":"4e1ch","depth":0,"type":"atomic"},{"text":"PIM is configured to use the following settings for users with the Application Administrator role assigned.","type":"unstyled","data":{},"entityRanges":[],"key":"dqtr5","depth":0,"inlineStyleRanges":[]},{"depth":0,"text":"Require approval to activate: Yes","data":{},"key":"fs7s9","inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item"},{"type":"unordered-list-item","text":"Approvers: None","data":{},"entityRanges":[],"key":"aqgof","depth":0,"inlineStyleRanges":[]},{"depth":0,"type":"unstyled","inlineStyleRanges":[],"key":"bpudn","data":{},"entityRanges":[],"text":"Check the box next to each true statement."}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","alignment":"left","src":"https://i.ibb.co/Cs1cMM8/Chart5.png","width":"auto","alt":"Name Role Chart"}},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","src":"https://i.ibb.co/FVBbzdZ/Chart6.png","alt":"Name Assignment Type Chart","height":"auto","width":"auto"}}}},"references":{"blocks":[{"entityRanges":[],"data":{},"key":"jsce","inlineStyleRanges":[],"type":"unstyled","depth":0,"text":"Only global administrators and privileged role administrators can approve the admin role assignments."},{"data":{},"depth":0,"entityRanges":[{"length":124,"offset":0,"key":0}],"type":"unstyled","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s ","key":"4ru2o"}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","targetOption":"_blank"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
