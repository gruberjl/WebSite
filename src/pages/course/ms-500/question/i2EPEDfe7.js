...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"When UserB submits a request to activate the role, User1 can approve the request.","isCorrectAnswer":true},{"value":"When UserB submits a request to activate the role, User2 can approve the request.","isCorrectAnswer":true},{"value":"When UserC submits a request to activate the role, User3 can approve the request.","isCorrectAnswer":false}],"id":"i2EPEDfe7","question":{"blocks":[{"type":"unstyled","entityRanges":[],"text":"your organization has a Microsoft 365 tenant with the following users.","key":"2u085","depth":0,"data":{},"inlineStyleRanges":[]},{"key":"7nj32","text":" ","depth":0,"inlineStyleRanges":[],"type":"atomic","entityRanges":[{"length":1,"key":0,"offset":0}],"data":{}},{"depth":0,"data":{},"key":"q8g8","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"Your organization has implemented Azure Active Directory (Azure AD) Privileged Identity Management (PIM)."},{"key":"9t9i0","data":{},"type":"unstyled","depth":0,"text":"From PIM, you see the Application Administrator role has the following users.","entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[{"key":1,"length":1,"offset":0}],"key":"4e1ch","type":"atomic","text":" ","data":{},"inlineStyleRanges":[],"depth":0},{"type":"unstyled","data":{},"depth":0,"text":"PIM is configured to use the following settings for users with the Application Administrator role assigned.","entityRanges":[],"inlineStyleRanges":[],"key":"dqtr5"},{"type":"unordered-list-item","entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"fs7s9","data":{},"text":"Require approval to activate: Yes"},{"data":{},"inlineStyleRanges":[],"depth":0,"key":"aqgof","text":"Approvers: None","type":"unordered-list-item","entityRanges":[]},{"text":"Check the box next to each true statement.","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"bpudn"}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"alt":"Name Role Chart","alignment":"left","height":"auto","src":"https://i.ibb.co/Cs1cMM8/Chart5.png","width":"auto"}},"1":{"data":{"alt":"Name Assignment Type Chart","height":"auto","width":"auto","src":"https://i.ibb.co/FVBbzdZ/Chart6.png","alignment":"left"},"type":"IMAGE","mutability":"MUTABLE"}}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","targetOption":"_blank"}}},"blocks":[{"type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"Only global administrators and privileged role administrators can approve the admin role assignments.","entityRanges":[],"key":"jsce","data":{}},{"type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":124,"key":0}],"data":{},"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s ","key":"4ru2o"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
