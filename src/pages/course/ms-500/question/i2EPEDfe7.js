...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"When UserB submits a request to activate the role, User1 can approve the request."},{"value":"When UserB submits a request to activate the role, User2 can approve the request.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"When UserC submits a request to activate the role, User3 can approve the request."}],"id":"i2EPEDfe7","question":{"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","height":"auto","alt":"Name Role Chart","width":"auto","src":"https://i.ibb.co/Cs1cMM8/Chart5.png"}},"1":{"mutability":"MUTABLE","data":{"height":"auto","alignment":"left","width":"auto","alt":"Name Assignment Type Chart","src":"https://i.ibb.co/FVBbzdZ/Chart6.png"},"type":"IMAGE"}},"blocks":[{"data":{},"key":"2u085","entityRanges":[],"depth":0,"text":"your organization has a Microsoft 365 tenant with the following users.","inlineStyleRanges":[],"type":"unstyled"},{"key":"7nj32","type":"atomic","entityRanges":[{"length":1,"offset":0,"key":0}],"inlineStyleRanges":[],"depth":0,"data":{},"text":" "},{"key":"q8g8","depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"Your organization has implemented Azure Active Directory (Azure AD) Privileged Identity Management (PIM).","data":{}},{"key":"9t9i0","depth":0,"text":"From PIM, you see the Application Administrator role has the following users.","inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"data":{}},{"depth":0,"type":"atomic","data":{},"key":"4e1ch","inlineStyleRanges":[],"text":" ","entityRanges":[{"key":1,"offset":0,"length":1}]},{"data":{},"entityRanges":[],"depth":0,"type":"unstyled","key":"dqtr5","text":"PIM is configured to use the following settings for users with the Application Administrator role assigned.","inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"type":"unordered-list-item","data":{},"text":"Require approval to activate: Yes","inlineStyleRanges":[],"key":"fs7s9"},{"text":"Approvers: None","depth":0,"key":"aqgof","data":{},"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[]},{"data":{},"text":"Check the box next to each true statement.","depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"key":"bpudn"}]},"references":{"blocks":[{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"text":"Only global administrators and privileged role administrators can approve the admin role assignments.","key":"jsce","depth":0,"data":{}},{"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s ","data":{},"entityRanges":[{"key":0,"length":124,"offset":0}],"key":"4ru2o","inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
