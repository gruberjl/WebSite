...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"When UserB submits a request to activate the role, User1 can approve the request."},{"isCorrectAnswer":true,"value":"When UserB submits a request to activate the role, User2 can approve the request."},{"value":"When UserC submits a request to activate the role, User3 can approve the request.","isCorrectAnswer":false}],"id":"i2EPEDfe7","question":{"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","alt":"Name Role Chart","alignment":"left","src":"https://i.ibb.co/Cs1cMM8/Chart5.png","width":"auto"}},"1":{"mutability":"MUTABLE","data":{"src":"https://i.ibb.co/FVBbzdZ/Chart6.png","width":"auto","alignment":"left","height":"auto","alt":"Name Assignment Type Chart"},"type":"IMAGE"}},"blocks":[{"entityRanges":[],"text":"your organization has a Microsoft 365 tenant with the following users.","key":"2u085","data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"depth":0,"data":{},"text":" ","key":"7nj32","entityRanges":[{"offset":0,"key":0,"length":1}],"inlineStyleRanges":[],"type":"atomic"},{"key":"q8g8","depth":0,"text":"Your organization has implemented Azure Active Directory (Azure AD) Privileged Identity Management (PIM).","type":"unstyled","inlineStyleRanges":[],"data":{},"entityRanges":[]},{"depth":0,"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"text":"From PIM, you see the Application Administrator role has the following users.","key":"9t9i0","data":{}},{"data":{},"entityRanges":[{"key":1,"length":1,"offset":0}],"text":" ","depth":0,"type":"atomic","key":"4e1ch","inlineStyleRanges":[]},{"entityRanges":[],"key":"dqtr5","text":"PIM is configured to use the following settings for users with the Application Administrator role assigned.","inlineStyleRanges":[],"data":{},"depth":0,"type":"unstyled"},{"depth":0,"type":"unordered-list-item","data":{},"text":"Require approval to activate: Yes","entityRanges":[],"key":"fs7s9","inlineStyleRanges":[]},{"depth":0,"type":"unordered-list-item","inlineStyleRanges":[],"data":{},"text":"Approvers: None","key":"aqgof","entityRanges":[]},{"key":"bpudn","entityRanges":[],"data":{},"depth":0,"text":"Check the box next to each true statement.","type":"unstyled","inlineStyleRanges":[]}]},"references":{"blocks":[{"data":{},"inlineStyleRanges":[],"key":"jsce","text":"Only global administrators and privileged role administrators can approve the admin role assignments.","entityRanges":[],"type":"unstyled","depth":0},{"key":"4ru2o","text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s ","inlineStyleRanges":[],"entityRanges":[{"key":0,"length":124,"offset":0}],"data":{},"type":"unstyled","depth":0}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
