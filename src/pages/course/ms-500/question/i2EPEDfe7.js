...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"If UserB requests the Application Administrator role, User1 can approve the request of UserB.","isCorrectAnswer":true},{"isCorrectAnswer":true,"value":"If UserB requests the Application Administrator role, User2 can approve the request of UserB."},{"isCorrectAnswer":false,"value":"If UserC requests the Application Administrator role, User3 can approve the request of UserC."}],"id":"i2EPEDfe7","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"alignment":"left","width":"auto","alt":"Name Role Chart","src":"https://i.ibb.co/Cs1cMM8/Chart5.png","height":"auto"},"type":"IMAGE"},"1":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","alignment":"left","width":"auto","alt":"Name Assignment Type Chart","src":"https://i.ibb.co/FVBbzdZ/Chart6.png"}}},"blocks":[{"data":{},"text":"You have a Microsoft 365 subscription that contains the users shown in the following table.","key":"2u085","depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[]},{"key":"7nj32","depth":0,"entityRanges":[{"length":1,"offset":0,"key":0}],"type":"atomic","inlineStyleRanges":[],"data":{},"text":" "},{"entityRanges":[],"depth":0,"key":"q8g8","type":"unstyled","text":"You implement Azure Active Directory (Azure AD) Privileged Identity Management (PIM).","data":{},"inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"key":"9t9i0","text":"From PIM, you review the Application Administrator role and discover the users shown in the following table.","type":"unstyled","data":{}},{"key":"4e1ch","inlineStyleRanges":[],"depth":0,"data":{},"text":" ","entityRanges":[{"length":1,"offset":0,"key":1}],"type":"atomic"},{"inlineStyleRanges":[],"depth":0,"data":{},"key":"dqtr5","entityRanges":[],"text":"The Application Administrator role is configured to use the following settings in PIM:","type":"unstyled"},{"text":"Maximum activation duration: 1 hour","type":"unordered-list-item","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"key":"fs7s9"},{"entityRanges":[],"data":{},"depth":0,"type":"unordered-list-item","inlineStyleRanges":[],"text":"Notifications: Disable","key":"8gga0"},{"data":{},"text":"Incident/Request ticket: Disable","key":"95k91","depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[]},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unordered-list-item","key":"81cbp","text":"Multi-Factor Authentication: Disable"},{"data":{},"inlineStyleRanges":[],"type":"unordered-list-item","depth":0,"text":"Require approval: Enable","entityRanges":[],"key":"91o23"},{"inlineStyleRanges":[],"key":"aqgof","depth":0,"entityRanges":[],"data":{},"text":"Selected approver: No results","type":"unordered-list-item"},{"text":"Check the box next to each of the following statements if the statement is true.","depth":0,"entityRanges":[],"key":"bpudn","data":{},"inlineStyleRanges":[],"type":"unstyled"}]},"references":{"blocks":[{"text":"Only global administrators and privileged role administrators can approve the admin role assignments.","inlineStyleRanges":[],"entityRanges":[],"depth":0,"key":"jsce","data":{},"type":"unstyled"},{"data":{},"depth":0,"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s ","type":"unstyled","entityRanges":[{"key":0,"length":124,"offset":0}],"key":"4ru2o"}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
