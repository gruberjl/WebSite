...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"When UserB submits a request to activate the role, User1 can approve the request."},{"value":"When UserB submits a request to activate the role, User2 can approve the request.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"When UserC submits a request to activate the role, User3 can approve the request."}],"id":"i2EPEDfe7","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"height":"auto","alignment":"left","src":"https://i.ibb.co/Cs1cMM8/Chart5.png","alt":"Name Role Chart","width":"auto"},"type":"IMAGE"},"1":{"data":{"height":"auto","width":"auto","alignment":"left","alt":"Name Assignment Type Chart","src":"https://i.ibb.co/FVBbzdZ/Chart6.png"},"type":"IMAGE","mutability":"MUTABLE"}},"blocks":[{"type":"unstyled","inlineStyleRanges":[],"key":"2u085","text":"your organization has a Microsoft 365 tenant with the following users.","depth":0,"entityRanges":[],"data":{}},{"entityRanges":[{"length":1,"key":0,"offset":0}],"data":{},"text":" ","depth":0,"type":"atomic","inlineStyleRanges":[],"key":"7nj32"},{"key":"q8g8","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{},"depth":0,"text":"Your organization has implemented Azure Active Directory (Azure AD) Privileged Identity Management (PIM)."},{"data":{},"text":"From PIM, you see the Application Administrator role has the following users.","type":"unstyled","key":"9t9i0","entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"depth":0,"key":"4e1ch","data":{},"entityRanges":[{"length":1,"offset":0,"key":1}],"text":" ","type":"atomic","inlineStyleRanges":[]},{"depth":0,"type":"unstyled","key":"dqtr5","text":"PIM is configured to use the following settings for users with the Application Administrator role assigned.","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"data":{},"type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"text":"Require approval to activate: Yes","depth":0,"key":"fs7s9"},{"entityRanges":[],"text":"Approvers: None","key":"aqgof","type":"unordered-list-item","depth":0,"data":{},"inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unstyled","text":"Check the box next to each true statement.","key":"bpudn","data":{}}]},"references":{"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unstyled","depth":0,"text":"Only global administrators and privileged role administrators can approve the admin role assignments.","key":"jsce"},{"key":"4ru2o","data":{},"inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":0,"length":124}],"type":"unstyled","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s "}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
