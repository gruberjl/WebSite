...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the action to block current and future messages and attachments with detected malware."},{"isCorrectAnswer":false,"value":"Add an exception for emails coming from gitbit.org"},{"value":"Add a condition","isCorrectAnswer":false},{"value":"Set the action to Dynamic Delivery","isCorrectAnswer":true}],"id":"HqQ5xjXNy","question":{"entityMap":{},"blocks":[{"key":"f48pv","text":"Your organization has a Microsoft 365 tenant with Microsoft 365 E5 licenses.","inlineStyleRanges":[],"data":{},"type":"unstyled","depth":0,"entityRanges":[]},{"depth":0,"key":"9sjqb","text":"You've just implemented a Defender for Office 365 safe attachments policy for your entire organization.","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[]},{"key":"c7c6m","data":{},"type":"unstyled","text":"Your help desk is getting calls that emails containing attachments are taking a long to be received.","entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled","depth":0,"text":"You need to reconfigure the safe attachments policy so emails are received more quickly but the attachments still need to be scanned for malware and any attachments with malware must be blocked.","key":"fj3du"},{"inlineStyleRanges":[],"depth":0,"entityRanges":[],"text":"How should you reconfigure the safe attachment policy?","key":"4jaft","type":"unstyled","data":{}}]},"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/office365/securitycompliance/dynamic-delivery-and-previewing"}}},"blocks":[{"text":"Sometimes safe attachments cause a delay in email delivery. When you're users complain that there is a delay when receiving emails with attachments then this option may be for you. In short, the email will be delivered automatically to the user's inbox and then after the scanning is complete the attachment will show up.","type":"unstyled","entityRanges":[],"depth":0,"data":{},"key":"aq9gm","inlineStyleRanges":[]},{"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","entityRanges":[{"key":0,"offset":0,"length":105}],"type":"unstyled","data":{},"inlineStyleRanges":[],"key":"6nn73"},{"entityRanges":[{"key":1,"offset":0,"length":93}],"depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{},"key":"3id4q","text":"https://docs.microsoft.com/en-us/office365/securitycompliance/dynamic-delivery-and-previewing"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
