...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the action to block current and future messages and attachments with detected malware."},{"isCorrectAnswer":false,"value":"Add an exception for emails coming from gitbit.org"},{"isCorrectAnswer":false,"value":"Add a condition"},{"isCorrectAnswer":true,"value":"Set the action to Dynamic Delivery"}],"id":"HqQ5xjXNy","question":{"blocks":[{"depth":0,"inlineStyleRanges":[],"key":"f48pv","data":{},"text":"Your organization has a Microsoft 365 tenant with Microsoft 365 E5 licenses.","type":"unstyled","entityRanges":[]},{"depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"9sjqb","text":"You've just implemented a Defender for Office 365 safe attachments policy for your entire organization.","type":"unstyled"},{"key":"c7c6m","inlineStyleRanges":[],"text":"Your help desk is getting calls that emails containing attachments are taking a long to be received.","entityRanges":[],"data":{},"type":"unstyled","depth":0},{"depth":0,"type":"unstyled","entityRanges":[],"key":"fj3du","text":"You need to reconfigure the safe attachments policy so emails are received more quickly but the attachments still need to be scanned for malware and any attachments with malware must be blocked.","data":{},"inlineStyleRanges":[]},{"depth":0,"text":"How should you reconfigure the safe attachment policy?","entityRanges":[],"key":"4jaft","inlineStyleRanges":[],"type":"unstyled","data":{}}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"},"1":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/office365/securitycompliance/dynamic-delivery-and-previewing"},"type":"LINK"}},"blocks":[{"text":"Sometimes safe attachments cause a delay in email delivery. When you're users complain that there is a delay when receiving emails with attachments then this option may be for you. In short, the email will be delivered automatically to the user's inbox and then after the scanning is complete the attachment will show up.","inlineStyleRanges":[],"key":"aq9gm","type":"unstyled","depth":0,"entityRanges":[],"data":{}},{"data":{},"depth":0,"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","key":"6nn73","inlineStyleRanges":[],"entityRanges":[{"key":0,"length":105,"offset":0}]},{"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/office365/securitycompliance/dynamic-delivery-and-previewing","entityRanges":[{"key":1,"length":93,"offset":0}],"key":"3id4q","depth":0,"data":{},"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
