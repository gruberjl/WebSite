...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the action to block current and future messages and attachments with detected malware."},{"value":"Add an exception for emails coming from gitbit.org","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Add a condition"},{"isCorrectAnswer":true,"value":"Set the action to Dynamic Delivery"}],"id":"HqQ5xjXNy","question":{"entityMap":{},"blocks":[{"entityRanges":[],"depth":0,"key":"f48pv","text":"Your organization has a Microsoft 365 tenant with Microsoft 365 E5 licenses.","data":{},"inlineStyleRanges":[],"type":"unstyled"},{"depth":0,"type":"unstyled","text":"You've just implemented a Defender for Office 365 safe attachments policy for your entire organization.","inlineStyleRanges":[],"entityRanges":[],"data":{},"key":"9sjqb"},{"entityRanges":[],"text":"Your help desk is getting calls that emails containing attachments are taking a long to be received.","type":"unstyled","inlineStyleRanges":[],"data":{},"key":"c7c6m","depth":0},{"key":"fj3du","data":{},"depth":0,"entityRanges":[],"text":"You need to reconfigure the safe attachments policy so emails are received more quickly but the attachments still need to be scanned for malware and any attachments with malware must be blocked.","inlineStyleRanges":[],"type":"unstyled"},{"text":"How should you reconfigure the safe attachment policy?","entityRanges":[],"key":"4jaft","data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled"}]},"references":{"blocks":[{"entityRanges":[],"data":{},"type":"unstyled","text":"Sometimes safe attachments cause a delay in email delivery. When you're users complain that there is a delay when receiving emails with attachments then this option may be for you. In short, the email will be delivered automatically to the user's inbox and then after the scanning is complete the attachment will show up.","inlineStyleRanges":[],"key":"aq9gm","depth":0},{"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","data":{},"inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":105,"key":0}],"key":"6nn73","type":"unstyled"},{"text":"https://docs.microsoft.com/en-us/office365/securitycompliance/dynamic-delivery-and-previewing","type":"unstyled","data":{},"entityRanges":[{"length":93,"offset":0,"key":1}],"key":"3id4q","depth":0,"inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"},"type":"LINK","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/office365/securitycompliance/dynamic-delivery-and-previewing"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
