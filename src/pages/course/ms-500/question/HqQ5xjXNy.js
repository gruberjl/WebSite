...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the action to block current and future messages and attachments with detected malware."},{"value":"Add an exception for emails coming from gitbit.org","isCorrectAnswer":false},{"value":"Add a condition","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Set the action to Dynamic Delivery"}],"id":"HqQ5xjXNy","question":{"blocks":[{"depth":0,"data":{},"key":"f48pv","entityRanges":[],"inlineStyleRanges":[],"text":"Your organization has a Microsoft 365 tenant with Microsoft 365 E5 licenses.","type":"unstyled"},{"depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[],"text":"You've just implemented a Defender for Office 365 safe attachments policy for your entire organization.","key":"9sjqb"},{"type":"unstyled","entityRanges":[],"depth":0,"data":{},"text":"Your help desk is getting calls that emails containing attachments are taking a long to be received.","key":"c7c6m","inlineStyleRanges":[]},{"key":"fj3du","depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"You need to reconfigure the safe attachments policy so emails are received more quickly but the attachments still need to be scanned for malware and any attachments with malware must be blocked.","data":{},"type":"unstyled"},{"key":"4jaft","text":"How should you reconfigure the safe attachment policy?","entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled","depth":0}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"},"mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/office365/securitycompliance/dynamic-delivery-and-previewing"},"type":"LINK"}},"blocks":[{"text":"Sometimes safe attachments cause a delay in email delivery. When you're users complain that there is a delay when receiving emails with attachments then this option may be for you. In short, the email will be delivered automatically to the user's inbox and then after the scanning is complete the attachment will show up.","depth":0,"type":"unstyled","key":"aq9gm","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","type":"unstyled","entityRanges":[{"key":0,"length":105,"offset":0}],"key":"6nn73","depth":0,"inlineStyleRanges":[],"data":{}},{"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"https://docs.microsoft.com/en-us/office365/securitycompliance/dynamic-delivery-and-previewing","depth":0,"entityRanges":[{"offset":0,"length":93,"key":1}],"key":"3id4q"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
