...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, assign a role group to Admin1."},{"isCorrectAnswer":false,"value":"From the Microsoft 365 admin center, assign a role to Admin1."},{"isCorrectAnswer":true,"value":"From the Microsoft Purview admin center, open the case and go to Settings > Access & permissions"}],"id":"fnZndWRTr","question":{"blocks":[{"data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"46kh2","type":"unstyled","text":"You have a Microsoft 365 subscription."},{"depth":0,"key":"6qs2l","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"The Global administrator role is assigned to your user account. You have a user named Admin1."},{"depth":0,"key":"653k","type":"unstyled","entityRanges":[],"text":"You create an eDiscovery case named Case1.","data":{},"inlineStyleRanges":[]},{"type":"unstyled","inlineStyleRanges":[],"data":{},"entityRanges":[],"depth":0,"key":"3avhu","text":"You need to ensure that Admin1 can view the results of Case1."},{"type":"unstyled","text":"What should you do first?","inlineStyleRanges":[],"entityRanges":[],"key":"chmgb","depth":0,"data":{}}],"entityMap":{}},"references":{"blocks":[{"type":"unstyled","text":"The user will need the eDiscovery Manager role assigned and then be given the permissions to the case.","data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"20j6g","depth":0},{"entityRanges":[],"depth":0,"text":"1. Go to Microsoft Purview admin center > Permissions > Microsoft Purview solutions roles  > eDiscovery Manager. Click Edit next to eDiscovery Manager.","inlineStyleRanges":[],"key":"6f8bi","data":{},"type":"unstyled"},{"entityRanges":[],"key":"7eq0k","inlineStyleRanges":[],"text":"2. Click Choose eDisvoery Manager > Add. Click the member you want to grant permissions to. Click Add. Click Done > Save.","depth":0,"type":"unstyled","data":{}},{"inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":0,"length":114}],"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","depth":0,"type":"unstyled","data":{},"key":"ch81d"},{"text":"https://docs.microsoft.com/en-us/office365/securitycompliance/assign-ediscovery-permissions","entityRanges":[{"offset":0,"key":1,"length":91}],"type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"3uetn","data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","targetOption":"_blank"},"type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/office365/securitycompliance/assign-ediscovery-permissions","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
