...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{},"blocks":[{"type":"unstyled","text":"https://docs.microsoft.com/en-us/office365/securitycompliance/assign-ediscovery-permissions","depth":0,"inlineStyleRanges":[],"data":{},"key":"20j6g","entityRanges":[]}]},"id":"fnZndWRTr","answers":[{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, assign a role group to Admin1."},{"value":"From the Microsoft 365 admin center, assign a role to Admin1.","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"From the Security & Compliance admin center, assign a role group to Admin1."}],"question":{"entityMap":{},"blocks":[{"text":"You have a Microsoft 365 subscription.","data":{},"inlineStyleRanges":[],"key":"46kh2","type":"unstyled","entityRanges":[],"depth":0},{"data":{},"depth":0,"key":"6qs2l","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"The Global administrator role is assigned to your user account. You have a user named Admin1."},{"text":"You create an eDiscovery case named Case1.","data":{},"key":"653k","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","depth":0},{"inlineStyleRanges":[],"type":"unstyled","data":{},"depth":0,"text":"You need to ensure that Admin1 can view the results of Case1.","entityRanges":[],"key":"3avhu"},{"key":"chmgb","inlineStyleRanges":[],"text":"What should you do first?","entityRanges":[],"data":{},"depth":0,"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
