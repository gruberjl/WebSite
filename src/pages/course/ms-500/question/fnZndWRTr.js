...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Azure Active Directory admin center, assign a role group to Admin1.","isCorrectAnswer":false},{"value":"From the Microsoft 365 admin center, assign a role to Admin1.","isCorrectAnswer":false},{"value":"From the Microsoft Purview admin center, open the case and go to Settings > Access & permissions","isCorrectAnswer":true}],"id":"fnZndWRTr","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unstyled","depth":0,"text":"You have a Microsoft 365 subscription.","key":"46kh2"},{"depth":0,"key":"6qs2l","inlineStyleRanges":[],"type":"unstyled","text":"The Global administrator role is assigned to your user account. You have a user named Admin1.","data":{},"entityRanges":[]},{"data":{},"entityRanges":[],"depth":0,"key":"653k","type":"unstyled","text":"You create an eDiscovery case named Case1.","inlineStyleRanges":[]},{"inlineStyleRanges":[],"data":{},"key":"3avhu","depth":0,"type":"unstyled","text":"You need to ensure that Admin1 can view the results of Case1.","entityRanges":[]},{"key":"chmgb","entityRanges":[],"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"What should you do first?","data":{}}]},"references":{"blocks":[{"key":"20j6g","entityRanges":[],"text":"The user will need the eDiscovery Manager role assigned and then be given the permissions to the case.","inlineStyleRanges":[],"depth":0,"data":{},"type":"unstyled"},{"data":{},"depth":0,"key":"6f8bi","inlineStyleRanges":[],"text":"1. Go to Microsoft Purview admin center > Permissions > Microsoft Purview solutions roles  > eDiscovery Manager. Click Edit next to eDiscovery Manager.","entityRanges":[],"type":"unstyled"},{"text":"2. Click Choose eDisvoery Manager > Add. Click the member you want to grant permissions to. Click Add. Click Done > Save.","data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled","key":"7eq0k","entityRanges":[]},{"type":"unstyled","key":"ch81d","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","depth":0,"entityRanges":[{"length":114,"key":0,"offset":0}],"inlineStyleRanges":[]},{"data":{},"type":"unstyled","key":"3uetn","entityRanges":[{"offset":0,"length":91,"key":1}],"depth":0,"text":"https://docs.microsoft.com/en-us/office365/securitycompliance/assign-ediscovery-permissions","inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f"},"mutability":"MUTABLE","type":"LINK"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/office365/securitycompliance/assign-ediscovery-permissions"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
