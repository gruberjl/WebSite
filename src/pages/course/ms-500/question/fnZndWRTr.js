...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Azure Active Directory admin center, assign a role group to Admin1.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Microsoft 365 admin center, assign a role to Admin1."},{"isCorrectAnswer":true,"value":"From the Microsoft Purview admin center, open the case and go to Settings > Access & permissions"}],"id":"fnZndWRTr","question":{"blocks":[{"entityRanges":[],"data":{},"key":"46kh2","depth":0,"type":"unstyled","text":"You have a Microsoft 365 subscription.","inlineStyleRanges":[]},{"type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0,"key":"6qs2l","text":"The Global administrator role is assigned to your user account. You have a user named Admin1."},{"inlineStyleRanges":[],"data":{},"entityRanges":[],"text":"You create an eDiscovery case named Case1.","key":"653k","type":"unstyled","depth":0},{"type":"unstyled","depth":0,"key":"3avhu","entityRanges":[],"data":{},"text":"You need to ensure that Admin1 can view the results of Case1.","inlineStyleRanges":[]},{"entityRanges":[],"data":{},"depth":0,"text":"What should you do first?","key":"chmgb","type":"unstyled","inlineStyleRanges":[]}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","targetOption":"_blank"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/office365/securitycompliance/assign-ediscovery-permissions","targetOption":"_blank"}}},"blocks":[{"depth":0,"type":"unstyled","entityRanges":[],"key":"20j6g","inlineStyleRanges":[],"text":"The user will need the eDiscovery Manager role assigned and then be given the permissions to the case.","data":{}},{"key":"6f8bi","data":{},"inlineStyleRanges":[],"depth":0,"text":"1. Go to Microsoft Purview admin center > Permissions > Microsoft Purview solutions roles  > eDiscovery Manager. Click Edit next to eDiscovery Manager.","type":"unstyled","entityRanges":[]},{"type":"unstyled","key":"7eq0k","text":"2. Click Choose eDisvoery Manager > Add. Click the member you want to grant permissions to. Click Add. Click Done > Save.","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[]},{"depth":0,"entityRanges":[{"length":114,"key":0,"offset":0}],"key":"ch81d","text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","inlineStyleRanges":[],"type":"unstyled","data":{}},{"key":"3uetn","entityRanges":[{"key":1,"offset":0,"length":91}],"inlineStyleRanges":[],"depth":0,"data":{},"type":"unstyled","text":"https://docs.microsoft.com/en-us/office365/securitycompliance/assign-ediscovery-permissions"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
