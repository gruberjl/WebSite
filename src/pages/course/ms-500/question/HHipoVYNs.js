...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"HHipoVYNs","answers":[{"value":"Set the frequency to One time","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Set the frequency to Weekly"},{"isCorrectAnswer":false,"value":"Set the frequency to Monthly"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers"}],"question":{"blocks":[{"entityRanges":[],"type":"unstyled","inlineStyleRanges":[{"style":"BOLD","length":23,"offset":0}],"text":"Security Requirements: Fabrikam identifies the following security requirements:","data":{},"key":"312gb","depth":0},{"entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"key":"c0t0v","type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","depth":0,"entityRanges":[],"data":{},"key":"4kl8j","type":"unordered-list-item","inlineStyleRanges":[]},{"depth":0,"key":"7n342","type":"unordered-list-item","data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations"},{"entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[],"data":{},"type":"unordered-list-item","key":"4v2gu","depth":0},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"c5gnj","entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"depth":0,"data":{}},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"cmhvm","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","depth":0,"type":"unordered-list-item"},{"inlineStyleRanges":[],"data":{},"key":"ad81j","type":"unordered-list-item","entityRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0},{"depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"3v1so","type":"unordered-list-item","text":"The principle of least privilege must be used whenever possible"},{"type":"unstyled","entityRanges":[],"data":{},"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","inlineStyleRanges":[],"depth":0,"key":"f6ml2"},{"data":{},"type":"unstyled","key":"8jjma","entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area."}],"entityMap":{}},"references":{"blocks":[{"type":"unstyled","text":"","key":"ao1ti","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[]}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
