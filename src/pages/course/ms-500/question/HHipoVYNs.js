...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Set the frequency to One time","isCorrectAnswer":false},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"id":"HHipoVYNs","question":{"entityMap":{},"blocks":[{"text":"Security Requirements: GitBit identifies the following security requirements:","entityRanges":[],"data":{},"depth":0,"key":"312gb","type":"unstyled","inlineStyleRanges":[{"offset":0,"style":"BOLD","length":23}]},{"depth":0,"type":"unordered-list-item","entityRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","key":"c0t0v","data":{},"inlineStyleRanges":[]},{"depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","data":{},"inlineStyleRanges":[],"key":"4kl8j","type":"unordered-list-item","entityRanges":[]},{"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","depth":0,"data":{},"key":"7n342","entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[]},{"depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unordered-list-item","key":"4v2gu"},{"data":{},"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item","inlineStyleRanges":[],"key":"c5gnj","entityRanges":[],"depth":0},{"type":"unordered-list-item","entityRanges":[],"key":"cmhvm","inlineStyleRanges":[],"data":{},"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","depth":0},{"depth":0,"type":"unordered-list-item","data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"ad81j","text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"3v1so","depth":0,"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item"},{"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","entityRanges":[],"key":"f6ml2","depth":0},{"type":"unstyled","depth":0,"entityRanges":[],"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","key":"8jjma","inlineStyleRanges":[],"data":{}}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","targetOption":"_blank"}}},"blocks":[{"data":{},"text":"Setting the frequency to weekly allows you to review the roles every 7 days.","inlineStyleRanges":[],"type":"unstyled","key":"ao1ti","entityRanges":[],"depth":0},{"entityRanges":[],"depth":0,"key":"a38rm","data":{},"text":"You set the access to be removed under \"Upon completion settings\"","type":"unstyled","inlineStyleRanges":[]},{"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","key":"beg9g","type":"unstyled","data":{},"depth":0,"entityRanges":[{"key":0,"length":94,"offset":0}],"inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
