...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"isCorrectAnswer":true,"value":"Set the frequency to Weekly"},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers"}],"id":"HHipoVYNs","question":{"entityMap":{},"blocks":[{"entityRanges":[],"inlineStyleRanges":[{"offset":0,"length":23,"style":"BOLD"}],"data":{},"text":"Security Requirements: GitBit identifies the following security requirements:","key":"312gb","depth":0,"type":"unstyled"},{"depth":0,"data":{},"type":"unordered-list-item","key":"c0t0v","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","inlineStyleRanges":[],"entityRanges":[]},{"data":{},"key":"4kl8j","depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement"},{"depth":0,"key":"7n342","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"data":{}},{"depth":0,"data":{},"key":"4v2gu","inlineStyleRanges":[],"entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","type":"unordered-list-item"},{"entityRanges":[],"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","data":{},"key":"c5gnj","type":"unordered-list-item","depth":0},{"type":"unordered-list-item","depth":0,"entityRanges":[],"key":"cmhvm","data":{},"inlineStyleRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"entityRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","key":"ad81j","type":"unordered-list-item","depth":0,"data":{},"inlineStyleRanges":[]},{"text":"The principle of least privilege must be used whenever possible","entityRanges":[],"key":"3v1so","inlineStyleRanges":[],"data":{},"type":"unordered-list-item","depth":0},{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"f6ml2","text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","type":"unstyled"},{"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","data":{},"type":"unstyled","key":"8jjma","inlineStyleRanges":[],"entityRanges":[],"depth":0}]},"references":{"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","targetOption":"_blank"},"mutability":"MUTABLE"}},"blocks":[{"depth":0,"entityRanges":[],"type":"unstyled","key":"ao1ti","text":"Setting the frequency to weekly allows you to review the roles every 7 days.","data":{},"inlineStyleRanges":[]},{"key":"a38rm","type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"text":"You set the access to be removed under \"Upon completion settings\""},{"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","key":"beg9g","entityRanges":[{"offset":0,"length":94,"key":0}],"data":{},"inlineStyleRanges":[],"depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
