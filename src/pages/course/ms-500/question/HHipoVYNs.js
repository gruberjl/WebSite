...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"id":"HHipoVYNs","question":{"entityMap":{},"blocks":[{"text":"Security Requirements: GitBit identifies the following security requirements:","type":"unstyled","depth":0,"entityRanges":[],"inlineStyleRanges":[{"offset":0,"style":"BOLD","length":23}],"key":"312gb","data":{}},{"key":"c0t0v","depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","data":{},"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"inlineStyleRanges":[],"type":"unordered-list-item","depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","key":"4kl8j","entityRanges":[],"data":{}},{"inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"7n342","type":"unordered-list-item","depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations"},{"key":"4v2gu","inlineStyleRanges":[],"depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","type":"unordered-list-item","entityRanges":[],"data":{}},{"inlineStyleRanges":[],"depth":0,"entityRanges":[],"data":{},"type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"c5gnj"},{"inlineStyleRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","entityRanges":[],"data":{},"type":"unordered-list-item","depth":0,"key":"cmhvm"},{"depth":0,"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","entityRanges":[],"inlineStyleRanges":[],"data":{},"key":"ad81j"},{"entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"key":"3v1so","text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item"},{"key":"f6ml2","inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[],"data":{},"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group."},{"inlineStyleRanges":[],"type":"unstyled","depth":0,"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","key":"8jjma","entityRanges":[],"data":{}}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2"}}},"blocks":[{"entityRanges":[],"depth":0,"type":"unstyled","inlineStyleRanges":[],"data":{},"key":"ao1ti","text":"Setting the frequency to weekly allows you to review the roles every 7 days."},{"inlineStyleRanges":[],"entityRanges":[],"data":{},"key":"a38rm","text":"You set the access to be removed under \"Upon completion settings\"","depth":0,"type":"unstyled"},{"data":{},"entityRanges":[{"offset":0,"key":0,"length":94}],"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","inlineStyleRanges":[],"key":"beg9g","depth":0,"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
