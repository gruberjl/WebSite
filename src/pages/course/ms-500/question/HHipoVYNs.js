...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Set the frequency to One time","isCorrectAnswer":false},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Set the frequency to Monthly"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers"}],"id":"HHipoVYNs","question":{"entityMap":{},"blocks":[{"text":"Security Requirements: GitBit identifies the following security requirements:","inlineStyleRanges":[{"offset":0,"style":"BOLD","length":23}],"key":"312gb","data":{},"type":"unstyled","entityRanges":[],"depth":0},{"depth":0,"data":{},"key":"c0t0v","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[],"inlineStyleRanges":[],"type":"unordered-list-item"},{"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unordered-list-item","depth":0,"key":"4kl8j"},{"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"7n342","depth":0,"type":"unordered-list-item","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"data":{},"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","entityRanges":[],"depth":0,"type":"unordered-list-item","key":"4v2gu","inlineStyleRanges":[]},{"data":{},"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item","key":"c5gnj","depth":0,"entityRanges":[]},{"depth":0,"type":"unordered-list-item","entityRanges":[],"data":{},"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","key":"cmhvm","inlineStyleRanges":[]},{"type":"unordered-list-item","entityRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","inlineStyleRanges":[],"depth":0,"data":{},"key":"ad81j"},{"text":"The principle of least privilege must be used whenever possible","key":"3v1so","inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unordered-list-item","depth":0},{"entityRanges":[],"type":"unstyled","data":{},"inlineStyleRanges":[],"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","key":"f6ml2","depth":0},{"depth":0,"type":"unstyled","key":"8jjma","inlineStyleRanges":[],"data":{},"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","entityRanges":[]}]},"references":{"blocks":[{"type":"unstyled","key":"ao1ti","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Setting the frequency to weekly allows you to review the roles every 7 days.","data":{}},{"type":"unstyled","text":"You set the access to be removed under \"Upon completion settings\"","entityRanges":[],"data":{},"depth":0,"key":"a38rm","inlineStyleRanges":[]},{"entityRanges":[{"key":0,"offset":0,"length":94}],"key":"beg9g","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","type":"unstyled","inlineStyleRanges":[],"data":{}}],"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","targetOption":"_blank"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
