...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Set the frequency to One time","isCorrectAnswer":false},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"id":"HHipoVYNs","question":{"blocks":[{"text":"Security Requirements: GitBit identifies the following security requirements:","entityRanges":[],"inlineStyleRanges":[{"style":"BOLD","offset":0,"length":23}],"depth":0,"key":"312gb","type":"unstyled","data":{}},{"entityRanges":[],"depth":0,"type":"unordered-list-item","inlineStyleRanges":[],"data":{},"key":"c0t0v","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"key":"4kl8j","entityRanges":[],"type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","depth":0,"data":{},"inlineStyleRanges":[]},{"inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"depth":0,"type":"unordered-list-item","key":"7n342","data":{}},{"depth":0,"entityRanges":[],"data":{},"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[],"key":"4v2gu","type":"unordered-list-item"},{"entityRanges":[],"data":{},"type":"unordered-list-item","depth":0,"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","inlineStyleRanges":[],"key":"c5gnj"},{"data":{},"inlineStyleRanges":[],"type":"unordered-list-item","key":"cmhvm","depth":0,"entityRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"inlineStyleRanges":[],"entityRanges":[],"key":"ad81j","data":{},"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0},{"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item","key":"3v1so","entityRanges":[],"inlineStyleRanges":[],"depth":0,"data":{}},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"data":{},"type":"unstyled","key":"f6ml2","text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group."},{"depth":0,"data":{},"entityRanges":[],"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","inlineStyleRanges":[],"key":"8jjma","type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"data":{},"entityRanges":[],"text":"Setting the frequency to weekly allows you to review the roles every 7 days.","key":"ao1ti","inlineStyleRanges":[],"depth":0,"type":"unstyled"},{"key":"a38rm","type":"unstyled","depth":0,"data":{},"entityRanges":[],"text":"You set the access to be removed under \"Upon completion settings\"","inlineStyleRanges":[]},{"key":"beg9g","data":{},"type":"unstyled","entityRanges":[{"length":94,"key":0,"offset":0}],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
