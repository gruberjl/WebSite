...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"HHipoVYNs","answers":[{"value":"Set the frequency to One time","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Set the frequency to Weekly"},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"question":{"entityMap":{},"blocks":[{"depth":0,"data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[{"style":"BOLD","length":23,"offset":0}],"text":"Security Requirements: Fabrikam identifies the following security requirements:","key":"312gb"},{"key":"c0t0v","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0},{"key":"4kl8j","type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[]},{"entityRanges":[],"data":{},"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","inlineStyleRanges":[],"type":"unordered-list-item","key":"7n342","depth":0},{"data":{},"key":"4v2gu","type":"unordered-list-item","entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","depth":0,"inlineStyleRanges":[]},{"key":"c5gnj","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item"},{"key":"cmhvm","depth":0,"type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{}},{"inlineStyleRanges":[],"key":"ad81j","entityRanges":[],"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0,"data":{}},{"inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","depth":0,"data":{},"key":"3v1so","entityRanges":[],"type":"unordered-list-item"},{"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","data":{},"key":"f6ml2","depth":0},{"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","data":{},"depth":0,"key":"8jjma"}]},"references":{"blocks":[{"type":"unstyled","entityRanges":[],"text":"","key":"ao1ti","inlineStyleRanges":[],"data":{},"depth":0}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
