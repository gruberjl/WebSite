...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers"}],"id":"HHipoVYNs","question":{"blocks":[{"depth":0,"entityRanges":[],"text":"Security Requirements: GitBit identifies the following security requirements:","key":"312gb","type":"unstyled","inlineStyleRanges":[{"offset":0,"style":"BOLD","length":23}],"data":{}},{"type":"unordered-list-item","key":"c0t0v","inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","depth":0},{"key":"4kl8j","depth":0,"inlineStyleRanges":[],"data":{},"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","entityRanges":[]},{"inlineStyleRanges":[],"depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"data":{},"type":"unordered-list-item","key":"7n342"},{"data":{},"depth":0,"type":"unordered-list-item","inlineStyleRanges":[],"key":"4v2gu","entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory"},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"c5gnj","depth":0,"type":"unordered-list-item"},{"depth":0,"inlineStyleRanges":[],"data":{},"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","entityRanges":[],"key":"cmhvm"},{"key":"ad81j","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Email messages that include attachments containing malware must be delivered without the attachment","data":{},"type":"unordered-list-item"},{"inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","key":"3v1so","data":{},"entityRanges":[],"text":"The principle of least privilege must be used whenever possible"},{"data":{},"type":"unstyled","depth":0,"entityRanges":[],"key":"f6ml2","inlineStyleRanges":[],"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group."},{"key":"8jjma","data":{},"depth":0,"type":"unstyled","entityRanges":[],"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","inlineStyleRanges":[]}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"key":"ao1ti","text":"Setting the frequency to weekly allows you to review the roles every 7 days.","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unstyled"},{"type":"unstyled","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"You set the access to be removed under \"Upon completion settings\"","key":"a38rm","data":{}},{"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","data":{},"inlineStyleRanges":[],"type":"unstyled","key":"beg9g","entityRanges":[{"length":94,"key":0,"offset":0}],"depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
