...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"id":"HHipoVYNs","question":{"blocks":[{"text":"Security Requirements: GitBit identifies the following security requirements:","data":{},"key":"312gb","type":"unstyled","entityRanges":[],"depth":0,"inlineStyleRanges":[{"style":"BOLD","offset":0,"length":23}]},{"type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","inlineStyleRanges":[],"key":"c0t0v","data":{},"entityRanges":[],"depth":0},{"inlineStyleRanges":[],"type":"unordered-list-item","key":"4kl8j","depth":0,"entityRanges":[],"data":{},"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement"},{"entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"7n342","type":"unordered-list-item"},{"entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","type":"unordered-list-item","data":{},"inlineStyleRanges":[],"depth":0,"key":"4v2gu"},{"data":{},"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","entityRanges":[],"type":"unordered-list-item","depth":0,"key":"c5gnj"},{"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","key":"cmhvm","inlineStyleRanges":[],"depth":0,"entityRanges":[],"type":"unordered-list-item","data":{}},{"key":"ad81j","inlineStyleRanges":[],"type":"unordered-list-item","depth":0,"data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment","entityRanges":[]},{"depth":0,"text":"The principle of least privilege must be used whenever possible","key":"3v1so","data":{},"inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[]},{"key":"f6ml2","entityRanges":[],"type":"unstyled","text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","data":{},"inlineStyleRanges":[],"depth":0},{"key":"8jjma","text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"key":"ao1ti","text":"Setting the frequency to weekly allows you to review the roles every 7 days.","type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{}},{"inlineStyleRanges":[],"text":"You set the access to be removed under \"Upon completion settings\"","depth":0,"key":"a38rm","type":"unstyled","data":{},"entityRanges":[]},{"inlineStyleRanges":[],"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","entityRanges":[{"key":0,"length":94,"offset":0}],"key":"beg9g","depth":0,"data":{}}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
