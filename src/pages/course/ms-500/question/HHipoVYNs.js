...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"HHipoVYNs","answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"isCorrectAnswer":true,"value":"Set the frequency to Weekly"},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"question":{"entityMap":{},"blocks":[{"entityRanges":[],"key":"312gb","type":"unstyled","text":"Security Requirements: Fabrikam identifies the following security requirements:","inlineStyleRanges":[{"style":"BOLD","offset":0,"length":23}],"data":{},"depth":0},{"inlineStyleRanges":[],"data":{},"type":"unordered-list-item","depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[],"key":"c0t0v"},{"type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","depth":0,"data":{},"entityRanges":[],"key":"4kl8j","inlineStyleRanges":[]},{"inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"7n342","type":"unordered-list-item","data":{},"depth":0,"entityRanges":[]},{"depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"entityRanges":[],"key":"4v2gu"},{"depth":0,"type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","entityRanges":[],"key":"c5gnj","data":{},"inlineStyleRanges":[]},{"data":{},"entityRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","depth":0,"key":"cmhvm","inlineStyleRanges":[]},{"depth":0,"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","data":{},"entityRanges":[],"key":"ad81j","inlineStyleRanges":[]},{"depth":0,"text":"The principle of least privilege must be used whenever possible","key":"3v1so","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"data":{}},{"key":"f6ml2","type":"unstyled","text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0},{"entityRanges":[],"type":"unstyled","depth":0,"data":{},"inlineStyleRanges":[],"key":"8jjma","text":"Which other settings should you configure? To answer, select the appropriate options in the answer area."}]},"references":{"entityMap":{},"blocks":[{"entityRanges":[],"data":{},"text":"","inlineStyleRanges":[],"depth":0,"key":"ao1ti","type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
