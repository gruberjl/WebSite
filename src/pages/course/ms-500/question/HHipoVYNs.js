...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Set the frequency to Monthly"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"question":{"entityMap":{},"blocks":[{"entityRanges":[],"depth":0,"type":"unstyled","data":{},"inlineStyleRanges":[{"length":23,"offset":0,"style":"BOLD"}],"key":"312gb","text":"Security Requirements: Fabrikam identifies the following security requirements:"},{"key":"c0t0v","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","depth":0,"key":"4kl8j","inlineStyleRanges":[]},{"data":{},"key":"7n342","depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"key":"4v2gu","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","depth":0,"inlineStyleRanges":[],"type":"unordered-list-item"},{"depth":0,"key":"c5gnj","type":"unordered-list-item","data":{},"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{},"depth":0,"key":"cmhvm"},{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"ad81j","type":"unordered-list-item","data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"3v1so","text":"The principle of least privilege must be used whenever possible","data":{},"type":"unordered-list-item"},{"depth":0,"key":"f6ml2","entityRanges":[],"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","type":"unstyled","inlineStyleRanges":[],"data":{}},{"entityRanges":[],"type":"unstyled","key":"8jjma","text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","data":{},"inlineStyleRanges":[],"depth":0}]},"references":{"blocks":[{"data":{},"key":"ao1ti","text":"","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"depth":0}],"entityMap":{}},"id":"HHipoVYNs"},
      previousQuestionId: '',
      nextQuestionId: '',
