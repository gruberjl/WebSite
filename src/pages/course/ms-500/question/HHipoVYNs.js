...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Set the frequency to One time","isCorrectAnswer":false},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers"}],"id":"HHipoVYNs","question":{"blocks":[{"entityRanges":[],"data":{},"depth":0,"key":"312gb","type":"unstyled","inlineStyleRanges":[{"style":"BOLD","length":23,"offset":0}],"text":"Security Requirements: GitBit identifies the following security requirements:"},{"key":"c0t0v","depth":0,"type":"unordered-list-item","entityRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","data":{},"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","key":"4kl8j"},{"data":{},"type":"unordered-list-item","depth":0,"key":"7n342","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"inlineStyleRanges":[]},{"data":{},"key":"4v2gu","inlineStyleRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","type":"unordered-list-item","depth":0,"entityRanges":[]},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"c5gnj","inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"depth":0,"data":{}},{"type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{},"key":"cmhvm","entityRanges":[]},{"inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","type":"unordered-list-item","key":"ad81j"},{"text":"The principle of least privilege must be used whenever possible","inlineStyleRanges":[],"type":"unordered-list-item","depth":0,"entityRanges":[],"key":"3v1so","data":{}},{"key":"f6ml2","type":"unstyled","depth":0,"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"8jjma","entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unstyled","text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","depth":0}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"data":{},"type":"unstyled","text":"Setting the frequency to weekly allows you to review the roles every 7 days.","depth":0,"key":"ao1ti","inlineStyleRanges":[]},{"entityRanges":[],"key":"a38rm","depth":0,"text":"You set the access to be removed under \"Upon completion settings\"","inlineStyleRanges":[],"type":"unstyled","data":{}},{"entityRanges":[{"key":0,"length":94,"offset":0}],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","type":"unstyled","data":{},"key":"beg9g","inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
