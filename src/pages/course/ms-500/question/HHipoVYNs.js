...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"isCorrectAnswer":true,"value":"Set the frequency to Weekly"},{"isCorrectAnswer":false,"value":"Set the frequency to Monthly"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers"}],"id":"HHipoVYNs","question":{"blocks":[{"text":"Security Requirements: Fabrikam identifies the following security requirements:","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[{"style":"BOLD","offset":0,"length":23}],"key":"312gb","type":"unstyled"},{"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0,"key":"c0t0v"},{"key":"4kl8j","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"type":"unordered-list-item","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","data":{},"depth":0,"key":"7n342","inlineStyleRanges":[]},{"entityRanges":[],"key":"4v2gu","data":{},"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[],"depth":0},{"key":"c5gnj","inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item"},{"key":"cmhvm","entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{}},{"key":"ad81j","data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment","entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"depth":0},{"inlineStyleRanges":[],"key":"3v1so","type":"unordered-list-item","text":"The principle of least privilege must be used whenever possible","entityRanges":[],"depth":0,"data":{}},{"key":"f6ml2","type":"unstyled","depth":0,"data":{},"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","entityRanges":[],"inlineStyleRanges":[]},{"data":{},"entityRanges":[],"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","key":"8jjma"}],"entityMap":{}},"references":{"blocks":[{"text":"","key":"ao1ti","depth":0,"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"data":{}}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
