...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"isCorrectAnswer":true,"value":"Set the frequency to Weekly"},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"references":{"entityMap":{},"blocks":[{"type":"unstyled","text":"","data":{},"inlineStyleRanges":[],"key":"ao1ti","entityRanges":[],"depth":0}]},"id":"HHipoVYNs","question":{"entityMap":{},"blocks":[{"depth":0,"type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[{"offset":0,"length":23,"style":"BOLD"}],"text":"Security Requirements: Fabrikam identifies the following security requirements:","key":"312gb"},{"depth":0,"inlineStyleRanges":[],"data":{},"type":"unordered-list-item","entityRanges":[],"key":"c0t0v","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","data":{},"entityRanges":[],"key":"4kl8j","depth":0,"inlineStyleRanges":[]},{"key":"7n342","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","depth":0,"data":{},"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[]},{"key":"4v2gu","depth":0,"data":{},"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory"},{"depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"data":{},"key":"c5gnj","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location"},{"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"data":{},"key":"cmhvm","depth":0},{"text":"Email messages that include attachments containing malware must be delivered without the attachment","type":"unordered-list-item","entityRanges":[],"depth":0,"key":"ad81j","inlineStyleRanges":[],"data":{}},{"depth":0,"inlineStyleRanges":[],"data":{},"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item","entityRanges":[],"key":"3v1so"},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"f6ml2","type":"unstyled","text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","depth":0},{"depth":0,"entityRanges":[],"type":"unstyled","text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","inlineStyleRanges":[],"key":"8jjma","data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
