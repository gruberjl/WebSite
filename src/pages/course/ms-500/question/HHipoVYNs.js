...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"HHipoVYNs","question":{"blocks":[{"data":{},"type":"unstyled","depth":0,"text":"Security Requirements: Fabrikam identifies the following security requirements:","entityRanges":[],"inlineStyleRanges":[{"length":23,"offset":0,"style":"BOLD"}],"key":"312gb"},{"entityRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","key":"c0t0v","data":{},"type":"unordered-list-item","depth":0,"inlineStyleRanges":[]},{"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","entityRanges":[],"data":{},"depth":0,"key":"4kl8j","type":"unordered-list-item","inlineStyleRanges":[]},{"entityRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"7n342","inlineStyleRanges":[],"type":"unordered-list-item","data":{},"depth":0},{"inlineStyleRanges":[],"entityRanges":[],"key":"4v2gu","data":{},"type":"unordered-list-item","depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory"},{"key":"c5gnj","data":{},"inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0},{"data":{},"key":"cmhvm","depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[]},{"key":"ad81j","data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0,"type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[],"type":"unordered-list-item","key":"3v1so","inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","data":{},"depth":0},{"key":"f6ml2","depth":0,"inlineStyleRanges":[],"data":{},"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","entityRanges":[],"type":"unstyled"},{"entityRanges":[],"type":"unstyled","data":{},"key":"8jjma","depth":0,"inlineStyleRanges":[],"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area."}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"type":"unstyled","depth":0,"text":"","inlineStyleRanges":[],"key":"ao1ti","data":{}}],"entityMap":{}},"answers":[{"value":"Set the frequency to One time","isCorrectAnswer":false},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers"}]},
      previousQuestionId: '',
      nextQuestionId: '',
