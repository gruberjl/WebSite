...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"isCorrectAnswer":true,"value":"Set the frequency to Weekly"},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"id":"HHipoVYNs","question":{"entityMap":{},"blocks":[{"depth":0,"inlineStyleRanges":[{"offset":0,"length":23,"style":"BOLD"}],"text":"Security Requirements: GitBit identifies the following security requirements:","entityRanges":[],"data":{},"key":"312gb","type":"unstyled"},{"depth":0,"entityRanges":[],"data":{},"key":"c0t0v","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","inlineStyleRanges":[],"type":"unordered-list-item"},{"data":{},"key":"4kl8j","depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[]},{"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"7n342","entityRanges":[],"data":{},"type":"unordered-list-item","inlineStyleRanges":[],"depth":0},{"data":{},"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","type":"unordered-list-item","entityRanges":[],"key":"4v2gu","inlineStyleRanges":[],"depth":0},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0,"key":"c5gnj","data":{},"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[]},{"data":{},"entityRanges":[],"key":"cmhvm","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","depth":0,"type":"unordered-list-item","inlineStyleRanges":[]},{"key":"ad81j","text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0,"entityRanges":[],"type":"unordered-list-item","data":{},"inlineStyleRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"type":"unordered-list-item","key":"3v1so","data":{},"text":"The principle of least privilege must be used whenever possible","depth":0},{"entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unstyled","key":"f6ml2","depth":0,"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group."},{"type":"unstyled","inlineStyleRanges":[],"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","entityRanges":[],"depth":0,"data":{},"key":"8jjma"}]},"references":{"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0,"type":"unstyled","key":"ao1ti","text":"Setting the frequency to weekly allows you to review the roles every 7 days."},{"data":{},"text":"You set the access to be removed under \"Upon completion settings\"","inlineStyleRanges":[],"type":"unstyled","depth":0,"entityRanges":[],"key":"a38rm"},{"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","inlineStyleRanges":[],"entityRanges":[{"length":94,"offset":0,"key":0}],"data":{},"key":"beg9g","depth":0,"type":"unstyled"}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","targetOption":"_blank"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
