...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Set the frequency to One time","isCorrectAnswer":false},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"id":"HHipoVYNs","question":{"blocks":[{"inlineStyleRanges":[{"length":23,"style":"BOLD","offset":0}],"text":"Security Requirements: GitBit identifies the following security requirements:","depth":0,"type":"unstyled","entityRanges":[],"data":{},"key":"312gb"},{"entityRanges":[],"key":"c0t0v","inlineStyleRanges":[],"depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","data":{}},{"depth":0,"data":{},"entityRanges":[],"key":"4kl8j","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","inlineStyleRanges":[],"type":"unordered-list-item"},{"key":"7n342","type":"unordered-list-item","data":{},"depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","type":"unordered-list-item","key":"4v2gu","depth":0,"data":{},"inlineStyleRanges":[]},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","depth":0,"key":"c5gnj"},{"type":"unordered-list-item","inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","key":"cmhvm"},{"depth":0,"key":"ad81j","text":"Email messages that include attachments containing malware must be delivered without the attachment","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"data":{}},{"data":{},"key":"3v1so","depth":0,"entityRanges":[],"type":"unordered-list-item","text":"The principle of least privilege must be used whenever possible","inlineStyleRanges":[]},{"type":"unstyled","inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"f6ml2","depth":0,"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group."},{"depth":0,"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"data":{},"key":"8jjma"}],"entityMap":{}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","targetOption":"_blank"}}},"blocks":[{"text":"Setting the frequency to weekly allows you to review the roles every 7 days.","data":{},"depth":0,"entityRanges":[],"type":"unstyled","key":"ao1ti","inlineStyleRanges":[]},{"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"a38rm","text":"You set the access to be removed under \"Upon completion settings\"","depth":0,"entityRanges":[]},{"entityRanges":[{"key":0,"offset":0,"length":94}],"type":"unstyled","data":{},"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","key":"beg9g","depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
