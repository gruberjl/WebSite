...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Set the frequency to One time","isCorrectAnswer":false},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"value":"Set the frequency to Monthly","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"id":"HHipoVYNs","question":{"blocks":[{"depth":0,"type":"unstyled","entityRanges":[],"key":"312gb","inlineStyleRanges":[{"offset":0,"style":"BOLD","length":23}],"data":{},"text":"Security Requirements: GitBit identifies the following security requirements:"},{"entityRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","key":"c0t0v","data":{},"depth":0,"type":"unordered-list-item","inlineStyleRanges":[]},{"data":{},"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","depth":0,"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"key":"4kl8j"},{"entityRanges":[],"data":{},"key":"7n342","inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","depth":0,"type":"unordered-list-item"},{"key":"4v2gu","entityRanges":[],"depth":0,"type":"unordered-list-item","data":{},"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[]},{"depth":0,"key":"c5gnj","entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"data":{},"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location"},{"depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{},"key":"cmhvm","inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item"},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unordered-list-item","key":"ad81j","data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"key":"3v1so","depth":0,"data":{},"type":"unordered-list-item","inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","entityRanges":[]},{"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","key":"f6ml2","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unstyled"},{"type":"unstyled","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"8jjma","text":"Which other settings should you configure? To answer, select the appropriate options in the answer area."}],"entityMap":{}},"references":{"blocks":[{"text":"Setting the frequency to weekly allows you to review the roles every 7 days.","key":"ao1ti","inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0,"data":{}},{"type":"unstyled","key":"a38rm","inlineStyleRanges":[],"entityRanges":[],"depth":0,"data":{},"text":"You set the access to be removed under \"Upon completion settings\""},{"depth":0,"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","key":"beg9g","entityRanges":[{"length":94,"key":0,"offset":0}]}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
