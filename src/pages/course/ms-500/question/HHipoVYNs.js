...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"value":"Set the frequency to Weekly","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Set the frequency to Monthly"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers"}],"id":"HHipoVYNs","question":{"entityMap":{},"blocks":[{"text":"Security Requirements: GitBit identifies the following security requirements:","inlineStyleRanges":[{"offset":0,"length":23,"style":"BOLD"}],"entityRanges":[],"type":"unstyled","depth":0,"key":"312gb","data":{}},{"type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"c0t0v"},{"entityRanges":[],"depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","key":"4kl8j","inlineStyleRanges":[],"data":{}},{"entityRanges":[],"key":"7n342","inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","depth":0,"type":"unordered-list-item","data":{}},{"data":{},"entityRanges":[],"depth":0,"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","key":"4v2gu","inlineStyleRanges":[]},{"data":{},"key":"c5gnj","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item","entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"depth":0,"inlineStyleRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","entityRanges":[],"data":{},"type":"unordered-list-item","key":"cmhvm"},{"data":{},"inlineStyleRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","type":"unordered-list-item","key":"ad81j","entityRanges":[],"depth":0},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"3v1so","depth":0,"type":"unordered-list-item","text":"The principle of least privilege must be used whenever possible"},{"data":{},"inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"f6ml2","entityRanges":[],"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group."},{"entityRanges":[],"depth":0,"data":{},"type":"unstyled","inlineStyleRanges":[],"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","key":"8jjma"}]},"references":{"blocks":[{"type":"unstyled","depth":0,"key":"ao1ti","data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"Setting the frequency to weekly allows you to review the roles every 7 days."},{"type":"unstyled","inlineStyleRanges":[],"key":"a38rm","text":"You set the access to be removed under \"Upon completion settings\"","depth":0,"data":{},"entityRanges":[]},{"key":"beg9g","depth":0,"inlineStyleRanges":[],"entityRanges":[{"key":0,"offset":0,"length":94}],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","type":"unstyled"}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
