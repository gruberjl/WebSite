...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"isCorrectAnswer":true,"value":"Set the frequency to Weekly"},{"isCorrectAnswer":false,"value":"Set the frequency to Monthly"},{"isCorrectAnswer":true,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers"}],"id":"HHipoVYNs","question":{"blocks":[{"key":"312gb","text":"Security Requirements: GitBit identifies the following security requirements:","type":"unstyled","depth":0,"data":{},"inlineStyleRanges":[{"length":23,"offset":0,"style":"BOLD"}],"entityRanges":[]},{"key":"c0t0v","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"key":"4kl8j","data":{},"depth":0},{"inlineStyleRanges":[],"data":{},"type":"unordered-list-item","entityRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","depth":0,"key":"7n342"},{"key":"4v2gu","inlineStyleRanges":[],"data":{},"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","depth":0,"type":"unordered-list-item","entityRanges":[]},{"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","entityRanges":[],"data":{},"depth":0,"key":"c5gnj","type":"unordered-list-item"},{"depth":0,"key":"cmhvm","entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"key":"ad81j","type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0},{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"data":{},"key":"3v1so","text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item"},{"key":"f6ml2","type":"unstyled","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","data":{}},{"depth":0,"entityRanges":[],"key":"8jjma","inlineStyleRanges":[],"type":"unstyled","text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","data":{}}],"entityMap":{}},"references":{"blocks":[{"key":"ao1ti","data":{},"type":"unstyled","entityRanges":[],"depth":0,"text":"Setting the frequency to weekly allows you to review the roles every 7 days.","inlineStyleRanges":[]},{"key":"a38rm","depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"You set the access to be removed under \"Upon completion settings\"","data":{}},{"type":"unstyled","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","entityRanges":[{"key":0,"offset":0,"length":94}],"inlineStyleRanges":[],"key":"beg9g","data":{}}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
