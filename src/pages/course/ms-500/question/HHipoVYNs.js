...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to One time"},{"isCorrectAnswer":true,"value":"Set the frequency to Weekly"},{"isCorrectAnswer":false,"value":"Set the frequency to Monthly"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs","isCorrectAnswer":false},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"id":"HHipoVYNs","question":{"blocks":[{"depth":0,"entityRanges":[],"data":{},"key":"312gb","text":"Security Requirements: GitBit identifies the following security requirements:","type":"unstyled","inlineStyleRanges":[{"style":"BOLD","offset":0,"length":23}]},{"data":{},"key":"c0t0v","inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","depth":0,"entityRanges":[],"type":"unordered-list-item"},{"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","entityRanges":[],"data":{},"key":"4kl8j","inlineStyleRanges":[],"depth":0,"type":"unordered-list-item"},{"data":{},"key":"7n342","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[]},{"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"key":"4v2gu","entityRanges":[],"inlineStyleRanges":[],"depth":0,"type":"unordered-list-item"},{"key":"c5gnj","inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","entityRanges":[],"data":{}},{"inlineStyleRanges":[],"data":{},"key":"cmhvm","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","entityRanges":[],"depth":0},{"type":"unordered-list-item","entityRanges":[],"data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment","key":"ad81j","depth":0,"inlineStyleRanges":[]},{"data":{},"text":"The principle of least privilege must be used whenever possible","inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"3v1so","type":"unordered-list-item"},{"key":"f6ml2","depth":0,"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.","entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled"},{"data":{},"entityRanges":[],"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","type":"unstyled","inlineStyleRanges":[],"depth":0,"key":"8jjma"}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","targetOption":"_blank"},"mutability":"MUTABLE"}},"blocks":[{"key":"ao1ti","depth":0,"text":"Setting the frequency to weekly allows you to review the roles every 7 days.","entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled"},{"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"You set the access to be removed under \"Upon completion settings\"","key":"a38rm","depth":0,"data":{}},{"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","type":"unstyled","data":{},"key":"beg9g","depth":0,"entityRanges":[{"offset":0,"key":0,"length":94}]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
