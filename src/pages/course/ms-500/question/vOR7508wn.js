...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Configure an enrollment restriction","isCorrectAnswer":false},{"value":"Create a device configuration profile","isCorrectAnswer":true},{"value":"Create a conditional access policy","isCorrectAnswer":false},{"value":"Create a Windows Autopilot deployment profile","isCorrectAnswer":false}],"id":"vOR7508wn","question":{"entityMap":{},"blocks":[{"depth":0,"key":"fnci6","text":"You have a Microsoft 365 tenant.","inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[]},{"entityRanges":[],"type":"unstyled","text":"You have 500 computers that run Windows 10.","key":"cvijs","depth":0,"data":{},"inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"type":"unstyled","text":"You plan to monitor the computers by using Microsoft Defender for Endpoint after the computers are enrolled in Microsoft Intune.","inlineStyleRanges":[],"data":{},"key":"cui53"},{"key":"4v75r","inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0,"text":"You need to ensure that the computers connect to Microsoft Defender for Endpoint.","type":"unstyled"},{"entityRanges":[],"data":{},"type":"unstyled","key":"ekj0t","depth":0,"inlineStyleRanges":[],"text":"How should you prepare Intune for Microsoft Defender for Endpoint?"}]},"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","targetOption":"_blank"}},"1":{"data":{"url":"https://docs.microsoft.com/en-us/intune/advanced-threat-protection","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"data":{},"text":"Create a device configuration profile to deploy Defender for Endpoint.","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"key":"5t9hf","depth":0},{"depth":0,"key":"4a27d","data":{},"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","entityRanges":[{"key":0,"offset":0,"length":129}],"type":"unstyled"},{"entityRanges":[{"key":1,"offset":0,"length":66}],"data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/intune/advanced-threat-protection","key":"aunfb"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
