...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Run the Set-SPOTenant cmdlet and specify the -ConditionalAccessPolicy parameter from the SharePoint Online PowerShell.","isCorrectAnswer":true},{"value":"Open the SharePoint admin center and configure the secure control settings.","isCorrectAnswer":false},{"value":"Open the Microsoft Azure AD admin center and create an Azure AD Identity Protection sign-in risk policy.","isCorrectAnswer":false},{"value":"Open the Microsoft Azure AD admin center and create an Azure AD Identity Protection user risk policy.","isCorrectAnswer":false}],"id":"i_VGw0WJG","question":{"blocks":[{"type":"unstyled","entityRanges":[],"text":"Your organization has a Microsoft 365 tenant. Some users access Microsoft SharePoint Online from unmanaged personal devices.","depth":0,"data":{},"inlineStyleRanges":[],"key":"4l16"},{"data":{},"type":"unstyled","inlineStyleRanges":[],"depth":0,"text":"Your manager has asked you to prevent the users from downloading, printing, and syncing files from their unmanaged personal devices.","entityRanges":[],"key":"c9bo6"},{"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"What do you need to do?","data":{},"key":"9cofa"}],"entityMap":{}},"references":{"blocks":[{"depth":0,"key":"82p5v","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"Connect to Sharepoint Online using PowerShell then run the following command: Set-SPOTenant -ConditionalAccessPolicy AllowLimitedAccess.","data":{}},{"entityRanges":[{"length":128,"offset":0,"key":0}],"depth":0,"key":"e64f5","type":"unstyled","data":{},"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI"},{"entityRanges":[{"key":1,"offset":0,"length":101}],"type":"unstyled","key":"fsm5k","depth":0,"text":"https://docs.microsoft.com/en-us/powershell/module/sharepoint-online/set-spotenant?view=sharepoint-ps","inlineStyleRanges":[],"data":{}},{"depth":0,"text":"https://docs.microsoft.com/en-us/sharepoint/control-access-from-unmanaged-devices","inlineStyleRanges":[],"key":"7n076","entityRanges":[{"key":2,"length":81,"offset":0}],"type":"unstyled","data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI","targetOption":"_blank"},"type":"LINK"},"1":{"type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/powershell/module/sharepoint-online/set-spotenant?view=sharepoint-ps"},"mutability":"MUTABLE"},"2":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/sharepoint/control-access-from-unmanaged-devices"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
