...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Only employees who have an Azure AD user account","isCorrectAnswer":false},{"value":"Employees who have an Azure AD user account or a synced on-premises account","isCorrectAnswer":true},{"value":"Only employees who have a synced on-premises account","isCorrectAnswer":false},{"value":"Fix the synchronization server and install Azure AD Connect in staging mode","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Fix the synchronization server and install an additional authentication agent"},{"isCorrectAnswer":false,"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet"},{"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false}],"id":"-7MLm8ziu","question":{"entityMap":{"0":{"data":{"src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png","width":"auto","alignment":"left","alt":"AD Connect Setup","height":"auto"},"type":"IMAGE","mutability":"MUTABLE"},"1":{"data":{"alt":"AD Connect Scheduler status","alignment":"left","width":"auto","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","height":"auto"},"mutability":"MUTABLE","type":"IMAGE"}},"blocks":[{"key":"3l77q","text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","depth":0,"entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unstyled"},{"key":"4tnb1","inlineStyleRanges":[],"type":"atomic","entityRanges":[{"length":1,"offset":0,"key":0}],"depth":0,"data":{},"text":" "},{"type":"unstyled","inlineStyleRanges":[],"depth":0,"key":"dv9ht","data":{},"entityRanges":[],"text":"The synchronization schedule is configured as shown in the following exhibit."},{"depth":0,"data":{},"text":" ","type":"atomic","inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":1,"length":1}],"key":"bm5re"},{"entityRanges":[],"inlineStyleRanges":[{"style":"color-rgb(80,80,80)","length":51,"offset":0},{"offset":0,"length":51,"style":"bgcolor-rgb(255,255,255)"},{"style":"fontsize-16","length":51,"offset":0},{"length":51,"offset":0,"style":"fontfamily-Roboto Condensed\", sans-serif"}],"data":{},"key":"f2iao","type":"unstyled","text":"Which employees can authenticate by using Azure AD?","depth":0},{"data":{},"text":"What should you do to remove the warning for pass-through authentication?","key":"7q87t","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[]}]},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"type":"LINK"}},"blocks":[{"data":{},"text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)","inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[],"key":"fdm35"},{"type":"unstyled","text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails).","key":"88p1k","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"key":"ftho5","entityRanges":[],"type":"unstyled","data":{},"text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.","inlineStyleRanges":[],"depth":0},{"data":{},"key":"e66bb","text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","entityRanges":[{"key":0,"offset":0,"length":69}],"inlineStyleRanges":[],"depth":0,"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
