...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Only employees who have an Azure AD user account"},{"value":"Employees who have an Azure AD user account or a synced on-premises account","isCorrectAnswer":true},{"value":"Only employees who have a synced on-premises account","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"isCorrectAnswer":true,"value":"Fix the synchronization server and install an additional authentication agent"},{"isCorrectAnswer":false,"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet"},{"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false}],"id":"-7MLm8ziu","question":{"blocks":[{"data":{},"inlineStyleRanges":[],"type":"unstyled","depth":0,"entityRanges":[],"key":"3l77q","text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit."},{"text":" ","data":{},"type":"atomic","entityRanges":[{"key":0,"length":1,"offset":0}],"depth":0,"inlineStyleRanges":[],"key":"4tnb1"},{"data":{},"key":"dv9ht","inlineStyleRanges":[],"text":"The synchronization schedule is configured as shown in the following exhibit.","depth":0,"type":"unstyled","entityRanges":[]},{"type":"atomic","text":" ","entityRanges":[{"key":1,"offset":0,"length":1}],"depth":0,"key":"bm5re","data":{},"inlineStyleRanges":[]},{"inlineStyleRanges":[{"length":51,"style":"color-rgb(80,80,80)","offset":0},{"length":51,"offset":0,"style":"bgcolor-rgb(255,255,255)"},{"style":"fontsize-16","offset":0,"length":51},{"length":51,"style":"fontfamily-Roboto Condensed\", sans-serif","offset":0}],"type":"unstyled","text":"Which employees can authenticate by using Azure AD?","key":"f2iao","depth":0,"entityRanges":[],"data":{}},{"type":"unstyled","depth":0,"text":"What should you do to remove the warning for pass-through authentication?","entityRanges":[],"data":{},"key":"7q87t","inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","width":"auto","alt":"AD Connect Setup","alignment":"left","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png"}},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","alignment":"left","alt":"AD Connect Scheduler status","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","width":"auto"}}}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"}}},"blocks":[{"key":"fdm35","depth":0,"text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)","type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"88p1k","depth":0,"text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails)."},{"key":"ftho5","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.","depth":0},{"key":"e66bb","entityRanges":[{"length":69,"key":0,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","inlineStyleRanges":[],"type":"unstyled","depth":0,"data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
