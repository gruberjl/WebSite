...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"entityMap":{"0":{"data":{"height":"auto","width":"auto","alignment":"left","alt":"AD Connect Setup","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png"},"mutability":"MUTABLE","type":"IMAGE"},"1":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","alt":"AD Connect Scheduler status","alignment":"left","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","width":"auto"}}},"blocks":[{"key":"3l77q","inlineStyleRanges":[],"depth":0,"type":"unstyled","data":{},"text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","entityRanges":[]},{"key":"4tnb1","type":"atomic","inlineStyleRanges":[],"text":" ","depth":0,"data":{},"entityRanges":[{"offset":0,"length":1,"key":0}]},{"type":"unstyled","key":"dv9ht","inlineStyleRanges":[],"data":{},"depth":0,"text":"The synchronization schedule is configured as shown in the following exhibit.","entityRanges":[]},{"data":{},"text":" ","entityRanges":[{"offset":0,"length":1,"key":1}],"key":"bm5re","depth":0,"type":"atomic","inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"type":"unstyled","key":"f2iao","inlineStyleRanges":[{"style":"color-rgb(80,80,80)","offset":0,"length":51},{"style":"bgcolor-rgb(255,255,255)","offset":0,"length":51},{"length":51,"style":"fontsize-16","offset":0},{"offset":0,"length":51,"style":"fontfamily-Roboto Condensed\", sans-serif"}],"data":{},"text":"Which employees can authenticate by using Azure AD?"},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","key":"7q87t","text":"What should you do to remove the warning for pass-through authentication?"}]},"id":"-7MLm8ziu","references":{"entityMap":{},"blocks":[{"data":{},"text":"","entityRanges":[],"key":"fdm35","inlineStyleRanges":[],"type":"unstyled","depth":0}]},"answers":[{"isCorrectAnswer":false,"value":"Only employees who have an Azure AD user account"},{"value":"Employees who have an Azure AD user account and a synced on-premises account","isCorrectAnswer":false},{"value":"Only employees who have a synced on-premises account","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false},{"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
