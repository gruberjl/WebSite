...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Only employees who have an Azure AD user account","isCorrectAnswer":false},{"value":"Employees who have an Azure AD user account or a synced on-premises account","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Only employees who have a synced on-premises account"},{"value":"Fix the synchronization server and install Azure AD Connect in staging mode","isCorrectAnswer":false},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet"},{"isCorrectAnswer":false,"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet"}],"id":"-7MLm8ziu","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"height":"auto","width":"auto","alt":"AD Connect Setup","alignment":"left","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png"},"type":"IMAGE"},"1":{"data":{"src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","width":"auto","height":"auto","alignment":"left","alt":"AD Connect Scheduler status"},"type":"IMAGE","mutability":"MUTABLE"}},"blocks":[{"data":{},"type":"unstyled","entityRanges":[],"key":"3l77q","text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","depth":0,"inlineStyleRanges":[]},{"type":"atomic","entityRanges":[{"offset":0,"length":1,"key":0}],"data":{},"depth":0,"inlineStyleRanges":[],"key":"4tnb1","text":" "},{"data":{},"entityRanges":[],"text":"The synchronization schedule is configured as shown in the following exhibit.","type":"unstyled","key":"dv9ht","inlineStyleRanges":[],"depth":0},{"key":"bm5re","inlineStyleRanges":[],"text":" ","data":{},"depth":0,"entityRanges":[{"offset":0,"key":1,"length":1}],"type":"atomic"},{"text":"Which employees can authenticate by using Azure AD?","data":{},"entityRanges":[],"key":"f2iao","depth":0,"type":"unstyled","inlineStyleRanges":[{"offset":0,"style":"color-rgb(80,80,80)","length":51},{"style":"bgcolor-rgb(255,255,255)","offset":0,"length":51},{"style":"fontsize-16","length":51,"offset":0},{"length":51,"style":"fontfamily-Roboto Condensed\", sans-serif","offset":0}]},{"data":{},"depth":0,"key":"7q87t","type":"unstyled","text":"What should you do to remove the warning for pass-through authentication?","inlineStyleRanges":[],"entityRanges":[]}]},"references":{"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0,"key":"fdm35","data":{},"text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)"},{"inlineStyleRanges":[],"key":"88p1k","type":"unstyled","text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails).","data":{},"depth":0,"entityRanges":[]},{"inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"ftho5","data":{},"text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.","type":"unstyled"},{"key":"e66bb","text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","depth":0,"inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":69,"key":0}],"data":{},"type":"unstyled"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
