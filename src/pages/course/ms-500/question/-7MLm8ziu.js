...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Only employees who have an Azure AD user account"},{"isCorrectAnswer":true,"value":"Employees who have an Azure AD user account or a synced on-premises account"},{"isCorrectAnswer":false,"value":"Only employees who have a synced on-premises account"},{"value":"Fix the synchronization server and install Azure AD Connect in staging mode","isCorrectAnswer":false},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet"},{"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false}],"id":"-7MLm8ziu","question":{"blocks":[{"text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","depth":0,"inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"3l77q","type":"unstyled"},{"data":{},"inlineStyleRanges":[],"type":"atomic","text":" ","entityRanges":[{"offset":0,"length":1,"key":0}],"key":"4tnb1","depth":0},{"inlineStyleRanges":[],"key":"dv9ht","depth":0,"type":"unstyled","entityRanges":[],"text":"The synchronization schedule is configured as shown in the following exhibit.","data":{}},{"key":"bm5re","type":"atomic","inlineStyleRanges":[],"depth":0,"data":{},"text":" ","entityRanges":[{"key":1,"offset":0,"length":1}]},{"depth":0,"entityRanges":[],"text":"Which employees can authenticate by using Azure AD?","key":"f2iao","type":"unstyled","inlineStyleRanges":[{"length":51,"offset":0,"style":"color-rgb(80,80,80)"},{"offset":0,"length":51,"style":"bgcolor-rgb(255,255,255)"},{"offset":0,"style":"fontsize-16","length":51},{"length":51,"style":"fontfamily-Roboto Condensed\", sans-serif","offset":0}],"data":{}},{"data":{},"key":"7q87t","text":"What should you do to remove the warning for pass-through authentication?","entityRanges":[],"inlineStyleRanges":[],"depth":0,"type":"unstyled"}],"entityMap":{"0":{"data":{"alignment":"left","alt":"AD Connect Setup","width":"auto","height":"auto","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png"},"type":"IMAGE","mutability":"MUTABLE"},"1":{"data":{"alignment":"left","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","width":"auto","alt":"AD Connect Scheduler status","height":"auto"},"mutability":"MUTABLE","type":"IMAGE"}}},"references":{"blocks":[{"inlineStyleRanges":[],"text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)","depth":0,"data":{},"type":"unstyled","entityRanges":[],"key":"fdm35"},{"type":"unstyled","key":"88p1k","entityRanges":[],"inlineStyleRanges":[],"depth":0,"data":{},"text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails)."},{"entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.","type":"unstyled","key":"ftho5"},{"entityRanges":[{"key":0,"length":69,"offset":0}],"key":"e66bb","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","data":{},"type":"unstyled","inlineStyleRanges":[]}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
