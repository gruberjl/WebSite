...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","key":"3l77q","depth":0,"data":{},"entityRanges":[],"type":"unstyled","inlineStyleRanges":[]},{"entityRanges":[{"offset":0,"key":0,"length":1}],"type":"atomic","depth":0,"inlineStyleRanges":[],"text":" ","data":{},"key":"4tnb1"},{"inlineStyleRanges":[],"depth":0,"text":"The synchronization schedule is configured as shown in the following exhibit.","key":"dv9ht","data":{},"entityRanges":[],"type":"unstyled"},{"key":"bm5re","type":"atomic","depth":0,"entityRanges":[{"offset":0,"key":1,"length":1}],"inlineStyleRanges":[],"text":" ","data":{}},{"text":"Which employees can authenticate by using Azure AD?","entityRanges":[],"type":"unstyled","data":{},"inlineStyleRanges":[{"style":"color-rgb(80,80,80)","length":51,"offset":0},{"length":51,"style":"bgcolor-rgb(255,255,255)","offset":0},{"offset":0,"length":51,"style":"fontsize-16"},{"style":"fontfamily-Roboto Condensed\", sans-serif","offset":0,"length":51}],"key":"f2iao","depth":0},{"depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"key":"7q87t","text":"What should you do to remove the warning for pass-through authentication?","data":{}},{"data":{},"key":"fncrb","entityRanges":[],"inlineStyleRanges":[{"style":"color-rgb(80,80,80)","offset":0,"length":48},{"length":48,"style":"bgcolor-rgb(255,255,255)","offset":0},{"offset":0,"style":"fontsize-16","length":48},{"length":48,"offset":0,"style":"fontfamily-Roboto Condensed\", sans-serif"}],"text":"NOTE: Each correct selection is worth one point. ","depth":0,"type":"unstyled"}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"alignment":"left","height":"auto","alt":"AD Connect Setup","width":"auto","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png"}},"1":{"mutability":"MUTABLE","data":{"width":"auto","alignment":"left","alt":"AD Connect Scheduler status","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","height":"auto"},"type":"IMAGE"}}},"id":"-7MLm8ziu","answers":[{"isCorrectAnswer":false,"value":"Only employees who have an Azure AD user account"},{"isCorrectAnswer":false,"value":"Employees who have an Azure AD user account and a synced on-premises account"},{"value":"Only employees who have a synced on-premises account","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"isCorrectAnswer":true,"value":"Fix the synchronization server and install an additional authentication agent"},{"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet"}],"references":{"blocks":[{"depth":0,"entityRanges":[],"text":"","type":"unstyled","key":"fdm35","data":{},"inlineStyleRanges":[]}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
