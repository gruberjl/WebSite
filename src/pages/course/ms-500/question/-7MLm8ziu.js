...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Only employees who have an Azure AD user account","isCorrectAnswer":false},{"value":"Employees who have an Azure AD user account or a synced on-premises account","isCorrectAnswer":true},{"value":"Only employees who have a synced on-premises account","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet"},{"isCorrectAnswer":false,"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet"}],"id":"-7MLm8ziu","question":{"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"key":"3l77q","depth":0,"text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","data":{},"type":"unstyled"},{"data":{},"inlineStyleRanges":[],"entityRanges":[{"key":0,"length":1,"offset":0}],"depth":0,"key":"4tnb1","type":"atomic","text":" "},{"data":{},"type":"unstyled","key":"dv9ht","entityRanges":[],"inlineStyleRanges":[],"text":"The synchronization schedule is configured as shown in the following exhibit.","depth":0},{"key":"bm5re","data":{},"entityRanges":[{"offset":0,"key":1,"length":1}],"type":"atomic","inlineStyleRanges":[],"depth":0,"text":" "},{"data":{},"depth":0,"key":"f2iao","inlineStyleRanges":[{"offset":0,"length":51,"style":"color-rgb(80,80,80)"},{"offset":0,"length":51,"style":"bgcolor-rgb(255,255,255)"},{"offset":0,"length":51,"style":"fontsize-16"},{"length":51,"style":"fontfamily-Roboto Condensed\", sans-serif","offset":0}],"text":"Which employees can authenticate by using Azure AD?","entityRanges":[],"type":"unstyled"},{"key":"7q87t","data":{},"type":"unstyled","inlineStyleRanges":[],"text":"What should you do to remove the warning for pass-through authentication?","entityRanges":[],"depth":0}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"width":"auto","height":"auto","alignment":"left","alt":"AD Connect Setup","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png"}},"1":{"type":"IMAGE","data":{"alt":"AD Connect Scheduler status","height":"auto","alignment":"left","width":"auto","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png"},"mutability":"MUTABLE"}}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"type":"LINK"}},"blocks":[{"depth":0,"data":{},"text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)","key":"fdm35","type":"unstyled","inlineStyleRanges":[],"entityRanges":[]},{"text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails).","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","data":{},"key":"88p1k","depth":0},{"type":"unstyled","inlineStyleRanges":[],"text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.","entityRanges":[],"key":"ftho5","depth":0,"data":{}},{"data":{},"key":"e66bb","entityRanges":[{"offset":0,"length":69,"key":0}],"type":"unstyled","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
