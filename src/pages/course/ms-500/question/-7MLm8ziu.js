...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"-7MLm8ziu","answers":[{"value":"Only employees who have an Azure AD user account","isCorrectAnswer":false},{"value":"Employees who have an Azure AD user account and a synced on-premises account","isCorrectAnswer":false},{"value":"Only employees who have a synced on-premises account","isCorrectAnswer":true},{"value":"Fix the synchronization server and install Azure AD Connect in staging mode","isCorrectAnswer":false},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet"}],"references":{"blocks":[{"depth":0,"key":"fdm35","data":{},"type":"unstyled","inlineStyleRanges":[],"text":"","entityRanges":[]}],"entityMap":{}},"question":{"blocks":[{"type":"unstyled","text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","key":"3l77q","entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0},{"type":"atomic","key":"4tnb1","inlineStyleRanges":[],"text":" ","entityRanges":[{"key":0,"offset":0,"length":1}],"depth":0,"data":{}},{"type":"unstyled","depth":0,"entityRanges":[],"key":"dv9ht","data":{},"inlineStyleRanges":[],"text":"The synchronization schedule is configured as shown in the following exhibit."},{"key":"bm5re","inlineStyleRanges":[],"entityRanges":[{"key":1,"length":1,"offset":0}],"data":{},"depth":0,"type":"atomic","text":" "},{"type":"unstyled","entityRanges":[],"key":"f2iao","data":{},"depth":0,"inlineStyleRanges":[{"offset":0,"length":51,"style":"color-rgb(80,80,80)"},{"offset":0,"style":"bgcolor-rgb(255,255,255)","length":51},{"length":51,"offset":0,"style":"fontsize-16"},{"style":"fontfamily-Roboto Condensed\", sans-serif","offset":0,"length":51}],"text":"Which employees can authenticate by using Azure AD?"},{"inlineStyleRanges":[],"depth":0,"key":"7q87t","data":{},"type":"unstyled","entityRanges":[],"text":"What should you do to remove the warning for pass-through authentication?"},{"text":"NOTE: Each correct selection is worth one point. ","key":"fncrb","inlineStyleRanges":[{"style":"color-rgb(80,80,80)","length":48,"offset":0},{"style":"bgcolor-rgb(255,255,255)","offset":0,"length":48},{"style":"fontsize-16","length":48,"offset":0},{"offset":0,"length":48,"style":"fontfamily-Roboto Condensed\", sans-serif"}],"entityRanges":[],"type":"unstyled","data":{},"depth":0}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"width":"auto","alignment":"left","alt":"AD Connect Setup","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png","height":"auto"}},"1":{"mutability":"MUTABLE","data":{"height":"auto","width":"auto","alt":"AD Connect Scheduler status","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","alignment":"left"},"type":"IMAGE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
