...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Only employees who have an Azure AD user account","isCorrectAnswer":false},{"value":"Employees who have an Azure AD user account or a synced on-premises account","isCorrectAnswer":true},{"value":"Only employees who have a synced on-premises account","isCorrectAnswer":false},{"value":"Fix the synchronization server and install Azure AD Connect in staging mode","isCorrectAnswer":false},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet"},{"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false}],"id":"-7MLm8ziu","question":{"blocks":[{"depth":0,"inlineStyleRanges":[],"data":{},"text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","entityRanges":[],"key":"3l77q","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[{"length":1,"offset":0,"key":0}],"type":"atomic","key":"4tnb1","inlineStyleRanges":[],"text":" "},{"entityRanges":[],"text":"The synchronization schedule is configured as shown in the following exhibit.","key":"dv9ht","inlineStyleRanges":[],"type":"unstyled","depth":0,"data":{}},{"key":"bm5re","type":"atomic","depth":0,"entityRanges":[{"length":1,"key":1,"offset":0}],"data":{},"text":" ","inlineStyleRanges":[]},{"key":"f2iao","depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[{"offset":0,"style":"color-rgb(80,80,80)","length":51},{"length":51,"style":"bgcolor-rgb(255,255,255)","offset":0},{"offset":0,"length":51,"style":"fontsize-16"},{"style":"fontfamily-Roboto Condensed\", sans-serif","length":51,"offset":0}],"data":{},"text":"Which employees can authenticate by using Azure AD?"},{"data":{},"type":"unstyled","inlineStyleRanges":[],"text":"What should you do to remove the warning for pass-through authentication?","depth":0,"key":"7q87t","entityRanges":[]}],"entityMap":{"0":{"data":{"alt":"AD Connect Setup","alignment":"left","width":"auto","height":"auto","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png"},"mutability":"MUTABLE","type":"IMAGE"},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","alt":"AD Connect Scheduler status","height":"auto","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","width":"auto"}}}},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"type":"unstyled","entityRanges":[],"depth":0,"text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)","data":{},"inlineStyleRanges":[],"key":"fdm35"},{"depth":0,"entityRanges":[],"key":"88p1k","data":{},"type":"unstyled","inlineStyleRanges":[],"text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails)."},{"key":"ftho5","entityRanges":[],"data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes."},{"entityRanges":[{"key":0,"length":69,"offset":0}],"data":{},"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","type":"unstyled","depth":0,"key":"e66bb"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
