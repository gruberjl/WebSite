...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[],"key":"3l77q","type":"unstyled","text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit."},{"data":{},"text":" ","depth":0,"inlineStyleRanges":[],"entityRanges":[{"length":1,"offset":0,"key":0}],"type":"atomic","key":"4tnb1"},{"type":"unstyled","text":"The synchronization schedule is configured as shown in the following exhibit.","inlineStyleRanges":[],"key":"dv9ht","entityRanges":[],"depth":0,"data":{}},{"entityRanges":[{"length":1,"key":1,"offset":0}],"key":"bm5re","text":" ","data":{},"type":"atomic","inlineStyleRanges":[],"depth":0},{"entityRanges":[],"inlineStyleRanges":[{"length":51,"offset":0,"style":"color-rgb(80,80,80)"},{"style":"bgcolor-rgb(255,255,255)","length":51,"offset":0},{"length":51,"style":"fontsize-16","offset":0},{"offset":0,"length":51,"style":"fontfamily-Roboto Condensed\", sans-serif"}],"data":{},"depth":0,"text":"Which employees can authenticate by using Azure AD?","type":"unstyled","key":"f2iao"},{"depth":0,"inlineStyleRanges":[],"type":"unstyled","text":"What should you do to remove the warning for pass-through authentication?","key":"7q87t","entityRanges":[],"data":{}},{"text":"NOTE: Each correct selection is worth one point. ","type":"unstyled","key":"fncrb","depth":0,"inlineStyleRanges":[{"length":48,"style":"color-rgb(80,80,80)","offset":0},{"style":"bgcolor-rgb(255,255,255)","offset":0,"length":48},{"offset":0,"style":"fontsize-16","length":48},{"length":48,"style":"fontfamily-Roboto Condensed\", sans-serif","offset":0}],"data":{},"entityRanges":[]}],"entityMap":{"0":{"data":{"width":"auto","height":"auto","alignment":"left","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png","alt":"AD Connect Setup"},"mutability":"MUTABLE","type":"IMAGE"},"1":{"data":{"width":"auto","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","alignment":"left","alt":"AD Connect Scheduler status","height":"auto"},"mutability":"MUTABLE","type":"IMAGE"}}},"references":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"data":{},"text":"","depth":0,"key":"fdm35","type":"unstyled","entityRanges":[]}]},"id":"-7MLm8ziu","answers":[{"value":"Only employees who have an Azure AD user account","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Employees who have an Azure AD user account and a synced on-premises account"},{"value":"Only employees who have a synced on-premises account","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"isCorrectAnswer":true,"value":"Fix the synchronization server and install an additional authentication agent"},{"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet"}]},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
