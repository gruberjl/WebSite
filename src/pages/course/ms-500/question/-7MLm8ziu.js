...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{},"blocks":[{"depth":0,"data":{},"type":"unstyled","inlineStyleRanges":[],"text":"","entityRanges":[],"key":"fdm35"}]},"question":{"entityMap":{"0":{"data":{"alignment":"left","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png","height":"auto","alt":"AD Connect Setup","width":"auto"},"mutability":"MUTABLE","type":"IMAGE"},"1":{"data":{"src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","alt":"AD Connect Scheduler status","alignment":"left","height":"auto","width":"auto"},"type":"IMAGE","mutability":"MUTABLE"}},"blocks":[{"type":"unstyled","data":{},"text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"3l77q"},{"data":{},"key":"4tnb1","entityRanges":[{"key":0,"offset":0,"length":1}],"depth":0,"inlineStyleRanges":[],"text":" ","type":"atomic"},{"key":"dv9ht","data":{},"depth":0,"text":"The synchronization schedule is configured as shown in the following exhibit.","type":"unstyled","entityRanges":[],"inlineStyleRanges":[]},{"type":"atomic","entityRanges":[{"offset":0,"length":1,"key":1}],"data":{},"depth":0,"inlineStyleRanges":[],"key":"bm5re","text":" "},{"entityRanges":[],"depth":0,"key":"f2iao","type":"unstyled","data":{},"text":"Which employees can authenticate by using Azure AD?","inlineStyleRanges":[{"offset":0,"style":"color-rgb(80,80,80)","length":51},{"offset":0,"length":51,"style":"bgcolor-rgb(255,255,255)"},{"offset":0,"style":"fontsize-16","length":51},{"offset":0,"style":"fontfamily-Roboto Condensed\", sans-serif","length":51}]},{"inlineStyleRanges":[],"key":"7q87t","data":{},"type":"unstyled","entityRanges":[],"depth":0,"text":"What should you do to remove the warning for pass-through authentication?"},{"key":"fncrb","depth":0,"text":"NOTE: Each correct selection is worth one point. ","type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[{"offset":0,"length":48,"style":"color-rgb(80,80,80)"},{"offset":0,"length":48,"style":"bgcolor-rgb(255,255,255)"},{"offset":0,"style":"fontsize-16","length":48},{"length":48,"offset":0,"style":"fontfamily-Roboto Condensed\", sans-serif"}]}]},"id":"-7MLm8ziu","answers":[{"value":"Only employees who have an Azure AD user account","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Employees who have an Azure AD user account and a synced on-premises account"},{"isCorrectAnswer":true,"value":"Only employees who have a synced on-premises account"},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet"}]},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
