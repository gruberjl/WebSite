...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Only employees who have an Azure AD user account"},{"isCorrectAnswer":true,"value":"Employees who have an Azure AD user account or a synced on-premises account"},{"value":"Only employees who have a synced on-premises account","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false},{"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false}],"id":"-7MLm8ziu","question":{"blocks":[{"key":"3l77q","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","data":{}},{"type":"atomic","depth":0,"entityRanges":[{"length":1,"offset":0,"key":0}],"inlineStyleRanges":[],"data":{},"key":"4tnb1","text":" "},{"inlineStyleRanges":[],"text":"The synchronization schedule is configured as shown in the following exhibit.","entityRanges":[],"depth":0,"data":{},"key":"dv9ht","type":"unstyled"},{"depth":0,"entityRanges":[{"length":1,"offset":0,"key":1}],"key":"bm5re","type":"atomic","inlineStyleRanges":[],"text":" ","data":{}},{"inlineStyleRanges":[{"style":"color-rgb(80,80,80)","offset":0,"length":51},{"length":51,"style":"bgcolor-rgb(255,255,255)","offset":0},{"offset":0,"style":"fontsize-16","length":51},{"length":51,"style":"fontfamily-Roboto Condensed\", sans-serif","offset":0}],"text":"Which employees can authenticate by using Azure AD?","key":"f2iao","data":{},"type":"unstyled","entityRanges":[],"depth":0},{"text":"What should you do to remove the warning for pass-through authentication?","type":"unstyled","key":"7q87t","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"width":"auto","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png","alignment":"left","height":"auto","alt":"AD Connect Setup"},"type":"IMAGE"},"1":{"data":{"height":"auto","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","alt":"AD Connect Scheduler status","alignment":"left","width":"auto"},"mutability":"MUTABLE","type":"IMAGE"}}},"references":{"blocks":[{"depth":0,"data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"key":"fdm35","text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)"},{"data":{},"entityRanges":[],"text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails).","type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"88p1k"},{"text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.","inlineStyleRanges":[],"type":"unstyled","depth":0,"entityRanges":[],"data":{},"key":"ftho5"},{"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","data":{},"inlineStyleRanges":[],"entityRanges":[{"key":0,"length":69,"offset":0}],"depth":0,"type":"unstyled","key":"e66bb"}],"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
