...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Only employees who have an Azure AD user account","isCorrectAnswer":false},{"value":"Employees who have an Azure AD user account or a synced on-premises account","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Only employees who have a synced on-premises account"},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet"},{"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false}],"id":"-7MLm8ziu","question":{"blocks":[{"data":{},"depth":0,"key":"3l77q","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit."},{"data":{},"text":" ","entityRanges":[{"key":0,"length":1,"offset":0}],"key":"4tnb1","depth":0,"inlineStyleRanges":[],"type":"atomic"},{"inlineStyleRanges":[],"depth":0,"text":"The synchronization schedule is configured as shown in the following exhibit.","type":"unstyled","entityRanges":[],"key":"dv9ht","data":{}},{"inlineStyleRanges":[],"type":"atomic","depth":0,"text":" ","key":"bm5re","data":{},"entityRanges":[{"offset":0,"key":1,"length":1}]},{"type":"unstyled","entityRanges":[],"key":"f2iao","inlineStyleRanges":[{"style":"color-rgb(80,80,80)","length":51,"offset":0},{"offset":0,"style":"bgcolor-rgb(255,255,255)","length":51},{"offset":0,"style":"fontsize-16","length":51},{"style":"fontfamily-Roboto Condensed\", sans-serif","length":51,"offset":0}],"data":{},"depth":0,"text":"Which employees can authenticate by using Azure AD?"},{"text":"What should you do to remove the warning for pass-through authentication?","key":"7q87t","data":{},"depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"alt":"AD Connect Setup","alignment":"left","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png","height":"auto","width":"auto"},"mutability":"MUTABLE","type":"IMAGE"},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","alt":"AD Connect Scheduler status","height":"auto","width":"auto","alignment":"left"}}}},"references":{"blocks":[{"key":"fdm35","text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)","depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"data":{}},{"text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails).","depth":0,"data":{},"inlineStyleRanges":[],"key":"88p1k","entityRanges":[],"type":"unstyled"},{"inlineStyleRanges":[],"key":"ftho5","entityRanges":[],"data":{},"depth":0,"text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.","type":"unstyled"},{"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","depth":0,"key":"e66bb","inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[{"length":69,"offset":0,"key":0}]}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
