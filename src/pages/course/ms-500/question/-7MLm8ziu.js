...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"depth":0,"type":"unstyled","text":"","inlineStyleRanges":[],"key":"fdm35","data":{},"entityRanges":[]}],"entityMap":{}},"question":{"blocks":[{"text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"3l77q","data":{},"type":"unstyled"},{"text":" ","key":"4tnb1","type":"atomic","depth":0,"entityRanges":[{"key":0,"length":1,"offset":0}],"inlineStyleRanges":[],"data":{}},{"depth":0,"key":"dv9ht","data":{},"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"The synchronization schedule is configured as shown in the following exhibit."},{"entityRanges":[{"offset":0,"length":1,"key":1}],"type":"atomic","key":"bm5re","inlineStyleRanges":[],"data":{},"text":" ","depth":0},{"depth":0,"data":{},"text":"Which employees can authenticate by using Azure AD?","key":"f2iao","entityRanges":[],"inlineStyleRanges":[{"offset":0,"length":51,"style":"color-rgb(80,80,80)"},{"style":"bgcolor-rgb(255,255,255)","length":51,"offset":0},{"offset":0,"style":"fontsize-16","length":51},{"style":"fontfamily-Roboto Condensed\", sans-serif","length":51,"offset":0}],"type":"unstyled"},{"entityRanges":[],"text":"What should you do to remove the warning for pass-through authentication?","type":"unstyled","inlineStyleRanges":[],"key":"7q87t","data":{},"depth":0},{"inlineStyleRanges":[{"offset":0,"style":"color-rgb(80,80,80)","length":48},{"style":"bgcolor-rgb(255,255,255)","length":48,"offset":0},{"length":48,"style":"fontsize-16","offset":0},{"offset":0,"style":"fontfamily-Roboto Condensed\", sans-serif","length":48}],"data":{},"key":"fncrb","type":"unstyled","depth":0,"entityRanges":[],"text":"NOTE: Each correct selection is worth one point. "}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","alt":"AD Connect Setup","width":"auto","height":"auto","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png"}},"1":{"data":{"height":"auto","alt":"AD Connect Scheduler status","width":"auto","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","alignment":"left"},"type":"IMAGE","mutability":"MUTABLE"}}},"id":"-7MLm8ziu","answers":[{"value":"Only employees who have an Azure AD user account","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Employees who have an Azure AD user account and a synced on-premises account"},{"isCorrectAnswer":true,"value":"Only employees who have a synced on-premises account"},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"isCorrectAnswer":true,"value":"Fix the synchronization server and install an additional authentication agent"},{"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet"}]},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
