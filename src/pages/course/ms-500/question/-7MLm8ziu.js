...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Only employees who have an Azure AD user account","isCorrectAnswer":false},{"value":"Employees who have an Azure AD user account or a synced on-premises account","isCorrectAnswer":true},{"value":"Only employees who have a synced on-premises account","isCorrectAnswer":false},{"value":"Fix the synchronization server and install Azure AD Connect in staging mode","isCorrectAnswer":false},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false},{"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false}],"id":"-7MLm8ziu","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"width":"auto","alt":"AD Connect Setup","height":"auto","alignment":"left","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png"},"type":"IMAGE"},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","width":"auto","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","alignment":"left","alt":"AD Connect Scheduler status"}}},"blocks":[{"type":"unstyled","depth":0,"entityRanges":[],"key":"3l77q","inlineStyleRanges":[],"data":{},"text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit."},{"entityRanges":[{"length":1,"offset":0,"key":0}],"depth":0,"type":"atomic","inlineStyleRanges":[],"text":" ","data":{},"key":"4tnb1"},{"key":"dv9ht","data":{},"type":"unstyled","inlineStyleRanges":[],"text":"The synchronization schedule is configured as shown in the following exhibit.","entityRanges":[],"depth":0},{"data":{},"type":"atomic","depth":0,"inlineStyleRanges":[],"key":"bm5re","text":" ","entityRanges":[{"key":1,"length":1,"offset":0}]},{"data":{},"inlineStyleRanges":[{"length":51,"style":"color-rgb(80,80,80)","offset":0},{"offset":0,"style":"bgcolor-rgb(255,255,255)","length":51},{"length":51,"offset":0,"style":"fontsize-16"},{"length":51,"style":"fontfamily-Roboto Condensed\", sans-serif","offset":0}],"entityRanges":[],"depth":0,"text":"Which employees can authenticate by using Azure AD?","type":"unstyled","key":"f2iao"},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"What should you do to remove the warning for pass-through authentication?","key":"7q87t","depth":0}]},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"type":"LINK"}},"blocks":[{"data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)","key":"fdm35","type":"unstyled"},{"text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails).","depth":0,"entityRanges":[],"type":"unstyled","key":"88p1k","inlineStyleRanges":[],"data":{}},{"key":"ftho5","data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.","entityRanges":[]},{"data":{},"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","type":"unstyled","depth":0,"key":"e66bb","entityRanges":[{"offset":0,"length":69,"key":0}]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
