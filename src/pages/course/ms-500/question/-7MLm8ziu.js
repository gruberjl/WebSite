...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Only employees who have an Azure AD user account"},{"isCorrectAnswer":true,"value":"Employees who have an Azure AD user account or a synced on-premises account"},{"value":"Only employees who have a synced on-premises account","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet"}],"id":"-7MLm8ziu","question":{"entityMap":{"0":{"type":"IMAGE","data":{"width":"auto","alt":"AD Connect Setup","alignment":"left","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png","height":"auto"},"mutability":"MUTABLE"},"1":{"data":{"alignment":"left","height":"auto","alt":"AD Connect Scheduler status","src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","width":"auto"},"type":"IMAGE","mutability":"MUTABLE"}},"blocks":[{"text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"3l77q","data":{},"entityRanges":[]},{"type":"atomic","depth":0,"key":"4tnb1","data":{},"inlineStyleRanges":[],"entityRanges":[{"key":0,"length":1,"offset":0}],"text":" "},{"key":"dv9ht","inlineStyleRanges":[],"type":"unstyled","text":"The synchronization schedule is configured as shown in the following exhibit.","data":{},"entityRanges":[],"depth":0},{"data":{},"depth":0,"inlineStyleRanges":[],"type":"atomic","key":"bm5re","entityRanges":[{"offset":0,"key":1,"length":1}],"text":" "},{"inlineStyleRanges":[{"style":"color-rgb(80,80,80)","offset":0,"length":51},{"style":"bgcolor-rgb(255,255,255)","length":51,"offset":0},{"style":"fontsize-16","offset":0,"length":51},{"style":"fontfamily-Roboto Condensed\", sans-serif","offset":0,"length":51}],"key":"f2iao","type":"unstyled","entityRanges":[],"data":{},"text":"Which employees can authenticate by using Azure AD?","depth":0},{"entityRanges":[],"data":{},"text":"What should you do to remove the warning for pass-through authentication?","depth":0,"type":"unstyled","key":"7q87t","inlineStyleRanges":[]}]},"references":{"blocks":[{"entityRanges":[],"data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"fdm35","text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)"},{"data":{},"inlineStyleRanges":[],"text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails).","type":"unstyled","depth":0,"entityRanges":[],"key":"88p1k"},{"type":"unstyled","key":"ftho5","data":{},"inlineStyleRanges":[],"text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.","entityRanges":[],"depth":0},{"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","inlineStyleRanges":[],"type":"unstyled","key":"e66bb","depth":0,"entityRanges":[{"length":69,"offset":0,"key":0}],"data":{}}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
