...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Only employees who have an Azure AD user account"},{"value":"Employees who have an Azure AD user account or a synced on-premises account","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Only employees who have a synced on-premises account"},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"value":"Fix the synchronization server and install an additional authentication agent","isCorrectAnswer":true},{"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false},{"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false}],"id":"-7MLm8ziu","question":{"blocks":[{"inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[],"key":"3l77q","text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","type":"unstyled"},{"inlineStyleRanges":[],"type":"atomic","data":{},"depth":0,"text":" ","key":"4tnb1","entityRanges":[{"offset":0,"length":1,"key":0}]},{"inlineStyleRanges":[],"text":"The synchronization schedule is configured as shown in the following exhibit.","key":"dv9ht","type":"unstyled","depth":0,"entityRanges":[],"data":{}},{"entityRanges":[{"offset":0,"length":1,"key":1}],"inlineStyleRanges":[],"key":"bm5re","data":{},"type":"atomic","depth":0,"text":" "},{"inlineStyleRanges":[{"length":51,"offset":0,"style":"color-rgb(80,80,80)"},{"style":"bgcolor-rgb(255,255,255)","offset":0,"length":51},{"length":51,"style":"fontsize-16","offset":0},{"length":51,"offset":0,"style":"fontfamily-Roboto Condensed\", sans-serif"}],"entityRanges":[],"data":{},"key":"f2iao","type":"unstyled","depth":0,"text":"Which employees can authenticate by using Azure AD?"},{"data":{},"type":"unstyled","key":"7q87t","inlineStyleRanges":[],"depth":0,"entityRanges":[],"text":"What should you do to remove the warning for pass-through authentication?"}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png","height":"auto","alignment":"left","width":"auto","alt":"AD Connect Setup"}},"1":{"type":"IMAGE","data":{"src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","height":"auto","alignment":"left","alt":"AD Connect Scheduler status","width":"auto"},"mutability":"MUTABLE"}}},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"}}},"blocks":[{"key":"fdm35","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)","type":"unstyled"},{"depth":0,"text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails).","entityRanges":[],"type":"unstyled","data":{},"key":"88p1k","inlineStyleRanges":[]},{"key":"ftho5","type":"unstyled","depth":0,"text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.","data":{},"inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[{"length":69,"offset":0,"key":0}],"key":"e66bb","type":"unstyled","data":{},"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
