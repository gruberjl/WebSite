...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Only employees who have an Azure AD user account"},{"value":"Employees who have an Azure AD user account or a synced on-premises account","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Only employees who have a synced on-premises account"},{"isCorrectAnswer":false,"value":"Fix the synchronization server and install Azure AD Connect in staging mode"},{"isCorrectAnswer":true,"value":"Fix the synchronization server and install an additional authentication agent"},{"isCorrectAnswer":false,"value":"Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet"},{"value":"Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet","isCorrectAnswer":false}],"id":"-7MLm8ziu","question":{"blocks":[{"type":"unstyled","key":"3l77q","data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.","depth":0},{"inlineStyleRanges":[],"type":"atomic","entityRanges":[{"key":0,"offset":0,"length":1}],"data":{},"depth":0,"text":" ","key":"4tnb1"},{"key":"dv9ht","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"The synchronization schedule is configured as shown in the following exhibit."},{"data":{},"text":" ","entityRanges":[{"key":1,"offset":0,"length":1}],"inlineStyleRanges":[],"depth":0,"key":"bm5re","type":"atomic"},{"text":"Which employees can authenticate by using Azure AD?","type":"unstyled","key":"f2iao","depth":0,"data":{},"inlineStyleRanges":[{"length":51,"style":"color-rgb(80,80,80)","offset":0},{"style":"bgcolor-rgb(255,255,255)","length":51,"offset":0},{"length":51,"offset":0,"style":"fontsize-16"},{"offset":0,"length":51,"style":"fontfamily-Roboto Condensed\", sans-serif"}],"entityRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"key":"7q87t","data":{},"text":"What should you do to remove the warning for pass-through authentication?","type":"unstyled","depth":0}],"entityMap":{"0":{"data":{"width":"auto","src":"https://i.ibb.co/VpsjVFh/ad-connect-setup.png","alignment":"left","height":"auto","alt":"AD Connect Setup"},"mutability":"MUTABLE","type":"IMAGE"},"1":{"type":"IMAGE","data":{"src":"https://i.ibb.co/CWcS1NP/ad-connect-status.png","height":"auto","alt":"AD Connect Scheduler status","alignment":"left","width":"auto"},"mutability":"MUTABLE"}}},"references":{"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)","depth":0,"type":"unstyled","key":"fdm35"},{"inlineStyleRanges":[],"entityRanges":[],"text":"The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails).","data":{},"key":"88p1k","type":"unstyled","depth":0},{"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"There's also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.","depth":0,"data":{},"key":"ftho5"},{"key":"e66bb","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","entityRanges":[{"length":69,"offset":0,"key":0}],"depth":0,"data":{},"type":"unstyled"}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-7MLm8ziu',
      questionIdx: '',
