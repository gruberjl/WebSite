...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User1"},{"isCorrectAnswer":true,"value":"User2"},{"isCorrectAnswer":false,"value":"User3"},{"isCorrectAnswer":false,"value":"User4"}],"id":"MhnVtUtm5","question":{"blocks":[{"data":{},"depth":0,"entityRanges":[],"type":"unstyled","key":"cosd7","inlineStyleRanges":[],"text":"Your organization has Microsoft 365 tenant with Microsoft 365 E5 licenses. The tenant contains the following users."},{"text":" ","depth":0,"type":"atomic","key":"377ga","inlineStyleRanges":[],"entityRanges":[{"length":1,"key":0,"offset":0}],"data":{}},{"key":"186in","depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"Your manager has asked you which admins can enable Microsoft Defender for Endpoint roles."},{"text":"Click the check box next to each user that can enable Microsoft Defender for Endpoint roles.","entityRanges":[],"key":"cb1f","inlineStyleRanges":[],"type":"unstyled","depth":0,"data":{}}],"entityMap":{"0":{"data":{"alt":"Users Roles Chart","alignment":"left","width":"auto","src":"https://i.ibb.co/6mjYxD7/users-roles.png","height":"auto"},"type":"IMAGE","mutability":"MUTABLE"}}},"references":{"blocks":[{"entityRanges":[],"key":"43u18","text":"The security administrator role gives any user assigned the role the ability to manage Microsoft Defender for Endpoint roles.","inlineStyleRanges":[],"depth":0,"data":{},"type":"unstyled"},{"inlineStyleRanges":[],"depth":0,"entityRanges":[{"length":95,"key":0,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","key":"7j6g","type":"unstyled","data":{}},{"depth":0,"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/windows/security/threat-protection/microsoft-defender-atp/rbac","type":"unstyled","key":"1cv0j","entityRanges":[{"offset":0,"key":1,"length":95}],"data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU"},"type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/windows/security/threat-protection/microsoft-defender-atp/rbac","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
