...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Policy to create: safe attachments"},{"isCorrectAnswer":false,"value":"Policy to create: Safe Links"},{"isCorrectAnswer":false,"value":"Policy to create: Anti-spam"},{"isCorrectAnswer":false,"value":"Policy to create: Anti-malware"},{"value":"Option to configure: Block","isCorrectAnswer":false},{"value":"Option to configure: Replace","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Option to configure: Dynamic delivery"},{"isCorrectAnswer":false,"value":"Option to configure: Monitor"},{"value":"Option to configure: Off","isCorrectAnswer":false}],"id":"v-e_rx1Nr","question":{"entityMap":{},"blocks":[{"entityRanges":[],"depth":0,"key":"57g3g","data":{},"type":"unstyled","inlineStyleRanges":[],"text":"Most end-user applications are provided by a Microsoft 365 E5 subscription"},{"depth":0,"type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[{"offset":0,"style":"BOLD","length":21}],"key":"cv9u9","text":"Security Requirements"},{"type":"unordered-list-item","inlineStyleRanges":[],"key":"4bjgg","entityRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","depth":0,"data":{}},{"data":{},"depth":0,"key":"11lmb","type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","entityRanges":[],"inlineStyleRanges":[]},{"key":"94f1n","type":"unordered-list-item","inlineStyleRanges":[],"depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","data":{},"entityRanges":[]},{"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"depth":0,"key":"f6vsk","inlineStyleRanges":[],"entityRanges":[]},{"key":"8ten9","type":"unordered-list-item","inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","data":{},"depth":0,"entityRanges":[]},{"inlineStyleRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","key":"9j4hh","type":"unordered-list-item","depth":0,"data":{},"entityRanges":[]},{"text":"Email messages that include attachments containing malware must be delivered without the attachment","inlineStyleRanges":[],"data":{},"type":"unordered-list-item","entityRanges":[],"key":"1k6jk","depth":0},{"type":"unordered-list-item","inlineStyleRanges":[],"depth":0,"text":"The principle of least privilege must be used whenever possible","entityRanges":[],"key":"649pg","data":{}},{"type":"unstyled","depth":0,"text":"You need to recommend an email malware solution that meets the security requirements.","entityRanges":[],"data":{},"key":"6qnnq","inlineStyleRanges":[]},{"text":"What should you include in the recommendation? To answer, select the appropriate options in the answer area","data":{},"depth":0,"type":"unstyled","key":"e2jmk","entityRanges":[],"inlineStyleRanges":[]}]},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","targetOption":"_blank"},"type":"LINK"}},"blocks":[{"entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"To configure \"Email messages that include attachments containing malware must be delivered without the attachment\" you'll need to create a safe attachments policy with the replace option.","type":"unstyled","key":"a4dok","depth":0},{"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","type":"unstyled","entityRanges":[{"key":0,"length":105,"offset":0}],"inlineStyleRanges":[],"depth":0,"key":"cb23c","data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
