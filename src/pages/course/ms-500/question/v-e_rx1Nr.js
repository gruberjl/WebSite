...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Policy to create: safe attachments","isCorrectAnswer":true},{"value":"Policy to create: Safe Links","isCorrectAnswer":false},{"value":"Policy to create: Anti-spam","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Policy to create: Anti-malware"},{"isCorrectAnswer":false,"value":"Option to configure: Block"},{"isCorrectAnswer":true,"value":"Option to configure: Replace"},{"isCorrectAnswer":false,"value":"Option to configure: Dynamic delivery"},{"value":"Option to configure: Monitor","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Option to configure: Off"}],"id":"v-e_rx1Nr","question":{"entityMap":{},"blocks":[{"key":"57g3g","inlineStyleRanges":[],"data":{},"depth":0,"text":"Most end-user applications are provided by a Microsoft 365 E5 subscription","type":"unstyled","entityRanges":[]},{"type":"unstyled","key":"cv9u9","inlineStyleRanges":[{"length":21,"style":"BOLD","offset":0}],"text":"Security Requirements","data":{},"entityRanges":[],"depth":0},{"data":{},"inlineStyleRanges":[],"type":"unordered-list-item","key":"4bjgg","depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[]},{"type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"11lmb","data":{}},{"type":"unordered-list-item","inlineStyleRanges":[],"data":{},"depth":0,"key":"94f1n","entityRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations"},{"entityRanges":[],"key":"f6vsk","inlineStyleRanges":[],"data":{},"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","depth":0},{"key":"8ten9","depth":0,"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","data":{}},{"inlineStyleRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{},"entityRanges":[],"depth":0,"key":"9j4hh","type":"unordered-list-item"},{"text":"Email messages that include attachments containing malware must be delivered without the attachment","entityRanges":[],"depth":0,"key":"1k6jk","type":"unordered-list-item","data":{},"inlineStyleRanges":[]},{"type":"unordered-list-item","text":"The principle of least privilege must be used whenever possible","key":"649pg","inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[]},{"entityRanges":[],"type":"unstyled","data":{},"text":"You need to recommend an email malware solution that meets the security requirements.","inlineStyleRanges":[],"depth":0,"key":"6qnnq"},{"key":"e2jmk","entityRanges":[],"text":"What should you include in the recommendation? To answer, select the appropriate options in the answer area","type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{}}]},"references":{"blocks":[{"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"a4dok","depth":0,"entityRanges":[],"text":"To configure \"Email messages that include attachments containing malware must be delivered without the attachment\" you'll need to create a safe attachments policy with the replace option."},{"inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":0,"length":105}],"key":"cb23c","type":"unstyled","depth":0,"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
