...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Policy to create: safe attachments","isCorrectAnswer":true},{"value":"Policy to create: Safe Links","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Policy to create: Anti-spam"},{"isCorrectAnswer":false,"value":"Policy to create: Anti-malware"},{"isCorrectAnswer":false,"value":"Option to configure: Block"},{"value":"Option to configure: Replace","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Option to configure: Dynamic delivery"},{"isCorrectAnswer":false,"value":"Option to configure: Monitor"},{"isCorrectAnswer":false,"value":"Option to configure: Off"}],"id":"v-e_rx1Nr","question":{"blocks":[{"inlineStyleRanges":[],"key":"57g3g","text":"Most end-user applications are provided by a Microsoft 365 E5 subscription","type":"unstyled","depth":0,"entityRanges":[],"data":{}},{"entityRanges":[],"data":{},"type":"unstyled","inlineStyleRanges":[{"offset":0,"style":"BOLD","length":21}],"depth":0,"text":"Security Requirements","key":"cv9u9"},{"key":"4bjgg","depth":0,"entityRanges":[],"type":"unordered-list-item","data":{},"inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"depth":0,"key":"11lmb","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","inlineStyleRanges":[],"data":{},"entityRanges":[]},{"key":"94f1n","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","type":"unordered-list-item","data":{}},{"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"depth":0,"key":"f6vsk"},{"entityRanges":[],"key":"8ten9","type":"unordered-list-item","inlineStyleRanges":[],"data":{},"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0},{"depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","entityRanges":[],"data":{},"key":"9j4hh","inlineStyleRanges":[],"type":"unordered-list-item"},{"inlineStyleRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","type":"unordered-list-item","entityRanges":[],"key":"1k6jk","data":{},"depth":0},{"depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"649pg","type":"unordered-list-item","text":"The principle of least privilege must be used whenever possible"},{"data":{},"key":"6qnnq","inlineStyleRanges":[],"entityRanges":[],"text":"You need to recommend an email malware solution that meets the security requirements.","type":"unstyled","depth":0},{"text":"What should you include in the recommendation? To answer, select the appropriate options in the answer area","entityRanges":[],"data":{},"type":"unstyled","key":"e2jmk","depth":0,"inlineStyleRanges":[]}],"entityMap":{}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"},"type":"LINK"}},"blocks":[{"text":"To configure \"Email messages that include attachments containing malware must be delivered without the attachment\" you'll need to create a safe attachments policy with the replace option.","depth":0,"entityRanges":[],"type":"unstyled","key":"a4dok","data":{},"inlineStyleRanges":[]},{"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","key":"cb23c","depth":0,"inlineStyleRanges":[],"data":{},"entityRanges":[{"key":0,"offset":0,"length":105}],"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
