...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Policy to create: safe attachments","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Policy to create: Safe Links"},{"isCorrectAnswer":false,"value":"Policy to create: Anti-spam"},{"value":"Policy to create: Anti-malware","isCorrectAnswer":false},{"value":"Option to configure: Block","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Option to configure: Replace"},{"isCorrectAnswer":false,"value":"Option to configure: Dynamic delivery"},{"isCorrectAnswer":false,"value":"Option to configure: Monitor"},{"value":"Option to configure: Off","isCorrectAnswer":false}],"id":"v-e_rx1Nr","question":{"entityMap":{},"blocks":[{"type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{},"key":"57g3g","entityRanges":[],"text":"Most end-user applications are provided by a Microsoft 365 E5 subscription"},{"entityRanges":[],"key":"cv9u9","inlineStyleRanges":[{"style":"BOLD","length":21,"offset":0}],"type":"unstyled","depth":0,"data":{},"text":"Security Requirements"},{"depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","key":"4bjgg","inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","data":{}},{"key":"11lmb","inlineStyleRanges":[],"type":"unordered-list-item","data":{},"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","depth":0,"entityRanges":[]},{"inlineStyleRanges":[],"key":"94f1n","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","depth":0,"data":{},"type":"unordered-list-item","entityRanges":[]},{"data":{},"depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","entityRanges":[],"type":"unordered-list-item","key":"f6vsk","inlineStyleRanges":[]},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"8ten9","depth":0,"data":{},"type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[],"depth":0,"key":"9j4hh","type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{},"inlineStyleRanges":[]},{"data":{},"inlineStyleRanges":[],"key":"1k6jk","depth":0,"text":"Email messages that include attachments containing malware must be delivered without the attachment","entityRanges":[],"type":"unordered-list-item"},{"key":"649pg","depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"data":{},"text":"The principle of least privilege must be used whenever possible"},{"depth":0,"key":"6qnnq","type":"unstyled","text":"You need to recommend an email malware solution that meets the security requirements.","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"text":"What should you include in the recommendation? To answer, select the appropriate options in the answer area","data":{},"depth":0,"type":"unstyled","key":"e2jmk"}]},"references":{"blocks":[{"data":{},"key":"a4dok","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"text":"To configure \"Email messages that include attachments containing malware must be delivered without the attachment\" you'll need to create a safe attachments policy with the replace option.","depth":0},{"key":"cb23c","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[{"key":0,"offset":0,"length":105}]}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
