...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Policy to create: safe attachments","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Policy to create: Safe Links"},{"value":"Policy to create: Anti-spam","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Policy to create: Anti-malware"},{"value":"Option to configure: Block","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Option to configure: Replace"},{"value":"Option to configure: Dynamic delivery","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Option to configure: Monitor"},{"value":"Option to configure: Off","isCorrectAnswer":false}],"id":"v-e_rx1Nr","question":{"blocks":[{"data":{},"key":"57g3g","depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"Most end-user applications are provided by a Microsoft 365 E5 subscription","type":"unstyled"},{"type":"unstyled","key":"cv9u9","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[{"style":"BOLD","length":21,"offset":0}],"text":"Security Requirements"},{"key":"4bjgg","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[],"type":"unordered-list-item","depth":0,"data":{},"inlineStyleRanges":[]},{"depth":0,"type":"unordered-list-item","key":"11lmb","inlineStyleRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","entityRanges":[],"data":{}},{"data":{},"entityRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"94f1n","inlineStyleRanges":[],"type":"unordered-list-item","depth":0},{"type":"unordered-list-item","entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","depth":0,"inlineStyleRanges":[],"key":"f6vsk","data":{}},{"depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"8ten9","type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location"},{"inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","key":"9j4hh","depth":0},{"key":"1k6jk","data":{},"inlineStyleRanges":[],"type":"unordered-list-item","depth":0,"entityRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"text":"The principle of least privilege must be used whenever possible","key":"649pg","inlineStyleRanges":[],"depth":0,"data":{},"type":"unordered-list-item","entityRanges":[]},{"key":"6qnnq","data":{},"text":"You need to recommend an email malware solution that meets the security requirements.","entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"key":"e2jmk","inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0,"text":"What should you include in the recommendation? To answer, select the appropriate options in the answer area","type":"unstyled"}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"},"mutability":"MUTABLE"}},"blocks":[{"data":{},"key":"a4dok","type":"unstyled","text":"To configure \"Email messages that include attachments containing malware must be delivered without the attachment\" you'll need to create a safe attachments policy with the replace option.","entityRanges":[],"inlineStyleRanges":[],"depth":0},{"type":"unstyled","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","data":{},"key":"cb23c","entityRanges":[{"length":105,"key":0,"offset":0}],"inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
