...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Policy to create: safe attachments","isCorrectAnswer":true},{"value":"Policy to create: Safe Links","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Policy to create: Anti-spam"},{"isCorrectAnswer":false,"value":"Policy to create: Anti-malware"},{"value":"Option to configure: Block","isCorrectAnswer":false},{"value":"Option to configure: Replace","isCorrectAnswer":true},{"value":"Option to configure: Dynamic delivery","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Option to configure: Monitor"},{"isCorrectAnswer":false,"value":"Option to configure: Off"}],"id":"v-e_rx1Nr","question":{"blocks":[{"data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"Most end-user applications are provided by a Microsoft 365 E5 subscription","key":"57g3g"},{"data":{},"entityRanges":[],"text":"Security Requirements","type":"unstyled","depth":0,"key":"cv9u9","inlineStyleRanges":[{"length":21,"offset":0,"style":"BOLD"}]},{"type":"unordered-list-item","data":{},"entityRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","key":"4bjgg","depth":0,"inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unordered-list-item","key":"11lmb","depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement"},{"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","data":{},"type":"unordered-list-item","entityRanges":[],"key":"94f1n","inlineStyleRanges":[],"depth":0},{"key":"f6vsk","depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unordered-list-item"},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"8ten9","depth":0,"entityRanges":[],"type":"unordered-list-item","data":{},"inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","key":"9j4hh","depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{}},{"depth":0,"data":{},"key":"1k6jk","inlineStyleRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","entityRanges":[],"type":"unordered-list-item"},{"data":{},"key":"649pg","inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"depth":0,"text":"The principle of least privilege must be used whenever possible"},{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"data":{},"depth":0,"key":"6qnnq","text":"You need to recommend an email malware solution that meets the security requirements."},{"key":"e2jmk","text":"What should you include in the recommendation? To answer, select the appropriate options in the answer area","entityRanges":[],"type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[]}],"entityMap":{}},"references":{"blocks":[{"depth":0,"key":"a4dok","text":"To configure \"Email messages that include attachments containing malware must be delivered without the attachment\" you'll need to create a safe attachments policy with the replace option.","entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unstyled"},{"data":{},"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","key":"cb23c","type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"key":0,"length":105,"offset":0}]}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
