...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Policy to create: safe attachments","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Policy to create: Safe Links"},{"isCorrectAnswer":false,"value":"Policy to create: Anti-spam"},{"value":"Policy to create: Anti-malware","isCorrectAnswer":false},{"value":"Option to configure: Block","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Option to configure: Replace"},{"isCorrectAnswer":false,"value":"Option to configure: Dynamic delivery"},{"isCorrectAnswer":false,"value":"Option to configure: Monitor"},{"value":"Option to configure: Off","isCorrectAnswer":false}],"id":"v-e_rx1Nr","question":{"blocks":[{"key":"57g3g","depth":0,"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"Most end-user applications are provided by a Microsoft 365 E5 subscription","data":{}},{"entityRanges":[],"depth":0,"key":"cv9u9","data":{},"text":"Security Requirements","type":"unstyled","inlineStyleRanges":[{"style":"BOLD","length":21,"offset":0}]},{"type":"unordered-list-item","depth":0,"entityRanges":[],"data":{},"key":"4bjgg","inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"entityRanges":[],"key":"11lmb","type":"unordered-list-item","data":{},"inlineStyleRanges":[],"depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement"},{"data":{},"inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"94f1n","entityRanges":[]},{"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[],"key":"f6vsk","entityRanges":[],"data":{},"type":"unordered-list-item","depth":0},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0,"entityRanges":[],"type":"unordered-list-item","data":{},"key":"8ten9","inlineStyleRanges":[]},{"key":"9j4hh","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","inlineStyleRanges":[],"data":{},"entityRanges":[],"depth":0,"type":"unordered-list-item"},{"key":"1k6jk","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[],"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"text":"The principle of least privilege must be used whenever possible","data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","depth":0,"key":"649pg"},{"type":"unstyled","text":"You need to recommend an email malware solution that meets the security requirements.","entityRanges":[],"key":"6qnnq","data":{},"depth":0,"inlineStyleRanges":[]},{"data":{},"key":"e2jmk","text":"What should you include in the recommendation? To answer, select the appropriate options in the answer area","inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[]}],"entityMap":{}},"references":{"blocks":[{"key":"a4dok","type":"unstyled","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[],"text":"To configure \"Email messages that include attachments containing malware must be delivered without the attachment\" you'll need to create a safe attachments policy with the replace option."},{"entityRanges":[{"key":0,"offset":0,"length":105}],"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","depth":0,"key":"cb23c","data":{},"inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
