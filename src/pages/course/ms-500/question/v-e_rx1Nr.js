...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Policy to create: safe attachments","isCorrectAnswer":true},{"value":"Policy to create: Safe Links","isCorrectAnswer":false},{"value":"Policy to create: Anti-spam","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Policy to create: Anti-malware"},{"value":"Option to configure: Block","isCorrectAnswer":false},{"value":"Option to configure: Replace","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Option to configure: Dynamic delivery"},{"isCorrectAnswer":false,"value":"Option to configure: Monitor"},{"value":"Option to configure: Off","isCorrectAnswer":false}],"id":"v-e_rx1Nr","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"Most end-user applications are provided by a Microsoft 365 E5 subscription","key":"57g3g","data":{},"depth":0},{"entityRanges":[],"type":"unstyled","inlineStyleRanges":[{"offset":0,"style":"BOLD","length":21}],"text":"Security Requirements","data":{},"key":"cv9u9","depth":0},{"inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","data":{},"entityRanges":[],"key":"4bjgg","type":"unordered-list-item","depth":0},{"inlineStyleRanges":[],"depth":0,"data":{},"key":"11lmb","entityRanges":[],"type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement"},{"data":{},"depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"94f1n","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[]},{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","key":"f6vsk"},{"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","data":{},"entityRanges":[],"depth":0,"key":"8ten9","type":"unordered-list-item"},{"data":{},"entityRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","inlineStyleRanges":[],"key":"9j4hh","depth":0,"type":"unordered-list-item"},{"text":"Email messages that include attachments containing malware must be delivered without the attachment","type":"unordered-list-item","inlineStyleRanges":[],"key":"1k6jk","depth":0,"data":{},"entityRanges":[]},{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"data":{},"type":"unordered-list-item","key":"649pg","text":"The principle of least privilege must be used whenever possible"},{"data":{},"entityRanges":[],"depth":0,"text":"You need to recommend an email malware solution that meets the security requirements.","inlineStyleRanges":[],"type":"unstyled","key":"6qnnq"},{"data":{},"type":"unstyled","inlineStyleRanges":[],"depth":0,"text":"What should you include in the recommendation? To answer, select the appropriate options in the answer area","entityRanges":[],"key":"e2jmk"}]},"references":{"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","targetOption":"_blank"},"mutability":"MUTABLE"}},"blocks":[{"entityRanges":[],"text":"To configure \"Email messages that include attachments containing malware must be delivered without the attachment\" you'll need to create a safe attachments policy with the replace option.","data":{},"type":"unstyled","key":"a4dok","depth":0,"inlineStyleRanges":[]},{"data":{},"type":"unstyled","entityRanges":[{"key":0,"length":105,"offset":0}],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","key":"cb23c","inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
