...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Policy to create: safe attachments","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Policy to create: Safe Links"},{"isCorrectAnswer":false,"value":"Policy to create: Anti-spam"},{"value":"Policy to create: Anti-malware","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Option to configure: Block"},{"isCorrectAnswer":true,"value":"Option to configure: Replace"},{"isCorrectAnswer":false,"value":"Option to configure: Dynamic delivery"},{"isCorrectAnswer":false,"value":"Option to configure: Monitor"},{"isCorrectAnswer":false,"value":"Option to configure: Off"}],"id":"v-e_rx1Nr","question":{"entityMap":{},"blocks":[{"entityRanges":[],"type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"57g3g","data":{},"text":"Most end-user applications are provided by a Microsoft 365 E5 subscription"},{"key":"cv9u9","depth":0,"data":{},"text":"Security Requirements","type":"unstyled","entityRanges":[],"inlineStyleRanges":[{"style":"BOLD","offset":0,"length":21}]},{"data":{},"inlineStyleRanges":[],"type":"unordered-list-item","key":"4bjgg","depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[]},{"depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","data":{},"entityRanges":[],"type":"unordered-list-item","key":"11lmb","inlineStyleRanges":[]},{"entityRanges":[],"key":"94f1n","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","data":{}},{"key":"f6vsk","inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"data":{},"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","depth":0},{"depth":0,"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","inlineStyleRanges":[],"key":"8ten9","type":"unordered-list-item","entityRanges":[],"data":{}},{"key":"9j4hh","data":{},"entityRanges":[],"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","depth":0,"inlineStyleRanges":[]},{"key":"1k6jk","depth":0,"entityRanges":[],"data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment","inlineStyleRanges":[],"type":"unordered-list-item"},{"key":"649pg","depth":0,"type":"unordered-list-item","text":"The principle of least privilege must be used whenever possible","inlineStyleRanges":[],"data":{},"entityRanges":[]},{"entityRanges":[],"depth":0,"key":"6qnnq","text":"You need to recommend an email malware solution that meets the security requirements.","data":{},"type":"unstyled","inlineStyleRanges":[]},{"key":"e2jmk","text":"What should you include in the recommendation? To answer, select the appropriate options in the answer area","type":"unstyled","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[]}]},"references":{"blocks":[{"data":{},"depth":0,"entityRanges":[],"key":"a4dok","inlineStyleRanges":[],"type":"unstyled","text":"To configure \"Email messages that include attachments containing malware must be delivered without the attachment\" you'll need to create a safe attachments policy with the replace option."},{"entityRanges":[{"key":0,"length":105,"offset":0}],"inlineStyleRanges":[],"type":"unstyled","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","key":"cb23c","data":{}}],"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","targetOption":"_blank"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
