...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Privileged role administrator","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Compliance administrator"},{"isCorrectAnswer":false,"value":"Security administrator"},{"value":"Global administrator","isCorrectAnswer":false}],"id":"1qkfdkiBU","question":{"entityMap":{},"blocks":[{"entityRanges":[],"key":"571u","depth":0,"data":{},"type":"unstyled","text":"Your organization has hired a new admin named John Gruber. Your manager has asked you to give John Gruber the ability to enable and configure Azure AD Privileged Identity Management. Your organization adhere's to the principle of least privilege","inlineStyleRanges":[{"offset":142,"length":75,"style":"color-rgb(33,37,41)"},{"style":"bgcolor-rgb(255,255,255)","length":75,"offset":142},{"style":"fontsize-16","length":75,"offset":142},{"offset":142,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":75}]},{"depth":0,"data":{},"text":"What role should you assign to John Gruber","key":"543ar","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled"}]},"references":{"blocks":[{"data":{},"type":"unstyled","depth":0,"entityRanges":[],"text":"Privileged role administrators can enable, configure, and manage the Azure AD Privileged Identity Management. Global admins can also but using the global admin roles would break the principle of least privilege.","inlineStyleRanges":[],"key":"33tk7"},{"inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":0,"length":95}],"type":"unstyled","key":"f2o0a","text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU ","data":{},"depth":0},{"inlineStyleRanges":[],"type":"unstyled","key":"2sgfr","depth":0,"entityRanges":[{"length":100,"offset":0,"key":1}],"text":"https://docs.microsoft.com/en-us/azure/active-directory/privileged-identity-management/pim-configure ","data":{}},{"inlineStyleRanges":[],"data":{},"type":"unstyled","key":"du7c","entityRanges":[{"length":133,"offset":0,"key":2}],"depth":0,"text":"https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference?view=o365-worldwide#privileged-role-administrator "}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","targetOption":"_blank"}},"1":{"mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/privileged-identity-management/pim-configure","targetOption":"_blank"},"type":"LINK"},"2":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference?view=o365-worldwide#privileged-role-administrator","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
