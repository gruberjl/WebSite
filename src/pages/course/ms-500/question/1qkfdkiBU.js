...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Privileged role administrator","isCorrectAnswer":true},{"value":"Compliance administrator","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Security administrator"},{"value":"Global administrator","isCorrectAnswer":false}],"id":"1qkfdkiBU","question":{"entityMap":{},"blocks":[{"data":{},"type":"unstyled","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":75,"offset":142},{"length":75,"offset":142,"style":"bgcolor-rgb(255,255,255)"},{"length":75,"offset":142,"style":"fontsize-16"},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":142,"length":75}],"depth":0,"key":"571u","entityRanges":[],"text":"Your organization has hired a new admin named John Gruber. Your manager has asked you to give John Gruber the ability to enable and configure Azure AD Privileged Identity Management. Your organization adhere's to the principle of least privilege"},{"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"What role should you assign to John Gruber","depth":0,"key":"543ar"}]},"references":{"blocks":[{"entityRanges":[],"key":"33tk7","depth":0,"inlineStyleRanges":[],"data":{},"text":"Privileged role administrators can enable, configure, and manage the Azure AD Privileged Identity Management. Global admins can also but using the global admin roles would break the principle of least privilege.","type":"unstyled"},{"depth":0,"key":"f2o0a","data":{},"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU ","type":"unstyled","entityRanges":[{"key":0,"offset":0,"length":95}]},{"text":"https://docs.microsoft.com/en-us/azure/active-directory/privileged-identity-management/pim-configure ","depth":0,"data":{},"entityRanges":[{"length":100,"offset":0,"key":1}],"inlineStyleRanges":[],"type":"unstyled","key":"2sgfr"},{"key":"du7c","type":"unstyled","data":{},"depth":0,"entityRanges":[{"offset":0,"length":133,"key":2}],"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference?view=o365-worldwide#privileged-role-administrator "}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"},"1":{"mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/privileged-identity-management/pim-configure","targetOption":"_blank"},"type":"LINK"},"2":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference?view=o365-worldwide#privileged-role-administrator","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
