...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Privileged role administrator","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Compliance administrator"},{"value":"Security administrator","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Global administrator"}],"id":"1qkfdkiBU","question":{"blocks":[{"data":{},"depth":0,"text":"Your organization has hired a new admin named John Gruber. Your manager has asked you to give John Gruber the ability to enable and configure Azure AD Privileged Identity Management. Your organization adhere's to the principle of least privilege","type":"unstyled","entityRanges":[],"inlineStyleRanges":[{"offset":142,"length":75,"style":"color-rgb(33,37,41)"},{"length":75,"style":"bgcolor-rgb(255,255,255)","offset":142},{"offset":142,"style":"fontsize-16","length":75},{"length":75,"offset":142,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"key":"571u"},{"key":"543ar","type":"unstyled","depth":0,"data":{},"inlineStyleRanges":[],"text":"What role should you assign to John Gruber","entityRanges":[]}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"33tk7","data":{},"text":"Privileged role administrators can enable, configure, and manage the Azure AD Privileged Identity Management. Global admins can also but using the global admin roles would break the principle of least privilege."},{"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU ","data":{},"entityRanges":[{"offset":0,"key":0,"length":95}],"inlineStyleRanges":[],"type":"unstyled","key":"f2o0a","depth":0},{"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/privileged-identity-management/pim-configure ","entityRanges":[{"offset":0,"length":100,"key":1}],"key":"2sgfr","data":{},"type":"unstyled","depth":0},{"type":"unstyled","entityRanges":[{"length":133,"key":2,"offset":0}],"data":{},"key":"du7c","text":"https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference?view=o365-worldwide#privileged-role-administrator ","depth":0,"inlineStyleRanges":[]}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU"}},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/privileged-identity-management/pim-configure"},"type":"LINK","mutability":"MUTABLE"},"2":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference?view=o365-worldwide#privileged-role-administrator"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
