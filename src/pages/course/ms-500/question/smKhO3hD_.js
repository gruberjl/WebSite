...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"From the Azure Active Directory admin center, view the sign-ins."},{"value":"From the Security & Compliance admin center, download a report.","isCorrectAnswer":false},{"value":"From the Enterprise applications blade of the Azure Active Directory admin center, view the audit logs.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, view the authentication methods."}],"id":"smKhO3hD_","question":{"blocks":[{"key":"f6avo","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"You have a Microsoft 365 E5 subscription.","type":"unstyled"},{"depth":0,"key":"8qbsp","type":"unstyled","text":"Some users are required to use an authenticator app to access Microsoft SharePoint Online.","data":{},"inlineStyleRanges":[],"entityRanges":[]},{"text":"You need to view which users have used an authenticator app to access SharePoint Online. The solution must minimize costs.","type":"unstyled","data":{},"key":"fb7q","depth":0,"inlineStyleRanges":[],"entityRanges":[]},{"key":"2adq3","type":"unstyled","text":"What should you do?","entityRanges":[],"depth":0,"inlineStyleRanges":[],"data":{}}],"entityMap":{}},"references":{"blocks":[{"text":"The user sign-ins report provides information on the sign-in pattern of a user, the number of users that have signed in over a week, and the status of these sign-ins.","inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"4at2l","data":{},"entityRanges":[]},{"key":"ds5vt","entityRanges":[],"text":"Note:","inlineStyleRanges":[{"length":4,"offset":0,"style":"BOLD"}],"type":"unstyled","depth":0,"data":{}},{"text":"There are several versions of this question in the exam. The question has two possible correct answers:","key":"36ilt","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0,"data":{}},{"inlineStyleRanges":[],"text":"From the Enterprise applications blade of the Azure Active Directory admin center, view the sign-ins.","depth":0,"entityRanges":[],"key":"fcce4","type":"ordered-list-item","data":{}},{"depth":0,"inlineStyleRanges":[],"key":"54o6n","type":"ordered-list-item","entityRanges":[],"data":{},"text":"From the Azure Active Directory admin center, view the sign-ins."},{"text":"Other incorrect answer options you may see on the exam include the following:","entityRanges":[],"type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"cqqvv","data":{}},{"depth":0,"text":"From Azure Log Analytics, query the logs.","key":"8n50b","type":"ordered-list-item","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"text":"From the Security & Compliance admin center, perform an audit log search.","inlineStyleRanges":[],"key":"anl57","type":"ordered-list-item","depth":0,"data":{},"entityRanges":[]},{"key":"ehkfk","inlineStyleRanges":[{"length":9,"style":"BOLD","offset":0}],"type":"unstyled","data":{},"text":"Reference:","entityRanges":[],"depth":0},{"type":"unstyled","key":"4pavl","text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins ","depth":0,"entityRanges":[{"offset":0,"length":91,"key":0}],"data":{},"inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
