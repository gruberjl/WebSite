...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Azure Active Directory admin center, view the sign-ins.","isCorrectAnswer":true},{"value":"From the Security & Compliance admin center, download a report.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Enterprise applications blade of the Azure Active Directory admin center, view the audit logs."},{"value":"From the Azure Active Directory admin center, view the authentication methods.","isCorrectAnswer":false}],"question":{"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"key":"f6avo","type":"unstyled","text":"You have a Microsoft 365 E5 subscription.","depth":0,"data":{}},{"text":"Some users are required to use an authenticator app to access Microsoft SharePoint Online.","entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","key":"8qbsp"},{"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"key":"fb7q","text":"You need to view which users have used an authenticator app to access SharePoint Online. The solution must minimize costs.","data":{},"depth":0},{"inlineStyleRanges":[],"text":"What should you do?","key":"2adq3","entityRanges":[],"depth":0,"data":{},"type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"inlineStyleRanges":[],"text":"The user sign-ins report provides information on the sign-in pattern of a user, the number of users that have signed in over a week, and the status of these sign- ins.","depth":0,"entityRanges":[],"key":"4at2l","data":{},"type":"unstyled"},{"key":"ds5vt","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":0,"length":4,"style":"BOLD"}],"data":{},"text":"Note:","entityRanges":[]},{"type":"unstyled","inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"36ilt","depth":0,"text":"There are several versions of this question in the exam. The question has two possible correct answers:"},{"text":"From the Enterprise applications blade of the Azure Active Directory admin center, view the sign-ins.","entityRanges":[],"type":"ordered-list-item","key":"fcce4","depth":0,"inlineStyleRanges":[],"data":{}},{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"54o6n","type":"ordered-list-item","data":{},"text":"From the Azure Active Directory admin center, view the sign-ins."},{"inlineStyleRanges":[],"entityRanges":[],"key":"cqqvv","data":{},"type":"unstyled","depth":0,"text":"Other incorrect answer options you may see on the exam include the following:"},{"inlineStyleRanges":[],"type":"ordered-list-item","text":"From Azure Log Analytics, query the logs.","depth":0,"data":{},"entityRanges":[],"key":"8n50b"},{"data":{},"key":"anl57","depth":0,"inlineStyleRanges":[],"type":"ordered-list-item","entityRanges":[],"text":"From the Security & Compliance admin center, perform an audit log search."},{"text":"Reference:","key":"ehkfk","entityRanges":[],"depth":0,"inlineStyleRanges":[{"style":"BOLD","length":9,"offset":0}],"data":{},"type":"unstyled"},{"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"4pavl","depth":0,"type":"unstyled"}],"entityMap":{}},"id":"smKhO3hD_"},
      previousQuestionId: '',
      nextQuestionId: '',
