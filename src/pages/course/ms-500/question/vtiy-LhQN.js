...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"vtiy-LhQN","question":{"entityMap":{},"blocks":[{"entityRanges":[],"depth":0,"text":"You have a Microsoft 365 subscription that contains 1,000 user mailboxes.","data":{},"type":"unstyled","key":"5as2h","inlineStyleRanges":[]},{"text":"An administrator named Admin1 must be able to search for the name of a competing company in the mailbox of a user named User5.","type":"unstyled","depth":0,"key":"13r1l","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"text":"You need to ensure that Admin1 can search the mailbox of User5 successfully. The solution must prevent Admin1 from sending email messages as User5.","depth":0,"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"data":{},"key":"ao6b"},{"data":{},"entityRanges":[],"key":"7ukls","depth":0,"inlineStyleRanges":[],"text":"Solution: You modify the permissions of the mailbox of User5, and then create an eDiscovery case.","type":"unstyled"},{"depth":0,"inlineStyleRanges":[],"text":"Does this meet the goal?","key":"49fsu","entityRanges":[],"data":{},"type":"unstyled"}]},"references":{"entityMap":{},"blocks":[{"text":"https://docs.microsoft.com/en-us/exchange/policy-and-compliance/ediscovery/ediscovery?view=exchserver-2019","depth":0,"type":"unstyled","key":"2gs5l","entityRanges":[],"data":{},"inlineStyleRanges":[]}]},"answers":[{"isCorrectAnswer":false,"value":"Yes"},{"value":"No","isCorrectAnswer":true}]},
      previousQuestionId: '',
      nextQuestionId: '',
