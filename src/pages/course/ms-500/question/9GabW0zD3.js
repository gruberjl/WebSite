...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Microsoft Azure portal, create an Azure Active Directory (Azure AD) Identity Protection user risk policy.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Microsoft Azure portal, create an Azure Active Directory (Azure AD) conditional access policy."},{"value":"From the SharePoint admin center, configure the Access control settings.","isCorrectAnswer":true},{"value":"From the Microsoft Azure portal, create an Azure Active Directory (Azure AD) Identity Protection sign-in risk policy.","isCorrectAnswer":false}],"id":"9GabW0zD3","references":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"key":"ds6so","data":{},"type":"unstyled","depth":0,"text":"As a SharePoint or global admin in Microsoft 365, you can use the Access control page of the SharePoint admin center or the Set-SPOTenant -"},{"depth":0,"text":"ConditionalAccessPolicy cmdlet to block or limit access to SharePoint and OneDrive content from unmanaged devices.","data":{},"type":"unstyled","inlineStyleRanges":[],"key":"2klcd","entityRanges":[]},{"entityRanges":[],"data":{},"text":"The question has two possible correct answers:","inlineStyleRanges":[],"depth":0,"type":"unstyled","key":"6gest"},{"entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0,"key":"fe4ec","type":"ordered-list-item","text":"Run the Set-SPOTenant cmdlet and specify the -ConditionalAccessPolicy parameter."},{"type":"ordered-list-item","key":"e6o14","data":{},"depth":0,"inlineStyleRanges":[],"text":"From the SharePoint admin center, configure the Access control settings.","entityRanges":[]},{"data":{},"text":"https://docs.microsoft.com/en-us/powershell/module/sharepoint-online/set-spotenant?view=sharepoint-ps https://docs.microsoft.com/en-us/sharepoint/control-access-from-unmanaged-devices","entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"depth":0,"key":"9k50n"}]},"question":{"entityMap":{},"blocks":[{"data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription.","key":"btii1","depth":0,"type":"unstyled"},{"entityRanges":[],"type":"unstyled","depth":0,"text":"Some users access Microsoft SharePoint Online from unmanaged devices.","data":{},"key":"f0q3a","inlineStyleRanges":[]},{"key":"fi90n","data":{},"entityRanges":[],"type":"unstyled","text":"You create a conditional access policy in Azure Active Directory.","inlineStyleRanges":[],"depth":0},{"entityRanges":[],"text":"You need to prevent the users from downloading, printing, and syncing files.","key":"bl0ih","data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"data":{},"type":"unstyled","inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"705ao","text":"What should you do?"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
