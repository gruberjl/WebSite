...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Yes"},{"value":"No","isCorrectAnswer":false}],"id":"tFkMZ6eu1","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"key":"c1k37","depth":0,"entityRanges":[],"text":"You have a Microsoft 365 subscription.","data":{},"type":"unstyled"},{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"You have a user named User1. Several users have full access to the mailbox of User1.","key":"4jctk","data":{}},{"key":"3p9vn","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them.","data":{},"type":"unstyled"},{"depth":0,"key":"el88j","data":{},"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank."},{"type":"unstyled","inlineStyleRanges":[],"depth":0,"key":"9pnn8","data":{},"entityRanges":[],"text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that"},{"entityRanges":[],"key":"64b9s","depth":0,"text":"meet the goal?","type":"unstyled","inlineStyleRanges":[],"data":{}}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1"}},"1":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","targetOption":"_blank"}}},"blocks":[{"data":{},"text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell.","key":"74go5","inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0},{"key":"2rkv1","inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[],"depth":0,"text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline."},{"depth":0,"data":{},"inlineStyleRanges":[],"key":"2amie","text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\"","type":"unstyled","entityRanges":[]},{"type":"unstyled","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[{"key":0,"length":105,"offset":0}],"key":"5dbc0","text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1"},{"depth":0,"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","entityRanges":[{"length":88,"offset":0,"key":1}],"type":"unstyled","key":"f55he","data":{},"inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
