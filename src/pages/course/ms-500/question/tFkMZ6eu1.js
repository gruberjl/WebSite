...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Yes"},{"isCorrectAnswer":false,"value":"No"}],"id":"tFkMZ6eu1","question":{"entityMap":{},"blocks":[{"data":{},"type":"unstyled","text":"You have a Microsoft 365 subscription.","key":"c1k37","entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unstyled","key":"4jctk","text":"You have a user named User1. Several users have full access to the mailbox of User1.","data":{}},{"depth":0,"inlineStyleRanges":[],"data":{},"text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them.","key":"3p9vn","type":"unstyled","entityRanges":[]},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank.","key":"el88j","type":"unstyled","depth":0},{"depth":0,"type":"unstyled","key":"9pnn8","entityRanges":[],"inlineStyleRanges":[],"text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that","data":{}},{"text":"meet the goal?","key":"64b9s","inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unstyled","depth":0}]},"references":{"blocks":[{"inlineStyleRanges":[],"key":"74go5","entityRanges":[],"data":{},"depth":0,"type":"unstyled","text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell."},{"type":"unstyled","depth":0,"key":"2rkv1","entityRanges":[],"inlineStyleRanges":[],"text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline.","data":{}},{"type":"unstyled","inlineStyleRanges":[],"depth":0,"entityRanges":[],"text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\"","key":"2amie","data":{}},{"data":{},"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","depth":0,"entityRanges":[{"length":105,"key":0,"offset":0}],"key":"5dbc0","type":"unstyled"},{"data":{},"entityRanges":[{"key":1,"offset":0,"length":88}],"key":"f55he","type":"unstyled","text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","depth":0,"inlineStyleRanges":[]}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"}},"1":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","targetOption":"_blank"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
