...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Yes","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"No"}],"id":"tFkMZ6eu1","question":{"entityMap":{},"blocks":[{"entityRanges":[],"data":{},"key":"c1k37","depth":0,"text":"You have a Microsoft 365 subscription.","inlineStyleRanges":[],"type":"unstyled"},{"key":"4jctk","text":"You have a user named User1. Several users have full access to the mailbox of User1.","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled"},{"key":"3p9vn","data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them."},{"text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank.","data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"el88j","type":"unstyled"},{"type":"unstyled","text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that","key":"9pnn8","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"data":{},"depth":0,"inlineStyleRanges":[],"key":"64b9s","type":"unstyled","entityRanges":[],"text":"meet the goal?"}]},"references":{"blocks":[{"depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{},"text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell.","key":"74go5","entityRanges":[]},{"data":{},"text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline.","entityRanges":[],"key":"2rkv1","depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"depth":0,"key":"2amie","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\""},{"type":"unstyled","key":"5dbc0","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","entityRanges":[{"offset":0,"key":0,"length":105}],"data":{},"inlineStyleRanges":[]},{"key":"f55he","entityRanges":[{"key":1,"length":88,"offset":0}],"depth":0,"data":{},"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
