...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Yes"},{"isCorrectAnswer":false,"value":"No"}],"id":"tFkMZ6eu1","question":{"blocks":[{"inlineStyleRanges":[],"depth":0,"key":"c1k37","entityRanges":[],"type":"unstyled","data":{},"text":"You have a Microsoft 365 subscription."},{"entityRanges":[],"type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[],"text":"You have a user named User1. Several users have full access to the mailbox of User1.","key":"4jctk"},{"text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them.","type":"unstyled","entityRanges":[],"key":"3p9vn","data":{},"inlineStyleRanges":[],"depth":0},{"text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank.","key":"el88j","inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0,"data":{}},{"key":"9pnn8","depth":0,"text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[]},{"type":"unstyled","text":"meet the goal?","entityRanges":[],"depth":0,"key":"64b9s","inlineStyleRanges":[],"data":{}}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"data":{},"depth":0,"type":"unstyled","inlineStyleRanges":[],"key":"74go5","text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell."},{"type":"unstyled","data":{},"depth":0,"key":"2rkv1","entityRanges":[],"inlineStyleRanges":[],"text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline."},{"entityRanges":[],"depth":0,"key":"2amie","inlineStyleRanges":[],"data":{},"type":"unstyled","text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\""},{"depth":0,"inlineStyleRanges":[],"entityRanges":[{"length":105,"key":0,"offset":0}],"key":"5dbc0","data":{},"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1"},{"entityRanges":[{"offset":0,"key":1,"length":88}],"type":"unstyled","key":"f55he","data":{},"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","depth":0}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"},"type":"LINK"},"1":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
