...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Yes"},{"value":"No","isCorrectAnswer":false}],"id":"tFkMZ6eu1","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"c1k37","data":{},"text":"You have a Microsoft 365 subscription.","entityRanges":[]},{"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"You have a user named User1. Several users have full access to the mailbox of User1.","entityRanges":[],"key":"4jctk","data":{}},{"inlineStyleRanges":[],"depth":0,"data":{},"type":"unstyled","entityRanges":[],"text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them.","key":"3p9vn"},{"type":"unstyled","entityRanges":[],"depth":0,"key":"el88j","inlineStyleRanges":[],"text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank.","data":{}},{"type":"unstyled","text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that","depth":0,"key":"9pnn8","data":{},"inlineStyleRanges":[],"entityRanges":[]},{"type":"unstyled","data":{},"entityRanges":[],"depth":0,"key":"64b9s","inlineStyleRanges":[],"text":"meet the goal?"}]},"references":{"blocks":[{"inlineStyleRanges":[],"depth":0,"entityRanges":[],"data":{},"type":"unstyled","text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell.","key":"74go5"},{"type":"unstyled","text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline.","inlineStyleRanges":[],"depth":0,"entityRanges":[],"data":{},"key":"2rkv1"},{"type":"unstyled","key":"2amie","depth":0,"data":{},"text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\"","entityRanges":[],"inlineStyleRanges":[]},{"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","key":"5dbc0","depth":0,"inlineStyleRanges":[],"type":"unstyled","entityRanges":[{"offset":0,"key":0,"length":105}],"data":{}},{"depth":0,"inlineStyleRanges":[],"type":"unstyled","entityRanges":[{"key":1,"length":88,"offset":0}],"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","key":"f55he","data":{}}],"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"},"mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","targetOption":"_blank"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
