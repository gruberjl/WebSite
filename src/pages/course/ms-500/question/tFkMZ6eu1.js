...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Yes"},{"isCorrectAnswer":false,"value":"No"}],"id":"tFkMZ6eu1","question":{"blocks":[{"entityRanges":[],"data":{},"key":"c1k37","text":"You have a Microsoft 365 subscription.","depth":0,"type":"unstyled","inlineStyleRanges":[]},{"key":"4jctk","type":"unstyled","entityRanges":[],"depth":0,"text":"You have a user named User1. Several users have full access to the mailbox of User1.","data":{},"inlineStyleRanges":[]},{"entityRanges":[],"key":"3p9vn","data":{},"inlineStyleRanges":[],"depth":0,"text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them.","type":"unstyled"},{"data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"el88j","entityRanges":[],"text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank."},{"inlineStyleRanges":[],"depth":0,"data":{},"type":"unstyled","entityRanges":[],"text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that","key":"9pnn8"},{"depth":0,"key":"64b9s","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"meet the goal?"}],"entityMap":{}},"references":{"blocks":[{"data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"74go5","text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell."},{"entityRanges":[],"key":"2rkv1","text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline.","data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled"},{"entityRanges":[],"data":{},"text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\"","key":"2amie","depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"entityRanges":[{"length":105,"key":0,"offset":0}],"data":{},"depth":0,"key":"5dbc0","text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","type":"unstyled","inlineStyleRanges":[]},{"key":"f55he","entityRanges":[{"key":1,"offset":0,"length":88}],"depth":0,"inlineStyleRanges":[],"type":"unstyled","text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","data":{}}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"}},"1":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
