...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Yes","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"No"}],"id":"tFkMZ6eu1","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription.","entityRanges":[],"depth":0,"data":{},"key":"c1k37","type":"unstyled"},{"text":"You have a user named User1. Several users have full access to the mailbox of User1.","entityRanges":[],"key":"4jctk","data":{},"type":"unstyled","inlineStyleRanges":[],"depth":0},{"type":"unstyled","depth":0,"entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them.","key":"3p9vn"},{"type":"unstyled","key":"el88j","data":{},"entityRanges":[],"text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank.","depth":0,"inlineStyleRanges":[]},{"key":"9pnn8","inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unstyled","data":{},"text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that"},{"entityRanges":[],"text":"meet the goal?","data":{},"inlineStyleRanges":[],"key":"64b9s","type":"unstyled","depth":0}]},"references":{"blocks":[{"type":"unstyled","text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell.","entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"key":"74go5"},{"key":"2rkv1","text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline.","entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0,"type":"unstyled"},{"entityRanges":[],"type":"unstyled","depth":0,"key":"2amie","text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\"","inlineStyleRanges":[],"data":{}},{"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","type":"unstyled","entityRanges":[{"key":0,"offset":0,"length":105}],"depth":0,"data":{},"inlineStyleRanges":[],"key":"5dbc0"},{"data":{},"entityRanges":[{"key":1,"offset":0,"length":88}],"key":"f55he","text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","type":"unstyled","inlineStyleRanges":[],"depth":0}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"}},"1":{"data":{"url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
