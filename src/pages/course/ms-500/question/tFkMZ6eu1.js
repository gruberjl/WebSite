...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Yes"},{"value":"No","isCorrectAnswer":false}],"id":"tFkMZ6eu1","question":{"blocks":[{"entityRanges":[],"data":{},"depth":0,"key":"c1k37","text":"You have a Microsoft 365 subscription.","type":"unstyled","inlineStyleRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"text":"You have a user named User1. Several users have full access to the mailbox of User1.","depth":0,"data":{},"type":"unstyled","key":"4jctk"},{"entityRanges":[],"data":{},"key":"3p9vn","type":"unstyled","text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them.","inlineStyleRanges":[],"depth":0},{"depth":0,"type":"unstyled","text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank.","entityRanges":[],"inlineStyleRanges":[],"data":{},"key":"el88j"},{"data":{},"entityRanges":[],"key":"9pnn8","text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that","type":"unstyled","inlineStyleRanges":[],"depth":0},{"depth":0,"entityRanges":[],"text":"meet the goal?","inlineStyleRanges":[],"key":"64b9s","data":{},"type":"unstyled"}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"entityRanges":[],"data":{},"key":"74go5","depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell."},{"data":{},"inlineStyleRanges":[],"key":"2rkv1","type":"unstyled","text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline.","depth":0,"entityRanges":[]},{"type":"unstyled","entityRanges":[],"text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\"","data":{},"key":"2amie","inlineStyleRanges":[],"depth":0},{"entityRanges":[{"length":105,"key":0,"offset":0}],"depth":0,"data":{},"key":"5dbc0","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","type":"unstyled"},{"depth":0,"inlineStyleRanges":[],"entityRanges":[{"length":88,"offset":0,"key":1}],"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","type":"unstyled","key":"f55he","data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
