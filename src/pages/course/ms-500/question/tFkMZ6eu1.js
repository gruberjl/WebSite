...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Yes","isCorrectAnswer":true},{"value":"No","isCorrectAnswer":false}],"id":"tFkMZ6eu1","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"key":"c1k37","depth":0,"data":{},"type":"unstyled","entityRanges":[],"text":"You have a Microsoft 365 subscription."},{"data":{},"key":"4jctk","depth":0,"text":"You have a user named User1. Several users have full access to the mailbox of User1.","type":"unstyled","inlineStyleRanges":[],"entityRanges":[]},{"depth":0,"key":"3p9vn","inlineStyleRanges":[],"data":{},"type":"unstyled","entityRanges":[],"text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them."},{"type":"unstyled","entityRanges":[],"depth":0,"key":"el88j","data":{},"inlineStyleRanges":[],"text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank."},{"key":"9pnn8","data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that","type":"unstyled","depth":0},{"data":{},"type":"unstyled","depth":0,"text":"meet the goal?","key":"64b9s","inlineStyleRanges":[],"entityRanges":[]}]},"references":{"blocks":[{"key":"74go5","text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell.","depth":0,"entityRanges":[],"data":{},"type":"unstyled","inlineStyleRanges":[]},{"data":{},"entityRanges":[],"key":"2rkv1","type":"unstyled","depth":0,"text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline.","inlineStyleRanges":[]},{"key":"2amie","text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\"","inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0,"data":{}},{"entityRanges":[{"key":0,"length":105,"offset":0}],"inlineStyleRanges":[],"key":"5dbc0","text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","type":"unstyled","data":{},"depth":0},{"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","key":"f55he","type":"unstyled","entityRanges":[{"offset":0,"key":1,"length":88}],"depth":0,"data":{},"inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1"},"mutability":"MUTABLE","type":"LINK"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
