...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Yes","isCorrectAnswer":true},{"value":"No","isCorrectAnswer":false}],"id":"tFkMZ6eu1","question":{"entityMap":{},"blocks":[{"type":"unstyled","entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"key":"c1k37","text":"You have a Microsoft 365 subscription."},{"entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0,"type":"unstyled","text":"You have a user named User1. Several users have full access to the mailbox of User1.","key":"4jctk"},{"data":{},"key":"3p9vn","entityRanges":[],"depth":0,"type":"unstyled","text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them.","inlineStyleRanges":[]},{"inlineStyleRanges":[],"key":"el88j","type":"unstyled","depth":0,"data":{},"text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank.","entityRanges":[]},{"key":"9pnn8","inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0,"type":"unstyled","text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that"},{"text":"meet the goal?","key":"64b9s","depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"data":{}}]},"references":{"blocks":[{"depth":0,"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell.","data":{},"key":"74go5"},{"data":{},"key":"2rkv1","depth":0,"text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline.","type":"unstyled","entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[],"key":"2amie","text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\"","depth":0,"data":{},"type":"unstyled","inlineStyleRanges":[]},{"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","entityRanges":[{"length":105,"offset":0,"key":0}],"inlineStyleRanges":[],"type":"unstyled","data":{},"key":"5dbc0"},{"inlineStyleRanges":[],"entityRanges":[{"key":1,"length":88,"offset":0}],"key":"f55he","depth":0,"data":{},"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","type":"unstyled"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
