...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Yes","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"No"}],"id":"tFkMZ6eu1","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription.","key":"c1k37","entityRanges":[],"type":"unstyled","depth":0,"data":{}},{"key":"4jctk","inlineStyleRanges":[],"text":"You have a user named User1. Several users have full access to the mailbox of User1.","data":{},"type":"unstyled","entityRanges":[],"depth":0},{"data":{},"depth":0,"key":"3p9vn","text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them.","inlineStyleRanges":[],"type":"unstyled","entityRanges":[]},{"data":{},"entityRanges":[],"key":"el88j","type":"unstyled","inlineStyleRanges":[],"text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank.","depth":0},{"data":{},"depth":0,"type":"unstyled","entityRanges":[],"key":"9pnn8","text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that","inlineStyleRanges":[]},{"data":{},"text":"meet the goal?","depth":0,"inlineStyleRanges":[],"key":"64b9s","type":"unstyled","entityRanges":[]}]},"references":{"blocks":[{"text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell.","type":"unstyled","entityRanges":[],"depth":0,"data":{},"key":"74go5","inlineStyleRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","key":"2rkv1","depth":0,"data":{},"text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline."},{"text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\"","data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","key":"2amie"},{"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","entityRanges":[{"length":105,"offset":0,"key":0}],"key":"5dbc0","depth":0},{"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","key":"f55he","type":"unstyled","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":1,"length":88}]}],"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1"},"mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
