...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Go to the Microsoft Azure admin center and create an Azure AD group. Go to the Microsoft Defender admin center and create a role. Then configure the permissions for DeviceGroupA."},{"isCorrectAnswer":false,"value":"Go to the Microsoft Defender Security center and create a role. Go to the Microsoft Defender Security center and configure the permissions for DeviceGroupA. Go to the Microsoft Azure AD admin center and create an Azure AD group."},{"isCorrectAnswer":false,"value":"Go to the Microsoft Defender Security center and create a role. Go to the Microsoft Azure AD admin center and create an Azure AD group. Go to the Microsoft Defender admin center and configure the permissions for DeviceGroupA."}],"id":"InQ53ABi0","question":{"blocks":[{"key":"5b1fh","type":"unstyled","depth":0,"text":"Your organization has a Microsoft 365 tenant with all computers running Windows 10 and are onboarded to Microsoft Defender for Endpoint.","entityRanges":[],"inlineStyleRanges":[],"data":{}},{"text":"Your organization has a device group named DeviceGroupA.","type":"unstyled","key":"72tpa","depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[]},{"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","offset":92,"length":12},{"style":"bgcolor-rgb(255,255,255)","offset":92,"length":12},{"offset":92,"length":12,"style":"fontsize-16"},{"offset":92,"length":12,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"depth":0,"key":"8lp0l","type":"unstyled","entityRanges":[],"data":{},"text":"Your manager has asked you to enable delegation for the security settings of the devices in DeviceGroupA."},{"entityRanges":[],"key":"4v18a","data":{},"type":"unstyled","inlineStyleRanges":[],"text":"What do you need to do?","depth":0}],"entityMap":{}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T"},"type":"LINK"}},"blocks":[{"text":"To delegate permissions to a set of devices in Defender for Endpoint you need to do 3 things:","depth":0,"type":"unstyled","key":"18lg0","inlineStyleRanges":[],"data":{},"entityRanges":[]},{"key":"fkce2","text":"Create a device group to specify the devices that will be delegated.","type":"unordered-list-item","inlineStyleRanges":[],"data":{},"entityRanges":[],"depth":0},{"type":"unordered-list-item","key":"62cah","entityRanges":[],"text":"Create a user group to specify who can manage the devices.","inlineStyleRanges":[],"depth":0,"data":{}},{"entityRanges":[],"key":"31ir5","depth":0,"text":"Create a role to specify what the users can do.","type":"unordered-list-item","data":{},"inlineStyleRanges":[]},{"entityRanges":[{"offset":0,"key":0,"length":129}],"type":"unstyled","key":"7sh1n","inlineStyleRanges":[],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
