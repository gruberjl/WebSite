...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Go to the Microsoft Azure admin center and create an Azure AD group. Go to the Microsoft Defender admin center and create a role. Then configure the permissions for DeviceGroupA."},{"isCorrectAnswer":false,"value":"Go to the Microsoft Defender Security center and create a role. Go to the Microsoft Defender Security center and configure the permissions for DeviceGroupA. Go to the Microsoft Azure AD admin center and create an Azure AD group."},{"isCorrectAnswer":false,"value":"Go to the Microsoft Defender Security center and create a role. Go to the Microsoft Azure AD admin center and create an Azure AD group. Go to the Microsoft Defender admin center and configure the permissions for DeviceGroupA."}],"id":"InQ53ABi0","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"data":{},"key":"5b1fh","text":"Your organization has a Microsoft 365 tenant with all computers running Windows 10 and are onboarded to Microsoft Defender for Endpoint.","depth":0,"type":"unstyled","entityRanges":[]},{"type":"unstyled","text":"Your organization has a device group named DeviceGroupA.","entityRanges":[],"key":"72tpa","data":{},"inlineStyleRanges":[],"depth":0},{"key":"8lp0l","text":"Your manager has asked you to enable delegation for the security settings of the devices in DeviceGroupA.","type":"unstyled","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[{"length":12,"offset":92,"style":"color-rgb(33,37,41)"},{"length":12,"style":"bgcolor-rgb(255,255,255)","offset":92},{"offset":92,"length":12,"style":"fontsize-16"},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":12,"offset":92}]},{"key":"4v18a","entityRanges":[],"inlineStyleRanges":[],"text":"What do you need to do?","type":"unstyled","data":{},"depth":0}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T"}}},"blocks":[{"text":"To delegate permissions to a set of devices in Defender for Endpoint you need to do 3 things:","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[],"type":"unstyled","key":"18lg0"},{"entityRanges":[],"data":{},"key":"fkce2","inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","text":"Create a device group to specify the devices that will be delegated."},{"depth":0,"text":"Create a user group to specify who can manage the devices.","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"62cah","type":"unordered-list-item"},{"data":{},"type":"unordered-list-item","depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"31ir5","text":"Create a role to specify what the users can do."},{"key":"7sh1n","entityRanges":[{"length":129,"offset":0,"key":0}],"inlineStyleRanges":[],"data":{},"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
