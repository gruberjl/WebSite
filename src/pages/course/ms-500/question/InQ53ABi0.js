...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Go to the Microsoft Azure admin center and create an Azure AD group. Go to the Microsoft Defender admin center and create a role. Then configure the permissions for DeviceGroupA."},{"isCorrectAnswer":false,"value":"Go to the Microsoft Defender Security center and create a role. Go to the Microsoft Defender Security center and configure the permissions for DeviceGroupA. Go to the Microsoft Azure AD admin center and create an Azure AD group."},{"isCorrectAnswer":false,"value":"Go to the Microsoft Defender Security center and create a role. Go to the Microsoft Azure AD admin center and create an Azure AD group. Go to the Microsoft Defender admin center and configure the permissions for DeviceGroupA."}],"id":"InQ53ABi0","question":{"entityMap":{},"blocks":[{"key":"5b1fh","type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"text":"Your organization has a Microsoft 365 tenant with all computers running Windows 10 and are onboarded to Microsoft Defender for Endpoint."},{"text":"Your organization has a device group named DeviceGroupA.","inlineStyleRanges":[],"entityRanges":[],"depth":0,"key":"72tpa","data":{},"type":"unstyled"},{"key":"8lp0l","data":{},"entityRanges":[],"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":12,"offset":92},{"style":"bgcolor-rgb(255,255,255)","length":12,"offset":92},{"length":12,"style":"fontsize-16","offset":92},{"length":12,"offset":92,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"depth":0,"text":"Your manager has asked you to enable delegation for the security settings of the devices in DeviceGroupA.","type":"unstyled"},{"type":"unstyled","key":"4v18a","text":"What do you need to do?","entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[]}]},"references":{"blocks":[{"depth":0,"inlineStyleRanges":[],"data":{},"entityRanges":[],"text":"To delegate permissions to a set of devices in Defender for Endpoint you need to do 3 things:","type":"unstyled","key":"18lg0"},{"text":"Create a device group to specify the devices that will be delegated.","type":"unordered-list-item","inlineStyleRanges":[],"depth":0,"entityRanges":[],"data":{},"key":"fkce2"},{"entityRanges":[],"data":{},"depth":0,"text":"Create a user group to specify who can manage the devices.","type":"unordered-list-item","key":"62cah","inlineStyleRanges":[]},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"31ir5","depth":0,"text":"Create a role to specify what the users can do.","type":"unordered-list-item"},{"type":"unstyled","key":"7sh1n","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","inlineStyleRanges":[],"entityRanges":[{"length":129,"key":0,"offset":0}],"depth":0}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
