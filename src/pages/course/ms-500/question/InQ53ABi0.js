...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Go to the Microsoft Azure admin center and create an Azure AD group. Go to the Microsoft Defender admin center and create a role. Then configure the permissions for DeviceGroupA."},{"isCorrectAnswer":false,"value":"Go to the Microsoft Defender Security center and create a role. Go to the Microsoft Defender Security center and configure the permissions for DeviceGroupA. Go to the Microsoft Azure AD admin center and create an Azure AD group."},{"value":"Go to the Microsoft Defender Security center and create a role. Go to the Microsoft Azure AD admin center and create an Azure AD group. Go to the Microsoft Defender admin center and configure the permissions for DeviceGroupA.","isCorrectAnswer":false}],"id":"InQ53ABi0","question":{"blocks":[{"type":"unstyled","inlineStyleRanges":[],"key":"5b1fh","depth":0,"text":"Your organization has a Microsoft 365 tenant with all computers running Windows 10 and are onboarded to Microsoft Defender for Endpoint.","data":{},"entityRanges":[]},{"key":"72tpa","depth":0,"text":"Your organization has a device group named DeviceGroupA.","data":{},"type":"unstyled","inlineStyleRanges":[],"entityRanges":[]},{"type":"unstyled","entityRanges":[],"depth":0,"data":{},"key":"8lp0l","inlineStyleRanges":[{"offset":92,"length":12,"style":"color-rgb(33,37,41)"},{"length":12,"offset":92,"style":"bgcolor-rgb(255,255,255)"},{"offset":92,"style":"fontsize-16","length":12},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":92,"length":12}],"text":"Your manager has asked you to enable delegation for the security settings of the devices in DeviceGroupA."},{"entityRanges":[],"text":"What do you need to do?","type":"unstyled","key":"4v18a","depth":0,"data":{},"inlineStyleRanges":[]}],"entityMap":{}},"references":{"blocks":[{"data":{},"inlineStyleRanges":[],"depth":0,"text":"To delegate permissions to a set of devices in Defender for Endpoint you need to do 3 things:","key":"18lg0","entityRanges":[],"type":"unstyled"},{"data":{},"key":"fkce2","entityRanges":[],"type":"unordered-list-item","text":"Create a device group to specify the devices that will be delegated.","depth":0,"inlineStyleRanges":[]},{"depth":0,"type":"unordered-list-item","key":"62cah","entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"Create a user group to specify who can manage the devices."},{"type":"unordered-list-item","entityRanges":[],"depth":0,"text":"Create a role to specify what the users can do.","key":"31ir5","data":{},"inlineStyleRanges":[]},{"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","entityRanges":[{"key":0,"length":129,"offset":0}],"key":"7sh1n","depth":0,"data":{},"type":"unstyled"}],"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
