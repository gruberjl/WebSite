...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Compliance Manager Assessor"},{"isCorrectAnswer":true,"value":"Global Administrator"},{"value":"Portal Admin","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Compliance Manager Administrator"}],"id":"4bRuCtuTK","question":{"entityMap":{},"blocks":[{"depth":0,"entityRanges":[],"type":"unstyled","text":"You have a Microsoft 365 subscription that contains a user named User1.","inlineStyleRanges":[],"key":"55r32","data":{}},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"cdcn4","depth":0,"type":"unstyled","text":"You plan to use Compliance Manager."},{"depth":0,"key":"7dnsm","data":{},"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"You need to ensure that User1 can assign Compliance Manager roles to users. The solution must use the principle of least privilege."},{"data":{},"text":"Which role should you assign to User1?","inlineStyleRanges":[],"depth":0,"type":"unstyled","key":"6ercr","entityRanges":[]}]},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/microsoft-365/compliance/working-with-compliance-manager?view=o365-worldwide","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"entityRanges":[],"text":"Compliance Manager Assessor can Create assessments, implement improvement actions, and update test status for improvement actions but they can't assign roles.","data":{},"type":"unstyled","key":"52v6e","inlineStyleRanges":[],"depth":0},{"text":"Portal admin isn't a role in Microsoft 365 or the compliance admin center.","key":"7d54g","data":{},"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"depth":0},{"data":{},"depth":0,"text":"Compliance Manager administrators can manage template creation and modification but cannot assign roles.","key":"co4ct","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled"},{"inlineStyleRanges":[],"depth":0,"text":"Global admin is the only role listed that can assign compliance manager roles.","key":"7iklp","data":{},"type":"unstyled","entityRanges":[]},{"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU ","inlineStyleRanges":[],"key":"5d67o","data":{},"depth":0,"entityRanges":[{"length":95,"key":0,"offset":0}]},{"entityRanges":[{"offset":0,"key":1,"length":109}],"text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/working-with-compliance-manager?view=o365-worldwide ","type":"unstyled","depth":0,"data":{},"key":"dq98i","inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
