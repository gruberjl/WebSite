...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User 1 can configure a user risk policy","isCorrectAnswer":true},{"value":"User 2 can configure a user risk policy","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User 3 can configure a user risk policy"},{"value":"User 4 can configure a user risk policy","isCorrectAnswer":false},{"value":"User 1 can view the risky users report","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"User 2 can view the risky users report"},{"isCorrectAnswer":true,"value":"User 3 can view the risky users report"},{"value":"User 4 can view the risky users report","isCorrectAnswer":true}],"id":"4Fm6TwtSS","question":{"blocks":[{"type":"unstyled","text":"You have a Microsoft 365 E5 subscription that contains the users shown in the following table. ","entityRanges":[],"key":"3v2ja","depth":0,"data":{},"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":94,"offset":0},{"style":"bgcolor-rgb(255,255,255)","length":94,"offset":0},{"style":"fontsize-16","length":94,"offset":0},{"offset":0,"length":94,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}]},{"key":"d45re","data":{},"type":"atomic","depth":0,"text":" ","entityRanges":[{"length":1,"key":0,"offset":0}],"inlineStyleRanges":[]},{"data":{},"type":"unstyled","depth":0,"entityRanges":[],"key":"drcns","inlineStyleRanges":[],"text":"You plan to implement Azure Active Directory (Azure AD) Identity Protection."},{"entityRanges":[],"depth":0,"text":"You need to identify which users can perform the following actions:","inlineStyleRanges":[],"data":{},"type":"unstyled","key":"688jb"},{"depth":0,"text":"Configure a user risk policy.","data":{},"type":"unordered-list-item","entityRanges":[],"key":"8fh21","inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"View the risky users' report.","type":"unordered-list-item","data":{},"key":"cvls6"},{"data":{},"depth":0,"inlineStyleRanges":[],"key":"4caqj","text":"Which users should you identify? To answer, select the appropriate options in the answer area.","type":"unstyled","entityRanges":[]}],"entityMap":{"0":{"data":{"alignment":"left","src":"https://i.ibb.co/WPhc9R4/user-role-chart.png","alt":"User role chart","width":"auto","height":"auto"},"type":"IMAGE","mutability":"MUTABLE"}}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","targetOption":"_blank"},"type":"LINK"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"data":{},"inlineStyleRanges":[],"key":"4bds8","text":"User 1 is a global admin so they can perform any action.","type":"unstyled","entityRanges":[],"depth":0},{"depth":0,"data":{},"key":"12r6a","text":"Compliance administrators don't have access to the user risk / risky users area so User 2 can't perform anything.","inlineStyleRanges":[],"type":"unstyled","entityRanges":[]},{"inlineStyleRanges":[],"text":"Security administrators can manage both user risk and risky users so User 3 can perform both actions.","depth":0,"key":"5t2vd","entityRanges":[],"type":"unstyled","data":{}},{"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"Security Readers can view the users' reports but can't make changes so User 4 can view but not configure.","data":{},"key":"4qh94","depth":0},{"inlineStyleRanges":[],"key":"amh74","type":"unstyled","entityRanges":[{"offset":0,"length":95,"key":0}],"data":{},"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU"},{"key":"ac94i","data":{},"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/overview-identity-protection","depth":0,"entityRanges":[{"key":1,"offset":0,"length":104}],"inlineStyleRanges":[],"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
