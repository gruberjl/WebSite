...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Open Microsoft Azure Active Directory Connect (Azure AD Connect) and configure attribute filtering."},{"value":"Purchase a Enterprise Mobility + Security E5 license for every user.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Open Microsoft Azure Active Directory Connect (Azure AD Connect) and select Directory extension attribute sync."},{"value":"Migrate all of the mailboxes hosted on-premises Microsoft 365","isCorrectAnswer":true}],"id":"19TOYt4la","question":{"entityMap":{},"blocks":[{"entityRanges":[],"data":{},"key":"3bsgp","text":"All user users have a Microsoft 365 E5 license. You have a hybrid Microsoft Exchange Server. Some of your user's mailboxes are located in Microsoft 365 while others are located in the on-premises Exchange server","inlineStyleRanges":[],"type":"unstyled","depth":0},{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"69ltf","type":"unstyled","text":"You are tasked with setting up and configuring Microsoft Defender for Office 365 anti-phishing policy.","data":{}},{"data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","key":"1o6pn","text":"Management has asked you to enable mailbox intelligence for all users.","entityRanges":[]},{"key":"d4hu7","depth":0,"inlineStyleRanges":[],"text":"What do you need to do to verify all mailboxes have mailbox intelligence enabled and working?","entityRanges":[],"data":{},"type":"unstyled"}]},"references":{"blocks":[{"depth":0,"entityRanges":[],"data":{},"type":"unstyled","text":"Mailbox intelligence will scan a user's mailbox to see if the user has sent or received emails from the sender of an email before. For mailbox intelligence to scan a mailbox then mailbox must be located in Microsoft 365's Exchange Online","key":"fvnj6","inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[{"length":94,"offset":0,"key":0}],"key":"7qat6","data":{},"depth":0,"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Protecting-email-against-phishing-attacks-GCOOUsSBT "}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protecting-email-against-phishing-attacks-GCOOUsSBT"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
