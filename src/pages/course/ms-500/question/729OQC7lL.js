...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Security & Compliance admin center, create a label policy","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From Exchange Online PowerShell, run Start-RetentionAutoTagLearning"},{"isCorrectAnswer":true,"value":"From Exchange Online PowerShell, run Start-ManagedFolderAssistant"},{"isCorrectAnswer":false,"value":"From the Security & Compliance admin center, create a data loss prevention (DLP) policy"}],"id":"729OQC7lL","question":{"blocks":[{"key":"63nes","depth":0,"text":"You have a Microsoft 365 subscription.","type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"entityRanges":[],"key":"670mu","type":"unstyled","depth":0,"text":"Yesterday, you created retention labels and published the labels to Microsoft Exchange Online mailboxes.","data":{},"inlineStyleRanges":[]},{"entityRanges":[],"type":"unstyled","key":"3jhv4","depth":0,"data":{},"text":"You need to ensure that the labels will be available for manual assignment as soon as possible.","inlineStyleRanges":[]},{"key":"4qe14","data":{},"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"What should you do?","entityRanges":[]}],"entityMap":{}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f"},"type":"LINK"},"1":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-a-custom-blocked-urls-list-wtih-atp","targetOption":"_blank"},"mutability":"MUTABLE"}},"blocks":[{"depth":0,"type":"unstyled","text":"Run the following PowerShell Command: \"Get-Mailbox -ResultSize unlimited | ?{$_.Name -notlike \"DiscoverySearchMailbox*\"} | %{ Start-ManagedFolderAssistant $_.UserPrincipalName }\"","key":"cug0","entityRanges":[],"inlineStyleRanges":[],"data":{}},{"data":{},"depth":0,"key":"4ce7u","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"Note: If you only need to publish the labels to one user immediately you can use \"Start-ManagedFolderAssistant UPN\" and replace UPN with the user's sign-in name"},{"entityRanges":[{"length":114,"key":0,"offset":0}],"depth":0,"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","type":"unstyled","key":"63al3","inlineStyleRanges":[]},{"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/start-managedfolderassistant?view=exchange-ps","depth":0,"entityRanges":[{"length":105,"offset":0,"key":1}],"key":"9t9k7","data":{},"inlineStyleRanges":[],"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
