...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Security & Compliance admin center, create a label policy","isCorrectAnswer":false},{"value":"From Exchange Online PowerShell, run Start-RetentionAutoTagLearning","isCorrectAnswer":false},{"value":"From Exchange Online PowerShell, run Start-ManagedFolderAssistant","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Security & Compliance admin center, create a data loss prevention (DLP) policy"}],"id":"729OQC7lL","question":{"blocks":[{"type":"unstyled","inlineStyleRanges":[],"key":"63nes","text":"You have a Microsoft 365 subscription.","entityRanges":[],"data":{},"depth":0},{"key":"670mu","inlineStyleRanges":[],"type":"unstyled","depth":0,"data":{},"entityRanges":[],"text":"Yesterday, you created retention labels and published the labels to Microsoft Exchange Online mailboxes."},{"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","key":"3jhv4","depth":0,"text":"You need to ensure that the labels will be available for manual assignment as soon as possible.","data":{}},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"What should you do?","type":"unstyled","depth":0,"key":"4qe14"}],"entityMap":{}},"references":{"blocks":[{"type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"cug0","text":"Run the following PowerShell Command: \"Get-Mailbox -ResultSize unlimited | ?{$_.Name -notlike \"DiscoverySearchMailbox*\"} | %{ Start-ManagedFolderAssistant $_.UserPrincipalName }\"","depth":0},{"text":"Note: If you only need to publish the labels to one user immediately you can use \"Start-ManagedFolderAssistant UPN\" and replace UPN with the user's sign-in name","key":"4ce7u","data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"depth":0},{"inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"63al3","data":{},"entityRanges":[{"length":114,"offset":0,"key":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f"},{"data":{},"key":"9t9k7","entityRanges":[{"offset":0,"length":105,"key":1}],"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/start-managedfolderassistant?view=exchange-ps"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-a-custom-blocked-urls-list-wtih-atp","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
