...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"From the Security & Compliance admin center, create a label policy"},{"isCorrectAnswer":false,"value":"From Exchange Online PowerShell, run Start-RetentionAutoTagLearning"},{"isCorrectAnswer":true,"value":"From Exchange Online PowerShell, run Start-ManagedFolderAssistant"},{"value":"From the Security & Compliance admin center, create a data loss prevention (DLP) policy","isCorrectAnswer":false}],"id":"729OQC7lL","question":{"entityMap":{},"blocks":[{"entityRanges":[],"data":{},"key":"63nes","depth":0,"inlineStyleRanges":[],"type":"unstyled","text":"You have a Microsoft 365 subscription."},{"data":{},"inlineStyleRanges":[],"text":"Yesterday, you created retention labels and published the labels to Microsoft Exchange Online mailboxes.","entityRanges":[],"type":"unstyled","key":"670mu","depth":0},{"text":"You need to ensure that the labels will be available for manual assignment as soon as possible.","data":{},"type":"unstyled","entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"3jhv4"},{"key":"4qe14","type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"What should you do?","data":{},"entityRanges":[]}]},"references":{"blocks":[{"depth":0,"entityRanges":[],"type":"unstyled","data":{},"inlineStyleRanges":[],"key":"cug0","text":"Run the following PowerShell Command: \"Get-Mailbox -ResultSize unlimited | ?{$_.Name -notlike \"DiscoverySearchMailbox*\"} | %{ Start-ManagedFolderAssistant $_.UserPrincipalName }\""},{"key":"4ce7u","depth":0,"data":{},"text":"Note: If you only need to publish the labels to one user immediately you can use \"Start-ManagedFolderAssistant UPN\" and replace UPN with the user's sign-in name","type":"unstyled","entityRanges":[],"inlineStyleRanges":[]},{"inlineStyleRanges":[],"data":{},"key":"63al3","depth":0,"entityRanges":[{"offset":0,"length":114,"key":0}],"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f"},{"entityRanges":[{"key":1,"offset":0,"length":105}],"depth":0,"data":{},"type":"unstyled","key":"9t9k7","inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/start-managedfolderassistant?view=exchange-ps"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-a-custom-blocked-urls-list-wtih-atp","targetOption":"_blank"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
