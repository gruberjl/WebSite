...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Security & Compliance admin center, create a label policy","isCorrectAnswer":false},{"value":"From Exchange Online PowerShell, run Start-RetentionAutoTagLearning","isCorrectAnswer":false},{"value":"From Exchange Online PowerShell, run Start-ManagedFolderAssistant","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Security & Compliance admin center, create a data loss prevention (DLP) policy"}],"id":"729OQC7lL","question":{"entityMap":{},"blocks":[{"key":"63nes","type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"You have a Microsoft 365 subscription."},{"text":"Yesterday, you created retention labels and published the labels to Microsoft Exchange Online mailboxes.","depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"key":"670mu"},{"inlineStyleRanges":[],"key":"3jhv4","text":"You need to ensure that the labels will be available for manual assignment as soon as possible.","entityRanges":[],"type":"unstyled","depth":0,"data":{}},{"text":"What should you do?","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"4qe14","data":{}}]},"references":{"blocks":[{"data":{},"text":"Run the following PowerShell Command: \"Get-Mailbox -ResultSize unlimited | ?{$_.Name -notlike \"DiscoverySearchMailbox*\"} | %{ Start-ManagedFolderAssistant $_.UserPrincipalName }\"","entityRanges":[],"inlineStyleRanges":[],"depth":0,"type":"unstyled","key":"cug0"},{"entityRanges":[],"key":"4ce7u","type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{},"text":"Note: If you only need to publish the labels to one user immediately you can use \"Start-ManagedFolderAssistant UPN\" and replace UPN with the user's sign-in name"},{"depth":0,"type":"unstyled","entityRanges":[{"key":0,"length":114,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","inlineStyleRanges":[],"key":"63al3","data":{}},{"data":{},"key":"9t9k7","text":"https://docs.microsoft.com/en-us/powershell/module/exchange/start-managedfolderassistant?view=exchange-ps","type":"unstyled","entityRanges":[{"key":1,"length":105,"offset":0}],"depth":0,"inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f"},"type":"LINK"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-a-custom-blocked-urls-list-wtih-atp"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
