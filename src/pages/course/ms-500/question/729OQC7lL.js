...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"From the Security & Compliance admin center, create a label policy"},{"isCorrectAnswer":false,"value":"From Exchange Online PowerShell, run Start-RetentionAutoTagLearning"},{"isCorrectAnswer":true,"value":"From Exchange Online PowerShell, run Start-ManagedFolderAssistant"},{"isCorrectAnswer":false,"value":"From the Security & Compliance admin center, create a data loss prevention (DLP) policy"}],"id":"729OQC7lL","question":{"blocks":[{"data":{},"text":"You have a Microsoft 365 subscription.","depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","key":"63nes"},{"entityRanges":[],"key":"670mu","depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{},"text":"Yesterday, you created retention labels and published the labels to Microsoft Exchange Online mailboxes."},{"key":"3jhv4","inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unstyled","text":"You need to ensure that the labels will be available for manual assignment as soon as possible.","depth":0},{"depth":0,"text":"What should you do?","type":"unstyled","inlineStyleRanges":[],"data":{},"key":"4qe14","entityRanges":[]}],"entityMap":{}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f"}},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-a-custom-blocked-urls-list-wtih-atp"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"depth":0,"inlineStyleRanges":[],"text":"Run the following PowerShell Command: \"Get-Mailbox -ResultSize unlimited | ?{$_.Name -notlike \"DiscoverySearchMailbox*\"} | %{ Start-ManagedFolderAssistant $_.UserPrincipalName }\"","key":"cug0","type":"unstyled","entityRanges":[],"data":{}},{"depth":0,"text":"Note: If you only need to publish the labels to one user immediately you can use \"Start-ManagedFolderAssistant UPN\" and replace UPN with the user's sign-in name","data":{},"inlineStyleRanges":[],"key":"4ce7u","entityRanges":[],"type":"unstyled"},{"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","entityRanges":[{"offset":0,"key":0,"length":114}],"data":{},"key":"63al3","depth":0,"type":"unstyled","inlineStyleRanges":[]},{"entityRanges":[{"key":1,"offset":0,"length":105}],"depth":0,"data":{},"inlineStyleRanges":[],"key":"9t9k7","text":"https://docs.microsoft.com/en-us/powershell/module/exchange/start-managedfolderassistant?view=exchange-ps","type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
