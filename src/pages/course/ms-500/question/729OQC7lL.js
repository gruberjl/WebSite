...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Security & Compliance admin center, create a label policy","isCorrectAnswer":false},{"value":"From Exchange Online PowerShell, run Start-RetentionAutoTagLearning","isCorrectAnswer":false},{"value":"From Exchange Online PowerShell, run Start-ManagedFolderAssistant","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Security & Compliance admin center, create a data loss prevention (DLP) policy"}],"id":"729OQC7lL","question":{"blocks":[{"inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"63nes","data":{},"type":"unstyled","text":"You have a Microsoft 365 subscription."},{"data":{},"depth":0,"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"text":"Yesterday, you created retention labels and published the labels to Microsoft Exchange Online mailboxes.","key":"670mu"},{"entityRanges":[],"data":{},"type":"unstyled","depth":0,"text":"You need to ensure that the labels will be available for manual assignment as soon as possible.","key":"3jhv4","inlineStyleRanges":[]},{"depth":0,"key":"4qe14","text":"What should you do?","data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f"},"mutability":"MUTABLE","type":"LINK"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-a-custom-blocked-urls-list-wtih-atp","targetOption":"_blank"}}},"blocks":[{"type":"unstyled","key":"cug0","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Run the following PowerShell Command: \"Get-Mailbox -ResultSize unlimited | ?{$_.Name -notlike \"DiscoverySearchMailbox*\"} | %{ Start-ManagedFolderAssistant $_.UserPrincipalName }\""},{"type":"unstyled","data":{},"text":"Note: If you only need to publish the labels to one user immediately you can use \"Start-ManagedFolderAssistant UPN\" and replace UPN with the user's sign-in name","key":"4ce7u","depth":0,"entityRanges":[],"inlineStyleRanges":[]},{"inlineStyleRanges":[],"data":{},"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","key":"63al3","depth":0,"entityRanges":[{"key":0,"offset":0,"length":114}]},{"entityRanges":[{"key":1,"offset":0,"length":105}],"depth":0,"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/start-managedfolderassistant?view=exchange-ps","inlineStyleRanges":[],"key":"9t9k7","data":{},"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
