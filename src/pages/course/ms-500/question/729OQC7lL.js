...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Security & Compliance admin center, create a label policy","isCorrectAnswer":false},{"value":"From Exchange Online PowerShell, run Start-RetentionAutoTagLearning","isCorrectAnswer":false},{"value":"From Exchange Online PowerShell, run Start-ManagedFolderAssistant","isCorrectAnswer":true},{"value":"From the Security & Compliance admin center, create a data loss prevention (DLP) policy","isCorrectAnswer":false}],"id":"729OQC7lL","question":{"entityMap":{},"blocks":[{"key":"63nes","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"depth":0,"data":{},"text":"You have a Microsoft 365 subscription."},{"data":{},"type":"unstyled","text":"Yesterday, you created retention labels and published the labels to Microsoft Exchange Online mailboxes.","entityRanges":[],"key":"670mu","inlineStyleRanges":[],"depth":0},{"type":"unstyled","inlineStyleRanges":[],"key":"3jhv4","text":"You need to ensure that the labels will be available for manual assignment as soon as possible.","data":{},"entityRanges":[],"depth":0},{"key":"4qe14","text":"What should you do?","depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{}}]},"references":{"blocks":[{"depth":0,"data":{},"key":"cug0","type":"unstyled","inlineStyleRanges":[],"text":"Run the following PowerShell Command: \"Get-Mailbox -ResultSize unlimited | ?{$_.Name -notlike \"DiscoverySearchMailbox*\"} | %{ Start-ManagedFolderAssistant $_.UserPrincipalName }\"","entityRanges":[]},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"Note: If you only need to publish the labels to one user immediately you can use \"Start-ManagedFolderAssistant UPN\" and replace UPN with the user's sign-in name","key":"4ce7u","depth":0},{"key":"63al3","data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[{"offset":0,"key":0,"length":114}],"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f"},{"data":{},"key":"9t9k7","inlineStyleRanges":[],"type":"unstyled","depth":0,"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/start-managedfolderassistant?view=exchange-ps","entityRanges":[{"key":1,"length":105,"offset":0}]}],"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f"},"mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-a-custom-blocked-urls-list-wtih-atp","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
