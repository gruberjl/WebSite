...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"depth":0,"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"text":"You need to implement a solution to manage when users select links in documents or email messages from Microsoft Office 365 ProPlus applications or Android devices. The solution must meet the following requirements:","data":{},"key":"2p2s2"},{"key":"93qsd","type":"unordered-list-item","inlineStyleRanges":[],"text":"Block access to a domain named fabrikam.com","entityRanges":[],"depth":0,"data":{}},{"inlineStyleRanges":[],"key":"8b4p7","entityRanges":[],"data":{},"type":"unordered-list-item","depth":0,"text":"Store information when the users select links to fabrikam.com"},{"type":"unstyled","data":{},"depth":0,"key":"42lo8","inlineStyleRanges":[],"text":"To complete this task, sign in to the Microsoft 365 portal.","entityRanges":[]}],"entityMap":{}},"id":"HnDt94N5E","references":{"entityMap":{},"blocks":[{"key":"c5kns","type":"unstyled","inlineStyleRanges":[],"text":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com","depth":0,"entityRanges":[],"data":{}},{"text":"Open the securiy & compliance admin center","type":"ordered-list-item","data":{},"entityRanges":[],"key":"ct5nh","depth":0,"inlineStyleRanges":[]},{"type":"ordered-list-item","inlineStyleRanges":[],"text":"Click Threat management > policy > Safe links > Global settings","data":{},"depth":0,"key":"13h4t","entityRanges":[]},{"text":"Enter the URL in the Block the following URLS","entityRanges":[],"depth":0,"data":{},"key":"5oiok","inlineStyleRanges":[],"type":"ordered-list-item"},{"inlineStyleRanges":[],"key":"7khlq","data":{},"type":"ordered-list-item","entityRanges":[],"depth":0,"text":"Uncheck Do not track when users click protected links in Office 365 apps."},{"text":"Click Save","entityRanges":[],"data":{},"depth":0,"type":"ordered-list-item","inlineStyleRanges":[],"key":"7vm0o"}]},"answers":[{"isCorrectAnswer":true,"value":"From the Security & Compliance admin center, go to safe links > add the link to the blocked list."},{"value":"From the Azure AD admin center, go to safe links > add the link to the blocked list.","isCorrectAnswer":false},{"value":"From the Security & Compliance admin center, go to Data Loss Prevention > add the link to the blocked list.","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
