...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Security & Compliance admin center, go to safe links > add the link to the blocked list.","isCorrectAnswer":true},{"value":"From the Azure AD admin center, go to safe links > add the link to the blocked list.","isCorrectAnswer":false},{"value":"From the Security & Compliance admin center, go to Data Loss Prevention > add the link to the blocked list.","isCorrectAnswer":false}],"id":"HnDt94N5E","question":{"blocks":[{"inlineStyleRanges":[],"depth":0,"key":"2p2s2","text":"You need to implement a solution to manage when users select links in documents or email messages from Microsoft Office 365 ProPlus applications or Android devices. The solution must meet the following requirements:","data":{},"type":"unstyled","entityRanges":[]},{"text":"Block access to a domain named fabrikam.com","data":{},"inlineStyleRanges":[],"key":"93qsd","type":"unordered-list-item","depth":0,"entityRanges":[]},{"text":"Store information when the users select links to fabrikam.com","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"key":"8b4p7","data":{},"depth":0},{"data":{},"text":"What steps need to be completed to fulfill the requirements?","type":"unstyled","entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"42lo8"}],"entityMap":{}},"references":{"entityMap":{},"blocks":[{"entityRanges":[],"data":{},"depth":0,"key":"c5kns","text":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com","type":"unstyled","inlineStyleRanges":[]},{"inlineStyleRanges":[],"key":"ct5nh","type":"ordered-list-item","text":"Open the securiy & compliance admin center","data":{},"entityRanges":[],"depth":0},{"entityRanges":[],"text":"Click Threat management > policy > Safe links > Global settings","key":"13h4t","type":"ordered-list-item","inlineStyleRanges":[],"depth":0,"data":{}},{"inlineStyleRanges":[],"depth":0,"text":"Enter the URL in the Block the following URLS","type":"ordered-list-item","data":{},"entityRanges":[],"key":"5oiok"},{"text":"Uncheck Do not track when users click protected links in Office 365 apps.","inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"7khlq","type":"ordered-list-item","depth":0},{"entityRanges":[],"text":"Click Save","key":"7vm0o","type":"ordered-list-item","data":{},"inlineStyleRanges":[],"depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
