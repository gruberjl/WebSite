...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Security & Compliance admin center, go to safe links > add the link to the blocked list.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, go to safe links > add the link to the blocked list."},{"value":"From the Security & Compliance admin center, go to Data Loss Prevention > add the link to the blocked list.","isCorrectAnswer":false}],"question":{"blocks":[{"data":{},"type":"unstyled","key":"2p2s2","text":"You need to implement a solution to manage when users select links in documents or email messages from Microsoft Office 365 ProPlus applications or Android devices. The solution must meet the following requirements:","entityRanges":[],"inlineStyleRanges":[],"depth":0},{"text":"Block access to a domain named fabrikam.com","key":"93qsd","data":{},"depth":0,"type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[]},{"key":"8b4p7","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","text":"Store information when the users select links to fabrikam.com"},{"text":"To complete this task, sign in to the Microsoft 365 portal.","key":"42lo8","data":{},"type":"unstyled","inlineStyleRanges":[],"depth":0,"entityRanges":[]}],"entityMap":{}},"id":"HnDt94N5E","references":{"entityMap":{},"blocks":[{"type":"unstyled","key":"c5kns","inlineStyleRanges":[],"text":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com","data":{},"depth":0,"entityRanges":[]},{"type":"ordered-list-item","key":"ct5nh","inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[],"text":"Open the securiy & compliance admin center"},{"key":"13h4t","text":"Click Threat management > policy > Safe links > Global settings","entityRanges":[],"data":{},"depth":0,"type":"ordered-list-item","inlineStyleRanges":[]},{"key":"5oiok","type":"ordered-list-item","inlineStyleRanges":[],"depth":0,"entityRanges":[],"data":{},"text":"Enter the URL in the Block the following URLS"},{"inlineStyleRanges":[],"depth":0,"data":{},"type":"ordered-list-item","text":"Uncheck Do not track when users click protected links in Office 365 apps.","entityRanges":[],"key":"7khlq"},{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"Click Save","type":"ordered-list-item","key":"7vm0o"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
