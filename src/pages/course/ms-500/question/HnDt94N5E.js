...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"HnDt94N5E","references":{"entityMap":{},"blocks":[{"text":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com","inlineStyleRanges":[],"key":"c5kns","data":{},"entityRanges":[],"type":"unstyled","depth":0},{"depth":0,"inlineStyleRanges":[],"text":"Open the securiy & compliance admin center","key":"ct5nh","type":"ordered-list-item","entityRanges":[],"data":{}},{"text":"Click Threat management > policy > Safe links > Global settings","key":"13h4t","inlineStyleRanges":[],"depth":0,"type":"ordered-list-item","data":{},"entityRanges":[]},{"text":"Enter the URL in the Block the following URLS","key":"5oiok","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"ordered-list-item"},{"entityRanges":[],"key":"7khlq","data":{},"type":"ordered-list-item","inlineStyleRanges":[],"text":"Uncheck Do not track when users click protected links in Office 365 apps.","depth":0},{"type":"ordered-list-item","key":"7vm0o","inlineStyleRanges":[],"depth":0,"entityRanges":[],"data":{},"text":"Click Save"}]},"answers":[{"isCorrectAnswer":true,"value":"From the Security & Compliance admin center, go to safe links > add the link to the blocked list."},{"value":"From the Azure AD admin center, go to safe links > add the link to the blocked list.","isCorrectAnswer":false},{"value":"From the Security & Compliance admin center, go to Data Loss Prevention > add the link to the blocked list.","isCorrectAnswer":false}],"question":{"entityMap":{},"blocks":[{"key":"2p2s2","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"depth":0,"data":{},"text":"You need to implement a solution to manage when users select links in documents or email messages from Microsoft Office 365 ProPlus applications or Android devices. The solution must meet the following requirements:"},{"type":"unordered-list-item","entityRanges":[],"key":"93qsd","depth":0,"text":"Block access to a domain named fabrikam.com","data":{},"inlineStyleRanges":[]},{"depth":0,"type":"unordered-list-item","entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"Store information when the users select links to fabrikam.com","key":"8b4p7"},{"inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"42lo8","depth":0,"type":"unstyled","text":"To complete this task, sign in to the Microsoft 365 portal."}]}},
      previousQuestionId: '',
      nextQuestionId: '',
