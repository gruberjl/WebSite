...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"HnDt94N5E","question":{"blocks":[{"type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"2p2s2","entityRanges":[],"text":"You need to implement a solution to manage when users select links in documents or email messages from Microsoft Office 365 ProPlus applications or Android devices. The solution must meet the following requirements:","data":{}},{"depth":0,"key":"93qsd","data":{},"entityRanges":[],"text":"Block access to a domain named fabrikam.com","inlineStyleRanges":[],"type":"unordered-list-item"},{"type":"unordered-list-item","key":"8b4p7","entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"text":"Store information when the users select links to fabrikam.com"},{"data":{},"type":"unstyled","key":"42lo8","text":"To complete this task, sign in to the Microsoft 365 portal.","entityRanges":[],"depth":0,"inlineStyleRanges":[]}],"entityMap":{}},"answers":[{"value":"From the Security & Compliance admin center, go to safe links > add the link to the blocked list.","isCorrectAnswer":true},{"value":"From the Azure AD admin center, go to safe links > add the link to the blocked list.","isCorrectAnswer":false},{"value":"From the Security & Compliance admin center, go to Data Loss Prevention > add the link to the blocked list.","isCorrectAnswer":false}],"references":{"blocks":[{"key":"c5kns","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0,"text":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com"},{"depth":0,"type":"ordered-list-item","text":"Open the securiy & compliance admin center","inlineStyleRanges":[],"data":{},"key":"ct5nh","entityRanges":[]},{"entityRanges":[],"text":"Click Threat management > policy > Safe links > Global settings","type":"ordered-list-item","inlineStyleRanges":[],"key":"13h4t","data":{},"depth":0},{"key":"5oiok","data":{},"text":"Enter the URL in the Block the following URLS","type":"ordered-list-item","depth":0,"entityRanges":[],"inlineStyleRanges":[]},{"data":{},"entityRanges":[],"key":"7khlq","type":"ordered-list-item","depth":0,"text":"Uncheck Do not track when users click protected links in Office 365 apps.","inlineStyleRanges":[]},{"key":"7vm0o","data":{},"entityRanges":[],"type":"ordered-list-item","text":"Click Save","depth":0,"inlineStyleRanges":[]}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
