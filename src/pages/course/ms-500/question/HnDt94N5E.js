...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Security & Compliance admin center, go to safe links > add the link to the blocked list.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, go to safe links > add the link to the blocked list."},{"isCorrectAnswer":false,"value":"From the Security & Compliance admin center, go to Data Loss Prevention > add the link to the blocked list."}],"id":"HnDt94N5E","question":{"entityMap":{},"blocks":[{"type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"2p2s2","data":{},"entityRanges":[],"text":"You need to implement a solution to manage when users select links in documents or email messages from Microsoft Office 365 ProPlus applications or Android devices. The solution must meet the following requirements:"},{"key":"93qsd","entityRanges":[],"depth":0,"text":"Block access to a domain named fabrikam.com","data":{},"type":"unordered-list-item","inlineStyleRanges":[]},{"inlineStyleRanges":[],"type":"unordered-list-item","text":"Store information when the users select links to fabrikam.com","depth":0,"entityRanges":[],"data":{},"key":"8b4p7"},{"text":"What steps need to be completed to fulfill the requirements?","data":{},"key":"42lo8","depth":0,"inlineStyleRanges":[],"type":"unstyled","entityRanges":[]}]},"references":{"blocks":[{"key":"c5kns","data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"text":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com","depth":0},{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"Open the securiy & compliance admin center","key":"ct5nh","data":{},"type":"ordered-list-item"},{"data":{},"type":"ordered-list-item","text":"Click Threat management > policy > Safe links > Global settings","entityRanges":[],"key":"13h4t","depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"type":"ordered-list-item","text":"Enter the URL in the Block the following URLS","data":{},"depth":0,"key":"5oiok","inlineStyleRanges":[]},{"inlineStyleRanges":[],"text":"Uncheck Do not track when users click protected links in Office 365 apps.","key":"7khlq","entityRanges":[],"depth":0,"data":{},"type":"ordered-list-item"},{"type":"ordered-list-item","inlineStyleRanges":[],"key":"7vm0o","entityRanges":[],"depth":0,"data":{},"text":"Click Save"}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
