...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Tenant Allow/Block List > URLs > Block. Add the URL to the \"Add URLs with wildcards\" section. Set the Remove block entry after to the number of days to block the URL. Click Add."},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, go to safe links > add the link to the blocked list."},{"isCorrectAnswer":false,"value":"From the Microsoft Compliance admin center go to Data Loss Prevention > add the link to the blocked list."},{"value":"Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Safe links > Global settings. Uncheck Do not track when users click protected links in Office 365 apps","isCorrectAnswer":true}],"id":"HnDt94N5E","question":{"entityMap":{},"blocks":[{"type":"unstyled","inlineStyleRanges":[],"key":"2p2s2","depth":0,"entityRanges":[],"data":{},"text":"You've been tasked with updating the safe links policy. Your manager gives you the following 2 requirements:"},{"data":{},"entityRanges":[],"key":"93qsd","text":"Block any access to the GitBit.org domain","type":"unordered-list-item","depth":0,"inlineStyleRanges":[]},{"key":"8b4p7","text":"Track user clicks on any links to gitbit.org.","type":"unordered-list-item","entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0},{"data":{},"text":"What steps need to be completed to fulfill the requirements?","inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"key":"42lo8","depth":0}]},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"},"mutability":"MUTABLE","type":"LINK"},"1":{"data":{"url":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"text":"To block URLs: Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Tenant Allow/Block List > URLs > Block. Add the URL to the \"Add URLs with wildcards\" section. Set the Remove block entry after to the number of days to block the URL. Click Add.","type":"unstyled","depth":0,"key":"c5kns","data":{},"inlineStyleRanges":[],"entityRanges":[]},{"inlineStyleRanges":[],"key":"b5702","depth":0,"type":"unstyled","entityRanges":[],"text":"To set up tracking: Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Safe links > Global settings. Disable Do not track when users click protected links in Office 365 apps. Click Save.","data":{}},{"inlineStyleRanges":[],"data":{},"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","depth":0,"key":"5s5au","entityRanges":[{"offset":0,"length":105,"key":0}]},{"key":"bpoog","data":{},"type":"unstyled","inlineStyleRanges":[],"text":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com","entityRanges":[{"offset":0,"length":89,"key":1}],"depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
