...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Tenant Allow/Block List > URLs > Block. Add the URL to the \"Add URLs with wildcards\" section. Set the Remove block entry after to the number of days to block the URL. Click Add."},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, go to safe links > add the link to the blocked list."},{"isCorrectAnswer":false,"value":"From the Microsoft Compliance admin center go to Data Loss Prevention > add the link to the blocked list."},{"value":"Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Safe links > Global settings. Uncheck Do not track when users click protected links in Office 365 apps","isCorrectAnswer":true}],"id":"HnDt94N5E","question":{"blocks":[{"data":{},"inlineStyleRanges":[],"text":"You've been tasked with updating the safe links policy. Your manager gives you the following 2 requirements:","entityRanges":[],"depth":0,"key":"2p2s2","type":"unstyled"},{"key":"93qsd","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Block any access to the GitBit.org domain","type":"unordered-list-item"},{"data":{},"key":"8b4p7","depth":0,"entityRanges":[],"text":"Track user clicks on any links to gitbit.org.","type":"unordered-list-item","inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"text":"What steps need to be completed to fulfill the requirements?","type":"unstyled","key":"42lo8","data":{},"inlineStyleRanges":[]}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"data":{},"text":"To block URLs: Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Tenant Allow/Block List > URLs > Block. Add the URL to the \"Add URLs with wildcards\" section. Set the Remove block entry after to the number of days to block the URL. Click Add.","type":"unstyled","key":"c5kns","inlineStyleRanges":[],"depth":0},{"depth":0,"type":"unstyled","text":"To set up tracking: Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Safe links > Global settings. Disable Do not track when users click protected links in Office 365 apps. Click Save.","entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"b5702"},{"entityRanges":[{"length":105,"key":0,"offset":0}],"inlineStyleRanges":[],"data":{},"key":"5s5au","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","type":"unstyled"},{"entityRanges":[{"key":1,"length":89,"offset":0}],"key":"bpoog","text":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com","depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{}}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
