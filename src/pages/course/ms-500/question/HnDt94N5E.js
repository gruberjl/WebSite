...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"HnDt94N5E","answers":[{"value":"From the Security & Compliance admin center, go to safe links > add the link to the blocked list.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, go to safe links > add the link to the blocked list."},{"isCorrectAnswer":false,"value":"From the Security & Compliance admin center, go to Data Loss Prevention > add the link to the blocked list."}],"references":{"blocks":[{"entityRanges":[],"type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com","key":"c5kns","data":{}},{"key":"ct5nh","inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"ordered-list-item","depth":0,"text":"Open the securiy & compliance admin center"},{"depth":0,"type":"ordered-list-item","text":"Click Threat management > policy > Safe links > Global settings","entityRanges":[],"key":"13h4t","inlineStyleRanges":[],"data":{}},{"type":"ordered-list-item","entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"Enter the URL in the Block the following URLS","depth":0,"key":"5oiok"},{"entityRanges":[],"data":{},"depth":0,"text":"Uncheck Do not track when users click protected links in Office 365 apps.","type":"ordered-list-item","key":"7khlq","inlineStyleRanges":[]},{"data":{},"entityRanges":[],"depth":0,"type":"ordered-list-item","key":"7vm0o","text":"Click Save","inlineStyleRanges":[]}],"entityMap":{}},"question":{"blocks":[{"type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"You need to implement a solution to manage when users select links in documents or email messages from Microsoft Office 365 ProPlus applications or Android devices. The solution must meet the following requirements:","key":"2p2s2"},{"depth":0,"key":"93qsd","inlineStyleRanges":[],"type":"unordered-list-item","data":{},"entityRanges":[],"text":"Block access to a domain named fabrikam.com"},{"depth":0,"inlineStyleRanges":[],"text":"Store information when the users select links to fabrikam.com","data":{},"key":"8b4p7","entityRanges":[],"type":"unordered-list-item"},{"depth":0,"inlineStyleRanges":[],"key":"42lo8","data":{},"entityRanges":[],"type":"unstyled","text":"To complete this task, sign in to the Microsoft 365 portal."}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
