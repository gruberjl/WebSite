...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User1: Can sign in to the My Apps portal without using MFA"},{"value":"User1: Completed the MFA registration","isCorrectAnswer":false},{"value":"User1: Must complete the MFA registration at the next sign-in","isCorrectAnswer":true},{"value":"User2: Can sign in to the My Apps portal without using MFA","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User2: Must use app passwords for legacy apps"},{"isCorrectAnswer":false,"value":"User2: Must use an app password to sign in to the My Apps portal"}],"id":"-T7jiUFfR","question":{"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","src":"https://i.ibb.co/pQps3R2/MFA.png","alt":"Multi-Factor Authentication","width":"auto","alignment":"left"}},"1":{"mutability":"MUTABLE","data":{"alignment":"left","alt":"User chart showing 3 users","src":"https://i.ibb.co/bmTyW56/user-chart.png","height":"auto","width":"auto"},"type":"IMAGE"}},"blocks":[{"inlineStyleRanges":[],"type":"unstyled","text":"You have a Microsoft 365 subscription that uses the default domain name of gitbit.org.","entityRanges":[],"key":"2h8s2","depth":0,"data":{}},{"depth":0,"inlineStyleRanges":[],"data":{},"key":"2t9f1","entityRanges":[],"text":"The multi-factor authentication (MFA) service settings are configured as shown in the exhibit.","type":"unstyled"},{"key":"2317e","type":"atomic","depth":0,"data":{},"inlineStyleRanges":[],"text":" ","entityRanges":[{"key":0,"offset":0,"length":1}]},{"text":"In gitbit.org, you create the users shown in the following table.","type":"unstyled","key":"ccd7r","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[]},{"entityRanges":[{"key":1,"offset":0,"length":1}],"depth":0,"key":"lvbg","text":" ","data":{},"inlineStyleRanges":[],"type":"atomic"},{"data":{},"type":"unstyled","key":"4b9b1","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"What is the effect of the configuration? To answer, select the appropriate options in the answer area."}]},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","targetOption":"_blank"}}},"blocks":[{"key":"5mu1d","data":{},"type":"unstyled","depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"The MFA Status Enabled means the user must set up MFA during the next login."},{"key":"d3ojg","inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[],"depth":0,"text":"Since \"Allow users to create app passwords to sign in to non-browser apps\" is checked that means a user can use the app password to login when MFA is not an available option."},{"inlineStyleRanges":[],"data":{},"key":"9clot","depth":0,"entityRanges":[{"offset":0,"length":128,"key":0}],"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","type":"unstyled"},{"entityRanges":[{"key":1,"length":91,"offset":0}],"key":"dnvn8","type":"unstyled","data":{},"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-T7jiUFfR',
      questionIdx: '',
