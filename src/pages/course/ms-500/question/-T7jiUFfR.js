...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User1 can sign in without MFA"},{"isCorrectAnswer":false,"value":"User1 has completed the MFA registration"},{"value":"User1 will be prompted to complete the MFA registration at the next sign-in","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"User2 can sign in without MFA"},{"isCorrectAnswer":true,"value":"User2 will be required to use app passwords for any apps that don't support MFA"},{"value":"User2 will be required to use their app password to sign into Microsoft 365 apps","isCorrectAnswer":false}],"id":"-T7jiUFfR","question":{"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"src":"https://i.ibb.co/pQps3R2/MFA.png","alignment":"left","height":"auto","width":"auto","alt":"Multi-Factor Authentication"}},"1":{"data":{"alignment":"left","src":"https://i.ibb.co/bmTyW56/user-chart.png","alt":"User chart showing 3 users","height":"auto","width":"auto"},"mutability":"MUTABLE","type":"IMAGE"}},"blocks":[{"entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"Your organization has a Microsoft 365 tenant with the domain name gitbit.org.","key":"2h8s2","depth":0,"type":"unstyled"},{"key":"2t9f1","data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","text":"The MFA configuration is shown below.","entityRanges":[]},{"key":"2317e","inlineStyleRanges":[],"data":{},"type":"atomic","entityRanges":[{"offset":0,"length":1,"key":0}],"text":" ","depth":0},{"entityRanges":[],"key":"ccd7r","type":"unstyled","depth":0,"data":{},"inlineStyleRanges":[],"text":"Your Microsoft 365 tenant has the following users."},{"type":"atomic","entityRanges":[{"key":1,"length":1,"offset":0}],"text":" ","key":"lvbg","depth":0,"inlineStyleRanges":[],"data":{}},{"inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"4b9b1","text":"What will happen when User1 and User2 log in?","entityRanges":[],"data":{}}]},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk"},"mutability":"MUTABLE","type":"LINK"},"1":{"mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","targetOption":"_blank"},"type":"LINK"}},"blocks":[{"depth":0,"data":{},"inlineStyleRanges":[],"key":"5mu1d","entityRanges":[],"type":"unstyled","text":"The MFA Status Enabled means the user must set up MFA during the next login."},{"entityRanges":[],"text":"Since \"Allow users to create app passwords to sign in to non-browser apps\" is checked that means a user can use the app password to log in when MFA is not an available option.","key":"d3ojg","data":{},"inlineStyleRanges":[],"type":"unstyled","depth":0},{"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":128,"key":0}],"type":"unstyled","key":"9clot","depth":0,"data":{}},{"depth":0,"inlineStyleRanges":[],"entityRanges":[{"length":91,"offset":0,"key":1}],"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","type":"unstyled","data":{},"key":"dnvn8"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-T7jiUFfR',
      questionIdx: '',
