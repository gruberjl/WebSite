...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User1: Can sign in to the My Apps portal without using MFA"},{"value":"User1: Completed the MFA registration","isCorrectAnswer":false},{"value":"User1: Must complete the MFA registration at the next sign-in","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"User2: Can sign in to the My Apps portal without using MFA"},{"value":"User2: Must use app passwords for legacy apps","isCorrectAnswer":true},{"value":"User2: Must use an app password to sign in to the My Apps portal","isCorrectAnswer":false}],"id":"-T7jiUFfR","question":{"blocks":[{"entityRanges":[],"key":"2h8s2","text":"You have a Microsoft 365 subscription that uses the default domain name of gitbit.org.","inlineStyleRanges":[],"data":{},"depth":0,"type":"unstyled"},{"type":"unstyled","entityRanges":[],"key":"2t9f1","text":"The multi-factor authentication (MFA) service settings are configured as shown in the exhibit.","depth":0,"data":{},"inlineStyleRanges":[]},{"text":" ","key":"2317e","data":{},"entityRanges":[{"key":0,"length":1,"offset":0}],"inlineStyleRanges":[],"type":"atomic","depth":0},{"depth":0,"text":"In gitbit.org, you create the users shown in the following table.","type":"unstyled","data":{},"key":"ccd7r","inlineStyleRanges":[],"entityRanges":[]},{"depth":0,"data":{},"entityRanges":[{"length":1,"key":1,"offset":0}],"text":" ","key":"lvbg","inlineStyleRanges":[],"type":"atomic"},{"entityRanges":[],"key":"4b9b1","depth":0,"data":{},"text":"What is the effect of the configuration? To answer, select the appropriate options in the answer area.","type":"unstyled","inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"alignment":"left","alt":"Multi-Factor Authentication","src":"https://i.ibb.co/pQps3R2/MFA.png","width":"auto","height":"auto"},"type":"IMAGE","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"src":"https://i.ibb.co/bmTyW56/user-chart.png","width":"auto","height":"auto","alignment":"left","alt":"User chart showing 3 users"}}}},"references":{"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"},"mutability":"MUTABLE"},"1":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","targetOption":"_blank"},"mutability":"MUTABLE"}},"blocks":[{"inlineStyleRanges":[],"text":"The MFA Status Enabled means the user must set up MFA during the next login.","entityRanges":[],"key":"5mu1d","data":{},"type":"unstyled","depth":0},{"depth":0,"text":"Since \"Allow users to create app passwords to sign in to non-browser apps\" is checked that means a user can use the app password to login when MFA is not an available option.","type":"unstyled","key":"d3ojg","data":{},"inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[{"key":0,"length":128,"offset":0}],"key":"9clot","text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","inlineStyleRanges":[],"depth":0,"type":"unstyled","data":{}},{"entityRanges":[{"offset":0,"length":91,"key":1}],"type":"unstyled","key":"dnvn8","inlineStyleRanges":[],"data":{},"depth":0,"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-T7jiUFfR',
      questionIdx: '',
