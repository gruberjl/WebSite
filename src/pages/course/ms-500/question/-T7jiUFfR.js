...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User1 can sign in without MFA"},{"value":"User1 has completed the MFA registration","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User1 will be prompted to complete the MFA registration at the next sign-in"},{"value":"User2 can sign in without MFA","isCorrectAnswer":false},{"value":"User2 will be required to use app passwords for any apps that don't support MFA","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"User2 will be required to use their app password to sign into Microsoft 365 apps"}],"id":"-T7jiUFfR","question":{"blocks":[{"inlineStyleRanges":[],"type":"unstyled","key":"2h8s2","entityRanges":[],"data":{},"text":"Your organization has a Microsoft 365 tenant with the domain name gitbit.org.","depth":0},{"key":"2t9f1","depth":0,"type":"unstyled","text":"The MFA configuration is shown below.","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"data":{},"inlineStyleRanges":[],"key":"2317e","text":" ","depth":0,"entityRanges":[{"offset":0,"length":1,"key":0}],"type":"atomic"},{"entityRanges":[],"depth":0,"key":"ccd7r","data":{},"inlineStyleRanges":[],"text":"Your Microsoft 365 tenant has the following users.","type":"unstyled"},{"entityRanges":[{"key":1,"length":1,"offset":0}],"text":" ","key":"lvbg","type":"atomic","depth":0,"data":{},"inlineStyleRanges":[]},{"entityRanges":[],"key":"4b9b1","inlineStyleRanges":[],"type":"unstyled","depth":0,"data":{},"text":"What will happen when User1 and User2 log in?"}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"alignment":"left","height":"auto","width":"auto","alt":"Multi-Factor Authentication","src":"https://i.ibb.co/pQps3R2/MFA.png"},"type":"IMAGE"},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","width":"auto","alt":"User chart showing 3 users","src":"https://i.ibb.co/bmTyW56/user-chart.png","alignment":"left"}}}},"references":{"blocks":[{"text":"The MFA Status Enabled means the user must set up MFA during the next login.","type":"unstyled","depth":0,"key":"5mu1d","entityRanges":[],"inlineStyleRanges":[],"data":{}},{"inlineStyleRanges":[],"type":"unstyled","key":"d3ojg","entityRanges":[],"depth":0,"text":"Since \"Allow users to create app passwords to sign in to non-browser apps\" is checked that means a user can use the app password to log in when MFA is not an available option.","data":{}},{"depth":0,"inlineStyleRanges":[],"entityRanges":[{"length":128,"offset":0,"key":0}],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","key":"9clot","type":"unstyled"},{"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","data":{},"entityRanges":[{"offset":0,"key":1,"length":91}],"depth":0,"key":"dnvn8","inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"}},"1":{"mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","targetOption":"_blank"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-T7jiUFfR',
      questionIdx: '',
