...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User1: Can sign in to the My Apps portal without using MFA","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"User1: Completed the MFA registration"},{"value":"User1: Must complete the MFA registration at the next sign-in","isCorrectAnswer":true},{"value":"User2: Can sign in to the My Apps portal without using MFA","isCorrectAnswer":false},{"value":"User2: Must use app passwords for legacy apps","isCorrectAnswer":true},{"value":"User2: Must use an app password to sign in to the My Apps portal","isCorrectAnswer":false}],"id":"-T7jiUFfR","question":{"entityMap":{"0":{"data":{"width":"auto","alt":"Multi-Factor Authentication","height":"auto","alignment":"left","src":"https://i.ibb.co/pQps3R2/MFA.png"},"mutability":"MUTABLE","type":"IMAGE"},"1":{"type":"IMAGE","data":{"height":"auto","alignment":"left","width":"auto","alt":"User chart showing 3 users","src":"https://i.ibb.co/bmTyW56/user-chart.png"},"mutability":"MUTABLE"}},"blocks":[{"type":"unstyled","key":"2h8s2","depth":0,"text":"You have a Microsoft 365 subscription that uses the default domain name of gitbit.org.","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"text":"The multi-factor authentication (MFA) service settings are configured as shown in the exhibit.","type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"2t9f1"},{"text":" ","entityRanges":[{"length":1,"key":0,"offset":0}],"key":"2317e","type":"atomic","data":{},"depth":0,"inlineStyleRanges":[]},{"type":"unstyled","data":{},"key":"ccd7r","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"In gitbit.org, you create the users shown in the following table."},{"inlineStyleRanges":[],"type":"atomic","depth":0,"data":{},"text":" ","key":"lvbg","entityRanges":[{"key":1,"offset":0,"length":1}]},{"data":{},"entityRanges":[],"type":"unstyled","text":"What is the effect of the configuration? To answer, select the appropriate options in the answer area.","key":"4b9b1","inlineStyleRanges":[],"depth":0}]},"references":{"blocks":[{"depth":0,"text":"The MFA Status Enabled means the user must set up MFA during the next login.","entityRanges":[],"type":"unstyled","key":"5mu1d","data":{},"inlineStyleRanges":[]},{"key":"d3ojg","depth":0,"entityRanges":[],"data":{},"text":"Since \"Allow users to create app passwords to sign in to non-browser apps\" is checked that means a user can use the app password to login when MFA is not an available option.","type":"unstyled","inlineStyleRanges":[]},{"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","key":"9clot","inlineStyleRanges":[],"type":"unstyled","depth":0,"entityRanges":[{"key":0,"length":128,"offset":0}]},{"type":"unstyled","inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","entityRanges":[{"offset":0,"key":1,"length":91}],"key":"dnvn8","data":{},"depth":0}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-T7jiUFfR',
      questionIdx: '',
