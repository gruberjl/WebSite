...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User1: Can sign in to the My Apps portal without using MFA"},{"value":"User1: Completed the MFA registration","isCorrectAnswer":false},{"value":"User1: Must complete the MFA registration at the next sign-in","isCorrectAnswer":true},{"value":"User2: Can sign in to the My Apps portal without using MFA","isCorrectAnswer":false},{"value":"User2: Must use app passwords for legacy apps","isCorrectAnswer":true},{"value":"User2: Must use an app password to sign in to the My Apps portal","isCorrectAnswer":false}],"id":"-T7jiUFfR","question":{"blocks":[{"key":"2h8s2","depth":0,"inlineStyleRanges":[],"data":{},"text":"You have a Microsoft 365 subscription that uses the default domain name of gitbit.org.","entityRanges":[],"type":"unstyled"},{"inlineStyleRanges":[],"data":{},"key":"2t9f1","entityRanges":[],"depth":0,"text":"The multi-factor authentication (MFA) service settings are configured as shown in the exhibit.","type":"unstyled"},{"depth":0,"text":" ","type":"atomic","data":{},"entityRanges":[{"length":1,"key":0,"offset":0}],"key":"2317e","inlineStyleRanges":[]},{"inlineStyleRanges":[],"text":"In gitbit.org, you create the users shown in the following table.","data":{},"depth":0,"type":"unstyled","key":"ccd7r","entityRanges":[]},{"key":"lvbg","text":" ","type":"atomic","entityRanges":[{"offset":0,"length":1,"key":1}],"depth":0,"inlineStyleRanges":[],"data":{}},{"depth":0,"text":"What is the effect of the configuration? To answer, select the appropriate options in the answer area.","entityRanges":[],"inlineStyleRanges":[],"key":"4b9b1","data":{},"type":"unstyled"}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","alt":"Multi-Factor Authentication","alignment":"left","width":"auto","src":"https://i.ibb.co/pQps3R2/MFA.png"}},"1":{"type":"IMAGE","data":{"height":"auto","alignment":"left","width":"auto","src":"https://i.ibb.co/bmTyW56/user-chart.png","alt":"User chart showing 3 users"},"mutability":"MUTABLE"}}},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates"},"mutability":"MUTABLE"}},"blocks":[{"entityRanges":[],"data":{},"depth":0,"type":"unstyled","text":"The MFA Status Enabled means the user must set up MFA during the next login.","inlineStyleRanges":[],"key":"5mu1d"},{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"Since \"Allow users to create app passwords to sign in to non-browser apps\" is checked that means a user can use the app password to login when MFA is not an available option.","type":"unstyled","key":"d3ojg","data":{}},{"depth":0,"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","key":"9clot","inlineStyleRanges":[],"type":"unstyled","entityRanges":[{"length":128,"offset":0,"key":0}]},{"entityRanges":[{"key":1,"length":91,"offset":0}],"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","depth":0,"data":{},"key":"dnvn8","type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-T7jiUFfR',
      questionIdx: '',
