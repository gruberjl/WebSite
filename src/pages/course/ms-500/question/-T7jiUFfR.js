...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User1: Can sign in to the My Apps portal without using MFA","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"User1: Completed the MFA registration"},{"value":"User1: Must complete the MFA registration at the next sign-in","isCorrectAnswer":true},{"value":"User2: Can sign in to the My Apps portal without using MFA","isCorrectAnswer":false},{"value":"User2: Must use app passwords for legacy apps","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"User2: Must use an app password to sign in to the My Apps portal"}],"id":"-T7jiUFfR","question":{"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"width":"auto","src":"https://i.ibb.co/pQps3R2/MFA.png","alt":"Multi-Factor Authentication","height":"auto","alignment":"left"}},"1":{"mutability":"MUTABLE","data":{"alt":"User chart showing 3 users","width":"auto","src":"https://i.ibb.co/bmTyW56/user-chart.png","height":"auto","alignment":"left"},"type":"IMAGE"}},"blocks":[{"text":"You have a Microsoft 365 subscription that uses the default domain name of gitbit.org.","key":"2h8s2","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unstyled"},{"text":"The multi-factor authentication (MFA) service settings are configured as shown in the exhibit.","inlineStyleRanges":[],"key":"2t9f1","data":{},"entityRanges":[],"depth":0,"type":"unstyled"},{"depth":0,"data":{},"key":"2317e","text":" ","type":"atomic","entityRanges":[{"key":0,"length":1,"offset":0}],"inlineStyleRanges":[]},{"entityRanges":[],"depth":0,"text":"In gitbit.org, you create the users shown in the following table.","type":"unstyled","key":"ccd7r","data":{},"inlineStyleRanges":[]},{"depth":0,"data":{},"text":" ","type":"atomic","key":"lvbg","entityRanges":[{"length":1,"key":1,"offset":0}],"inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"What is the effect of the configuration? To answer, select the appropriate options in the answer area.","data":{},"type":"unstyled","key":"4b9b1"}]},"references":{"blocks":[{"entityRanges":[],"depth":0,"key":"5mu1d","inlineStyleRanges":[],"data":{},"text":"The MFA Status Enabled means the user must set up MFA during the next login.","type":"unstyled"},{"text":"Since \"Allow users to create app passwords to sign in to non-browser apps\" is checked that means a user can use the app password to login when MFA is not an available option.","data":{},"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"depth":0,"key":"d3ojg"},{"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","entityRanges":[{"key":0,"length":128,"offset":0}],"inlineStyleRanges":[],"depth":0,"key":"9clot","type":"unstyled"},{"inlineStyleRanges":[],"depth":0,"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","type":"unstyled","entityRanges":[{"key":1,"length":91,"offset":0}],"key":"dnvn8","data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"},"type":"LINK"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-T7jiUFfR',
      questionIdx: '',
