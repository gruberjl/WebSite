...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User1: Can sign in to the My Apps portal without using MFA","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"User1: Completed the MFA registration"},{"isCorrectAnswer":true,"value":"User1: Must complete the MFA registration at the next sign-in"},{"isCorrectAnswer":false,"value":"User2: Can sign in to the My Apps portal without using MFA"},{"value":"User2: Must use app passwords for legacy apps","isCorrectAnswer":true},{"value":"User2: Must use an app password to sign in to the My Apps portal","isCorrectAnswer":false}],"id":"-T7jiUFfR","question":{"blocks":[{"type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription that uses the default domain name of gitbit.org.","key":"2h8s2","depth":0},{"inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"2t9f1","type":"unstyled","depth":0,"text":"The multi-factor authentication (MFA) service settings are configured as shown in the exhibit."},{"inlineStyleRanges":[],"key":"2317e","entityRanges":[{"key":0,"length":1,"offset":0}],"text":" ","depth":0,"data":{},"type":"atomic"},{"depth":0,"text":"In gitbit.org, you create the users shown in the following table.","type":"unstyled","inlineStyleRanges":[],"data":{},"key":"ccd7r","entityRanges":[]},{"type":"atomic","text":" ","data":{},"inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":1,"key":1}],"depth":0,"key":"lvbg"},{"depth":0,"inlineStyleRanges":[],"text":"What is the effect of the configuration? To answer, select the appropriate options in the answer area.","entityRanges":[],"key":"4b9b1","data":{},"type":"unstyled"}],"entityMap":{"0":{"data":{"alignment":"left","src":"https://i.ibb.co/pQps3R2/MFA.png","height":"auto","width":"auto","alt":"Multi-Factor Authentication"},"mutability":"MUTABLE","type":"IMAGE"},"1":{"mutability":"MUTABLE","data":{"src":"https://i.ibb.co/bmTyW56/user-chart.png","alt":"User chart showing 3 users","alignment":"left","width":"auto","height":"auto"},"type":"IMAGE"}}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk"},"type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","targetOption":"_blank"}}},"blocks":[{"type":"unstyled","text":"The MFA Status Enabled means the user must set up MFA during the next login.","entityRanges":[],"data":{},"key":"5mu1d","inlineStyleRanges":[],"depth":0},{"data":{},"depth":0,"type":"unstyled","key":"d3ojg","entityRanges":[],"inlineStyleRanges":[],"text":"Since \"Allow users to create app passwords to sign in to non-browser apps\" is checked that means a user can use the app password to login when MFA is not an available option."},{"key":"9clot","type":"unstyled","entityRanges":[{"length":128,"offset":0,"key":0}],"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","inlineStyleRanges":[],"depth":0,"data":{}},{"entityRanges":[{"key":1,"length":91,"offset":0}],"data":{},"key":"dnvn8","type":"unstyled","depth":0,"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-T7jiUFfR',
      questionIdx: '',
