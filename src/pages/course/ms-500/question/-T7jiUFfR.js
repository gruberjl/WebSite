...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User1: Can sign in to the My Apps portal without using MFA","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"User1: Completed the MFA registration"},{"value":"User1: Must complete the MFA registration at the next sign-in","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"User2: Can sign in to the My Apps portal without using MFA"},{"value":"User2: Must use app passwords for legacy apps","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"User2: Must use an app password to sign in to the My Apps portal"}],"id":"-T7jiUFfR","question":{"blocks":[{"depth":0,"text":"You have a Microsoft 365 subscription that uses the default domain name of gitbit.org.","type":"unstyled","inlineStyleRanges":[],"key":"2h8s2","entityRanges":[],"data":{}},{"key":"2t9f1","type":"unstyled","data":{},"depth":0,"text":"The multi-factor authentication (MFA) service settings are configured as shown in the exhibit.","inlineStyleRanges":[],"entityRanges":[]},{"depth":0,"data":{},"type":"atomic","entityRanges":[{"offset":0,"key":0,"length":1}],"key":"2317e","text":" ","inlineStyleRanges":[]},{"key":"ccd7r","text":"In gitbit.org, you create the users shown in the following table.","data":{},"type":"unstyled","inlineStyleRanges":[],"depth":0,"entityRanges":[]},{"text":" ","depth":0,"type":"atomic","key":"lvbg","data":{},"entityRanges":[{"key":1,"offset":0,"length":1}],"inlineStyleRanges":[]},{"type":"unstyled","depth":0,"data":{},"entityRanges":[],"key":"4b9b1","inlineStyleRanges":[],"text":"What is the effect of the configuration? To answer, select the appropriate options in the answer area."}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"height":"auto","alt":"Multi-Factor Authentication","alignment":"left","width":"auto","src":"https://i.ibb.co/pQps3R2/MFA.png"},"type":"IMAGE"},"1":{"type":"IMAGE","data":{"alt":"User chart showing 3 users","height":"auto","width":"auto","src":"https://i.ibb.co/bmTyW56/user-chart.png","alignment":"left"},"mutability":"MUTABLE"}}},"references":{"blocks":[{"entityRanges":[],"text":"The MFA Status Enabled means the user must set up MFA during the next login.","inlineStyleRanges":[],"type":"unstyled","key":"5mu1d","data":{},"depth":0},{"type":"unstyled","inlineStyleRanges":[],"key":"d3ojg","data":{},"entityRanges":[],"text":"Since \"Allow users to create app passwords to sign in to non-browser apps\" is checked that means a user can use the app password to login when MFA is not an available option.","depth":0},{"key":"9clot","type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":0,"length":128}],"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","data":{},"depth":0},{"entityRanges":[{"length":91,"offset":0,"key":1}],"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","key":"dnvn8","data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"},"type":"LINK"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-T7jiUFfR',
      questionIdx: '',
