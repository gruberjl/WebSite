...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User1 can sign in without MFA"},{"isCorrectAnswer":false,"value":"User1 has completed the MFA registration"},{"value":"User1 will be prompted to complete the MFA registration at the next sign-in","isCorrectAnswer":true},{"value":"User2 can sign in without MFA","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User2 will be required to use app passwords for any apps that don't support MFA"},{"value":"User2 will be required to use their app password to sign into Microsoft 365 apps","isCorrectAnswer":false}],"id":"-T7jiUFfR","question":{"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","alignment":"left","width":"auto","alt":"Multi-Factor Authentication","src":"https://i.ibb.co/pQps3R2/MFA.png"}},"1":{"data":{"src":"https://i.ibb.co/bmTyW56/user-chart.png","height":"auto","alignment":"left","alt":"User chart showing 3 users","width":"auto"},"mutability":"MUTABLE","type":"IMAGE"}},"blocks":[{"depth":0,"entityRanges":[],"text":"Your organization has a Microsoft 365 tenant with the domain name gitbit.org.","inlineStyleRanges":[],"type":"unstyled","key":"2h8s2","data":{}},{"text":"The MFA configuration is shown below.","key":"2t9f1","depth":0,"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"data":{}},{"inlineStyleRanges":[],"key":"2317e","depth":0,"type":"atomic","data":{},"entityRanges":[{"offset":0,"key":0,"length":1}],"text":" "},{"text":"Your Microsoft 365 tenant has the following users.","depth":0,"key":"ccd7r","data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled"},{"text":" ","key":"lvbg","depth":0,"data":{},"entityRanges":[{"length":1,"key":1,"offset":0}],"type":"atomic","inlineStyleRanges":[]},{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0,"data":{},"key":"4b9b1","text":"What will happen when User1 and User2 log in?"}]},"references":{"blocks":[{"entityRanges":[],"text":"The MFA Status Enabled means the user must set up MFA during the next login.","depth":0,"data":{},"key":"5mu1d","type":"unstyled","inlineStyleRanges":[]},{"key":"d3ojg","type":"unstyled","data":{},"text":"Since \"Allow users to create app passwords to sign in to non-browser apps\" is checked that means a user can use the app password to log in when MFA is not an available option.","inlineStyleRanges":[],"entityRanges":[],"depth":0},{"inlineStyleRanges":[],"key":"9clot","entityRanges":[{"offset":0,"length":128,"key":0}],"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","depth":0,"type":"unstyled","data":{}},{"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates","depth":0,"data":{},"type":"unstyled","entityRanges":[{"key":1,"length":91,"offset":0}],"key":"dnvn8","inlineStyleRanges":[]}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"}},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '-T7jiUFfR',
      questionIdx: '',
