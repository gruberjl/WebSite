...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"iooPU7VvM","question":{"blocks":[{"type":"unstyled","inlineStyleRanges":[],"depth":0,"text":"You have a Microsoft 365 subscription that contains 1,000 user mailboxes.","key":"bgf7r","data":{},"entityRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"key":"7e3r0","text":"An administrator named Admin1 must be able to search for the name of a competing company in the mailbox of a user named User5.","type":"unstyled","data":{},"depth":0},{"text":"You need to ensure that Admin1 can search the mailbox of User5 successfully. The solution must prevent Admin1 from sending email messages as User5.","depth":0,"entityRanges":[],"data":{},"type":"unstyled","key":"fbuvd","inlineStyleRanges":[]},{"depth":0,"text":"Solution: You start a message trace, and then create a Data Subject Request (DSR) case.","type":"unstyled","inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"e20h4"},{"data":{},"entityRanges":[],"type":"unstyled","text":"Does this meet the goal?","inlineStyleRanges":[],"key":"2fg2","depth":0}],"entityMap":{}},"answers":[{"value":"Yes","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"No"}],"references":{"blocks":[{"type":"unstyled","entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/exchange/policy-and-compliance/ediscovery/ediscovery?view=exchserver-2019","key":"9ipr5"}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
