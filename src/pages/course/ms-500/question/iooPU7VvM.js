...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription that contains 1,000 user mailboxes.","data":{},"key":"bgf7r","type":"unstyled"},{"inlineStyleRanges":[],"data":{},"type":"unstyled","key":"7e3r0","text":"An administrator named Admin1 must be able to search for the name of a competing company in the mailbox of a user named User5.","depth":0,"entityRanges":[]},{"data":{},"type":"unstyled","entityRanges":[],"text":"You need to ensure that Admin1 can search the mailbox of User5 successfully. The solution must prevent Admin1 from sending email messages as User5.","key":"fbuvd","depth":0,"inlineStyleRanges":[]},{"key":"e20h4","entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"depth":0,"text":"Solution: You start a message trace, and then create a Data Subject Request (DSR) case.","data":{}},{"text":"Does this meet the goal?","key":"2fg2","data":{},"depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[]}],"entityMap":{}},"id":"iooPU7VvM","answers":[{"value":"Yes","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"No"}],"references":{"blocks":[{"key":"9ipr5","depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{},"text":"https://docs.microsoft.com/en-us/exchange/policy-and-compliance/ediscovery/ediscovery?view=exchserver-2019"}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
