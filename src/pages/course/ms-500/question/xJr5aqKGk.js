...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User 1 will be blocked from signing in"},{"value":"User 1 will be able to sign in without MFA","isCorrectAnswer":true},{"value":"User 1 will be prompted for MFA before signing in","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User 2 will be blocked from signing in"},{"isCorrectAnswer":false,"value":"User 2 will be able to sign in without MFA"},{"value":"User 2 will be prompted for MFA before signing in","isCorrectAnswer":false}],"id":"xJr5aqKGk","question":{"blocks":[{"type":"unstyled","entityRanges":[],"depth":0,"key":"9h023","data":{},"inlineStyleRanges":[],"text":"You have a Microsoft 365 tenant named GitBit.org that contains the following users:"},{"text":" ","depth":0,"entityRanges":[{"key":0,"offset":0,"length":1}],"type":"atomic","data":{},"key":"17ndt","inlineStyleRanges":[]},{"inlineStyleRanges":[],"type":"unstyled","text":"You create an Azure AD Identity Protection sign-in risk policy.","entityRanges":[],"depth":0,"key":"dn9c4","data":{}},{"entityRanges":[],"type":"unstyled","data":{},"key":"crs1t","inlineStyleRanges":[{"length":7,"offset":30,"style":"BOLD"},{"offset":41,"style":"BOLD","length":15}],"text":"You've assigned the policy to GroupA and excluded GroupB.","depth":0},{"text":"You've set the sign-in risk condition to low and above.","depth":0,"key":"ceebf","type":"unstyled","entityRanges":[],"inlineStyleRanges":[{"offset":41,"length":13,"style":"BOLD"}],"data":{}},{"data":{},"key":"de801","depth":0,"type":"unstyled","inlineStyleRanges":[{"length":25,"style":"BOLD","offset":33}],"entityRanges":[],"text":"You've set the access control to Allow access, require MFA"},{"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"You need to understand how the policy will affect your users.","data":{},"key":"8daa5","depth":0},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","key":"84q3k","text":"What will happen when one of the user's signs in from an anonymous IP address?","depth":0}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"alt":"Char showing User1 and User2 that has Group memberships","alignment":"left","width":"auto","src":"https://i.ibb.co/rtkchN3/user-groups.png","height":"auto"}}}},"references":{"blocks":[{"entityRanges":[],"type":"unstyled","data":{},"key":"9c8uc","depth":0,"inlineStyleRanges":[],"text":"User1 is excluded from the policy because excluding GroupB takes precedence over the inclusion of GroupA."},{"key":"d20ah","data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"User2 is blocked from signing in because the MFA status for the user is Disabled. Once User2 configures their MFA then they'll be able to log in with MFA."},{"type":"unstyled","depth":0,"key":"3ktpn","entityRanges":[{"key":0,"length":123,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","data":{},"inlineStyleRanges":[]}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
