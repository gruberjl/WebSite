...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User 1 will be blocked from signing in","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User 1 will be able to sign in without MFA"},{"value":"User 1 will be prompted for MFA before signing in","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User 2 will be blocked from signing in"},{"value":"User 2 will be able to sign in without MFA","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"User 2 will be prompted for MFA before signing in"}],"id":"xJr5aqKGk","question":{"entityMap":{"0":{"type":"IMAGE","data":{"alignment":"left","width":"auto","src":"https://i.ibb.co/rtkchN3/user-groups.png","alt":"Char showing User1 and User2 that has Group memberships","height":"auto"},"mutability":"MUTABLE"}},"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unstyled","data":{},"key":"9h023","text":"You have a Microsoft 365 tenant named GitBit.org that contains the following users:"},{"key":"17ndt","type":"atomic","inlineStyleRanges":[],"entityRanges":[{"key":0,"offset":0,"length":1}],"data":{},"depth":0,"text":" "},{"key":"dn9c4","text":"You create an Azure AD Identity Protection sign-in risk policy.","inlineStyleRanges":[],"depth":0,"entityRanges":[],"data":{},"type":"unstyled"},{"depth":0,"text":"You've assigned the policy to GroupA and excluded GroupB.","type":"unstyled","key":"crs1t","inlineStyleRanges":[{"style":"BOLD","length":7,"offset":30},{"offset":41,"style":"BOLD","length":15}],"entityRanges":[],"data":{}},{"key":"ceebf","entityRanges":[],"type":"unstyled","text":"You've set the sign-in risk condition to low and above.","depth":0,"inlineStyleRanges":[{"offset":41,"length":13,"style":"BOLD"}],"data":{}},{"data":{},"inlineStyleRanges":[{"style":"BOLD","offset":33,"length":25}],"depth":0,"entityRanges":[],"key":"de801","text":"You've set the access control to Allow access, require MFA","type":"unstyled"},{"depth":0,"data":{},"inlineStyleRanges":[],"key":"8daa5","type":"unstyled","text":"You need to understand how the policy will affect your users.","entityRanges":[]},{"inlineStyleRanges":[],"depth":0,"key":"84q3k","data":{},"text":"What will happen when one of the user's signs in from an anonymous IP address?","type":"unstyled","entityRanges":[]}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"}}},"blocks":[{"text":"User1 is excluded from the policy because excluding GroupB takes precedence over the inclusion of GroupA.","data":{},"inlineStyleRanges":[],"key":"9c8uc","type":"unstyled","entityRanges":[],"depth":0},{"text":"User2 is blocked from signing in because the MFA status for the user is Disabled. Once User2 configures their MFA then they'll be able to log in with MFA.","data":{},"type":"unstyled","depth":0,"key":"d20ah","inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[{"length":123,"offset":0,"key":0}],"data":{},"depth":0,"key":"3ktpn","type":"unstyled","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
