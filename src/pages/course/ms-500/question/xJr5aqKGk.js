...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User 1 will be blocked from signing in"},{"isCorrectAnswer":true,"value":"User 1 will be able to sign in without MFA"},{"isCorrectAnswer":false,"value":"User 1 will be prompted for MFA before signing in"},{"value":"User 2 will be blocked from signing in","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"User 2 will be able to sign in without MFA"},{"value":"User 2 will be prompted for MFA before signing in","isCorrectAnswer":false}],"id":"xJr5aqKGk","question":{"entityMap":{"0":{"type":"IMAGE","data":{"height":"auto","width":"auto","alt":"Char showing User1 and User2 that has Group memberships","src":"https://i.ibb.co/rtkchN3/user-groups.png","alignment":"left"},"mutability":"MUTABLE"}},"blocks":[{"data":{},"entityRanges":[],"depth":0,"text":"You have a Microsoft 365 tenant named GitBit.org that contains the following users:","inlineStyleRanges":[],"type":"unstyled","key":"9h023"},{"depth":0,"inlineStyleRanges":[],"text":" ","key":"17ndt","data":{},"type":"atomic","entityRanges":[{"length":1,"key":0,"offset":0}]},{"key":"dn9c4","data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"You create an Azure AD Identity Protection sign-in risk policy.","depth":0,"type":"unstyled"},{"text":"You've assigned the policy to GroupA and excluded GroupB.","key":"crs1t","type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[{"length":7,"offset":30,"style":"BOLD"},{"style":"BOLD","offset":41,"length":15}],"depth":0},{"depth":0,"type":"unstyled","inlineStyleRanges":[{"offset":41,"length":13,"style":"BOLD"}],"entityRanges":[],"key":"ceebf","data":{},"text":"You've set the sign-in risk condition to low and above."},{"inlineStyleRanges":[{"style":"BOLD","length":25,"offset":33}],"type":"unstyled","depth":0,"text":"You've set the access control to Allow access, require MFA","entityRanges":[],"data":{},"key":"de801"},{"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"8daa5","entityRanges":[],"depth":0,"text":"You need to understand how the policy will affect your users."},{"key":"84q3k","depth":0,"type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"What will happen when one of the user's signs in from an anonymous IP address?"}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"}}},"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"depth":0,"data":{},"text":"User1 is excluded from the policy because excluding GroupB takes precedence over the inclusion of GroupA.","type":"unstyled","key":"9c8uc"},{"depth":0,"text":"User2 is blocked from signing in because the MFA status for the user is Disabled. Once User2 configures their MFA then they'll be able to log in with MFA.","type":"unstyled","inlineStyleRanges":[],"key":"d20ah","entityRanges":[],"data":{}},{"key":"3ktpn","entityRanges":[{"length":123,"key":0,"offset":0}],"data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
