...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User 1 will be blocked from signing in","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User 1 will be able to sign in without MFA"},{"isCorrectAnswer":false,"value":"User 1 will be prompted for MFA before signing in"},{"value":"User 2 will be blocked from signing in","isCorrectAnswer":true},{"value":"User 2 will be able to sign in without MFA","isCorrectAnswer":false},{"value":"User 2 will be prompted for MFA before signing in","isCorrectAnswer":false}],"id":"xJr5aqKGk","question":{"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"text":"You have a Microsoft 365 tenant named GitBit.org that contains the following users:","key":"9h023","depth":0,"data":{},"type":"unstyled"},{"depth":0,"inlineStyleRanges":[],"text":" ","type":"atomic","entityRanges":[{"length":1,"offset":0,"key":0}],"key":"17ndt","data":{}},{"entityRanges":[],"data":{},"type":"unstyled","depth":0,"key":"dn9c4","inlineStyleRanges":[],"text":"You create an Azure AD Identity Protection sign-in risk policy."},{"type":"unstyled","inlineStyleRanges":[{"style":"BOLD","offset":30,"length":7},{"length":15,"style":"BOLD","offset":41}],"entityRanges":[],"data":{},"depth":0,"key":"crs1t","text":"You've assigned the policy to GroupA and excluded GroupB."},{"inlineStyleRanges":[{"length":13,"style":"BOLD","offset":41}],"depth":0,"data":{},"text":"You've set the sign-in risk condition to low and above.","type":"unstyled","key":"ceebf","entityRanges":[]},{"data":{},"inlineStyleRanges":[{"style":"BOLD","length":25,"offset":33}],"type":"unstyled","entityRanges":[],"key":"de801","depth":0,"text":"You've set the access control to Allow access, require MFA"},{"text":"You need to understand how the policy will affect your users.","key":"8daa5","depth":0,"inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unstyled"},{"entityRanges":[],"type":"unstyled","depth":0,"key":"84q3k","inlineStyleRanges":[],"data":{},"text":"What will happen when one of the user's signs in from an anonymous IP address?"}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"alt":"Char showing User1 and User2 that has Group memberships","src":"https://i.ibb.co/rtkchN3/user-groups.png","width":"auto","alignment":"left","height":"auto"}}}},"references":{"blocks":[{"data":{},"type":"unstyled","key":"9c8uc","entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"User1 is excluded from the policy because excluding GroupB takes precedence over the inclusion of GroupA."},{"text":"User2 is blocked from signing in because the MFA status for the user is Disabled. Once User2 configures their MFA then they'll be able to log in with MFA.","entityRanges":[],"depth":0,"data":{},"type":"unstyled","key":"d20ah","inlineStyleRanges":[]},{"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","entityRanges":[{"offset":0,"length":123,"key":0}],"type":"unstyled","key":"3ktpn","depth":0,"data":{},"inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
