...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User 1 will be blocked from signing in","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User 1 will be able to sign in without MFA"},{"value":"User 1 will be prompted for MFA before signing in","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User 2 will be blocked from signing in"},{"value":"User 2 will be able to sign in without MFA","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"User 2 will be prompted for MFA before signing in"}],"id":"xJr5aqKGk","question":{"blocks":[{"entityRanges":[],"data":{},"type":"unstyled","inlineStyleRanges":[],"depth":0,"text":"You have a Microsoft 365 tenant named GitBit.org that contains the following users:","key":"9h023"},{"data":{},"inlineStyleRanges":[],"entityRanges":[{"length":1,"offset":0,"key":0}],"type":"atomic","text":" ","key":"17ndt","depth":0},{"inlineStyleRanges":[],"type":"unstyled","key":"dn9c4","data":{},"text":"You create an Azure AD Identity Protection sign-in risk policy.","entityRanges":[],"depth":0},{"data":{},"key":"crs1t","depth":0,"type":"unstyled","entityRanges":[],"inlineStyleRanges":[{"style":"BOLD","length":7,"offset":30},{"style":"BOLD","offset":41,"length":15}],"text":"You've assigned the policy to GroupA and excluded GroupB."},{"entityRanges":[],"depth":0,"text":"You've set the sign-in risk condition to low and above.","key":"ceebf","type":"unstyled","inlineStyleRanges":[{"style":"BOLD","offset":41,"length":13}],"data":{}},{"type":"unstyled","key":"de801","entityRanges":[],"data":{},"text":"You've set the access control to Allow access, require MFA","depth":0,"inlineStyleRanges":[{"style":"BOLD","length":25,"offset":33}]},{"key":"8daa5","inlineStyleRanges":[],"entityRanges":[],"text":"You need to understand how the policy will affect your users.","type":"unstyled","data":{},"depth":0},{"key":"84q3k","entityRanges":[],"depth":0,"type":"unstyled","data":{},"text":"What will happen when one of the user's signs in from an anonymous IP address?","inlineStyleRanges":[]}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","width":"auto","src":"https://i.ibb.co/rtkchN3/user-groups.png","alt":"Char showing User1 and User2 that has Group memberships","alignment":"left"}}}},"references":{"blocks":[{"key":"9c8uc","data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"User1 is excluded from the policy because excluding GroupB takes precedence over the inclusion of GroupA.","depth":0,"type":"unstyled"},{"inlineStyleRanges":[],"text":"User2 is blocked from signing in because the MFA status for the user is Disabled. Once User2 configures their MFA then they'll be able to log in with MFA.","type":"unstyled","entityRanges":[],"key":"d20ah","data":{},"depth":0},{"type":"unstyled","inlineStyleRanges":[],"key":"3ktpn","text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","entityRanges":[{"offset":0,"length":123,"key":0}],"depth":0,"data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
