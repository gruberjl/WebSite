...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User 1 will be blocked from signing in"},{"value":"User 1 will be able to sign in without MFA","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"User 1 will be prompted for MFA before signing in"},{"value":"User 2 will be blocked from signing in","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"User 2 will be able to sign in without MFA"},{"value":"User 2 will be prompted for MFA before signing in","isCorrectAnswer":false}],"id":"xJr5aqKGk","question":{"blocks":[{"key":"9h023","inlineStyleRanges":[],"text":"You have a Microsoft 365 tenant named GitBit.org that contains the following users:","type":"unstyled","depth":0,"entityRanges":[],"data":{}},{"text":" ","entityRanges":[{"length":1,"key":0,"offset":0}],"type":"atomic","key":"17ndt","inlineStyleRanges":[],"depth":0,"data":{}},{"depth":0,"text":"You create an Azure AD Identity Protection sign-in risk policy.","key":"dn9c4","data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[]},{"key":"crs1t","depth":0,"type":"unstyled","entityRanges":[],"inlineStyleRanges":[{"length":7,"style":"BOLD","offset":30},{"style":"BOLD","length":15,"offset":41}],"data":{},"text":"You've assigned the policy to GroupA and excluded GroupB."},{"key":"ceebf","inlineStyleRanges":[{"style":"BOLD","length":13,"offset":41}],"type":"unstyled","text":"You've set the sign-in risk condition to low and above.","entityRanges":[],"data":{},"depth":0},{"data":{},"entityRanges":[],"key":"de801","text":"You've set the access control to Allow access, require MFA","inlineStyleRanges":[{"offset":33,"style":"BOLD","length":25}],"type":"unstyled","depth":0},{"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"8daa5","data":{},"text":"You need to understand how the policy will affect your users.","type":"unstyled"},{"depth":0,"type":"unstyled","key":"84q3k","text":"What will happen when one of the user's signs in from an anonymous IP address?","data":{},"inlineStyleRanges":[],"entityRanges":[]}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"alignment":"left","height":"auto","width":"auto","alt":"Char showing User1 and User2 that has Group memberships","src":"https://i.ibb.co/rtkchN3/user-groups.png"}}}},"references":{"blocks":[{"entityRanges":[],"depth":0,"type":"unstyled","data":{},"inlineStyleRanges":[],"key":"9c8uc","text":"User1 is excluded from the policy because excluding GroupB takes precedence over the inclusion of GroupA."},{"inlineStyleRanges":[],"data":{},"text":"User2 is blocked from signing in because the MFA status for the user is Disabled. Once User2 configures their MFA then they'll be able to log in with MFA.","type":"unstyled","depth":0,"key":"d20ah","entityRanges":[]},{"type":"unstyled","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","depth":0,"key":"3ktpn","entityRanges":[{"key":0,"length":123,"offset":0}],"inlineStyleRanges":[]}],"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
