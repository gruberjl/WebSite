...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Security and compliance admin center grant the user eDiscovery Manager role","isCorrectAnswer":true},{"value":"From the Security and compliance admin center grant the user Data Investigator role","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Microsoft 365 admin center grant the user global admin permissions"}],"id":"2n-EJrfdv","question":{"entityMap":{},"blocks":[{"depth":0,"key":"e6u20","type":"unstyled","entityRanges":[],"data":{},"text":"You need to ensure that a user named Joe Gruber can perform searches and place holds on mailboxes, SharePoint Online sites, and OneDrive for Business locations. The solution must use the principle of least privilege.","inlineStyleRanges":[]},{"depth":0,"type":"unstyled","data":{},"inlineStyleRanges":[{"offset":0,"length":48,"style":"color-rgb(33,37,41)"},{"length":48,"offset":0,"style":"bgcolor-rgb(255,255,255)"},{"offset":0,"length":48,"style":"fontsize-16"},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":48,"offset":0}],"text":"What steps should you take to complete the task?","entityRanges":[],"key":"vvka"}]},"references":{"blocks":[{"depth":0,"inlineStyleRanges":[],"key":"1olit","entityRanges":[],"text":"Global admins can perform what the question is asking but wouldn't use the principle of least privilege. Data investigators can perform searches on mailboxes, SharePoint Online sites, and OneDrive for Business locations but they can't place holds on mailboxes.","type":"unstyled","data":{}},{"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","type":"unstyled","depth":0,"key":"abr","entityRanges":[{"offset":0,"key":0,"length":95}],"inlineStyleRanges":[],"data":{}},{"entityRanges":[{"key":1,"length":115,"offset":0}],"key":"1jdf1","type":"unstyled","depth":0,"text":"https://www.iorad.com/player/1801786/MS-500---ensure-that-a-user-can-perform-searches-and-place-holds-on-mailboxes- ","inlineStyleRanges":[],"data":{}},{"text":"Open the security and compliance admin center","key":"e2k9i","depth":0,"inlineStyleRanges":[],"type":"ordered-list-item","entityRanges":[],"data":{}},{"data":{},"key":"6gepr","depth":0,"text":"Click Permissions","entityRanges":[],"inlineStyleRanges":[],"type":"ordered-list-item"},{"key":"2fhrh","data":{},"text":"Scroll down to the eDiscovery Manager role and click on it.","depth":0,"type":"ordered-list-item","inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[],"type":"ordered-list-item","text":"Click Edit next to the eDiscovery Manager role.","inlineStyleRanges":[],"key":"85enr","depth":0,"data":{}},{"key":"buq8g","data":{},"entityRanges":[],"text":"Click Choose eDiscovery Manager.","type":"ordered-list-item","inlineStyleRanges":[],"depth":0},{"entityRanges":[],"data":{},"depth":0,"text":"Click Add. Add Jo Gruber the role.","key":"96amj","inlineStyleRanges":[],"type":"ordered-list-item"},{"depth":0,"data":{},"key":"3s761","type":"ordered-list-item","entityRanges":[],"text":"Click Done then Save then Close.","inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU"}},"1":{"data":{"url":"https://www.iorad.com/player/1801786/MS-500---ensure-that-a-user-can-perform-searches-and-place-holds-on-mailboxes-","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
