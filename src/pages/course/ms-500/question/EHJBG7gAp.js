...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Configure 10 device exclusions on the automation lists.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Create two alert notification policies."},{"value":"Download and run the offboarding package for the executives' computers.","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Create two machine groups in Microsoft Defender admin center."}],"id":"EHJBG7gAp","question":{"entityMap":{},"blocks":[{"key":"318uf","depth":0,"text":"Your organization is using Microsoft 365 and has 500 computers. You need to protect all the computers using Microsoft Defender for Endpoint. Ten of the devices are used by executives.","inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[]},{"depth":0,"inlineStyleRanges":[],"key":"2emgs","entityRanges":[],"data":{},"type":"unstyled","text":"Your manager explains the requirements to you as follows:"},{"entityRanges":[],"type":"unordered-list-item","key":"3csrt","data":{},"text":"Administrators must manually approve all remediation for any of the executives.","depth":0,"inlineStyleRanges":[]},{"key":"92bbm","inlineStyleRanges":[],"text":"All other users must have remediation performed automatically.","data":{},"depth":0,"entityRanges":[],"type":"unordered-list-item"},{"inlineStyleRanges":[],"depth":0,"entityRanges":[],"data":{},"text":"What should you recommend?","type":"unstyled","key":"4qvot"}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","targetOption":"_blank"}},"1":{"data":{"url":"https://docs.microsoft.com/en-us/windows/security/threat-protection/windows-defender-atp/machine-groups-windows-defender-advanced-threat-protection","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"depth":0,"inlineStyleRanges":[],"key":"agnug","text":"You'll need two machine groups. One for the automated remediation and the other for manual approval.","data":{},"entityRanges":[],"type":"unstyled"},{"type":"unstyled","key":"3270o","depth":0,"inlineStyleRanges":[],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","entityRanges":[{"length":129,"key":0,"offset":0}]},{"text":"https://docs.microsoft.com/en-us/windows/security/threat-protection/windows-defender-atp/machine-groups-windows-defender-advanced-threat-protection","inlineStyleRanges":[],"data":{},"key":"46q9a","entityRanges":[{"length":147,"offset":0,"key":1}],"depth":0,"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
