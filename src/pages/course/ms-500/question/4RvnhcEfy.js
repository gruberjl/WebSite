...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"4RvnhcEfy","question":{"blocks":[{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{},"text":"You have a Microsoft 365 subscription that uses a default domain name of litwareinc.com.","key":"dnpo8"},{"key":"2mcb0","data":{},"text":"You configure the Sharing settings in Microsoft OneDrive as shown in the following exhibit.","depth":0,"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled"},{"data":{},"entityRanges":[{"key":0,"offset":0,"length":1}],"depth":0,"inlineStyleRanges":[],"text":" ","key":"8ogn7","type":"atomic"},{"data":{},"inlineStyleRanges":[],"key":"122r8","type":"unstyled","entityRanges":[],"depth":0,"text":"Click the checkbox next to each correct answer."}],"entityMap":{"0":{"type":"IMAGE","data":{"src":"https://i.ibb.co/nP9z6jR/onedrive-sharing-settings.png","width":"auto","height":"auto","alt":"OneDrive Sharing Settings"},"mutability":"MUTABLE"}}},"answers":[{"value":"A user who has an email address of user1@fabrikam.com cannot access OneDrive content","isCorrectAnswer":true},{"value":"A user who has an email address of user1@fabrikam.com can access OneDrive content after a link is created","isCorrectAnswer":false},{"value":"A user who has an email address of user1@fabrikam.com must be added to a group brfore the user can access shared files","isCorrectAnswer":false},{"value":"If a new guest user is created for user2@contoso.com the user cannot access OneDrive content","isCorrectAnswer":false},{"value":"If a new guest user is created for user2@contoso.com the user can access OneDrive content after a link is created","isCorrectAnswer":true},{"value":"If a new guest user is created for user2@contoso.com must be added to a group before the user can access shared files","isCorrectAnswer":false}],"references":{"blocks":[{"type":"unstyled","inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off","depth":0,"data":{},"key":"52o7v","entityRanges":[]}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
