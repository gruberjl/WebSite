...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"entityMap":{},"blocks":[{"depth":0,"entityRanges":[],"text":"SIMULATION - You need to ensure that group owners renew their Office 365 groups every 180 days. ","inlineStyleRanges":[{"offset":13,"style":"color-rgb(80,80,80)","length":82},{"length":82,"offset":13,"style":"bgcolor-rgb(255,255,255)"},{"offset":13,"style":"fontsize-16","length":82},{"style":"fontfamily-Roboto Condensed\", sans-serif","length":82,"offset":13}],"type":"unstyled","key":"fptda","data":{}}]},"answers":[{"value":"Go to the Microsoft 365 admin center > Groups > Active Groups > Click a group > Group settings","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Go to the Azure Active Directory admin center > Azure Active Directory > Groups > Expiration"},{"value":"Go to the Azure Active Directory admin center > Azure Active Directory > Groups > Groups Settings","isCorrectAnswer":false}],"references":{"entityMap":{},"blocks":[{"type":"unstyled","text":"https://www.iorad.com/player/1796067/MS-500---Ensure-that-group-owners-renew-their-Office-365-groups-every-180-days-","depth":0,"key":"941t8","inlineStyleRanges":[],"entityRanges":[],"data":{}}]},"id":"R9z9unnvI"},
      previousQuestionId: '',
      nextQuestionId: '',
