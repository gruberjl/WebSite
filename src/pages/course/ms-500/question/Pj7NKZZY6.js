...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"A device configuration profile that has device restrictions configured"},{"value":"A device configuration profile that has the Endpoint Protection settings configured","isCorrectAnswer":false},{"value":"A device configuration policy that has the System Security settings configured","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"A device compliance policy that has the Device Health settings configured"}],"id":"Pj7NKZZY6","question":{"blocks":[{"inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription.","key":"k7l7","data":{},"entityRanges":[],"depth":0,"type":"unstyled"},{"key":"2u8na","inlineStyleRanges":[],"depth":0,"data":{},"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","type":"unstyled","entityRanges":[]},{"data":{},"text":"You plan to view only security-related Windows telemetry data.","inlineStyleRanges":[],"depth":0,"entityRanges":[],"type":"unstyled","key":"ftuo9"},{"type":"unstyled","data":{},"entityRanges":[],"text":"You need to ensure that only Windows security data is sent to Microsoft.","inlineStyleRanges":[],"depth":0,"key":"ce2sa"},{"data":{},"type":"unstyled","text":"What should you create from the Intune admin center?","depth":0,"key":"arrfp","entityRanges":[],"inlineStyleRanges":[]}],"entityMap":{}},"references":{"blocks":[{"inlineStyleRanges":[],"key":"7sspj","depth":0,"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create.","entityRanges":[],"data":{},"type":"unstyled"},{"text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","data":{},"type":"unstyled","key":"e8kfh","inlineStyleRanges":[],"entityRanges":[{"length":87,"offset":0,"key":0}],"depth":0},{"inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[{"length":94,"key":1,"offset":0}],"key":"e14v9","depth":0,"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry"}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"},"mutability":"MUTABLE","type":"LINK"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
