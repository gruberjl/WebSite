...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"A device configuration profile that has device restrictions configured"},{"isCorrectAnswer":false,"value":"A device configuration profile that has the Endpoint Protection settings configured"},{"value":"A device configuration policy that has the System Security settings configured","isCorrectAnswer":false},{"value":"A device compliance policy that has the Device Health settings configured","isCorrectAnswer":false}],"id":"Pj7NKZZY6","question":{"entityMap":{},"blocks":[{"text":"You have a Microsoft 365 subscription.","data":{},"key":"k7l7","inlineStyleRanges":[],"type":"unstyled","depth":0,"entityRanges":[]},{"key":"2u8na","depth":0,"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune."},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"You plan to view only security-related Windows telemetry data.","type":"unstyled","key":"ftuo9","depth":0},{"text":"You need to ensure that only Windows security data is sent to Microsoft.","key":"ce2sa","inlineStyleRanges":[],"depth":0,"data":{},"type":"unstyled","entityRanges":[]},{"type":"unstyled","text":"What should you create from the Intune admin center?","key":"arrfp","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[]}]},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","targetOption":"_blank"}}},"blocks":[{"entityRanges":[],"type":"unstyled","data":{},"key":"7sspj","depth":0,"inlineStyleRanges":[],"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create."},{"inlineStyleRanges":[],"type":"unstyled","key":"e8kfh","data":{},"entityRanges":[{"key":0,"offset":0,"length":87}],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"},{"entityRanges":[{"offset":0,"length":94,"key":1}],"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","depth":0,"key":"e14v9"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
