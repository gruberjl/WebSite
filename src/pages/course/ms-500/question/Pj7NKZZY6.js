...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device configuration profile that has device restrictions configured","isCorrectAnswer":true},{"value":"A device configuration profile that has the Endpoint Protection settings configured","isCorrectAnswer":false},{"value":"A device configuration policy that has the System Security settings configured","isCorrectAnswer":false},{"value":"A device compliance policy that has the Device Health settings configured","isCorrectAnswer":false}],"id":"Pj7NKZZY6","question":{"entityMap":{},"blocks":[{"depth":0,"key":"k7l7","text":"You have a Microsoft 365 subscription.","data":{},"inlineStyleRanges":[],"type":"unstyled","entityRanges":[]},{"entityRanges":[],"data":{},"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","type":"unstyled","key":"2u8na","inlineStyleRanges":[],"depth":0},{"key":"ftuo9","depth":0,"type":"unstyled","entityRanges":[],"text":"You plan to view only security-related Windows telemetry data.","data":{},"inlineStyleRanges":[]},{"key":"ce2sa","entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"You need to ensure that only Windows security data is sent to Microsoft.","depth":0,"type":"unstyled"},{"depth":0,"type":"unstyled","entityRanges":[],"data":{},"text":"What should you create from the Intune admin center?","inlineStyleRanges":[],"key":"arrfp"}]},"references":{"blocks":[{"type":"unstyled","entityRanges":[],"key":"7sspj","text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create.","data":{},"depth":0,"inlineStyleRanges":[]},{"entityRanges":[{"key":0,"length":87,"offset":0}],"key":"e8kfh","inlineStyleRanges":[],"data":{},"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","depth":0},{"entityRanges":[{"key":1,"length":94,"offset":0}],"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","inlineStyleRanges":[],"key":"e14v9","depth":0,"data":{},"type":"unstyled"}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"}},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
