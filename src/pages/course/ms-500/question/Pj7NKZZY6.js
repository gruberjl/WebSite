...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device configuration profile that has device restrictions configured","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"A device configuration profile that has the Endpoint Protection settings configured"},{"isCorrectAnswer":false,"value":"A device configuration policy that has the System Security settings configured"},{"value":"A device compliance policy that has the Device Health settings configured","isCorrectAnswer":false}],"id":"Pj7NKZZY6","question":{"entityMap":{},"blocks":[{"data":{},"inlineStyleRanges":[],"key":"k7l7","type":"unstyled","text":"You have a Microsoft 365 subscription.","entityRanges":[],"depth":0},{"key":"2u8na","depth":0,"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","data":{}},{"inlineStyleRanges":[],"text":"You plan to view only security-related Windows telemetry data.","data":{},"entityRanges":[],"type":"unstyled","depth":0,"key":"ftuo9"},{"key":"ce2sa","inlineStyleRanges":[],"data":{},"entityRanges":[],"text":"You need to ensure that only Windows security data is sent to Microsoft.","depth":0,"type":"unstyled"},{"key":"arrfp","type":"unstyled","entityRanges":[],"depth":0,"text":"What should you create from the Intune admin center?","data":{},"inlineStyleRanges":[]}]},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"},"type":"LINK","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry"}}},"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"depth":0,"type":"unstyled","data":{},"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create.","key":"7sspj"},{"data":{},"inlineStyleRanges":[],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","key":"e8kfh","type":"unstyled","entityRanges":[{"key":0,"offset":0,"length":87}]},{"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","type":"unstyled","data":{},"entityRanges":[{"offset":0,"key":1,"length":94}],"inlineStyleRanges":[],"key":"e14v9","depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
