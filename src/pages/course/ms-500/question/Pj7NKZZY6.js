...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device configuration profile that has device restrictions configured","isCorrectAnswer":true},{"value":"A device configuration profile that has the Endpoint Protection settings configured","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"A device configuration policy that has the System Security settings configured"},{"isCorrectAnswer":false,"value":"A device compliance policy that has the Device Health settings configured"}],"id":"Pj7NKZZY6","question":{"entityMap":{},"blocks":[{"type":"unstyled","key":"k7l7","inlineStyleRanges":[],"entityRanges":[],"depth":0,"data":{},"text":"You have a Microsoft 365 subscription."},{"key":"2u8na","type":"unstyled","entityRanges":[],"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","data":{},"inlineStyleRanges":[],"depth":0},{"entityRanges":[],"data":{},"key":"ftuo9","depth":0,"text":"You plan to view only security-related Windows telemetry data.","inlineStyleRanges":[],"type":"unstyled"},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","key":"ce2sa","text":"You need to ensure that only Windows security data is sent to Microsoft.","depth":0},{"inlineStyleRanges":[],"key":"arrfp","type":"unstyled","entityRanges":[],"data":{},"depth":0,"text":"What should you create from the Intune admin center?"}]},"references":{"blocks":[{"depth":0,"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create.","entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"key":"7sspj","data":{}},{"key":"e8kfh","text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","depth":0,"inlineStyleRanges":[],"entityRanges":[{"length":87,"offset":0,"key":0}],"type":"unstyled","data":{}},{"entityRanges":[{"length":94,"offset":0,"key":1}],"depth":0,"type":"unstyled","inlineStyleRanges":[],"key":"e14v9","text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","data":{}}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
