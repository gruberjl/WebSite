...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device configuration profile that has device restrictions configured","isCorrectAnswer":true},{"value":"A device configuration profile that has the Endpoint Protection settings configured","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"A device configuration policy that has the System Security settings configured"},{"isCorrectAnswer":false,"value":"A device compliance policy that has the Device Health settings configured"}],"id":"Pj7NKZZY6","question":{"entityMap":{},"blocks":[{"key":"k7l7","depth":0,"entityRanges":[],"type":"unstyled","data":{},"text":"You have a Microsoft 365 subscription.","inlineStyleRanges":[]},{"depth":0,"inlineStyleRanges":[],"data":{},"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","type":"unstyled","key":"2u8na","entityRanges":[]},{"depth":0,"data":{},"inlineStyleRanges":[],"text":"You plan to view only security-related Windows telemetry data.","entityRanges":[],"type":"unstyled","key":"ftuo9"},{"depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[],"key":"ce2sa","text":"You need to ensure that only Windows security data is sent to Microsoft."},{"type":"unstyled","text":"What should you create from the Intune admin center?","entityRanges":[],"key":"arrfp","depth":0,"data":{},"inlineStyleRanges":[]}]},"references":{"blocks":[{"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"key":"7sspj","depth":0,"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create.","data":{}},{"data":{},"key":"e8kfh","entityRanges":[{"offset":0,"key":0,"length":87}],"text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","depth":0,"type":"unstyled","inlineStyleRanges":[]},{"depth":0,"inlineStyleRanges":[],"entityRanges":[{"length":94,"offset":0,"key":1}],"type":"unstyled","data":{},"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","key":"e14v9"}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"},"mutability":"MUTABLE","type":"LINK"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
