...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device configuration profile that has device restrictions configured","isCorrectAnswer":true},{"value":"A device configuration profile that has the Endpoint Protection settings configured","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"A device configuration policy that has the System Security settings configured"},{"value":"A device compliance policy that has the Device Health settings configured","isCorrectAnswer":false}],"id":"Pj7NKZZY6","question":{"blocks":[{"type":"unstyled","data":{},"key":"k7l7","entityRanges":[],"inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription.","depth":0},{"type":"unstyled","key":"2u8na","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","data":{}},{"text":"You plan to view only security-related Windows telemetry data.","key":"ftuo9","entityRanges":[],"type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[]},{"type":"unstyled","depth":0,"text":"You need to ensure that only Windows security data is sent to Microsoft.","key":"ce2sa","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"key":"arrfp","inlineStyleRanges":[],"type":"unstyled","depth":0,"data":{},"text":"What should you create from the Intune admin center?","entityRanges":[]}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create.","depth":0,"type":"unstyled","key":"7sspj","inlineStyleRanges":[],"data":{}},{"data":{},"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","key":"e8kfh","depth":0,"inlineStyleRanges":[],"entityRanges":[{"key":0,"offset":0,"length":87}]},{"entityRanges":[{"offset":0,"key":1,"length":94}],"depth":0,"inlineStyleRanges":[],"key":"e14v9","data":{},"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","type":"unstyled"}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
