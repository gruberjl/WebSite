...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device configuration profile that has device restrictions configured","isCorrectAnswer":true},{"value":"A device configuration profile that has the Endpoint Protection settings configured","isCorrectAnswer":false},{"value":"A device configuration policy that has the System Security settings configured","isCorrectAnswer":false},{"value":"A device compliance policy that has the Device Health settings configured","isCorrectAnswer":false}],"id":"Pj7NKZZY6","question":{"blocks":[{"key":"k7l7","depth":0,"type":"unstyled","entityRanges":[],"data":{},"text":"You have a Microsoft 365 subscription.","inlineStyleRanges":[]},{"key":"2u8na","type":"unstyled","data":{},"depth":0,"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","entityRanges":[],"inlineStyleRanges":[]},{"text":"You plan to view only security-related Windows telemetry data.","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"key":"ftuo9","data":{},"depth":0},{"key":"ce2sa","text":"You need to ensure that only Windows security data is sent to Microsoft.","inlineStyleRanges":[],"entityRanges":[],"depth":0,"data":{},"type":"unstyled"},{"data":{},"depth":0,"inlineStyleRanges":[],"text":"What should you create from the Intune admin center?","type":"unstyled","entityRanges":[],"key":"arrfp"}],"entityMap":{}},"references":{"blocks":[{"type":"unstyled","inlineStyleRanges":[],"data":{},"key":"7sspj","depth":0,"entityRanges":[],"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create."},{"text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","type":"unstyled","key":"e8kfh","entityRanges":[{"length":87,"key":0,"offset":0}],"depth":0,"data":{},"inlineStyleRanges":[]},{"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":1,"length":94}],"key":"e14v9","depth":0,"data":{},"type":"unstyled"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"}},"1":{"data":{"url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
