...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"A device configuration profile that has device restrictions configured"},{"isCorrectAnswer":false,"value":"A device configuration profile that has the Endpoint Protection settings configured"},{"value":"A device configuration policy that has the System Security settings configured","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"A device compliance policy that has the Device Health settings configured"}],"id":"Pj7NKZZY6","question":{"blocks":[{"depth":0,"inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription.","entityRanges":[],"key":"k7l7","data":{},"type":"unstyled"},{"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","key":"2u8na","data":{},"type":"unstyled","entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"key":"ftuo9","depth":0,"type":"unstyled","data":{},"text":"You plan to view only security-related Windows telemetry data.","inlineStyleRanges":[],"entityRanges":[]},{"key":"ce2sa","entityRanges":[],"data":{},"depth":0,"text":"You need to ensure that only Windows security data is sent to Microsoft.","inlineStyleRanges":[],"type":"unstyled"},{"entityRanges":[],"depth":0,"data":{},"key":"arrfp","type":"unstyled","text":"What should you create from the Intune admin center?","inlineStyleRanges":[]}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry"}}},"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"key":"7sspj","type":"unstyled","depth":0,"data":{},"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create."},{"entityRanges":[{"key":0,"length":87,"offset":0}],"key":"e8kfh","data":{},"type":"unstyled","inlineStyleRanges":[],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"},{"inlineStyleRanges":[],"depth":0,"key":"e14v9","entityRanges":[{"offset":0,"key":1,"length":94}],"data":{},"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
