...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"A device configuration profile that has device restrictions configured"},{"isCorrectAnswer":false,"value":"A device configuration profile that has the Endpoint Protection settings configured"},{"isCorrectAnswer":false,"value":"A device configuration policy that has the System Security settings configured"},{"isCorrectAnswer":false,"value":"A device compliance policy that has the Device Health settings configured"}],"id":"Pj7NKZZY6","question":{"blocks":[{"key":"k7l7","text":"You have a Microsoft 365 subscription.","type":"unstyled","inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[]},{"key":"2u8na","text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","depth":0,"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","data":{}},{"entityRanges":[],"text":"You plan to view only security-related Windows telemetry data.","inlineStyleRanges":[],"depth":0,"data":{},"key":"ftuo9","type":"unstyled"},{"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"ce2sa","data":{},"text":"You need to ensure that only Windows security data is sent to Microsoft."},{"depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"arrfp","text":"What should you create from the Intune admin center?","type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"inlineStyleRanges":[],"type":"unstyled","data":{},"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create.","depth":0,"entityRanges":[],"key":"7sspj"},{"depth":0,"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","key":"e8kfh","entityRanges":[{"key":0,"offset":0,"length":87}]},{"depth":0,"key":"e14v9","data":{},"entityRanges":[{"length":94,"offset":0,"key":1}],"type":"unstyled","inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry"}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","targetOption":"_blank"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
