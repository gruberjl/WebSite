...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"A device configuration profile that has device restrictions configured"},{"isCorrectAnswer":false,"value":"A device configuration profile that has the Endpoint Protection settings configured"},{"isCorrectAnswer":false,"value":"A device configuration policy that has the System Security settings configured"},{"isCorrectAnswer":false,"value":"A device compliance policy that has the Device Health settings configured"}],"id":"Pj7NKZZY6","question":{"blocks":[{"key":"k7l7","entityRanges":[],"type":"unstyled","text":"You have a Microsoft 365 subscription.","data":{},"depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","key":"2u8na"},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"You plan to view only security-related Windows telemetry data.","key":"ftuo9","depth":0},{"depth":0,"data":{},"entityRanges":[],"text":"You need to ensure that only Windows security data is sent to Microsoft.","type":"unstyled","key":"ce2sa","inlineStyleRanges":[]},{"text":"What should you create from the Intune admin center?","depth":0,"inlineStyleRanges":[],"data":{},"type":"unstyled","entityRanges":[],"key":"arrfp"}],"entityMap":{}},"references":{"blocks":[{"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"key":"7sspj","depth":0,"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create.","data":{}},{"entityRanges":[{"offset":0,"key":0,"length":87}],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","depth":0,"key":"e8kfh","type":"unstyled","inlineStyleRanges":[]},{"depth":0,"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","data":{},"key":"e14v9","type":"unstyled","entityRanges":[{"offset":0,"key":1,"length":94}],"inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
