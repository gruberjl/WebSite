...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"A device configuration profile that has device restrictions configured"},{"value":"A device configuration profile that has the Endpoint Protection settings configured","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"A device configuration policy that has the System Security settings configured"},{"value":"A device compliance policy that has the Device Health settings configured","isCorrectAnswer":false}],"id":"Pj7NKZZY6","question":{"blocks":[{"depth":0,"inlineStyleRanges":[],"key":"k7l7","type":"unstyled","data":{},"entityRanges":[],"text":"You have a Microsoft 365 subscription."},{"type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[],"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","entityRanges":[],"key":"2u8na"},{"inlineStyleRanges":[],"text":"You plan to view only security-related Windows telemetry data.","depth":0,"entityRanges":[],"key":"ftuo9","data":{},"type":"unstyled"},{"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"You need to ensure that only Windows security data is sent to Microsoft.","key":"ce2sa","depth":0,"data":{}},{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"data":{},"key":"arrfp","depth":0,"text":"What should you create from the Intune admin center?"}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","targetOption":"_blank"},"mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","targetOption":"_blank"},"type":"LINK"}},"blocks":[{"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create.","entityRanges":[],"type":"unstyled","data":{},"key":"7sspj","depth":0,"inlineStyleRanges":[]},{"key":"e8kfh","entityRanges":[{"key":0,"offset":0,"length":87}],"depth":0,"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","type":"unstyled","inlineStyleRanges":[]},{"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","entityRanges":[{"key":1,"length":94,"offset":0}],"depth":0,"type":"unstyled","inlineStyleRanges":[],"key":"e14v9","data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
