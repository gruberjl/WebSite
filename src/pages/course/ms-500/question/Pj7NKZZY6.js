...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"A device configuration profile that has device restrictions configured"},{"isCorrectAnswer":false,"value":"A device configuration profile that has the Endpoint Protection settings configured"},{"isCorrectAnswer":false,"value":"A device configuration policy that has the System Security settings configured"},{"value":"A device compliance policy that has the Device Health settings configured","isCorrectAnswer":false}],"id":"Pj7NKZZY6","question":{"blocks":[{"text":"You have a Microsoft 365 subscription.","depth":0,"key":"k7l7","data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled"},{"entityRanges":[],"depth":0,"type":"unstyled","data":{},"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","inlineStyleRanges":[],"key":"2u8na"},{"inlineStyleRanges":[],"depth":0,"key":"ftuo9","data":{},"text":"You plan to view only security-related Windows telemetry data.","type":"unstyled","entityRanges":[]},{"text":"You need to ensure that only Windows security data is sent to Microsoft.","data":{},"type":"unstyled","depth":0,"key":"ce2sa","inlineStyleRanges":[],"entityRanges":[]},{"key":"arrfp","depth":0,"type":"unstyled","data":{},"inlineStyleRanges":[],"text":"What should you create from the Intune admin center?","entityRanges":[]}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled","key":"7sspj","text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create."},{"type":"unstyled","key":"e8kfh","inlineStyleRanges":[],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","depth":0,"entityRanges":[{"key":0,"length":87,"offset":0}]},{"key":"e14v9","depth":0,"inlineStyleRanges":[],"data":{},"type":"unstyled","entityRanges":[{"length":94,"key":1,"offset":0}],"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry"}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","targetOption":"_blank"},"type":"LINK"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
