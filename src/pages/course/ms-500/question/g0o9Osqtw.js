...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"User1 can run an antivirus scan on Device1."},{"value":"User2 can collect an investigation package from Device2.","isCorrectAnswer":false},{"value":"User3 can isolate Device1","isCorrectAnswer":true}],"id":"g0o9Osqtw","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"src":"https://i.ibb.co/4RW4mhR/user-group-membership.png","alt":"User Group Membership chart","alignment":"left","width":"auto","height":"auto"},"type":"IMAGE"},"1":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","src":"https://i.ibb.co/Mkq6rTY/role-permissions.png","alt":"Role Permissions chart","width":"auto","alignment":"left"}},"2":{"data":{"alignment":"left","alt":"Machine group access","height":"auto","src":"https://i.ibb.co/5h01sfF/machine-group-access.png","width":"auto"},"type":"IMAGE","mutability":"MUTABLE"}},"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"Your company has a Microsoft 365 subscription that contains the users shown in the following table.","type":"unstyled","key":"dljoj","data":{}},{"entityRanges":[{"offset":0,"key":0,"length":1}],"type":"atomic","depth":0,"key":"8m1v6","inlineStyleRanges":[],"text":" ","data":{}},{"text":"The company implements Microsoft Defender for Endpoints. Microsoft Defender for Endpoints includes the roles shown in the following table:","type":"unstyled","key":"960sq","entityRanges":[],"inlineStyleRanges":[],"depth":0,"data":{}},{"data":{},"key":"476d9","depth":0,"entityRanges":[{"key":1,"offset":0,"length":1}],"text":" ","type":"atomic","inlineStyleRanges":[]},{"depth":0,"data":{},"inlineStyleRanges":[],"text":"Microsoft Defender for Endpoints contains the machine groups shown in the following table:","entityRanges":[],"type":"unstyled","key":"1lkcp"},{"inlineStyleRanges":[],"data":{},"text":" ","type":"atomic","entityRanges":[{"key":2,"offset":0,"length":1}],"key":"3hlpj","depth":0},{"entityRanges":[],"depth":0,"type":"unstyled","key":"f5ss2","text":"For each of the following statements, check the box if the statement is true.","inlineStyleRanges":[],"data":{}}]},"references":{"blocks":[{"entityRanges":[],"key":"9f4m1","depth":0,"text":"User1 has alerts investigation so user1 can run anti-virus scans.","data":{},"inlineStyleRanges":[],"type":"unstyled"},{"inlineStyleRanges":[],"text":"User2 does not have the alerts investigation permission so user2 cannot collect an investigation package","type":"unstyled","key":"cpdh6","depth":0,"data":{},"entityRanges":[]},{"entityRanges":[],"text":"User3 has Active remediation actions so User3 can isolate Device1","depth":0,"key":"e6oda","type":"unstyled","data":{},"inlineStyleRanges":[]},{"data":{},"depth":0,"type":"unstyled","key":"deele","text":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","entityRanges":[{"offset":0,"length":129,"key":0}],"inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
