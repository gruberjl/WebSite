...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Synchronization Service Manager"},{"value":"Azure AD Connect wizard","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Synchronization Rules Editor"},{"isCorrectAnswer":false,"value":"IdFix"}],"id":"B-wB_zqgR","question":{"blocks":[{"entityRanges":[],"key":"4ufo4","text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","depth":0,"data":{},"type":"unstyled","inlineStyleRanges":[]},{"key":"c4img","entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","data":{},"type":"unstyled"},{"entityRanges":[],"inlineStyleRanges":[],"text":"GitBit identifies the following issues:","data":{},"key":"45i9j","depth":0,"type":"unstyled"},{"inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line.","entityRanges":[],"key":"fe0i","data":{}},{"depth":0,"type":"unordered-list-item","key":"aa9gq","text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.","entityRanges":[],"inlineStyleRanges":[],"data":{}},{"text":"You need to resolve the issue that generates the automated email messages to the IT team.","type":"unstyled","inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[],"key":"8ofra"},{"inlineStyleRanges":[],"type":"unstyled","depth":0,"text":"Which tool should you run first?","entityRanges":[],"key":"96grf","data":{}}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"}}},"blocks":[{"data":{},"type":"unstyled","key":"7fdiu","entityRanges":[],"inlineStyleRanges":[],"text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","depth":0},{"inlineStyleRanges":[],"key":"1sh5q","entityRanges":[{"length":69,"key":0,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","type":"unstyled","depth":0,"data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
