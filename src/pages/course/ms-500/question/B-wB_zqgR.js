...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Synchronization Service Manager"},{"isCorrectAnswer":false,"value":"Azure AD Connect wizard"},{"isCorrectAnswer":false,"value":"Synchronization Rules Editor"},{"value":"IdFix","isCorrectAnswer":false}],"id":"B-wB_zqgR","question":{"entityMap":{},"blocks":[{"text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","depth":0,"data":{},"inlineStyleRanges":[],"key":"4ufo4","entityRanges":[],"type":"unstyled"},{"entityRanges":[],"data":{},"text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","key":"c4img","depth":0,"type":"unstyled","inlineStyleRanges":[]},{"entityRanges":[],"type":"unstyled","data":{},"inlineStyleRanges":[],"key":"45i9j","text":"GitBit identifies the following issues:","depth":0},{"inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line.","data":{},"entityRanges":[],"key":"fe0i"},{"depth":0,"text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"data":{},"key":"aa9gq"},{"text":"You need to resolve the issue that generates the automated email messages to the IT team.","key":"8ofra","inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[],"data":{}},{"text":"Which tool should you run first?","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","data":{},"key":"96grf","depth":0}]},"references":{"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"},"mutability":"MUTABLE"}},"blocks":[{"key":"7fdiu","type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{},"entityRanges":[],"text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed."},{"data":{},"key":"1sh5q","inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":69,"key":0}],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
