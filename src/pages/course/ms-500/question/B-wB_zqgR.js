...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Synchronization Service Manager","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Azure AD Connect wizard"},{"value":"Synchronization Rules Editor","isCorrectAnswer":false},{"value":"IdFix","isCorrectAnswer":false}],"id":"B-wB_zqgR","question":{"entityMap":{},"blocks":[{"text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"key":"4ufo4","data":{},"depth":0},{"text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","type":"unstyled","depth":0,"key":"c4img","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"inlineStyleRanges":[],"key":"45i9j","type":"unstyled","entityRanges":[],"data":{},"depth":0,"text":"GitBit identifies the following issues:"},{"type":"unordered-list-item","key":"fe0i","depth":0,"entityRanges":[],"text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line.","data":{},"inlineStyleRanges":[]},{"type":"unordered-list-item","key":"aa9gq","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming."},{"key":"8ofra","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"You need to resolve the issue that generates the automated email messages to the IT team."},{"type":"unstyled","depth":0,"entityRanges":[],"key":"96grf","text":"Which tool should you run first?","data":{},"inlineStyleRanges":[]}]},"references":{"blocks":[{"data":{},"inlineStyleRanges":[],"key":"7fdiu","type":"unstyled","entityRanges":[],"text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","depth":0},{"inlineStyleRanges":[],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","key":"1sh5q","type":"unstyled","depth":0,"entityRanges":[{"key":0,"length":69,"offset":0}]}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
