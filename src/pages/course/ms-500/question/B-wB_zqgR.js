...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Synchronization Service Manager"},{"value":"Azure AD Connect wizard","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Synchronization Rules Editor"},{"value":"IdFix","isCorrectAnswer":false}],"id":"B-wB_zqgR","question":{"blocks":[{"type":"unstyled","depth":0,"key":"4ufo4","entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment."},{"entityRanges":[],"data":{},"text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","key":"c4img","inlineStyleRanges":[],"depth":0,"type":"unstyled"},{"type":"unstyled","entityRanges":[],"data":{},"key":"45i9j","text":"GitBit identifies the following issues:","depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"type":"unordered-list-item","key":"fe0i","data":{},"depth":0,"inlineStyleRanges":[],"text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line."},{"key":"aa9gq","entityRanges":[],"depth":0,"type":"unordered-list-item","data":{},"inlineStyleRanges":[],"text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming."},{"key":"8ofra","data":{},"depth":0,"entityRanges":[],"text":"You need to resolve the issue that generates the automated email messages to the IT team.","inlineStyleRanges":[],"type":"unstyled"},{"depth":0,"data":{},"entityRanges":[],"type":"unstyled","key":"96grf","inlineStyleRanges":[],"text":"Which tool should you run first?"}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"}}},"blocks":[{"entityRanges":[],"key":"7fdiu","type":"unstyled","data":{},"text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","depth":0,"inlineStyleRanges":[]},{"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","key":"1sh5q","depth":0,"inlineStyleRanges":[],"data":{},"entityRanges":[{"length":69,"offset":0,"key":0}],"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
