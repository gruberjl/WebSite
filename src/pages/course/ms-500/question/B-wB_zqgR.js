...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Synchronization Service Manager","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Azure AD Connect wizard"},{"value":"Synchronization Rules Editor","isCorrectAnswer":false},{"value":"IdFix","isCorrectAnswer":false}],"id":"B-wB_zqgR","question":{"blocks":[{"key":"4ufo4","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","depth":0,"data":{}},{"entityRanges":[],"key":"c4img","type":"unstyled","inlineStyleRanges":[],"depth":0,"data":{},"text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription."},{"key":"45i9j","depth":0,"type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"GitBit identifies the following issues:"},{"key":"fe0i","data":{},"depth":0,"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line."},{"inlineStyleRanges":[],"data":{},"text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.","type":"unordered-list-item","depth":0,"entityRanges":[],"key":"aa9gq"},{"key":"8ofra","inlineStyleRanges":[],"data":{},"text":"You need to resolve the issue that generates the automated email messages to the IT team.","depth":0,"type":"unstyled","entityRanges":[]},{"type":"unstyled","depth":0,"data":{},"text":"Which tool should you run first?","entityRanges":[],"inlineStyleRanges":[],"key":"96grf"}],"entityMap":{}},"references":{"blocks":[{"depth":0,"text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","key":"7fdiu","entityRanges":[],"type":"unstyled","data":{},"inlineStyleRanges":[]},{"type":"unstyled","inlineStyleRanges":[],"data":{},"entityRanges":[{"key":0,"offset":0,"length":69}],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","key":"1sh5q","depth":0}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
