...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Synchronization Service Manager"},{"value":"Azure AD Connect wizard","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Synchronization Rules Editor"},{"value":"IdFix","isCorrectAnswer":false}],"id":"B-wB_zqgR","question":{"blocks":[{"entityRanges":[],"data":{},"type":"unstyled","text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","key":"4ufo4","inlineStyleRanges":[],"depth":0},{"data":{},"key":"c4img","entityRanges":[],"type":"unstyled","text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","depth":0,"inlineStyleRanges":[]},{"data":{},"key":"45i9j","entityRanges":[],"type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"GitBit identifies the following issues:"},{"data":{},"depth":0,"text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line.","entityRanges":[],"inlineStyleRanges":[],"type":"unordered-list-item","key":"fe0i"},{"key":"aa9gq","depth":0,"text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.","entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unordered-list-item"},{"inlineStyleRanges":[],"text":"You need to resolve the issue that generates the automated email messages to the IT team.","type":"unstyled","entityRanges":[],"key":"8ofra","depth":0,"data":{}},{"data":{},"inlineStyleRanges":[],"text":"Which tool should you run first?","entityRanges":[],"depth":0,"type":"unstyled","key":"96grf"}],"entityMap":{}},"references":{"blocks":[{"data":{},"key":"7fdiu","depth":0,"inlineStyleRanges":[],"text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","type":"unstyled","entityRanges":[]},{"depth":0,"type":"unstyled","entityRanges":[{"offset":0,"length":69,"key":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","data":{},"key":"1sh5q","inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
