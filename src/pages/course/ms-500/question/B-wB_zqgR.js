...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Synchronization Service Manager","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Azure AD Connect wizard"},{"value":"Synchronization Rules Editor","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"IdFix"}],"id":"B-wB_zqgR","question":{"blocks":[{"text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","entityRanges":[],"data":{},"type":"unstyled","inlineStyleRanges":[],"key":"4ufo4","depth":0},{"type":"unstyled","data":{},"key":"c4img","text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","depth":0,"entityRanges":[],"inlineStyleRanges":[]},{"depth":0,"text":"GitBit identifies the following issues:","type":"unstyled","data":{},"key":"45i9j","inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[],"text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line.","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"data":{},"key":"fe0i"},{"key":"aa9gq","type":"unordered-list-item","entityRanges":[],"data":{},"text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.","inlineStyleRanges":[],"depth":0},{"type":"unstyled","text":"You need to resolve the issue that generates the automated email messages to the IT team.","depth":0,"entityRanges":[],"data":{},"key":"8ofra","inlineStyleRanges":[]},{"data":{},"text":"Which tool should you run first?","entityRanges":[],"key":"96grf","inlineStyleRanges":[],"type":"unstyled","depth":0}],"entityMap":{}},"references":{"blocks":[{"text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","inlineStyleRanges":[],"depth":0,"key":"7fdiu","entityRanges":[],"type":"unstyled","data":{}},{"depth":0,"inlineStyleRanges":[],"data":{},"key":"1sh5q","type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","entityRanges":[{"offset":0,"length":69,"key":0}]}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
