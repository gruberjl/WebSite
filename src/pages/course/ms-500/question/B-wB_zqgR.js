...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Synchronization Service Manager"},{"value":"Azure AD Connect wizard","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Synchronization Rules Editor"},{"value":"IdFix","isCorrectAnswer":false}],"id":"B-wB_zqgR","question":{"blocks":[{"text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","key":"4ufo4","entityRanges":[],"data":{},"depth":0,"type":"unstyled","inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0,"data":{},"key":"c4img","text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription."},{"data":{},"key":"45i9j","inlineStyleRanges":[],"text":"GitBit identifies the following issues:","type":"unstyled","depth":0,"entityRanges":[]},{"data":{},"type":"unordered-list-item","key":"fe0i","text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line.","depth":0,"entityRanges":[],"inlineStyleRanges":[]},{"key":"aa9gq","entityRanges":[],"inlineStyleRanges":[],"text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.","type":"unordered-list-item","depth":0,"data":{}},{"entityRanges":[],"data":{},"type":"unstyled","key":"8ofra","text":"You need to resolve the issue that generates the automated email messages to the IT team.","depth":0,"inlineStyleRanges":[]},{"data":{},"type":"unstyled","key":"96grf","inlineStyleRanges":[],"entityRanges":[],"text":"Which tool should you run first?","depth":0}],"entityMap":{}},"references":{"blocks":[{"type":"unstyled","depth":0,"entityRanges":[],"key":"7fdiu","inlineStyleRanges":[],"text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","data":{}},{"entityRanges":[{"key":0,"offset":0,"length":69}],"data":{},"key":"1sh5q","depth":0,"inlineStyleRanges":[],"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
