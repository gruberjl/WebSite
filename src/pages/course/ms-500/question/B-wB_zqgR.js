...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Synchronization Service Manager","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Azure AD Connect wizard"},{"isCorrectAnswer":false,"value":"Synchronization Rules Editor"},{"value":"IdFix","isCorrectAnswer":false}],"id":"B-wB_zqgR","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"key":"4ufo4","depth":0,"text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","type":"unstyled","entityRanges":[],"data":{}},{"text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","inlineStyleRanges":[],"entityRanges":[],"depth":0,"key":"c4img","data":{},"type":"unstyled"},{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"data":{},"text":"GitBit identifies the following issues:","key":"45i9j","depth":0},{"key":"fe0i","depth":0,"data":{},"text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line.","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"data":{},"key":"aa9gq","inlineStyleRanges":[],"type":"unordered-list-item","text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming."},{"entityRanges":[],"data":{},"key":"8ofra","inlineStyleRanges":[],"depth":0,"text":"You need to resolve the issue that generates the automated email messages to the IT team.","type":"unstyled"},{"depth":0,"key":"96grf","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"text":"Which tool should you run first?","data":{}}]},"references":{"blocks":[{"key":"7fdiu","text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","data":{},"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0},{"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","key":"1sh5q","entityRanges":[{"length":69,"key":0,"offset":0}],"type":"unstyled","depth":0,"inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
