...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Synchronization Service Manager"},{"isCorrectAnswer":false,"value":"Azure AD Connect wizard"},{"isCorrectAnswer":false,"value":"Synchronization Rules Editor"},{"value":"IdFix","isCorrectAnswer":false}],"id":"B-wB_zqgR","question":{"blocks":[{"entityRanges":[],"type":"unstyled","depth":0,"data":{},"inlineStyleRanges":[],"text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","key":"4ufo4"},{"data":{},"type":"unstyled","key":"c4img","depth":0,"entityRanges":[],"text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","inlineStyleRanges":[]},{"text":"GitBit identifies the following issues:","entityRanges":[],"key":"45i9j","depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled"},{"entityRanges":[],"depth":0,"text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line.","type":"unordered-list-item","key":"fe0i","data":{},"inlineStyleRanges":[]},{"type":"unordered-list-item","depth":0,"data":{},"key":"aa9gq","text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.","entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[],"key":"8ofra","depth":0,"data":{},"text":"You need to resolve the issue that generates the automated email messages to the IT team.","type":"unstyled","inlineStyleRanges":[]},{"inlineStyleRanges":[],"depth":0,"text":"Which tool should you run first?","type":"unstyled","data":{},"entityRanges":[],"key":"96grf"}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"}}},"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unstyled","text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","key":"7fdiu","depth":0},{"data":{},"type":"unstyled","key":"1sh5q","text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":69,"key":0}],"depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
