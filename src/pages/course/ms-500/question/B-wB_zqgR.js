...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Synchronization Service Manager"},{"value":"Azure AD Connect wizard","isCorrectAnswer":false},{"value":"Synchronization Rules Editor","isCorrectAnswer":false},{"value":"IdFix","isCorrectAnswer":false}],"id":"B-wB_zqgR","question":{"entityMap":{},"blocks":[{"depth":0,"data":{},"type":"unstyled","key":"4ufo4","entityRanges":[],"text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","inlineStyleRanges":[]},{"entityRanges":[],"text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","depth":0,"data":{},"inlineStyleRanges":[],"key":"c4img","type":"unstyled"},{"depth":0,"entityRanges":[],"type":"unstyled","data":{},"text":"GitBit identifies the following issues:","inlineStyleRanges":[],"key":"45i9j"},{"inlineStyleRanges":[],"text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line.","entityRanges":[],"data":{},"key":"fe0i","depth":0,"type":"unordered-list-item"},{"type":"unordered-list-item","data":{},"depth":0,"inlineStyleRanges":[],"text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.","entityRanges":[],"key":"aa9gq"},{"depth":0,"type":"unstyled","inlineStyleRanges":[],"data":{},"key":"8ofra","text":"You need to resolve the issue that generates the automated email messages to the IT team.","entityRanges":[]},{"inlineStyleRanges":[],"data":{},"type":"unstyled","text":"Which tool should you run first?","key":"96grf","depth":0,"entityRanges":[]}]},"references":{"blocks":[{"data":{},"depth":0,"type":"unstyled","entityRanges":[],"key":"7fdiu","text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","inlineStyleRanges":[]},{"entityRanges":[{"length":69,"key":0,"offset":0}],"inlineStyleRanges":[],"depth":0,"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","key":"1sh5q","data":{}}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
