...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Synchronization Service Manager","isCorrectAnswer":true},{"value":"Azure AD Connect wizard","isCorrectAnswer":false},{"value":"Synchronization Rules Editor","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"IdFix"}],"id":"B-wB_zqgR","question":{"blocks":[{"depth":0,"text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","data":{},"type":"unstyled","entityRanges":[],"key":"4ufo4","inlineStyleRanges":[]},{"depth":0,"text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","entityRanges":[],"inlineStyleRanges":[],"key":"c4img","data":{},"type":"unstyled"},{"key":"45i9j","data":{},"inlineStyleRanges":[],"text":"GitBit identifies the following issues:","depth":0,"type":"unstyled","entityRanges":[]},{"depth":0,"data":{},"inlineStyleRanges":[],"key":"fe0i","type":"unordered-list-item","entityRanges":[],"text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line."},{"inlineStyleRanges":[],"depth":0,"data":{},"text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.","key":"aa9gq","entityRanges":[],"type":"unordered-list-item"},{"entityRanges":[],"key":"8ofra","data":{},"type":"unstyled","depth":0,"text":"You need to resolve the issue that generates the automated email messages to the IT team.","inlineStyleRanges":[]},{"inlineStyleRanges":[],"text":"Which tool should you run first?","key":"96grf","entityRanges":[],"depth":0,"data":{},"type":"unstyled"}],"entityMap":{}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"}}},"blocks":[{"depth":0,"data":{},"key":"7fdiu","text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","entityRanges":[],"type":"unstyled","inlineStyleRanges":[]},{"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","key":"1sh5q","inlineStyleRanges":[],"type":"unstyled","entityRanges":[{"key":0,"offset":0,"length":69}],"depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
