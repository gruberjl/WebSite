...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Synchronization Service Manager","isCorrectAnswer":true},{"value":"Azure AD Connect wizard","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Synchronization Rules Editor"},{"value":"IdFix","isCorrectAnswer":false}],"id":"B-wB_zqgR","question":{"blocks":[{"data":{},"key":"4ufo4","depth":0,"type":"unstyled","text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","entityRanges":[],"inlineStyleRanges":[]},{"text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","type":"unstyled","entityRanges":[],"key":"c4img","inlineStyleRanges":[],"depth":0,"data":{}},{"inlineStyleRanges":[],"text":"GitBit identifies the following issues:","type":"unstyled","entityRanges":[],"depth":0,"key":"45i9j","data":{}},{"entityRanges":[],"data":{},"text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line.","key":"fe0i","depth":0,"inlineStyleRanges":[],"type":"unordered-list-item"},{"inlineStyleRanges":[],"entityRanges":[],"key":"aa9gq","text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.","type":"unordered-list-item","depth":0,"data":{}},{"entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"8ofra","text":"You need to resolve the issue that generates the automated email messages to the IT team."},{"entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[],"text":"Which tool should you run first?","type":"unstyled","key":"96grf"}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"}}},"blocks":[{"data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"7fdiu","text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","type":"unstyled","depth":0},{"entityRanges":[{"key":0,"length":69,"offset":0}],"depth":0,"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","type":"unstyled","data":{},"key":"1sh5q"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
