...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Security & Compliance admin center, download a report.","isCorrectAnswer":false},{"value":"From Azure Log Analytics, query the logs.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Security & Compliance admin center, perform an audit log search."},{"isCorrectAnswer":true,"value":"From the Enterprise applications blade of the Azure Active Directory admin center, view the sign-ins."}],"id":"5ledeExCv","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"key":"3d6td","data":{},"text":"You have a Microsoft 365 E5 subscription.","depth":0,"entityRanges":[],"type":"unstyled"},{"data":{},"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"depth":0,"key":"56pai","text":"Some users are required to use an authenticator app to access Microsoft SharePoint Online."},{"text":"You need to view which users have used an authenticator app to access SharePoint Online. The solution must minimize costs.","key":"f5jt4","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"depth":0,"inlineStyleRanges":[],"key":"9ses4","text":"What should you do?","entityRanges":[],"type":"unstyled","data":{}}]},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"},"type":"LINK"},"1":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","targetOption":"_blank"},"mutability":"MUTABLE"}},"blocks":[{"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"You can view the sign-in logs from Azure Active Directory admin center > Enterprise applications > Sign-in logs.","key":"18nsd","data":{}},{"inlineStyleRanges":[],"key":"7qvcs","text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","type":"unstyled","data":{},"entityRanges":[{"offset":0,"key":0,"length":105}],"depth":0},{"type":"unstyled","data":{},"depth":0,"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","inlineStyleRanges":[],"key":"e7m5a","entityRanges":[{"length":91,"key":1,"offset":0}]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
