...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Device1"},{"value":"Device2","isCorrectAnswer":true},{"value":"Device6","isCorrectAnswer":true}],"id":"Vw6DPEjhS","question":{"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","alignment":"left","width":"auto","alt":"Devices Chart","src":"https://i.ibb.co/rt25GT1/Devices.png"}},"1":{"type":"IMAGE","data":{"height":"auto","width":"auto","alignment":"left","alt":"Device policies chart","src":"https://i.ibb.co/YZzVcsL/Device-policies.png"},"mutability":"MUTABLE"},"2":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","alignment":"left","width":"auto","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","alt":"Device policy group chart"}}},"blocks":[{"depth":0,"entityRanges":[],"data":{},"type":"unstyled","text":"The devices enrolled in Intune are configured as shown in the following table:","key":"6t3pm","inlineStyleRanges":[]},{"text":" ","key":"9tjo3","inlineStyleRanges":[],"depth":0,"type":"atomic","entityRanges":[{"key":0,"offset":0,"length":1}],"data":{}},{"key":"c0grv","depth":0,"entityRanges":[],"text":"The device compliance policies in Intune are configured as shown in the following table:","data":{},"inlineStyleRanges":[],"type":"unstyled"},{"inlineStyleRanges":[],"depth":0,"entityRanges":[{"key":1,"length":1,"offset":0}],"text":" ","data":{},"key":"99it7","type":"atomic"},{"depth":0,"text":"The device compliance policies have the assignments shown in the following table:","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","data":{},"key":"56p0h"},{"key":"62f10","data":{},"inlineStyleRanges":[],"type":"atomic","depth":0,"text":" ","entityRanges":[{"length":1,"key":2,"offset":0}]},{"depth":0,"type":"unstyled","text":"The Mark devices with no compliance policy are assigned as Compliant.","entityRanges":[],"inlineStyleRanges":[],"key":"a7l90","data":{}},{"key":"16cgt","inlineStyleRanges":[],"text":"You are evaluating which devices are compliant with Intune.","depth":0,"entityRanges":[],"data":{},"type":"unstyled"},{"entityRanges":[],"text":"Check the box if the device is compliant","depth":0,"data":{},"key":"evag6","type":"unstyled","inlineStyleRanges":[]}]},"references":{"blocks":[{"depth":0,"text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","entityRanges":[],"inlineStyleRanges":[{"length":89,"offset":0,"style":"color-rgb(33,37,41)"},{"style":"bgcolor-rgb(255,255,255)","length":89,"offset":0},{"style":"fontsize-16","offset":0,"length":89},{"offset":0,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":89}],"key":"77i1q","type":"unstyled","data":{}},{"key":"bi4mp","data":{},"entityRanges":[],"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant."},{"data":{},"key":"aisi1","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant.","type":"unstyled"},{"type":"unstyled","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN ","entityRanges":[{"length":86,"key":0,"offset":0}],"data":{},"key":"4tanb","inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
