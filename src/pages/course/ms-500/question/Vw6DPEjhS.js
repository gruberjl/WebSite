...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Device1","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Device2"},{"value":"Device6","isCorrectAnswer":true}],"id":"Vw6DPEjhS","question":{"blocks":[{"depth":0,"inlineStyleRanges":[],"key":"6t3pm","data":{},"text":"The devices enrolled in Intune are configured as shown in the following table:","entityRanges":[],"type":"unstyled"},{"data":{},"key":"9tjo3","type":"atomic","entityRanges":[{"length":1,"offset":0,"key":0}],"inlineStyleRanges":[],"text":" ","depth":0},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"text":"The device compliance policies in Intune are configured as shown in the following table:","key":"c0grv","type":"unstyled"},{"type":"atomic","entityRanges":[{"length":1,"key":1,"offset":0}],"key":"99it7","depth":0,"data":{},"text":" ","inlineStyleRanges":[]},{"inlineStyleRanges":[],"depth":0,"key":"56p0h","data":{},"entityRanges":[],"type":"unstyled","text":"The device compliance policies have the assignments shown in the following table:"},{"entityRanges":[{"offset":0,"key":2,"length":1}],"key":"62f10","inlineStyleRanges":[],"depth":0,"text":" ","type":"atomic","data":{}},{"type":"unstyled","text":"The Mark devices with no compliance policy are assigned as Compliant.","depth":0,"entityRanges":[],"key":"a7l90","data":{},"inlineStyleRanges":[]},{"type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"16cgt","text":"You are evaluating which devices are compliant with Intune.","depth":0},{"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Check the box if the device is compliant","key":"evag6","data":{}}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"alignment":"left","height":"auto","alt":"Devices Chart","src":"https://i.ibb.co/rt25GT1/Devices.png","width":"auto"}},"1":{"data":{"src":"https://i.ibb.co/YZzVcsL/Device-policies.png","height":"auto","alignment":"left","width":"auto","alt":"Device policies chart"},"mutability":"MUTABLE","type":"IMAGE"},"2":{"type":"IMAGE","data":{"alt":"Device policy group chart","width":"auto","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","height":"auto","alignment":"left"},"mutability":"MUTABLE"}}},"references":{"blocks":[{"type":"unstyled","depth":0,"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","offset":0,"length":89},{"length":89,"style":"bgcolor-rgb(255,255,255)","offset":0},{"style":"fontsize-16","length":89,"offset":0},{"length":89,"offset":0,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","entityRanges":[],"key":"77i1q","data":{}},{"entityRanges":[],"type":"unstyled","key":"bi4mp","text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","depth":0,"inlineStyleRanges":[],"data":{}},{"depth":0,"type":"unstyled","inlineStyleRanges":[],"data":{},"key":"aisi1","text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant.","entityRanges":[]},{"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN ","key":"4tanb","entityRanges":[{"offset":0,"key":0,"length":86}],"type":"unstyled","depth":0,"data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
