...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Device1"},{"isCorrectAnswer":true,"value":"Device2"},{"isCorrectAnswer":true,"value":"Device6"}],"id":"Vw6DPEjhS","question":{"blocks":[{"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"The devices enrolled in Intune are configured as shown in the following table:","key":"6t3pm","entityRanges":[],"data":{}},{"entityRanges":[{"length":1,"key":0,"offset":0}],"inlineStyleRanges":[],"data":{},"type":"atomic","depth":0,"key":"9tjo3","text":" "},{"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"The device compliance policies in Intune are configured as shown in the following table:","data":{},"key":"c0grv"},{"type":"atomic","inlineStyleRanges":[],"text":" ","entityRanges":[{"length":1,"key":1,"offset":0}],"data":{},"key":"99it7","depth":0},{"key":"56p0h","inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"text":"The device compliance policies have the assignments shown in the following table:","depth":0,"data":{}},{"data":{},"inlineStyleRanges":[],"entityRanges":[{"key":2,"length":1,"offset":0}],"text":" ","depth":0,"type":"atomic","key":"62f10"},{"text":"The Mark devices with no compliance policy are assigned as Compliant.","key":"a7l90","inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[],"data":{}},{"depth":0,"key":"16cgt","text":"You are evaluating which devices are compliant with Intune.","data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"Check the box if the device is compliant","key":"evag6","depth":0}],"entityMap":{"0":{"data":{"width":"auto","alt":"Devices Chart","alignment":"left","height":"auto","src":"https://i.ibb.co/rt25GT1/Devices.png"},"type":"IMAGE","mutability":"MUTABLE"},"1":{"type":"IMAGE","mutability":"MUTABLE","data":{"alt":"Device policies chart","alignment":"left","src":"https://i.ibb.co/YZzVcsL/Device-policies.png","width":"auto","height":"auto"}},"2":{"mutability":"MUTABLE","data":{"alt":"Device policy group chart","width":"auto","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","alignment":"left","height":"auto"},"type":"IMAGE"}}},"references":{"blocks":[{"type":"unstyled","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":89,"offset":0},{"offset":0,"length":89,"style":"bgcolor-rgb(255,255,255)"},{"offset":0,"style":"fontsize-16","length":89},{"length":89,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":0}],"key":"77i1q","depth":0,"text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","entityRanges":[],"data":{}},{"entityRanges":[],"depth":0,"type":"unstyled","text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","data":{},"key":"bi4mp","inlineStyleRanges":[]},{"data":{},"text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant.","entityRanges":[],"inlineStyleRanges":[],"depth":0,"key":"aisi1","type":"unstyled"},{"text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN ","entityRanges":[{"offset":0,"key":0,"length":86}],"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"4tanb","depth":0}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
