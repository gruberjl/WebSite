...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Device1","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Device2"},{"isCorrectAnswer":true,"value":"Device6"}],"id":"Vw6DPEjhS","question":{"blocks":[{"entityRanges":[],"text":"The devices enrolled in Intune are configured as shown in the following table:","type":"unstyled","data":{},"inlineStyleRanges":[],"depth":0,"key":"6t3pm"},{"key":"9tjo3","depth":0,"entityRanges":[{"key":0,"length":1,"offset":0}],"data":{},"inlineStyleRanges":[],"type":"atomic","text":" "},{"type":"unstyled","text":"The device compliance policies in Intune are configured as shown in the following table:","data":{},"depth":0,"key":"c0grv","entityRanges":[],"inlineStyleRanges":[]},{"key":"99it7","type":"atomic","depth":0,"entityRanges":[{"key":1,"offset":0,"length":1}],"data":{},"text":" ","inlineStyleRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"text":"The device compliance policies have the assignments shown in the following table:","data":{},"key":"56p0h","depth":0,"type":"unstyled"},{"depth":0,"data":{},"text":" ","entityRanges":[{"key":2,"length":1,"offset":0}],"type":"atomic","inlineStyleRanges":[],"key":"62f10"},{"inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"a7l90","depth":0,"text":"The Mark devices with no compliance policy are assigned as Compliant.","type":"unstyled"},{"type":"unstyled","inlineStyleRanges":[],"text":"You are evaluating which devices are compliant with Intune.","depth":0,"entityRanges":[],"key":"16cgt","data":{}},{"data":{},"entityRanges":[],"text":"Check the box if the device is compliant","type":"unstyled","depth":0,"key":"evag6","inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"alt":"Devices Chart","height":"auto","src":"https://i.ibb.co/rt25GT1/Devices.png","alignment":"left","width":"auto"}},"1":{"data":{"alignment":"left","alt":"Device policies chart","height":"auto","width":"auto","src":"https://i.ibb.co/YZzVcsL/Device-policies.png"},"mutability":"MUTABLE","type":"IMAGE"},"2":{"mutability":"MUTABLE","data":{"height":"auto","alignment":"left","width":"auto","alt":"Device policy group chart","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png"},"type":"IMAGE"}}},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"type":"unstyled","depth":0,"key":"77i1q","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":89,"offset":0},{"offset":0,"length":89,"style":"bgcolor-rgb(255,255,255)"},{"style":"fontsize-16","length":89,"offset":0},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":89,"offset":0}],"text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","data":{},"entityRanges":[]},{"entityRanges":[],"text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled","key":"bi4mp"},{"inlineStyleRanges":[],"entityRanges":[],"key":"aisi1","type":"unstyled","text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant.","depth":0,"data":{}},{"type":"unstyled","key":"4tanb","text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN ","entityRanges":[{"offset":0,"key":0,"length":86}],"data":{},"depth":0,"inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
