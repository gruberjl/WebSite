...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Device1"},{"value":"Device2","isCorrectAnswer":true},{"value":"Device6","isCorrectAnswer":true}],"id":"Vw6DPEjhS","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"alt":"Devices Chart","height":"auto","alignment":"left","width":"auto","src":"https://i.ibb.co/rt25GT1/Devices.png"},"type":"IMAGE"},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"alt":"Device policies chart","src":"https://i.ibb.co/YZzVcsL/Device-policies.png","width":"auto","height":"auto","alignment":"left"}},"2":{"data":{"height":"auto","width":"auto","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","alt":"Device policy group chart","alignment":"left"},"type":"IMAGE","mutability":"MUTABLE"}},"blocks":[{"key":"6t3pm","data":{},"inlineStyleRanges":[],"depth":0,"text":"The devices enrolled in Intune are configured as shown in the following table:","type":"unstyled","entityRanges":[]},{"type":"atomic","data":{},"entityRanges":[{"key":0,"offset":0,"length":1}],"text":" ","key":"9tjo3","depth":0,"inlineStyleRanges":[]},{"depth":0,"data":{},"key":"c0grv","type":"unstyled","entityRanges":[],"text":"The device compliance policies in Intune are configured as shown in the following table:","inlineStyleRanges":[]},{"data":{},"key":"99it7","type":"atomic","depth":0,"entityRanges":[{"offset":0,"length":1,"key":1}],"inlineStyleRanges":[],"text":" "},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"key":"56p0h","text":"The device compliance policies have the assignments shown in the following table:","type":"unstyled"},{"depth":0,"inlineStyleRanges":[],"type":"atomic","data":{},"entityRanges":[{"length":1,"offset":0,"key":2}],"key":"62f10","text":" "},{"type":"unstyled","depth":0,"text":"The Mark devices with no compliance policy are assigned as Compliant.","key":"a7l90","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"key":"16cgt","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"You are evaluating which devices are compliant with Intune.","type":"unstyled","data":{}},{"depth":0,"text":"Check the box if the device is compliant","inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unstyled","key":"evag6"}]},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"depth":0,"data":{},"inlineStyleRanges":[{"offset":0,"length":89,"style":"color-rgb(33,37,41)"},{"style":"bgcolor-rgb(255,255,255)","length":89,"offset":0},{"offset":0,"style":"fontsize-16","length":89},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":89,"offset":0}],"key":"77i1q","entityRanges":[],"text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","type":"unstyled"},{"data":{},"inlineStyleRanges":[],"text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","depth":0,"type":"unstyled","key":"bi4mp","entityRanges":[]},{"text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant.","data":{},"key":"aisi1","type":"unstyled","inlineStyleRanges":[],"depth":0,"entityRanges":[]},{"entityRanges":[{"offset":0,"key":0,"length":86}],"data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled","key":"4tanb","text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN "}]}},
      previousQuestionId: '',
      nextQuestionId: '',
