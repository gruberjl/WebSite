...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Device1"},{"isCorrectAnswer":true,"value":"Device2"},{"isCorrectAnswer":true,"value":"Device6"}],"id":"Vw6DPEjhS","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"height":"auto","alt":"Devices Chart","alignment":"left","width":"auto","src":"https://i.ibb.co/rt25GT1/Devices.png"},"type":"IMAGE"},"1":{"mutability":"MUTABLE","data":{"height":"auto","src":"https://i.ibb.co/YZzVcsL/Device-policies.png","alignment":"left","width":"auto","alt":"Device policies chart"},"type":"IMAGE"},"2":{"mutability":"MUTABLE","type":"IMAGE","data":{"width":"auto","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","height":"auto","alignment":"left","alt":"Device policy group chart"}}},"blocks":[{"entityRanges":[],"key":"6t3pm","data":{},"text":"The devices enrolled in Intune are configured as shown in the following table:","depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"inlineStyleRanges":[],"text":" ","entityRanges":[{"offset":0,"key":0,"length":1}],"depth":0,"type":"atomic","data":{},"key":"9tjo3"},{"entityRanges":[],"type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[],"key":"c0grv","text":"The device compliance policies in Intune are configured as shown in the following table:"},{"depth":0,"key":"99it7","entityRanges":[{"key":1,"offset":0,"length":1}],"data":{},"inlineStyleRanges":[],"text":" ","type":"atomic"},{"text":"The device compliance policies have the assignments shown in the following table:","key":"56p0h","entityRanges":[],"type":"unstyled","data":{},"inlineStyleRanges":[],"depth":0},{"type":"atomic","inlineStyleRanges":[],"depth":0,"key":"62f10","text":" ","data":{},"entityRanges":[{"length":1,"key":2,"offset":0}]},{"key":"a7l90","type":"unstyled","data":{},"entityRanges":[],"depth":0,"text":"The Mark devices with no compliance policy are assigned as Compliant.","inlineStyleRanges":[]},{"entityRanges":[],"type":"unstyled","key":"16cgt","data":{},"text":"You are evaluating which devices are compliant with Intune.","inlineStyleRanges":[],"depth":0},{"inlineStyleRanges":[],"text":"Check the box if the device is compliant","type":"unstyled","key":"evag6","depth":0,"data":{},"entityRanges":[]}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN","targetOption":"_blank"}}},"blocks":[{"text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","depth":0,"data":{},"entityRanges":[],"key":"77i1q","type":"unstyled","inlineStyleRanges":[{"length":89,"offset":0,"style":"color-rgb(33,37,41)"},{"offset":0,"length":89,"style":"bgcolor-rgb(255,255,255)"},{"length":89,"offset":0,"style":"fontsize-16"},{"offset":0,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":89}]},{"text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","depth":0,"inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unstyled","key":"bi4mp"},{"data":{},"type":"unstyled","key":"aisi1","text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant.","entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"depth":0,"type":"unstyled","entityRanges":[{"offset":0,"length":86,"key":0}],"key":"4tanb","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN ","inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
