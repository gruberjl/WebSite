...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Device1"},{"isCorrectAnswer":true,"value":"Device2"},{"value":"Device6","isCorrectAnswer":true}],"id":"Vw6DPEjhS","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"width":"auto","alt":"Devices Chart","alignment":"left","height":"auto","src":"https://i.ibb.co/rt25GT1/Devices.png"},"type":"IMAGE"},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","alt":"Device policies chart","width":"auto","src":"https://i.ibb.co/YZzVcsL/Device-policies.png","height":"auto"}},"2":{"mutability":"MUTABLE","type":"IMAGE","data":{"width":"auto","height":"auto","alt":"Device policy group chart","alignment":"left","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png"}}},"blocks":[{"depth":0,"type":"unstyled","entityRanges":[],"key":"6t3pm","inlineStyleRanges":[],"text":"The devices enrolled in Intune are configured as shown in the following table:","data":{}},{"key":"9tjo3","data":{},"entityRanges":[{"offset":0,"length":1,"key":0}],"type":"atomic","text":" ","inlineStyleRanges":[],"depth":0},{"entityRanges":[],"text":"The device compliance policies in Intune are configured as shown in the following table:","depth":0,"data":{},"type":"unstyled","inlineStyleRanges":[],"key":"c0grv"},{"entityRanges":[{"length":1,"key":1,"offset":0}],"inlineStyleRanges":[],"depth":0,"data":{},"key":"99it7","type":"atomic","text":" "},{"type":"unstyled","inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[],"text":"The device compliance policies have the assignments shown in the following table:","key":"56p0h"},{"key":"62f10","depth":0,"inlineStyleRanges":[],"text":" ","entityRanges":[{"length":1,"offset":0,"key":2}],"data":{},"type":"atomic"},{"entityRanges":[],"key":"a7l90","data":{},"inlineStyleRanges":[],"depth":0,"text":"The Mark devices with no compliance policy are assigned as Compliant.","type":"unstyled"},{"key":"16cgt","depth":0,"data":{},"text":"You are evaluating which devices are compliant with Intune.","inlineStyleRanges":[],"type":"unstyled","entityRanges":[]},{"type":"unstyled","entityRanges":[],"text":"Check the box if the device is compliant","data":{},"inlineStyleRanges":[],"key":"evag6","depth":0}]},"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN","targetOption":"_blank"}}},"blocks":[{"inlineStyleRanges":[{"length":89,"offset":0,"style":"color-rgb(33,37,41)"},{"style":"bgcolor-rgb(255,255,255)","length":89,"offset":0},{"length":89,"offset":0,"style":"fontsize-16"},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":89,"offset":0}],"depth":0,"data":{},"type":"unstyled","entityRanges":[],"key":"77i1q","text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant."},{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","key":"bi4mp","data":{},"type":"unstyled"},{"key":"aisi1","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant.","data":{},"type":"unstyled"},{"depth":0,"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN ","entityRanges":[{"key":0,"length":86,"offset":0}],"type":"unstyled","key":"4tanb","inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
