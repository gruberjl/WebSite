...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Device1"},{"value":"Device2","isCorrectAnswer":true},{"value":"Device6","isCorrectAnswer":true}],"id":"Vw6DPEjhS","question":{"blocks":[{"text":"The devices enrolled in Intune are configured as shown in the following table:","inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[],"depth":0,"key":"6t3pm"},{"key":"9tjo3","inlineStyleRanges":[],"type":"atomic","data":{},"depth":0,"text":" ","entityRanges":[{"length":1,"offset":0,"key":0}]},{"text":"The device compliance policies in Intune are configured as shown in the following table:","entityRanges":[],"key":"c0grv","depth":0,"type":"unstyled","data":{},"inlineStyleRanges":[]},{"text":" ","data":{},"depth":0,"key":"99it7","type":"atomic","entityRanges":[{"key":1,"offset":0,"length":1}],"inlineStyleRanges":[]},{"key":"56p0h","inlineStyleRanges":[],"text":"The device compliance policies have the assignments shown in the following table:","depth":0,"type":"unstyled","entityRanges":[],"data":{}},{"inlineStyleRanges":[],"depth":0,"entityRanges":[{"key":2,"length":1,"offset":0}],"type":"atomic","text":" ","data":{},"key":"62f10"},{"inlineStyleRanges":[],"entityRanges":[],"text":"The Mark devices with no compliance policy are assigned as Compliant.","data":{},"key":"a7l90","depth":0,"type":"unstyled"},{"data":{},"depth":0,"key":"16cgt","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"text":"You are evaluating which devices are compliant with Intune."},{"key":"evag6","entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","text":"Check the box if the device is compliant"}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"alt":"Devices Chart","height":"auto","width":"auto","alignment":"left","src":"https://i.ibb.co/rt25GT1/Devices.png"}},"1":{"data":{"width":"auto","height":"auto","alignment":"left","alt":"Device policies chart","src":"https://i.ibb.co/YZzVcsL/Device-policies.png"},"type":"IMAGE","mutability":"MUTABLE"},"2":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","height":"auto","width":"auto","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","alt":"Device policy group chart"}}}},"references":{"blocks":[{"inlineStyleRanges":[{"length":89,"style":"color-rgb(33,37,41)","offset":0},{"style":"bgcolor-rgb(255,255,255)","length":89,"offset":0},{"style":"fontsize-16","offset":0,"length":89},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":89,"offset":0}],"key":"77i1q","text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","type":"unstyled","entityRanges":[],"depth":0,"data":{}},{"data":{},"key":"bi4mp","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","type":"unstyled"},{"depth":0,"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"key":"aisi1","data":{},"text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant."},{"depth":0,"key":"4tanb","text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN ","type":"unstyled","inlineStyleRanges":[],"data":{},"entityRanges":[{"length":86,"offset":0,"key":0}]}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
