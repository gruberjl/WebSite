...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Device1","isCorrectAnswer":false},{"value":"Device2","isCorrectAnswer":true},{"value":"Device6","isCorrectAnswer":true}],"id":"Vw6DPEjhS","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"height":"auto","alt":"Devices Chart","width":"auto","src":"https://i.ibb.co/rt25GT1/Devices.png","alignment":"left"},"type":"IMAGE"},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","alt":"Device policies chart","src":"https://i.ibb.co/YZzVcsL/Device-policies.png","alignment":"left","width":"auto"}},"2":{"data":{"height":"auto","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","alt":"Device policy group chart","alignment":"left","width":"auto"},"type":"IMAGE","mutability":"MUTABLE"}},"blocks":[{"key":"6t3pm","data":{},"depth":0,"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"text":"The devices enrolled in Intune are configured as shown in the following table:"},{"depth":0,"type":"atomic","entityRanges":[{"offset":0,"length":1,"key":0}],"inlineStyleRanges":[],"key":"9tjo3","data":{},"text":" "},{"inlineStyleRanges":[],"text":"The device compliance policies in Intune are configured as shown in the following table:","key":"c0grv","data":{},"entityRanges":[],"depth":0,"type":"unstyled"},{"type":"atomic","entityRanges":[{"offset":0,"key":1,"length":1}],"key":"99it7","data":{},"text":" ","inlineStyleRanges":[],"depth":0},{"key":"56p0h","data":{},"type":"unstyled","depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"The device compliance policies have the assignments shown in the following table:"},{"inlineStyleRanges":[],"type":"atomic","key":"62f10","entityRanges":[{"offset":0,"length":1,"key":2}],"data":{},"depth":0,"text":" "},{"type":"unstyled","data":{},"key":"a7l90","text":"The Mark devices with no compliance policy are assigned as Compliant.","entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"data":{},"text":"You are evaluating which devices are compliant with Intune.","type":"unstyled","depth":0,"key":"16cgt","entityRanges":[],"inlineStyleRanges":[]},{"text":"Check the box if the device is compliant","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"evag6","depth":0,"type":"unstyled"}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN","targetOption":"_blank"}}},"blocks":[{"text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","depth":0,"entityRanges":[],"data":{},"type":"unstyled","key":"77i1q","inlineStyleRanges":[{"offset":0,"length":89,"style":"color-rgb(33,37,41)"},{"length":89,"style":"bgcolor-rgb(255,255,255)","offset":0},{"offset":0,"length":89,"style":"fontsize-16"},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":0,"length":89}]},{"entityRanges":[],"text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","data":{},"depth":0,"key":"bi4mp","type":"unstyled","inlineStyleRanges":[]},{"key":"aisi1","inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0,"type":"unstyled","text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant."},{"entityRanges":[{"length":86,"key":0,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN ","key":"4tanb","depth":0,"data":{},"type":"unstyled","inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
