...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Device1","isCorrectAnswer":false},{"value":"Device2","isCorrectAnswer":true},{"isCorrectAnswer":true,"value":"Device6"}],"id":"Vw6DPEjhS","question":{"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"width":"auto","height":"auto","alignment":"left","alt":"Devices Chart","src":"https://i.ibb.co/rt25GT1/Devices.png"}},"1":{"type":"IMAGE","mutability":"MUTABLE","data":{"width":"auto","src":"https://i.ibb.co/YZzVcsL/Device-policies.png","alignment":"left","alt":"Device policies chart","height":"auto"}},"2":{"type":"IMAGE","mutability":"MUTABLE","data":{"width":"auto","height":"auto","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","alignment":"left","alt":"Device policy group chart"}}},"blocks":[{"data":{},"depth":0,"entityRanges":[],"key":"6t3pm","type":"unstyled","inlineStyleRanges":[],"text":"The devices enrolled in Intune are configured as shown in the following table:"},{"inlineStyleRanges":[],"entityRanges":[{"key":0,"offset":0,"length":1}],"depth":0,"text":" ","key":"9tjo3","data":{},"type":"atomic"},{"text":"The device compliance policies in Intune are configured as shown in the following table:","type":"unstyled","depth":0,"entityRanges":[],"key":"c0grv","inlineStyleRanges":[],"data":{}},{"entityRanges":[{"length":1,"key":1,"offset":0}],"inlineStyleRanges":[],"key":"99it7","type":"atomic","data":{},"depth":0,"text":" "},{"entityRanges":[],"key":"56p0h","type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{},"text":"The device compliance policies have the assignments shown in the following table:"},{"entityRanges":[{"length":1,"offset":0,"key":2}],"key":"62f10","inlineStyleRanges":[],"depth":0,"type":"atomic","data":{},"text":" "},{"key":"a7l90","inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[],"data":{},"text":"The Mark devices with no compliance policy are assigned as Compliant."},{"depth":0,"inlineStyleRanges":[],"key":"16cgt","data":{},"entityRanges":[],"type":"unstyled","text":"You are evaluating which devices are compliant with Intune."},{"depth":0,"text":"Check the box if the device is compliant","data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","key":"evag6"}]},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"key":"77i1q","text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","data":{},"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":89,"offset":0},{"style":"bgcolor-rgb(255,255,255)","offset":0,"length":89},{"length":89,"offset":0,"style":"fontsize-16"},{"offset":0,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":89}],"type":"unstyled","depth":0,"entityRanges":[]},{"depth":0,"data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"key":"bi4mp","text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant."},{"entityRanges":[],"depth":0,"key":"aisi1","inlineStyleRanges":[],"data":{},"type":"unstyled","text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant."},{"depth":0,"key":"4tanb","text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN ","type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"key":0,"offset":0,"length":86}],"data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
