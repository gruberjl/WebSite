...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Device1","isCorrectAnswer":false},{"value":"Device2","isCorrectAnswer":true},{"value":"Device6","isCorrectAnswer":true}],"id":"Vw6DPEjhS","question":{"entityMap":{"0":{"type":"IMAGE","data":{"height":"auto","width":"auto","src":"https://i.ibb.co/rt25GT1/Devices.png","alignment":"left","alt":"Devices Chart"},"mutability":"MUTABLE"},"1":{"data":{"height":"auto","src":"https://i.ibb.co/YZzVcsL/Device-policies.png","width":"auto","alt":"Device policies chart","alignment":"left"},"type":"IMAGE","mutability":"MUTABLE"},"2":{"type":"IMAGE","data":{"width":"auto","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","height":"auto","alignment":"left","alt":"Device policy group chart"},"mutability":"MUTABLE"}},"blocks":[{"key":"6t3pm","inlineStyleRanges":[],"type":"unstyled","depth":0,"entityRanges":[],"data":{},"text":"The devices enrolled in Intune are configured as shown in the following table:"},{"text":" ","data":{},"type":"atomic","entityRanges":[{"key":0,"offset":0,"length":1}],"key":"9tjo3","inlineStyleRanges":[],"depth":0},{"key":"c0grv","text":"The device compliance policies in Intune are configured as shown in the following table:","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unstyled"},{"key":"99it7","data":{},"depth":0,"entityRanges":[{"key":1,"offset":0,"length":1}],"text":" ","inlineStyleRanges":[],"type":"atomic"},{"entityRanges":[],"depth":0,"key":"56p0h","text":"The device compliance policies have the assignments shown in the following table:","data":{},"inlineStyleRanges":[],"type":"unstyled"},{"key":"62f10","type":"atomic","data":{},"text":" ","entityRanges":[{"key":2,"length":1,"offset":0}],"depth":0,"inlineStyleRanges":[]},{"text":"The Mark devices with no compliance policy are assigned as Compliant.","depth":0,"key":"a7l90","inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unstyled"},{"key":"16cgt","data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"You are evaluating which devices are compliant with Intune."},{"inlineStyleRanges":[],"key":"evag6","depth":0,"text":"Check the box if the device is compliant","data":{},"type":"unstyled","entityRanges":[]}]},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":89,"offset":0},{"style":"bgcolor-rgb(255,255,255)","offset":0,"length":89},{"length":89,"style":"fontsize-16","offset":0},{"length":89,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":0}],"data":{},"key":"77i1q","type":"unstyled","entityRanges":[],"text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","depth":0},{"text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","key":"bi4mp","data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[],"type":"unstyled","data":{},"key":"aisi1","depth":0,"inlineStyleRanges":[],"text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant."},{"entityRanges":[{"offset":0,"key":0,"length":86}],"key":"4tanb","depth":0,"inlineStyleRanges":[],"data":{},"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN "}]}},
      previousQuestionId: '',
      nextQuestionId: '',
