...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Device1"},{"isCorrectAnswer":true,"value":"Device2"},{"value":"Device6","isCorrectAnswer":true}],"id":"Vw6DPEjhS","question":{"blocks":[{"inlineStyleRanges":[],"text":"The devices enrolled in Intune are configured as shown in the following table:","entityRanges":[],"type":"unstyled","depth":0,"data":{},"key":"6t3pm"},{"type":"atomic","data":{},"key":"9tjo3","text":" ","depth":0,"entityRanges":[{"key":0,"offset":0,"length":1}],"inlineStyleRanges":[]},{"depth":0,"data":{},"entityRanges":[],"type":"unstyled","key":"c0grv","text":"The device compliance policies in Intune are configured as shown in the following table:","inlineStyleRanges":[]},{"text":" ","key":"99it7","depth":0,"entityRanges":[{"offset":0,"length":1,"key":1}],"type":"atomic","data":{},"inlineStyleRanges":[]},{"type":"unstyled","key":"56p0h","data":{},"depth":0,"inlineStyleRanges":[],"text":"The device compliance policies have the assignments shown in the following table:","entityRanges":[]},{"entityRanges":[{"offset":0,"key":2,"length":1}],"key":"62f10","depth":0,"text":" ","type":"atomic","data":{},"inlineStyleRanges":[]},{"key":"a7l90","inlineStyleRanges":[],"depth":0,"type":"unstyled","text":"The Mark devices with no compliance policy are assigned as Compliant.","entityRanges":[],"data":{}},{"text":"You are evaluating which devices are compliant with Intune.","inlineStyleRanges":[],"data":{},"type":"unstyled","depth":0,"entityRanges":[],"key":"16cgt"},{"key":"evag6","inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"Check the box if the device is compliant","type":"unstyled","depth":0}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","alt":"Devices Chart","src":"https://i.ibb.co/rt25GT1/Devices.png","height":"auto","width":"auto"}},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"width":"auto","alt":"Device policies chart","height":"auto","src":"https://i.ibb.co/YZzVcsL/Device-policies.png","alignment":"left"}},"2":{"type":"IMAGE","mutability":"MUTABLE","data":{"alt":"Device policy group chart","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","alignment":"left","width":"auto","height":"auto"}}}},"references":{"blocks":[{"text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":89,"offset":0},{"length":89,"style":"bgcolor-rgb(255,255,255)","offset":0},{"offset":0,"style":"fontsize-16","length":89},{"offset":0,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":89}],"key":"77i1q","type":"unstyled","depth":0,"entityRanges":[],"data":{}},{"depth":0,"inlineStyleRanges":[],"data":{},"text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","type":"unstyled","key":"bi4mp","entityRanges":[]},{"depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"aisi1","entityRanges":[],"text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant."},{"text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN ","entityRanges":[{"length":86,"offset":0,"key":0}],"type":"unstyled","data":{},"key":"4tanb","inlineStyleRanges":[],"depth":0}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
