...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Device1"},{"value":"Device2","isCorrectAnswer":true},{"value":"Device6","isCorrectAnswer":true}],"id":"Vw6DPEjhS","question":{"entityMap":{"0":{"type":"IMAGE","data":{"alignment":"left","height":"auto","alt":"Devices Chart","width":"auto","src":"https://i.ibb.co/rt25GT1/Devices.png"},"mutability":"MUTABLE"},"1":{"type":"IMAGE","data":{"src":"https://i.ibb.co/YZzVcsL/Device-policies.png","alignment":"left","height":"auto","width":"auto","alt":"Device policies chart"},"mutability":"MUTABLE"},"2":{"data":{"src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","width":"auto","height":"auto","alignment":"left","alt":"Device policy group chart"},"mutability":"MUTABLE","type":"IMAGE"}},"blocks":[{"data":{},"type":"unstyled","text":"The devices enrolled in Intune are configured as shown in the following table:","depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"6t3pm"},{"data":{},"type":"atomic","entityRanges":[{"key":0,"offset":0,"length":1}],"depth":0,"text":" ","key":"9tjo3","inlineStyleRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"text":"The device compliance policies in Intune are configured as shown in the following table:","key":"c0grv","type":"unstyled","depth":0,"data":{}},{"depth":0,"text":" ","entityRanges":[{"key":1,"length":1,"offset":0}],"type":"atomic","inlineStyleRanges":[],"data":{},"key":"99it7"},{"text":"The device compliance policies have the assignments shown in the following table:","depth":0,"key":"56p0h","inlineStyleRanges":[],"data":{},"type":"unstyled","entityRanges":[]},{"key":"62f10","data":{},"text":" ","type":"atomic","depth":0,"inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":2,"length":1}]},{"key":"a7l90","entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"The Mark devices with no compliance policy are assigned as Compliant.","depth":0,"type":"unstyled"},{"data":{},"type":"unstyled","key":"16cgt","depth":0,"text":"You are evaluating which devices are compliant with Intune.","entityRanges":[],"inlineStyleRanges":[]},{"text":"Check the box if the device is compliant","entityRanges":[],"type":"unstyled","data":{},"key":"evag6","inlineStyleRanges":[],"depth":0}]},"references":{"blocks":[{"type":"unstyled","depth":0,"text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant.","entityRanges":[],"key":"77i1q","inlineStyleRanges":[{"length":89,"offset":0,"style":"color-rgb(33,37,41)"},{"style":"bgcolor-rgb(255,255,255)","offset":0,"length":89},{"length":89,"style":"fontsize-16","offset":0},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":89,"offset":0}],"data":{}},{"key":"bi4mp","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","data":{},"depth":0},{"entityRanges":[],"data":{},"type":"unstyled","key":"aisi1","depth":0,"inlineStyleRanges":[],"text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant."},{"inlineStyleRanges":[],"entityRanges":[{"length":86,"key":0,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN ","data":{},"key":"4tanb","type":"unstyled","depth":0}],"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
