...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Device1","isCorrectAnswer":false},{"value":"Device2","isCorrectAnswer":true},{"value":"Device6","isCorrectAnswer":true}],"id":"Vw6DPEjhS","question":{"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","height":"auto","width":"auto","alt":"Devices Chart","src":"https://i.ibb.co/rt25GT1/Devices.png"}},"1":{"type":"IMAGE","data":{"alignment":"left","src":"https://i.ibb.co/YZzVcsL/Device-policies.png","alt":"Device policies chart","width":"auto","height":"auto"},"mutability":"MUTABLE"},"2":{"data":{"height":"auto","alignment":"left","src":"https://i.ibb.co/hXnkN3N/Device-policy-goups.png","width":"auto","alt":"Device policy group chart"},"mutability":"MUTABLE","type":"IMAGE"}},"blocks":[{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0,"text":"The devices enrolled in Intune are configured as shown in the following table:","key":"6t3pm","data":{}},{"type":"atomic","text":" ","data":{},"entityRanges":[{"length":1,"key":0,"offset":0}],"depth":0,"key":"9tjo3","inlineStyleRanges":[]},{"type":"unstyled","data":{},"text":"The device compliance policies in Intune are configured as shown in the following table:","depth":0,"inlineStyleRanges":[],"key":"c0grv","entityRanges":[]},{"inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[{"offset":0,"key":1,"length":1}],"text":" ","key":"99it7","type":"atomic"},{"text":"The device compliance policies have the assignments shown in the following table:","key":"56p0h","depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled","entityRanges":[]},{"key":"62f10","depth":0,"data":{},"type":"atomic","inlineStyleRanges":[],"entityRanges":[{"key":2,"length":1,"offset":0}],"text":" "},{"key":"a7l90","depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"The Mark devices with no compliance policy are assigned as Compliant.","type":"unstyled","data":{}},{"key":"16cgt","depth":0,"data":{},"text":"You are evaluating which devices are compliant with Intune.","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled"},{"type":"unstyled","key":"evag6","data":{},"depth":0,"text":"Check the box if the device is compliant","inlineStyleRanges":[],"entityRanges":[]}]},"references":{"blocks":[{"entityRanges":[],"key":"77i1q","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":0,"style":"color-rgb(33,37,41)","length":89},{"length":89,"offset":0,"style":"bgcolor-rgb(255,255,255)"},{"length":89,"style":"fontsize-16","offset":0},{"offset":0,"length":89,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"data":{},"text":"Device1 is an Android device that is not encrypted that's a member of GroupA and GroupC. DevicePolicy3 applies to Android devices that are members of GroupA so DevicePolicy3 is applied and requires the device to be encrypted. Since Device1 is not encrypted the device is not compliant."},{"entityRanges":[],"text":"Device2 is a Windows 10 computer that's encrypted and a member of GroupB and GroupC. DevicePolicy2 has an exclusion of GroupC so Device2 doesn't have a compliance policy. As stated all devices that don't have a compliance policy are marked compliant so Device2 is marked compliant.","key":"bi4mp","type":"unstyled","data":{},"inlineStyleRanges":[],"depth":0},{"entityRanges":[],"key":"aisi1","depth":0,"type":"unstyled","data":{},"text":"Device6 is a Windows 10 computer that is not a member of any group therefore it has no compliance policy applied and is therefore marked as compliant.","inlineStyleRanges":[]},{"data":{},"key":"4tanb","entityRanges":[{"key":0,"offset":0,"length":86}],"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN "}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
