...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Change the Assignment Type for Admin2 to Permanent"},{"value":"From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1"},{"value":"Change the Assignment Type for Admin1 to Eligible","isCorrectAnswer":true}],"id":"8HIVdM93U","question":{"blocks":[{"depth":0,"text":"Fabrikam identifies the following security requirements:","entityRanges":[],"key":"376vd","data":{},"type":"unstyled","inlineStyleRanges":[]},{"type":"unordered-list-item","inlineStyleRanges":[],"data":{},"depth":0,"key":"5f2ru","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[]},{"key":"7oc0n","type":"unordered-list-item","depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","inlineStyleRanges":[],"data":{},"entityRanges":[]},{"inlineStyleRanges":[],"type":"unordered-list-item","key":"bo064","depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"data":{}},{"type":"unordered-list-item","inlineStyleRanges":[],"data":{},"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","key":"bq41i","depth":0,"entityRanges":[]},{"data":{},"entityRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","inlineStyleRanges":[],"key":"8jnbt","type":"unordered-list-item","depth":0},{"data":{},"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","inlineStyleRanges":[],"key":"fkpir","entityRanges":[],"depth":0,"type":"unordered-list-item"},{"type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"Email messages that include attachments containing malware must be delivered without the attachment","data":{},"key":"3knma"},{"depth":0,"key":"4habl","entityRanges":[],"inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","data":{},"type":"unordered-list-item"},{"key":"stm8","entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit.","data":{},"depth":0},{"depth":0,"entityRanges":[{"key":0,"offset":0,"length":1}],"inlineStyleRanges":[],"key":"1b5s7","data":{},"text":" ","type":"atomic"},{"type":"unstyled","text":"","entityRanges":[],"key":"a2q2u","depth":0,"inlineStyleRanges":[],"data":{}},{"entityRanges":[{"offset":0,"key":1,"length":1}],"text":" ","data":{},"inlineStyleRanges":[],"type":"atomic","key":"14f2n","depth":0},{"type":"unstyled","inlineStyleRanges":[],"text":"What should you do to meet the security requirements?","depth":0,"entityRanges":[],"key":"dsva5","data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"src":"https://i.ibb.co/5cPfF5D/Active-Assignments.png","width":"auto","alt":"Active Assignments","height":"auto","alignment":"left"},"type":"IMAGE"},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"width":"auto","src":"https://i.ibb.co/N609WF4/Eligible-Assignments.png","height":"auto","alignment":"left","alt":"Eligible Assignments"}}}},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"data":{},"type":"unstyled","entityRanges":[],"key":"dctl8","depth":0,"text":"To fulfill the security requirement \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time.\" the user accounts should not say Permanent in the End time.","inlineStyleRanges":[{"offset":37,"style":"color-rgb(33,37,41)","length":126},{"offset":37,"length":126,"style":"bgcolor-rgb(255,255,255)"},{"offset":37,"style":"fontsize-16","length":126},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":37,"length":126}]},{"inlineStyleRanges":[],"data":{},"entityRanges":[{"key":0,"length":124,"offset":0}],"type":"unstyled","depth":0,"key":"8hpni","text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
