...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Change the Assignment Type for Admin2 to Permanent","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2"},{"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Change the Assignment Type for Admin1 to Eligible"}],"id":"8HIVdM93U","question":{"entityMap":{"0":{"type":"IMAGE","data":{"src":"https://i.ibb.co/5cPfF5D/Active-Assignments.png","height":"auto","width":"auto","alt":"Active Assignments","alignment":"left"},"mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"height":"auto","width":"auto","alt":"Eligible Assignments","src":"https://i.ibb.co/N609WF4/Eligible-Assignments.png","alignment":"left"},"type":"IMAGE"}},"blocks":[{"type":"unstyled","data":{},"text":"Fabrikam identifies the following security requirements:","inlineStyleRanges":[],"entityRanges":[],"key":"376vd","depth":0},{"entityRanges":[],"key":"5f2ru","type":"unordered-list-item","depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","data":{},"inlineStyleRanges":[]},{"data":{},"key":"7oc0n","type":"unordered-list-item","inlineStyleRanges":[],"depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","entityRanges":[]},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","type":"unordered-list-item","key":"bo064","depth":0},{"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","depth":0,"type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"data":{},"key":"bq41i"},{"data":{},"key":"8jnbt","entityRanges":[],"inlineStyleRanges":[],"type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0},{"inlineStyleRanges":[],"key":"fkpir","data":{},"entityRanges":[],"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","depth":0},{"data":{},"inlineStyleRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","key":"3knma","type":"unordered-list-item","depth":0,"entityRanges":[]},{"text":"The principle of least privilege must be used whenever possible","data":{},"depth":0,"type":"unordered-list-item","entityRanges":[],"key":"4habl","inlineStyleRanges":[]},{"text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit.","data":{},"key":"stm8","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0},{"text":" ","data":{},"depth":0,"entityRanges":[{"key":0,"length":1,"offset":0}],"key":"1b5s7","type":"atomic","inlineStyleRanges":[]},{"inlineStyleRanges":[],"type":"unstyled","text":"","entityRanges":[],"data":{},"depth":0,"key":"a2q2u"},{"key":"14f2n","entityRanges":[{"length":1,"offset":0,"key":1}],"data":{},"text":" ","depth":0,"type":"atomic","inlineStyleRanges":[]},{"key":"dsva5","inlineStyleRanges":[],"entityRanges":[],"text":"What should you do to meet the security requirements?","data":{},"type":"unstyled","depth":0}]},"references":{"blocks":[{"text":"To fulfill the security requirement \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time.\" the user accounts should not say Permanent in the End time.","entityRanges":[],"type":"unstyled","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":126,"offset":37},{"style":"bgcolor-rgb(255,255,255)","offset":37,"length":126},{"style":"fontsize-16","offset":37,"length":126},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":126,"offset":37}],"depth":0,"key":"dctl8","data":{}},{"key":"8hpni","type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"length":124,"key":0,"offset":0}],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","targetOption":"_blank"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
