...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Change the Assignment Type for Admin2 to Permanent","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1","isCorrectAnswer":false},{"value":"Change the Assignment Type for Admin1 to Eligible","isCorrectAnswer":true}],"id":"8HIVdM93U","question":{"entityMap":{"0":{"data":{"height":"auto","width":"auto","alignment":"left","src":"https://i.ibb.co/5cPfF5D/Active-Assignments.png","alt":"Active Assignments"},"mutability":"MUTABLE","type":"IMAGE"},"1":{"type":"IMAGE","data":{"src":"https://i.ibb.co/N609WF4/Eligible-Assignments.png","height":"auto","alignment":"left","width":"auto","alt":"Eligible Assignments"},"mutability":"MUTABLE"}},"blocks":[{"inlineStyleRanges":[],"depth":0,"text":"Fabrikam identifies the following security requirements:","entityRanges":[],"key":"376vd","type":"unstyled","data":{}},{"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","data":{},"depth":0,"key":"5f2ru"},{"key":"7oc0n","type":"unordered-list-item","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","data":{}},{"key":"bo064","entityRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"data":{}},{"inlineStyleRanges":[],"data":{},"key":"bq41i","depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","entityRanges":[],"type":"unordered-list-item"},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"8jnbt","depth":0,"data":{},"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"data":{},"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","key":"fkpir","inlineStyleRanges":[],"type":"unordered-list-item"},{"entityRanges":[],"key":"3knma","inlineStyleRanges":[],"data":{},"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0},{"depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item","key":"4habl","data":{}},{"key":"stm8","data":{},"text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit.","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0},{"type":"atomic","inlineStyleRanges":[],"depth":0,"data":{},"text":" ","key":"1b5s7","entityRanges":[{"key":0,"offset":0,"length":1}]},{"key":"a2q2u","depth":0,"type":"unstyled","text":"","data":{},"inlineStyleRanges":[],"entityRanges":[]},{"depth":0,"type":"atomic","text":" ","data":{},"key":"14f2n","inlineStyleRanges":[],"entityRanges":[{"key":1,"length":1,"offset":0}]},{"depth":0,"text":"What should you do to meet the security requirements?","entityRanges":[],"inlineStyleRanges":[],"key":"dsva5","data":{},"type":"unstyled"}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","targetOption":"_blank"}}},"blocks":[{"depth":0,"entityRanges":[],"text":"To fulfill the security requirement \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time.\" the user accounts should not say Permanent in the End time.","data":{},"type":"unstyled","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":126,"offset":37},{"offset":37,"style":"bgcolor-rgb(255,255,255)","length":126},{"length":126,"offset":37,"style":"fontsize-16"},{"offset":37,"length":126,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"key":"dctl8"},{"type":"unstyled","entityRanges":[{"key":0,"offset":0,"length":124}],"key":"8hpni","text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","depth":0,"inlineStyleRanges":[],"data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/8HIVdM93U',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
