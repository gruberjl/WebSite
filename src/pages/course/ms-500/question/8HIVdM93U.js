...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Change the Assignment Type for Admin2 to Permanent"},{"value":"From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Change the Assignment Type for Admin1 to Eligible"}],"id":"8HIVdM93U","question":{"entityMap":{"0":{"type":"IMAGE","data":{"alignment":"left","height":"auto","width":"auto","alt":"Active Assignments","src":"https://i.ibb.co/5cPfF5D/Active-Assignments.png"},"mutability":"MUTABLE"},"1":{"data":{"alignment":"left","alt":"Eligible Assignments","src":"https://i.ibb.co/N609WF4/Eligible-Assignments.png","width":"auto","height":"auto"},"type":"IMAGE","mutability":"MUTABLE"}},"blocks":[{"data":{},"depth":0,"text":"Fabrikam identifies the following security requirements:","key":"376vd","type":"unstyled","entityRanges":[],"inlineStyleRanges":[]},{"data":{},"key":"5f2ru","inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","entityRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"key":"7oc0n","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","depth":0,"data":{},"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[],"data":{},"key":"bo064","depth":0,"inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","type":"unordered-list-item"},{"key":"bq41i","entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"type":"unordered-list-item"},{"key":"8jnbt","data":{},"inlineStyleRanges":[],"type":"unordered-list-item","depth":0,"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","entityRanges":[]},{"data":{},"depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","key":"fkpir","inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[]},{"type":"unordered-list-item","data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0,"entityRanges":[],"key":"3knma","inlineStyleRanges":[]},{"text":"The principle of least privilege must be used whenever possible","depth":0,"type":"unordered-list-item","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"4habl"},{"entityRanges":[],"text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit.","key":"stm8","data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"depth":0,"entityRanges":[{"offset":0,"key":0,"length":1}],"inlineStyleRanges":[],"data":{},"key":"1b5s7","text":" ","type":"atomic"},{"text":"","depth":0,"key":"a2q2u","entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"data":{}},{"data":{},"entityRanges":[{"offset":0,"key":1,"length":1}],"inlineStyleRanges":[],"key":"14f2n","depth":0,"type":"atomic","text":" "},{"key":"dsva5","inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[],"text":"What should you do to meet the security requirements?","type":"unstyled"}]},"references":{"blocks":[{"key":"dctl8","inlineStyleRanges":[{"length":126,"offset":37,"style":"color-rgb(33,37,41)"},{"style":"bgcolor-rgb(255,255,255)","offset":37,"length":126},{"style":"fontsize-16","length":126,"offset":37},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":37,"length":126}],"data":{},"entityRanges":[],"depth":0,"text":"To fulfill the security requirement \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time.\" the user accounts should not say Permanent in the End time.","type":"unstyled"},{"depth":0,"inlineStyleRanges":[],"key":"8hpni","entityRanges":[{"offset":0,"key":0,"length":124}],"data":{},"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s"}],"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","targetOption":"_blank"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
