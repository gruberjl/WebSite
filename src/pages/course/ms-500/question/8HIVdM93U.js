...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Change the Assignment Type for Admin2 to Permanent","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1"},{"isCorrectAnswer":true,"value":"Change the Assignment Type for Admin1 to Eligible"}],"id":"8HIVdM93U","question":{"blocks":[{"entityRanges":[],"key":"376vd","data":{},"inlineStyleRanges":[],"text":"Fabrikam identifies the following security requirements:","depth":0,"type":"unstyled"},{"key":"5f2ru","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","depth":0,"entityRanges":[],"type":"unordered-list-item","data":{},"inlineStyleRanges":[]},{"entityRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","key":"7oc0n","data":{},"depth":0,"type":"unordered-list-item","inlineStyleRanges":[]},{"inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unordered-list-item","depth":0,"key":"bo064","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations"},{"depth":0,"data":{},"key":"bq41i","entityRanges":[],"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[]},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","inlineStyleRanges":[],"data":{},"depth":0,"type":"unordered-list-item","entityRanges":[],"key":"8jnbt"},{"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","depth":0,"key":"fkpir","data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unordered-list-item"},{"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0,"key":"3knma"},{"type":"unordered-list-item","depth":0,"entityRanges":[],"text":"The principle of least privilege must be used whenever possible","inlineStyleRanges":[],"data":{},"key":"4habl"},{"data":{},"entityRanges":[],"key":"stm8","inlineStyleRanges":[],"depth":0,"text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit.","type":"unstyled"},{"key":"1b5s7","entityRanges":[{"length":1,"key":0,"offset":0}],"type":"atomic","text":" ","inlineStyleRanges":[],"depth":0,"data":{}},{"data":{},"type":"unstyled","inlineStyleRanges":[],"text":"","entityRanges":[],"key":"a2q2u","depth":0},{"entityRanges":[{"offset":0,"key":1,"length":1}],"key":"14f2n","depth":0,"data":{},"type":"atomic","text":" ","inlineStyleRanges":[]},{"text":"What should you do to meet the security requirements?","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"data":{},"key":"dsva5","depth":0}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"width":"auto","alignment":"left","height":"auto","alt":"Active Assignments","src":"https://i.ibb.co/5cPfF5D/Active-Assignments.png"}},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","width":"auto","src":"https://i.ibb.co/N609WF4/Eligible-Assignments.png","height":"auto","alt":"Eligible Assignments"}}}},"references":{"blocks":[{"key":"dctl8","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":126,"offset":37},{"style":"bgcolor-rgb(255,255,255)","offset":37,"length":126},{"style":"fontsize-16","length":126,"offset":37},{"offset":37,"length":126,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"text":"To fulfill the security requirement \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time.\" the user accounts should not say Permanent in the End time.","entityRanges":[],"depth":0,"data":{},"type":"unstyled"},{"data":{},"type":"unstyled","inlineStyleRanges":[],"key":"8hpni","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","entityRanges":[{"key":0,"length":124,"offset":0}]}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
