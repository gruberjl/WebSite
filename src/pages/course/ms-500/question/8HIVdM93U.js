...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Change the Assignment Type for Admin2 to Permanent"},{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2"},{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1"},{"isCorrectAnswer":true,"value":"Change the Assignment Type for Admin1 to Eligible"}],"id":"8HIVdM93U","question":{"blocks":[{"text":"Fabrikam identifies the following security requirements:","entityRanges":[],"depth":0,"type":"unstyled","inlineStyleRanges":[],"key":"376vd","data":{}},{"key":"5f2ru","inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[],"data":{}},{"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"7oc0n"},{"entityRanges":[],"key":"bo064","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","inlineStyleRanges":[],"type":"unordered-list-item","data":{},"depth":0},{"key":"bq41i","data":{},"inlineStyleRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","type":"unordered-list-item","entityRanges":[],"depth":0},{"data":{},"key":"8jnbt","inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","entityRanges":[]},{"type":"unordered-list-item","entityRanges":[],"data":{},"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","key":"fkpir","depth":0,"inlineStyleRanges":[]},{"key":"3knma","type":"unordered-list-item","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","data":{}},{"depth":0,"inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","entityRanges":[],"type":"unordered-list-item","key":"4habl","data":{}},{"inlineStyleRanges":[],"key":"stm8","type":"unstyled","depth":0,"data":{},"text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit.","entityRanges":[]},{"key":"1b5s7","entityRanges":[{"length":1,"key":0,"offset":0}],"depth":0,"text":" ","data":{},"inlineStyleRanges":[],"type":"atomic"},{"type":"unstyled","key":"a2q2u","inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[],"text":""},{"entityRanges":[{"length":1,"key":1,"offset":0}],"data":{},"depth":0,"inlineStyleRanges":[],"type":"atomic","text":" ","key":"14f2n"},{"key":"dsva5","depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"What should you do to meet the security requirements?"}],"entityMap":{"0":{"type":"IMAGE","data":{"height":"auto","src":"https://i.ibb.co/5cPfF5D/Active-Assignments.png","width":"auto","alignment":"left","alt":"Active Assignments"},"mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"height":"auto","alt":"Eligible Assignments","width":"auto","alignment":"left","src":"https://i.ibb.co/N609WF4/Eligible-Assignments.png"},"type":"IMAGE"}}},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","targetOption":"_blank"}}},"blocks":[{"entityRanges":[],"key":"dctl8","depth":0,"inlineStyleRanges":[{"length":126,"style":"color-rgb(33,37,41)","offset":37},{"offset":37,"style":"bgcolor-rgb(255,255,255)","length":126},{"offset":37,"style":"fontsize-16","length":126},{"length":126,"offset":37,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"text":"To fulfill the security requirement \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time.\" the user accounts should not say Permanent in the End time.","data":{},"type":"unstyled"},{"inlineStyleRanges":[],"data":{},"type":"unstyled","key":"8hpni","entityRanges":[{"length":124,"key":0,"offset":0}],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
