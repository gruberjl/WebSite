...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Change the Assignment Type for Admin2 to Permanent"},{"value":"From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1"},{"isCorrectAnswer":true,"value":"Change the Assignment Type for Admin1 to Eligible"}],"id":"8HIVdM93U","question":{"blocks":[{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"key":"376vd","text":"Fabrikam identifies the following security requirements:","data":{},"depth":0},{"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","key":"5f2ru","depth":0,"data":{},"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[]},{"inlineStyleRanges":[],"key":"7oc0n","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","data":{},"depth":0,"type":"unordered-list-item","entityRanges":[]},{"entityRanges":[],"data":{},"type":"unordered-list-item","key":"bo064","inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","depth":0},{"entityRanges":[],"data":{},"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","key":"bq41i","depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"key":"8jnbt","type":"unordered-list-item","data":{},"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0},{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","key":"fkpir","type":"unordered-list-item","data":{}},{"depth":0,"inlineStyleRanges":[],"key":"3knma","type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","entityRanges":[],"data":{}},{"data":{},"type":"unordered-list-item","entityRanges":[],"text":"The principle of least privilege must be used whenever possible","key":"4habl","depth":0,"inlineStyleRanges":[]},{"type":"unstyled","key":"stm8","data":{},"depth":0,"text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit.","entityRanges":[],"inlineStyleRanges":[]},{"text":" ","inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":0,"length":1}],"key":"1b5s7","depth":0,"data":{},"type":"atomic"},{"depth":0,"data":{},"type":"unstyled","inlineStyleRanges":[],"key":"a2q2u","text":"","entityRanges":[]},{"data":{},"text":" ","depth":0,"inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":1,"length":1}],"key":"14f2n","type":"atomic"},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","key":"dsva5","depth":0,"text":"What should you do to meet the security requirements?"}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"src":"https://i.ibb.co/5cPfF5D/Active-Assignments.png","alt":"Active Assignments","width":"auto","height":"auto","alignment":"left"}},"1":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","alignment":"left","src":"https://i.ibb.co/N609WF4/Eligible-Assignments.png","width":"auto","alt":"Eligible Assignments"}}}},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"text":"To fulfill the security requirement \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time.\" the user accounts should not say Permanent in the End time.","key":"dctl8","entityRanges":[],"depth":0,"data":{},"type":"unstyled","inlineStyleRanges":[{"length":126,"style":"color-rgb(33,37,41)","offset":37},{"style":"bgcolor-rgb(255,255,255)","length":126,"offset":37},{"offset":37,"style":"fontsize-16","length":126},{"length":126,"offset":37,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}]},{"data":{},"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":0,"length":124}],"key":"8hpni","type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
