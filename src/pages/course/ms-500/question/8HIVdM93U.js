...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Change the Assignment Type for Admin2 to Permanent","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2"},{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1"},{"value":"Change the Assignment Type for Admin1 to Eligible","isCorrectAnswer":true}],"references":{"blocks":[{"type":"unstyled","data":{},"entityRanges":[],"text":"","key":"dctl8","inlineStyleRanges":[],"depth":0}],"entityMap":{}},"question":{"blocks":[{"inlineStyleRanges":[],"text":"Fabrikam identifies the following security requirements:","entityRanges":[],"type":"unstyled","data":{},"key":"376vd","depth":0},{"inlineStyleRanges":[],"entityRanges":[],"key":"5f2ru","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","data":{},"depth":0},{"entityRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","key":"7oc0n","depth":0,"data":{},"inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"key":"bo064","type":"unordered-list-item","inlineStyleRanges":[],"data":{},"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations"},{"key":"bq41i","inlineStyleRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"type":"unordered-list-item","entityRanges":[],"depth":0},{"data":{},"entityRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","inlineStyleRanges":[],"type":"unordered-list-item","key":"8jnbt","depth":0},{"type":"unordered-list-item","entityRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","inlineStyleRanges":[],"data":{},"key":"fkpir","depth":0},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","depth":0,"text":"Email messages that include attachments containing malware must be delivered without the attachment","key":"3knma"},{"text":"The principle of least privilege must be used whenever possible","entityRanges":[],"data":{},"depth":0,"type":"unordered-list-item","inlineStyleRanges":[],"key":"4habl"},{"data":{},"type":"unstyled","entityRanges":[],"key":"stm8","depth":0,"inlineStyleRanges":[],"text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit."},{"data":{},"type":"atomic","entityRanges":[{"offset":0,"key":0,"length":1}],"text":" ","key":"1b5s7","inlineStyleRanges":[],"depth":0},{"inlineStyleRanges":[],"text":"","data":{},"entityRanges":[],"key":"a2q2u","depth":0,"type":"unstyled"},{"entityRanges":[{"length":1,"offset":0,"key":1}],"depth":0,"type":"atomic","data":{},"inlineStyleRanges":[],"key":"14f2n","text":" "},{"type":"unstyled","depth":0,"data":{},"key":"dsva5","entityRanges":[],"inlineStyleRanges":[],"text":"What should you do to meet the security requirements?"}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"alignment":"left","width":"auto","src":"https://i.ibb.co/5cPfF5D/Active-Assignments.png","height":"auto","alt":"Active Assignments"}},"1":{"type":"IMAGE","mutability":"MUTABLE","data":{"alt":"Eligible Assignments","src":"https://i.ibb.co/N609WF4/Eligible-Assignments.png","width":"auto","height":"auto","alignment":"left"}}}},"id":"8HIVdM93U"},
      previousQuestionId: '',
      nextQuestionId: '',
