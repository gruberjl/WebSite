...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Change the Assignment Type for Admin2 to Permanent","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1","isCorrectAnswer":false},{"value":"Change the Assignment Type for Admin1 to Eligible","isCorrectAnswer":true}],"id":"8HIVdM93U","question":{"entityMap":{"0":{"type":"IMAGE","data":{"height":"auto","alignment":"left","width":"auto","src":"https://i.ibb.co/5cPfF5D/Active-Assignments.png","alt":"Active Assignments"},"mutability":"MUTABLE"},"1":{"data":{"src":"https://i.ibb.co/N609WF4/Eligible-Assignments.png","alt":"Eligible Assignments","width":"auto","height":"auto","alignment":"left"},"type":"IMAGE","mutability":"MUTABLE"}},"blocks":[{"data":{},"depth":0,"inlineStyleRanges":[],"text":"Fabrikam identifies the following security requirements:","entityRanges":[],"type":"unstyled","key":"376vd"},{"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","entityRanges":[],"data":{},"key":"5f2ru"},{"inlineStyleRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","key":"7oc0n","depth":0,"entityRanges":[],"type":"unordered-list-item","data":{}},{"entityRanges":[],"data":{},"type":"unordered-list-item","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"bo064","depth":0,"inlineStyleRanges":[]},{"data":{},"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[],"entityRanges":[],"key":"bq41i","depth":0},{"key":"8jnbt","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item","depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[]},{"type":"unordered-list-item","key":"fkpir","entityRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{},"inlineStyleRanges":[],"depth":0},{"key":"3knma","inlineStyleRanges":[],"data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment","entityRanges":[],"type":"unordered-list-item","depth":0},{"key":"4habl","type":"unordered-list-item","text":"The principle of least privilege must be used whenever possible","entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0},{"depth":0,"entityRanges":[],"data":{},"key":"stm8","inlineStyleRanges":[],"type":"unstyled","text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit."},{"depth":0,"inlineStyleRanges":[],"key":"1b5s7","entityRanges":[{"length":1,"key":0,"offset":0}],"text":" ","data":{},"type":"atomic"},{"key":"a2q2u","text":"","depth":0,"type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"entityRanges":[{"key":1,"length":1,"offset":0}],"data":{},"type":"atomic","key":"14f2n","inlineStyleRanges":[],"text":" ","depth":0},{"key":"dsva5","depth":0,"text":"What should you do to meet the security requirements?","entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unstyled"}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s"}}},"blocks":[{"key":"dctl8","text":"To fulfill the security requirement \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time.\" the user accounts should not say Permanent in the End time.","type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[{"offset":37,"style":"color-rgb(33,37,41)","length":126},{"style":"bgcolor-rgb(255,255,255)","length":126,"offset":37},{"style":"fontsize-16","offset":37,"length":126},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":126,"offset":37}],"depth":0},{"entityRanges":[{"offset":0,"length":124,"key":0}],"data":{},"key":"8hpni","text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","depth":0,"inlineStyleRanges":[],"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
