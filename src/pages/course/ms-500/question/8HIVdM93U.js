...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Change the Assignment Type for Admin2 to Permanent","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1","isCorrectAnswer":false},{"value":"Change the Assignment Type for Admin1 to Eligible","isCorrectAnswer":true}],"id":"8HIVdM93U","question":{"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","key":"376vd","data":{},"depth":0,"text":"Fabrikam identifies the following security requirements:"},{"type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","inlineStyleRanges":[],"key":"5f2ru","depth":0,"entityRanges":[],"data":{}},{"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"key":"7oc0n","data":{},"depth":0},{"entityRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"bo064","inlineStyleRanges":[],"data":{},"type":"unordered-list-item","depth":0},{"depth":0,"entityRanges":[],"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","key":"bq41i","data":{},"inlineStyleRanges":[]},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","data":{},"inlineStyleRanges":[],"key":"8jnbt","depth":0,"type":"unordered-list-item","entityRanges":[]},{"key":"fkpir","inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{}},{"data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment","entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"3knma","type":"unordered-list-item"},{"inlineStyleRanges":[],"key":"4habl","text":"The principle of least privilege must be used whenever possible","depth":0,"entityRanges":[],"type":"unordered-list-item","data":{}},{"key":"stm8","depth":0,"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit.","data":{}},{"entityRanges":[{"length":1,"key":0,"offset":0}],"inlineStyleRanges":[],"data":{},"type":"atomic","text":" ","depth":0,"key":"1b5s7"},{"inlineStyleRanges":[],"data":{},"text":"","type":"unstyled","entityRanges":[],"depth":0,"key":"a2q2u"},{"key":"14f2n","data":{},"type":"atomic","inlineStyleRanges":[],"text":" ","entityRanges":[{"key":1,"offset":0,"length":1}],"depth":0},{"text":"What should you do to meet the security requirements?","entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"key":"dsva5","type":"unstyled"}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","src":"https://i.ibb.co/5cPfF5D/Active-Assignments.png","alt":"Active Assignments","width":"auto","alignment":"left"}},"1":{"data":{"height":"auto","alignment":"left","width":"auto","alt":"Eligible Assignments","src":"https://i.ibb.co/N609WF4/Eligible-Assignments.png"},"mutability":"MUTABLE","type":"IMAGE"}}},"references":{"blocks":[{"depth":0,"entityRanges":[],"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":126,"offset":37},{"style":"bgcolor-rgb(255,255,255)","length":126,"offset":37},{"style":"fontsize-16","length":126,"offset":37},{"offset":37,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":126}],"text":"To fulfill the security requirement \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time.\" the user accounts should not say Permanent in the End time.","type":"unstyled","key":"dctl8","data":{}},{"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","inlineStyleRanges":[],"type":"unstyled","data":{},"depth":0,"key":"8hpni","entityRanges":[{"key":0,"offset":0,"length":124}]}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
