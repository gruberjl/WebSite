...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Change the Assignment Type for Admin2 to Permanent","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, assign the Exchange administrator role to Admin2","isCorrectAnswer":false},{"value":"From the Azure Active Directory admin center, remove the Exchange administrator role to Admin1","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Change the Assignment Type for Admin1 to Eligible"}],"id":"8HIVdM93U","question":{"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","width":"auto","alt":"Active Assignments","alignment":"left","src":"https://i.ibb.co/5cPfF5D/Active-Assignments.png"}},"1":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","alt":"Eligible Assignments","alignment":"left","width":"auto","src":"https://i.ibb.co/N609WF4/Eligible-Assignments.png"}}},"blocks":[{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"Fabrikam identifies the following security requirements:","key":"376vd","data":{}},{"key":"5f2ru","inlineStyleRanges":[],"data":{},"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","depth":0,"entityRanges":[],"type":"unordered-list-item"},{"inlineStyleRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","entityRanges":[],"key":"7oc0n","data":{},"depth":0},{"data":{},"depth":0,"entityRanges":[],"key":"bo064","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","type":"unordered-list-item","inlineStyleRanges":[]},{"type":"unordered-list-item","entityRanges":[],"data":{},"key":"bq41i","depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[]},{"data":{},"depth":0,"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","inlineStyleRanges":[],"entityRanges":[],"key":"8jnbt","type":"unordered-list-item"},{"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","key":"fkpir","type":"unordered-list-item","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0,"inlineStyleRanges":[],"key":"3knma","type":"unordered-list-item","entityRanges":[]},{"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item","entityRanges":[],"key":"4habl","data":{},"inlineStyleRanges":[],"depth":0},{"text":"An administrator configures Azure AD Privileged Identity Management as shown in the following exhibit.","entityRanges":[],"key":"stm8","type":"unstyled","inlineStyleRanges":[],"data":{},"depth":0},{"data":{},"type":"atomic","entityRanges":[{"length":1,"offset":0,"key":0}],"inlineStyleRanges":[],"key":"1b5s7","text":" ","depth":0},{"data":{},"depth":0,"text":"","entityRanges":[],"inlineStyleRanges":[],"key":"a2q2u","type":"unstyled"},{"text":" ","entityRanges":[{"key":1,"offset":0,"length":1}],"inlineStyleRanges":[],"data":{},"type":"atomic","key":"14f2n","depth":0},{"data":{},"key":"dsva5","depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"What should you do to meet the security requirements?"}]},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s"},"type":"LINK"}},"blocks":[{"entityRanges":[],"inlineStyleRanges":[{"length":126,"style":"color-rgb(33,37,41)","offset":37},{"offset":37,"length":126,"style":"bgcolor-rgb(255,255,255)"},{"length":126,"offset":37,"style":"fontsize-16"},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":126,"offset":37}],"text":"To fulfill the security requirement \"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time.\" the user accounts should not say Permanent in the End time.","type":"unstyled","key":"dctl8","depth":0,"data":{}},{"key":"8hpni","depth":0,"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","entityRanges":[{"length":124,"key":0,"offset":0}],"data":{},"inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
