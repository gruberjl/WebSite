...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Turn off Delayed updates for the Microsoft Defender for Identity sensors.","isCorrectAnswer":false},{"value":"Configure auditing in the Office 365 Security & Compliance center.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Turn on Delayed updates for the Microsoft Defender for Identity sensors."},{"isCorrectAnswer":true,"value":"Integrate SIEM and Microsoft Defender for identity."}],"id":"L1SBGW44b","question":{"blocks":[{"data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Your network contains an on-premises Active Directory domain. The domain contains servers that run Windows Server and have advanced auditing enabled.","key":"9bi1q","type":"unstyled"},{"inlineStyleRanges":[],"text":"The security logs of the servers are collected by using a third-party SIEM solution.","key":"83ivf","type":"unstyled","depth":0,"data":{},"entityRanges":[]},{"entityRanges":[],"key":"7e2p1","data":{},"inlineStyleRanges":[],"text":"You purchase a Microsoft 365 subscription and plan to deploy Microsoft Defender for identity by using standalone sensors.","depth":0,"type":"unstyled"},{"key":"ckv72","data":{},"depth":0,"type":"unstyled","entityRanges":[],"text":"You need to ensure that you can detect when sensitive groups are modified and when malicious services are created.","inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"data":{},"key":"5jeqb","text":"What should you do?"}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA","targetOption":"_blank"}},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-event-forwarding"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"5ild6","text":"You'll need to integrate a SIEM and Defender for Identity when you're using a third-party SIEM solution and you want Defender for Identity to detect when sensitive groups are modified and when malicious services are created. In short, anytime you want Defender for Identity to alert when the SIEM solution picks up an issue."},{"inlineStyleRanges":[],"data":{},"type":"unstyled","entityRanges":[],"key":"f9d07","depth":0,"text":"How do you integrate a SIEM solution and Defender for Identity? By configuring event forwarding on the domain controllers / SIEM solution."},{"text":"There are multiple variations of this same question in the MS-500 with a couple of different correct answers:","key":"a52ju","entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{}},{"entityRanges":[],"data":{},"text":"1. Integrate SIEM and Defender for Identity.","inlineStyleRanges":[],"key":"8soon","depth":0,"type":"unstyled"},{"depth":0,"text":"2. Configure Event Forwarding on the domain controllers","type":"unstyled","key":"537gi","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"text":"https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA","entityRanges":[{"length":90,"key":0,"offset":0}],"data":{},"depth":0,"type":"unstyled","key":"bkm9o","inlineStyleRanges":[]},{"text":"https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-event-forwarding ","type":"unstyled","key":"6vb60","inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[{"offset":0,"key":1,"length":92}]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
