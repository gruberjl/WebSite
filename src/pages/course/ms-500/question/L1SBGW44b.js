...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Disable the delayed updates option for the Microsoft Defender for Identity sensors."},{"isCorrectAnswer":false,"value":"Enable auditing in the Office 365 Security & Compliance center."},{"value":"Enable the delayed updates option for the Microsoft Defender for Identity sensors.","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Integrate the third-party SIEM solution with Microsoft Defender for identity."}],"id":"L1SBGW44b","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"text":"Your organization has an on-premises Active Directory domain that runs Windows Server 2022 servers and has advanced auditing enabled. Your organization is already collecting the servers' security logs using a third-party SIEM solution.","entityRanges":[],"key":"9bi1q","data":{},"depth":0,"type":"unstyled"},{"depth":0,"key":"7e2p1","entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"Your organization has purchased a Microsoft 365 tenant and your manager has asked you to deploy Microsoft Defender for identity by using standalone sensors.","type":"unstyled"},{"data":{},"depth":0,"key":"ckv72","inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"text":"You need to configure the Defender for Identity standalone sensor to detect when certain sensitive groups are updated and any time malicious services are created."},{"type":"unstyled","text":"How can you fulfill your manager's request?","entityRanges":[],"inlineStyleRanges":[],"depth":0,"key":"5jeqb","data":{}}]},"references":{"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA","targetOption":"_blank"},"mutability":"MUTABLE"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-event-forwarding","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"data":{},"text":"You'll need to integrate a SIEM and Defender for Identity when you're using a third-party SIEM solution and you want Defender for Identity to detect when sensitive groups are modified and when malicious services are created. In short, anytime you want Defender for Identity to alert when the SIEM solution picks up an issue.","entityRanges":[],"key":"5ild6","type":"unstyled","inlineStyleRanges":[],"depth":0},{"entityRanges":[{"key":0,"offset":0,"length":90}],"type":"unstyled","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA","depth":0,"data":{},"key":"bkm9o"},{"depth":0,"entityRanges":[{"key":1,"offset":0,"length":92}],"key":"6vb60","text":"https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-event-forwarding ","inlineStyleRanges":[],"data":{},"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
