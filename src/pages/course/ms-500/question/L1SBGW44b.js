...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Turn off Delayed updates for the Microsoft Defender for Identity sensors."},{"value":"Configure auditing in the Office 365 Security & Compliance center.","isCorrectAnswer":false},{"value":"Turn on Delayed updates for the Microsoft Defender for Identity sensors.","isCorrectAnswer":false},{"value":"Integrate SIEM and Microsoft Defender for identity.","isCorrectAnswer":true}],"id":"L1SBGW44b","question":{"entityMap":{},"blocks":[{"data":{},"type":"unstyled","entityRanges":[],"text":"Your network contains an on-premises Active Directory domain. The domain contains servers that run Windows Server and have advanced auditing enabled.","key":"9bi1q","inlineStyleRanges":[],"depth":0},{"key":"83ivf","entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"The security logs of the servers are collected by using a third-party SIEM solution.","depth":0},{"entityRanges":[],"depth":0,"key":"7e2p1","data":{},"text":"You purchase a Microsoft 365 subscription and plan to deploy Microsoft Defender for identity by using standalone sensors.","inlineStyleRanges":[],"type":"unstyled"},{"type":"unstyled","key":"ckv72","inlineStyleRanges":[],"text":"You need to ensure that you can detect when sensitive groups are modified and when malicious services are created.","data":{},"entityRanges":[],"depth":0},{"data":{},"text":"What should you do?","depth":0,"entityRanges":[],"key":"5jeqb","inlineStyleRanges":[],"type":"unstyled"}]},"references":{"blocks":[{"entityRanges":[],"data":{},"key":"5ild6","depth":0,"inlineStyleRanges":[],"type":"unstyled","text":"You'll need to integrate a SIEM and Defender for Identity when you're using a third-party SIEM solution and you want Defender for Identity to detect when sensitive groups are modified and when malicious services are created. In short, anytime you want Defender for Identity to alert when the SIEM solution picks up an issue."},{"inlineStyleRanges":[],"type":"unstyled","key":"f9d07","depth":0,"text":"How do you integrate a SIEM solution and Defender for Identity? By configuring event forwarding on the domain controllers / SIEM solution.","entityRanges":[],"data":{}},{"inlineStyleRanges":[],"text":"There are multiple variations of this same question in the MS-500 with a couple of different correct answers:","entityRanges":[],"depth":0,"key":"a52ju","type":"unstyled","data":{}},{"data":{},"text":"1. Integrate SIEM and Defender for Identity.","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"key":"8soon","depth":0},{"depth":0,"key":"537gi","data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"2. Configure Event Forwarding on the domain controllers"},{"type":"unstyled","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA","depth":0,"entityRanges":[{"offset":0,"length":90,"key":0}],"key":"bkm9o","data":{}},{"entityRanges":[{"key":1,"length":92,"offset":0}],"data":{},"depth":0,"text":"https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-event-forwarding ","key":"6vb60","type":"unstyled","inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA","targetOption":"_blank"}},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-event-forwarding","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
