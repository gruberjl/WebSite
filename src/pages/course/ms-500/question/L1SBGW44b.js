...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Turn off Delayed updates for the Microsoft Defender for Identity sensors."},{"value":"Configure auditing in the Office 365 Security & Compliance center.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Turn on Delayed updates for the Microsoft Defender for Identity sensors."},{"value":"Integrate SIEM and Microsoft Defender for identity.","isCorrectAnswer":true}],"id":"L1SBGW44b","question":{"entityMap":{},"blocks":[{"depth":0,"data":{},"inlineStyleRanges":[],"text":"Your network contains an on-premises Active Directory domain. The domain contains servers that run Windows Server and have advanced auditing enabled.","key":"9bi1q","type":"unstyled","entityRanges":[]},{"data":{},"depth":0,"text":"The security logs of the servers are collected by using a third-party SIEM solution.","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"key":"83ivf"},{"depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"You purchase a Microsoft 365 subscription and plan to deploy Microsoft Defender for identity by using standalone sensors.","entityRanges":[],"key":"7e2p1"},{"key":"ckv72","inlineStyleRanges":[],"entityRanges":[],"text":"You need to ensure that you can detect when sensitive groups are modified and when malicious services are created.","type":"unstyled","data":{},"depth":0},{"data":{},"depth":0,"entityRanges":[],"text":"What should you do?","type":"unstyled","key":"5jeqb","inlineStyleRanges":[]}]},"references":{"blocks":[{"inlineStyleRanges":[],"text":"You'll need to integrate a SIEM and Defender for Identity when you're using a third-party SIEM solution and you want Defender for Identity to detect when sensitive groups are modified and when malicious services are created. In short, anytime you want Defender for Identity to alert when the SIEM solution picks up an issue.","key":"5ild6","depth":0,"entityRanges":[],"data":{},"type":"unstyled"},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"How do you integrate a SIEM solution and Defender for Identity? By configuring event forwarding on the domain controllers / SIEM solution.","key":"f9d07","type":"unstyled","depth":0},{"depth":0,"text":"There are multiple variations of this same question in the MS-500 with a couple of different correct answers:","inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[],"key":"a52ju"},{"depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"1. Integrate SIEM and Defender for Identity.","key":"8soon","type":"unstyled"},{"type":"unstyled","key":"537gi","text":"2. Configure Event Forwarding on the domain controllers","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[]},{"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA","key":"bkm9o","depth":0,"inlineStyleRanges":[],"entityRanges":[{"key":0,"offset":0,"length":90}],"type":"unstyled"},{"entityRanges":[{"offset":0,"key":1,"length":92}],"inlineStyleRanges":[],"type":"unstyled","depth":0,"text":"https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-event-forwarding ","data":{},"key":"6vb60"}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA"},"mutability":"MUTABLE","type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-event-forwarding","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
