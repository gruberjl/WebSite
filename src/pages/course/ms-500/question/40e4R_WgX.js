...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Increase the permission level for OneDrive External sharing so your users can share with users at Uber Bikes.","isCorrectAnswer":false},{"value":"Modify the Links settings.","isCorrectAnswer":true},{"value":"Decrease the permissions for OneDrive External sharing so your users can only share with users at Uber Bikes.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Modify the Device access settings so your users cannot access OneDrive files unless they are on a managed device."},{"isCorrectAnswer":false,"value":"Modify the Sync settings so your users can't sync their files to their devices."}],"id":"40e4R_WgX","question":{"blocks":[{"key":"33fgs","inlineStyleRanges":[],"text":"Your organization has a Microsoft 365 tenant with a primary domain of GitBit.org","type":"unstyled","depth":0,"data":{},"entityRanges":[]},{"key":"9sl95","depth":0,"text":"Your organization works with a partner company named Uber Bikes. Your Microsoft OneDrive settings haven't been changed.","type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"text":"You need to allow your users to share files from Microsoft OneDrive to specific users at Uber Bikes but prevent your users from sharing files with anyone else.","key":"26io4","entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{}},{"data":{},"key":"8uovg","depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"What settings should you change in the SharePoint Online admin center?"}],"entityMap":{}},"references":{"blocks":[{"key":"ahbov","type":"unstyled","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"By default, OneDrive files can be shared with anyone so increasing the permission level doesn't make sense."},{"inlineStyleRanges":[],"key":"4thd2","data":{},"type":"unstyled","text":"By default, the link settings are set to \"Anyone with the link\" so they should be set to Specific people.","depth":0,"entityRanges":[]},{"data":{},"inlineStyleRanges":[],"key":"6sb7a","entityRanges":[],"text":"By setting the OneDrive External sharing to the least permissive level users would only be able to share with users that are currently in the GitBit organization so your users wouldn't be able to share with Litware.","type":"unstyled","depth":0},{"entityRanges":[],"depth":0,"data":{},"type":"unstyled","inlineStyleRanges":[],"key":"b8vlr","text":"Decreasing the permission level for OneDrive External sharing would be correct so users cannot share with anyone."},{"entityRanges":[],"text":"Modifying the device and sync settings wouldn't change who users can share too.","inlineStyleRanges":[],"depth":0,"data":{},"type":"unstyled","key":"237vv"},{"inlineStyleRanges":[],"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI ","entityRanges":[{"offset":0,"key":0,"length":128}],"depth":0,"key":"1ne1r","data":{}},{"entityRanges":[{"key":1,"offset":0,"length":75}],"depth":0,"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off ","key":"2e97s","type":"unstyled","data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI"}},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
