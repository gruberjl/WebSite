...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Increase the permission level for OneDrive External sharing so your users can share with users at Uber Bikes.","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Modify the Links settings."},{"isCorrectAnswer":true,"value":"Decrease the permissions for OneDrive External sharing so your users can only share with users at Uber Bikes."},{"isCorrectAnswer":false,"value":"Modify the Device access settings so your users cannot access OneDrive files unless they are on a managed device."},{"isCorrectAnswer":false,"value":"Modify the Sync settings so your users can't sync their files to their devices."}],"id":"40e4R_WgX","question":{"blocks":[{"text":"Your organization has a Microsoft 365 tenant with a primary domain of GitBit.org","key":"33fgs","inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[],"data":{}},{"key":"9sl95","inlineStyleRanges":[],"data":{},"depth":0,"text":"Your organization works with a partner company named Uber Bikes. Your Microsoft OneDrive settings haven't been changed.","type":"unstyled","entityRanges":[]},{"type":"unstyled","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"You need to allow your users to share files from Microsoft OneDrive to specific users at Uber Bikes but prevent your users from sharing files with anyone else.","key":"26io4"},{"key":"8uovg","entityRanges":[],"inlineStyleRanges":[],"depth":0,"data":{},"text":"What settings should you change in the SharePoint Online admin center?","type":"unstyled"}],"entityMap":{}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI","targetOption":"_blank"},"type":"LINK"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"data":{},"type":"unstyled","key":"ahbov","inlineStyleRanges":[],"depth":0,"entityRanges":[],"text":"By default, OneDrive files can be shared with anyone so increasing the permission level doesn't make sense."},{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"4thd2","data":{},"text":"By default, the link settings are set to \"Anyone with the link\" so they should be set to Specific people.","type":"unstyled"},{"data":{},"type":"unstyled","entityRanges":[],"depth":0,"key":"6sb7a","text":"By setting the OneDrive External sharing to the least permissive level users would only be able to share with users that are currently in the GitBit organization so your users wouldn't be able to share with Litware.","inlineStyleRanges":[]},{"entityRanges":[],"key":"b8vlr","type":"unstyled","inlineStyleRanges":[],"depth":0,"data":{},"text":"Decreasing the permission level for OneDrive External sharing would be correct so users cannot share with anyone."},{"inlineStyleRanges":[],"data":{},"text":"Modifying the device and sync settings wouldn't change who users can share too.","type":"unstyled","key":"237vv","depth":0,"entityRanges":[]},{"inlineStyleRanges":[],"depth":0,"key":"1ne1r","text":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI ","entityRanges":[{"key":0,"length":128,"offset":0}],"type":"unstyled","data":{}},{"key":"2e97s","inlineStyleRanges":[],"type":"unstyled","entityRanges":[{"key":1,"length":75,"offset":0}],"depth":0,"text":"https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off ","data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
