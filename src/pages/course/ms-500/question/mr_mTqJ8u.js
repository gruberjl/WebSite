...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Connect to the Security & Compliance admin center using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Go to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file"},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center by using PowerShell > Export the current rules as a JSON file > Modify the file > Upload the file"},{"isCorrectAnswer":false,"value":"Go to the Security & Compliance admin center > Export the current rules as a JSON file > Modify the file > Upload the file"}],"id":"mr_mTqJ8u","question":{"blocks":[{"data":{},"text":"Your organization has a Microsoft 365 tenant.","type":"unstyled","key":"3ik3u","entityRanges":[],"inlineStyleRanges":[],"depth":0},{"inlineStyleRanges":[],"key":"crflb","depth":0,"entityRanges":[],"data":{},"text":"You need to include a sensitive information type in Data Subject Request cases.","type":"unstyled"},{"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"e3rai","data":{},"text":"Which four actions should you perform in sequence?","type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"depth":0,"inlineStyleRanges":[],"type":"unstyled","text":"1. Connect to the Security & Compliance admin center using PowerShell. The command is \"Connect-IPPSSession\"","entityRanges":[],"key":"dkobb","data":{}},{"key":"bhkqv","text":"2. Export the current rules as an XML file. The command is \"Get-DlpSensitiveInformationTypeRulePackage | Export-Clixml .\\rules.xml\"","entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0,"type":"unstyled"},{"text":"3. Modify the file making the changes you desire","depth":0,"key":"64qbf","inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unstyled"},{"type":"unstyled","key":"ds3ee","entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"text":"4. Upload the file. The command is \"New-DlpSensitiveInformationTypeRulePackage -FileData ([System.IO.File]::ReadAllBytes('PathToXml.xml'))\""},{"entityRanges":[{"key":0,"length":116,"offset":0}],"key":"46fov","inlineStyleRanges":[],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","data":{},"type":"unstyled"},{"depth":0,"key":"ejiq","entityRanges":[{"length":125,"offset":0,"key":1}],"inlineStyleRanges":[],"type":"unstyled","text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","data":{}}],"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w"},"mutability":"MUTABLE"},"1":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","targetOption":"_blank"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
