...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"key":"3ik3u","data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","text":"You have a Microsoft 365 subscription.","entityRanges":[]},{"text":"You need to include a custom sensitive information type in Data Subject Request (DSR) cases.","inlineStyleRanges":[],"key":"crflb","data":{},"entityRanges":[],"type":"unstyled","depth":0},{"key":"e3rai","entityRanges":[],"type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"Which four actions should you perform in sequence? To answer, move the appropriate actions from the list of actions to the answer area and arrange them in the correct order.","data":{}}],"entityMap":{}},"answers":[{"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":true},{"value":"Connect to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":false},{"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an JSON file > Modify the file > Upload the file","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center > Export the current rules as an JSON file > Modify the file > Upload the file"}],"references":{"blocks":[{"depth":0,"text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"dkobb"}],"entityMap":{}},"id":"mr_mTqJ8u"},
      previousQuestionId: '',
      nextQuestionId: '',
