...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file"},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an JSON file > Modify the file > Upload the file"},{"value":"Connect to the Security & Compliance admin center > Export the current rules as an JSON file > Modify the file > Upload the file","isCorrectAnswer":false}],"question":{"blocks":[{"inlineStyleRanges":[],"type":"unstyled","depth":0,"text":"You have a Microsoft 365 subscription.","key":"3ik3u","data":{},"entityRanges":[]},{"key":"crflb","data":{},"type":"unstyled","inlineStyleRanges":[],"text":"You need to include a custom sensitive information type in Data Subject Request (DSR) cases.","entityRanges":[],"depth":0},{"text":"Which four actions should you perform in sequence? To answer, move the appropriate actions from the list of actions to the answer area and arrange them in the correct order.","entityRanges":[],"inlineStyleRanges":[],"data":{},"key":"e3rai","depth":0,"type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"type":"unstyled","data":{},"inlineStyleRanges":[],"key":"dkobb","text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","depth":0}],"entityMap":{}},"id":"mr_mTqJ8u"},
      previousQuestionId: '',
      nextQuestionId: '',
