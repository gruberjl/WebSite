...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"mr_mTqJ8u","answers":[{"isCorrectAnswer":true,"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file"},{"value":"Connect to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":false},{"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an JSON file > Modify the file > Upload the file","isCorrectAnswer":false},{"value":"Connect to the Security & Compliance admin center > Export the current rules as an JSON file > Modify the file > Upload the file","isCorrectAnswer":false}],"references":{"entityMap":{},"blocks":[{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"unstyled","text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","data":{},"key":"dkobb"}]},"question":{"blocks":[{"key":"3ik3u","text":"You have a Microsoft 365 subscription.","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{},"depth":0},{"depth":0,"data":{},"text":"You need to include a custom sensitive information type in Data Subject Request (DSR) cases.","inlineStyleRanges":[],"key":"crflb","type":"unstyled","entityRanges":[]},{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"key":"e3rai","depth":0,"text":"Which four actions should you perform in sequence? To answer, move the appropriate actions from the list of actions to the answer area and arrange them in the correct order.","data":{}}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
