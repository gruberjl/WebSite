...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Connect to the Security & Compliance admin center using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file"},{"value":"Go to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":false},{"value":"Connect to the Security & Compliance admin center by using PowerShell > Export the current rules as a JSON file > Modify the file > Upload the file","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Go to the Security & Compliance admin center > Export the current rules as a JSON file > Modify the file > Upload the file"}],"id":"mr_mTqJ8u","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"data":{},"text":"Your organization has a Microsoft 365 tenant.","key":"3ik3u","depth":0,"type":"unstyled","entityRanges":[]},{"entityRanges":[],"depth":0,"text":"You need to include a sensitive information type in Data Subject Request cases.","type":"unstyled","inlineStyleRanges":[],"key":"crflb","data":{}},{"text":"Which four actions should you perform in sequence?","depth":0,"entityRanges":[],"key":"e3rai","type":"unstyled","inlineStyleRanges":[],"data":{}}]},"references":{"blocks":[{"text":"1. Connect to the Security & Compliance admin center using PowerShell. The command is \"Connect-IPPSSession\"","key":"dkobb","type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0},{"depth":0,"data":{},"key":"bhkqv","type":"unstyled","entityRanges":[],"text":"2. Export the current rules as an XML file. The command is \"Get-DlpSensitiveInformationTypeRulePackage | Export-Clixml .\\rules.xml\"","inlineStyleRanges":[]},{"type":"unstyled","key":"64qbf","entityRanges":[],"text":"3. Modify the file making the changes you desire","depth":0,"data":{},"inlineStyleRanges":[]},{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0,"key":"ds3ee","data":{},"text":"4. Upload the file. The command is \"New-DlpSensitiveInformationTypeRulePackage -FileData ([System.IO.File]::ReadAllBytes('PathToXml.xml'))\""},{"entityRanges":[{"offset":0,"key":0,"length":116}],"key":"46fov","depth":0,"type":"unstyled","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","inlineStyleRanges":[]},{"depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"ejiq","entityRanges":[{"length":125,"key":1,"offset":0}],"text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
