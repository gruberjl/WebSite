...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"entityMap":{},"blocks":[{"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"key":"3ik3u","data":{},"text":"You have a Microsoft 365 subscription.","depth":0},{"entityRanges":[],"key":"crflb","inlineStyleRanges":[],"data":{},"depth":0,"type":"unstyled","text":"You need to include a custom sensitive information type in Data Subject Request (DSR) cases."},{"inlineStyleRanges":[],"data":{},"depth":0,"text":"Which four actions should you perform in sequence? To answer, move the appropriate actions from the list of actions to the answer area and arrange them in the correct order.","type":"unstyled","key":"e3rai","entityRanges":[]}]},"id":"mr_mTqJ8u","answers":[{"isCorrectAnswer":true,"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file"},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file"},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an JSON file > Modify the file > Upload the file"},{"value":"Connect to the Security & Compliance admin center > Export the current rules as an JSON file > Modify the file > Upload the file","isCorrectAnswer":false}],"references":{"entityMap":{},"blocks":[{"depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{},"text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","key":"dkobb","entityRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
