...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"data":{},"depth":0,"entityRanges":[],"type":"unstyled","text":"You have a Microsoft 365 subscription.","inlineStyleRanges":[],"key":"3ik3u"},{"text":"You need to include a custom sensitive information type in Data Subject Request (DSR) cases.","type":"unstyled","entityRanges":[],"key":"crflb","depth":0,"data":{},"inlineStyleRanges":[]},{"entityRanges":[],"type":"unstyled","key":"e3rai","inlineStyleRanges":[],"data":{},"depth":0,"text":"Which four actions should you perform in sequence? To answer, move the appropriate actions from the list of actions to the answer area and arrange them in the correct order."}],"entityMap":{}},"references":{"blocks":[{"key":"dkobb","data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide"}],"entityMap":{}},"id":"mr_mTqJ8u","answers":[{"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file"},{"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an JSON file > Modify the file > Upload the file","isCorrectAnswer":false},{"value":"Connect to the Security & Compliance admin center > Export the current rules as an JSON file > Modify the file > Upload the file","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
