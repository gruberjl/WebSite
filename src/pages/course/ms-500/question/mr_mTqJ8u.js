...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Connect to the Security & Compliance admin center using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":true},{"value":"Connect to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an JSON file > Modify the file > Upload the file"},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center > Export the current rules as an JSON file > Modify the file > Upload the file"}],"id":"mr_mTqJ8u","question":{"blocks":[{"key":"3ik3u","type":"unstyled","text":"You have a Microsoft 365 subscription.","depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[]},{"depth":0,"data":{},"entityRanges":[],"text":"You need to include a custom sensitive information type in Data Subject Request (DSR) cases.","key":"crflb","inlineStyleRanges":[],"type":"unstyled"},{"depth":0,"type":"unstyled","entityRanges":[],"data":{},"key":"e3rai","inlineStyleRanges":[],"text":"Which four actions should you perform in sequence?"}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w"},"mutability":"MUTABLE","type":"LINK"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"entityRanges":[],"text":"1. Connect to the Security & Compliance admin center using PowerShell. The command is \"Connect-IPPSSession\"","data":{},"type":"unstyled","key":"dkobb","depth":0,"inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"data":{},"type":"unstyled","text":"2. Export the current rules as an XML file. The command is \"Get-DlpSensitiveInformationTypeRulePackage | Export-Clixml .\\rules.xml\"","key":"bhkqv"},{"inlineStyleRanges":[],"text":"3. Modify the file making the changes you desire","key":"64qbf","data":{},"type":"unstyled","depth":0,"entityRanges":[]},{"key":"ds3ee","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"4. Upload the file. The command is \"New-DlpSensitiveInformationTypeRulePackage -FileData ([System.IO.File]::ReadAllBytes('PathToXml.xml'))\"","type":"unstyled","data":{}},{"depth":0,"data":{},"inlineStyleRanges":[],"key":"46fov","type":"unstyled","entityRanges":[{"length":116,"key":0,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w"},{"type":"unstyled","data":{},"text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","depth":0,"entityRanges":[{"length":125,"key":1,"offset":0}],"inlineStyleRanges":[],"key":"ejiq"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
