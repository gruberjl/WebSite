...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"key":"dkobb","text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","type":"unstyled","data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[]}],"entityMap":{}},"question":{"blocks":[{"entityRanges":[],"text":"You have a Microsoft 365 subscription.","type":"unstyled","depth":0,"key":"3ik3u","data":{},"inlineStyleRanges":[]},{"type":"unstyled","depth":0,"entityRanges":[],"key":"crflb","inlineStyleRanges":[],"text":"You need to include a custom sensitive information type in Data Subject Request (DSR) cases.","data":{}},{"data":{},"key":"e3rai","entityRanges":[],"type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"Which four actions should you perform in sequence? To answer, move the appropriate actions from the list of actions to the answer area and arrange them in the correct order."}],"entityMap":{}},"id":"mr_mTqJ8u","answers":[{"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":true},{"value":"Connect to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an JSON file > Modify the file > Upload the file"},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center > Export the current rules as an JSON file > Modify the file > Upload the file"}]},
      previousQuestionId: '',
      nextQuestionId: '',
