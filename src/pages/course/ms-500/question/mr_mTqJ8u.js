...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Connect to the Security & Compliance admin center using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file"},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file"},{"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an JSON file > Modify the file > Upload the file","isCorrectAnswer":false},{"value":"Connect to the Security & Compliance admin center > Export the current rules as an JSON file > Modify the file > Upload the file","isCorrectAnswer":false}],"id":"mr_mTqJ8u","question":{"blocks":[{"data":{},"depth":0,"text":"You have a Microsoft 365 subscription.","type":"unstyled","key":"3ik3u","entityRanges":[],"inlineStyleRanges":[]},{"type":"unstyled","entityRanges":[],"depth":0,"key":"crflb","text":"You need to include a custom sensitive information type in Data Subject Request (DSR) cases.","data":{},"inlineStyleRanges":[]},{"depth":0,"type":"unstyled","data":{},"text":"Which four actions should you perform in sequence?","key":"e3rai","entityRanges":[],"inlineStyleRanges":[]}],"entityMap":{}},"references":{"blocks":[{"key":"dkobb","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"1. Connect to the Security & Compliance admin center using PowerShell. The command is \"Connect-IPPSSession\"","depth":0,"data":{}},{"key":"bhkqv","inlineStyleRanges":[],"entityRanges":[],"depth":0,"data":{},"text":"2. Export the current rules as an XML file. The command is \"Get-DlpSensitiveInformationTypeRulePackage | Export-Clixml .\\rules.xml\"","type":"unstyled"},{"inlineStyleRanges":[],"key":"64qbf","text":"3. Modify the file making the changes you desire","type":"unstyled","entityRanges":[],"data":{},"depth":0},{"data":{},"key":"ds3ee","depth":0,"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"text":"4. Upload the file. The command is \"New-DlpSensitiveInformationTypeRulePackage -FileData ([System.IO.File]::ReadAllBytes('PathToXml.xml'))\""},{"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","key":"46fov","entityRanges":[{"key":0,"offset":0,"length":116}],"depth":0,"data":{},"type":"unstyled"},{"key":"ejiq","entityRanges":[{"offset":0,"length":125,"key":1}],"depth":0,"type":"unstyled","text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","data":{},"inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w"},"type":"LINK","mutability":"MUTABLE"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
