...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"mr_mTqJ8u","question":{"entityMap":{},"blocks":[{"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"You have a Microsoft 365 subscription.","depth":0,"key":"3ik3u"},{"key":"crflb","depth":0,"type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"You need to include a custom sensitive information type in Data Subject Request (DSR) cases."},{"key":"e3rai","data":{},"entityRanges":[],"text":"Which four actions should you perform in sequence? To answer, move the appropriate actions from the list of actions to the answer area and arrange them in the correct order.","depth":0,"inlineStyleRanges":[],"type":"unstyled"}]},"answers":[{"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file"},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center  by using PowerShell > Export the current rules as an JSON file > Modify the file > Upload the file"},{"value":"Connect to the Security & Compliance admin center > Export the current rules as an JSON file > Modify the file > Upload the file","isCorrectAnswer":false}],"references":{"blocks":[{"key":"dkobb","data":{},"entityRanges":[],"type":"unstyled","depth":0,"text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","inlineStyleRanges":[]}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
