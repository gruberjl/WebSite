...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"From the Microsoft 365 compliance center create a new Data loss prevention policy with a customized alert notification"},{"value":"From the Microsoft 365 admin center edit the default Data loss prevention policy with custom notification to Joe Gruber","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Azure AD admin center > Sharing > Block sharing > Customize alert notifications."}],"references":{"blocks":[{"entityRanges":[],"type":"unstyled","text":"https://www.iorad.com/player/1802115/MS-500---ensure-that-a-user-named-Joe-Gruber-receives-incident-reports-when-email-messages","depth":0,"key":"7ofpi","inlineStyleRanges":[],"data":{}},{"entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0,"type":"ordered-list-item","text":"Open the Microsoft 365 compliance center.","key":"esne0"},{"data":{},"type":"ordered-list-item","inlineStyleRanges":[],"entityRanges":[],"key":"86orm","depth":0,"text":"Go to Policies > Data loss prevention > Policies > Create policy."},{"depth":0,"text":"Select the U.K. Data Protection Act.","key":"11ml6","type":"ordered-list-item","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"text":"Unselect every location except Exchange email.","type":"ordered-list-item","depth":0,"data":{},"key":"8cgea","entityRanges":[],"inlineStyleRanges":[]},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0,"type":"ordered-list-item","text":"Customize the alert configuration > add Joe Gruber and remove John Gruber.","key":"cg844"},{"type":"ordered-list-item","text":"Save the changes.","depth":0,"key":"ultc","entityRanges":[],"data":{},"inlineStyleRanges":[]}],"entityMap":{}},"id":"H8rYT4gCH","question":{"entityMap":{},"blocks":[{"type":"unstyled","depth":0,"entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"SIMULATION -","key":"4t5vp"},{"type":"unstyled","depth":0,"key":"df7q8","inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"You need to ensure that a user named Joe Gruber receives incident reports when email messages that contain data covered by the U.K. Data Protection Act are sent outside of your organization."},{"data":{},"type":"unstyled","key":"43bu","depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"To complete this task, sign in to the Microsoft 365 admin center."}]}},
      previousQuestionId: '',
      nextQuestionId: '',
