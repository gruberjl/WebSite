...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Microsoft 365 compliance center create a new Data loss prevention policy with a customized alert notification","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Microsoft 365 admin center edit the default Data loss prevention policy with custom notification to Joe Gruber"},{"isCorrectAnswer":false,"value":"From the Azure AD admin center > Sharing > Block sharing > Customize alert notifications."}],"id":"H8rYT4gCH","question":{"entityMap":{},"blocks":[{"entityRanges":[],"text":"You need to ensure that a user named Joe Gruber receives incident reports when email messages that contain data covered by the U.K. Data Protection Act are sent outside of your organization.","type":"unstyled","inlineStyleRanges":[],"data":{},"key":"4t5vp","depth":0},{"depth":0,"inlineStyleRanges":[{"length":48,"style":"color-rgb(33,37,41)","offset":0},{"length":48,"style":"bgcolor-rgb(255,255,255)","offset":0},{"offset":0,"length":48,"style":"fontsize-16"},{"length":48,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":0}],"entityRanges":[],"data":{},"type":"unstyled","key":"43bu","text":"What steps should you take to complete the task?"}]},"references":{"blocks":[{"entityRanges":[{"key":0,"offset":0,"length":116}],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w ","key":"7ofpi","data":{},"type":"unstyled","inlineStyleRanges":[]},{"key":"a70lu","inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[{"length":127,"offset":0,"key":1}],"type":"unstyled","text":"https://www.iorad.com/player/1802115/MS-500---ensure-that-a-user-named-Joe-Gruber-receives-incident-reports-when-email-messages"},{"inlineStyleRanges":[],"entityRanges":[],"type":"ordered-list-item","data":{},"key":"esne0","depth":0,"text":"Open the Microsoft 365 compliance center."},{"entityRanges":[],"key":"86orm","depth":0,"data":{},"type":"ordered-list-item","text":"Go to Policies > Data loss prevention > Policies > Create policy.","inlineStyleRanges":[]},{"data":{},"text":"Select the U.K. Data Protection Act.","inlineStyleRanges":[],"key":"11ml6","type":"ordered-list-item","entityRanges":[],"depth":0},{"text":"Unselect every location except Exchange email.","depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"8cgea","data":{},"type":"ordered-list-item"},{"text":"Customize the alert configuration > add Joe Gruber and remove John Gruber.","key":"cg844","depth":0,"type":"ordered-list-item","data":{},"inlineStyleRanges":[],"entityRanges":[]},{"inlineStyleRanges":[],"text":"Save the changes.","data":{},"depth":0,"entityRanges":[],"key":"ultc","type":"ordered-list-item"}],"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","targetOption":"_blank"},"mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"url":"https://www.iorad.com/player/1802115/MS-500---ensure-that-a-user-named-Joe-Gruber-receives-incident-reports-when-email-messages","targetOption":"_blank"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
