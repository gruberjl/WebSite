...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"From the Microsoft 365 compliance center create a new Data loss prevention policy with a customized alert notification"},{"value":"From the Microsoft 365 admin center edit the default Data loss prevention policy with custom notification to Joe Gruber","isCorrectAnswer":false},{"value":"From the Azure AD admin center > Sharing > Block sharing > Customize alert notifications.","isCorrectAnswer":false}],"id":"H8rYT4gCH","question":{"blocks":[{"type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{},"text":"You need to ensure that a user named Joe Gruber receives incident reports when email messages that contain data covered by the U.K. Data Protection Act are sent outside of your organization.","key":"4t5vp","entityRanges":[]},{"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":48,"offset":0},{"style":"bgcolor-rgb(255,255,255)","length":48,"offset":0},{"style":"fontsize-16","offset":0,"length":48},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":48,"offset":0}],"key":"43bu","type":"unstyled","depth":0,"data":{},"text":"What steps should you take to complete the task?","entityRanges":[]}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w"},"mutability":"MUTABLE","type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.iorad.com/player/1802115/MS-500---ensure-that-a-user-named-Joe-Gruber-receives-incident-reports-when-email-messages"}}},"blocks":[{"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w ","type":"unstyled","inlineStyleRanges":[],"depth":0,"key":"7ofpi","data":{},"entityRanges":[{"offset":0,"key":0,"length":116}]},{"type":"unstyled","key":"a70lu","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[{"key":1,"offset":0,"length":127}],"text":"https://www.iorad.com/player/1802115/MS-500---ensure-that-a-user-named-Joe-Gruber-receives-incident-reports-when-email-messages"},{"key":"esne0","entityRanges":[],"inlineStyleRanges":[],"text":"Open the Microsoft 365 compliance center.","depth":0,"type":"ordered-list-item","data":{}},{"depth":0,"key":"86orm","type":"ordered-list-item","inlineStyleRanges":[],"text":"Go to Policies > Data loss prevention > Policies > Create policy.","entityRanges":[],"data":{}},{"data":{},"text":"Select the U.K. Data Protection Act.","inlineStyleRanges":[],"depth":0,"type":"ordered-list-item","entityRanges":[],"key":"11ml6"},{"inlineStyleRanges":[],"entityRanges":[],"type":"ordered-list-item","key":"8cgea","data":{},"text":"Unselect every location except Exchange email.","depth":0},{"inlineStyleRanges":[],"type":"ordered-list-item","text":"Customize the alert configuration > add Joe Gruber and remove John Gruber.","key":"cg844","entityRanges":[],"depth":0,"data":{}},{"entityRanges":[],"type":"ordered-list-item","depth":0,"text":"Save the changes.","data":{},"inlineStyleRanges":[],"key":"ultc"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
