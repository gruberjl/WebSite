...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Open Exchange Online admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Open Azure AD admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link."},{"value":"Open Endpoint admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link.","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Open the security and compliance admin center > Threat management > policy > Global settings > Add the url to the Block the following URLs textbox."}],"references":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"text":"https://www.iorad.com/player/1797294/MS-500---Ensure-that-all-links-to-malware-contoso-com-within-documents-stored-in-Microsoft-Office-36","key":"9cim8","data":{},"depth":0,"entityRanges":[],"type":"unstyled"},{"entityRanges":[],"type":"ordered-list-item","key":"fasks","text":"Open the security and compliance admin center","data":{},"depth":0,"inlineStyleRanges":[]},{"type":"ordered-list-item","key":"54pkb","text":"Navigate to Threat management > Policy > Safe Links > click the Global Settings gear.","entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[]},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"key":"2piid","text":"Add the url to the Block the following URLs textbox.","type":"ordered-list-item"},{"key":"7hjpn","depth":0,"entityRanges":[],"data":{},"type":"ordered-list-item","inlineStyleRanges":[],"text":"Click Save."},{"data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled","key":"a6dqh","entityRanges":[],"text":"https://docs.microsoft.com/en-us/microsoft-365/security/office-365-security/set-up-atp-safe-links-policies?view=o365-worldwide"}]},"id":"fSO8Mosh0","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"text":"SIMULATION -","type":"unstyled","entityRanges":[],"key":"b8ar9","data":{},"depth":0},{"data":{},"text":"You need to ensure that all links to malware.contoso.com within documents stored in Microsoft Office 365 are blocked when the documents are accessed from","type":"unstyled","depth":0,"key":"fhsu","entityRanges":[],"inlineStyleRanges":[]},{"text":"Office 365 ProPlus applications.","inlineStyleRanges":[],"key":"et8cv","entityRanges":[],"type":"unstyled","data":{},"depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
