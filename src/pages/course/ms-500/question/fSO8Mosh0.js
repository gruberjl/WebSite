...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"text":"https://www.iorad.com/player/1797294/MS-500---Ensure-that-all-links-to-malware-contoso-com-within-documents-stored-in-Microsoft-Office-36","key":"9cim8","depth":0},{"entityRanges":[],"inlineStyleRanges":[],"type":"ordered-list-item","key":"fasks","data":{},"depth":0,"text":"Open the security and compliance admin center"},{"type":"ordered-list-item","entityRanges":[],"data":{},"key":"54pkb","text":"Navigate to Threat management > Policy > Safe Links > click the Global Settings gear.","inlineStyleRanges":[],"depth":0},{"depth":0,"data":{},"text":"Add the url to the Block the following URLs textbox.","key":"2piid","type":"ordered-list-item","entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[],"text":"Click Save.","type":"ordered-list-item","key":"7hjpn","data":{},"inlineStyleRanges":[],"depth":0},{"data":{},"text":"https://docs.microsoft.com/en-us/microsoft-365/security/office-365-security/set-up-atp-safe-links-policies?view=o365-worldwide","type":"unstyled","entityRanges":[],"depth":0,"key":"a6dqh","inlineStyleRanges":[]}],"entityMap":{}},"id":"fSO8Mosh0","answers":[{"value":"Open Exchange Online admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link.","isCorrectAnswer":false},{"value":"Open Azure AD admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Open Endpoint admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link."},{"value":"Open the security and compliance admin center > Threat management > policy > Global settings > Add the url to the Block the following URLs textbox.","isCorrectAnswer":true}],"question":{"entityMap":{},"blocks":[{"entityRanges":[],"type":"unstyled","key":"b8ar9","depth":0,"data":{},"inlineStyleRanges":[],"text":"SIMULATION -"},{"type":"unstyled","key":"fhsu","inlineStyleRanges":[],"text":"You need to ensure that all links to malware.contoso.com within documents stored in Microsoft Office 365 are blocked when the documents are accessed from","entityRanges":[],"data":{},"depth":0},{"key":"et8cv","entityRanges":[],"data":{},"text":"Office 365 ProPlus applications.","type":"unstyled","depth":0,"inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
