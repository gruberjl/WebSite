...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"fSO8Mosh0","question":{"blocks":[{"key":"b8ar9","type":"unstyled","inlineStyleRanges":[],"depth":0,"entityRanges":[],"data":{},"text":"SIMULATION -"},{"key":"fhsu","inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unstyled","text":"You need to ensure that all links to malware.contoso.com within documents stored in Microsoft Office 365 are blocked when the documents are accessed from","data":{}},{"text":"Office 365 ProPlus applications.","depth":0,"type":"unstyled","key":"et8cv","data":{},"inlineStyleRanges":[],"entityRanges":[]}],"entityMap":{}},"references":{"entityMap":{},"blocks":[{"depth":0,"key":"9cim8","text":"https://www.iorad.com/player/1797294/MS-500---Ensure-that-all-links-to-malware-contoso-com-within-documents-stored-in-Microsoft-Office-36","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"text":"Open the security and compliance admin center","depth":0,"key":"fasks","type":"ordered-list-item","data":{}},{"depth":0,"type":"ordered-list-item","inlineStyleRanges":[],"text":"Navigate to Threat management > Policy > Safe Links > click the Global Settings gear.","key":"54pkb","entityRanges":[],"data":{}},{"type":"ordered-list-item","inlineStyleRanges":[],"depth":0,"data":{},"key":"2piid","text":"Add the url to the Block the following URLs textbox.","entityRanges":[]},{"depth":0,"key":"7hjpn","entityRanges":[],"text":"Click Save.","data":{},"type":"ordered-list-item","inlineStyleRanges":[]},{"depth":0,"text":"https://docs.microsoft.com/en-us/microsoft-365/security/office-365-security/set-up-atp-safe-links-policies?view=o365-worldwide","entityRanges":[],"key":"a6dqh","type":"unstyled","inlineStyleRanges":[],"data":{}}]},"answers":[{"isCorrectAnswer":false,"value":"Open Exchange Online admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link."},{"value":"Open Azure AD admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link.","isCorrectAnswer":false},{"value":"Open Endpoint admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link.","isCorrectAnswer":false},{"value":"Open the security and compliance admin center > Threat management > policy > Global settings > Add the url to the Block the following URLs textbox.","isCorrectAnswer":true}]},
      previousQuestionId: '',
      nextQuestionId: '',
