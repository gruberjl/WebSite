...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"fSO8Mosh0","answers":[{"isCorrectAnswer":false,"value":"Open Exchange Online admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link."},{"value":"Open Azure AD admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link.","isCorrectAnswer":false},{"value":"Open Endpoint admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link.","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Open the security and compliance admin center > Threat management > policy > Global settings > Add the url to the Block the following URLs textbox."}],"references":{"entityMap":{},"blocks":[{"entityRanges":[],"data":{},"text":"https://www.iorad.com/player/1797294/MS-500---Ensure-that-all-links-to-malware-contoso-com-within-documents-stored-in-Microsoft-Office-36","type":"unstyled","key":"9cim8","inlineStyleRanges":[],"depth":0},{"key":"fasks","entityRanges":[],"type":"ordered-list-item","data":{},"text":"Open the security and compliance admin center","inlineStyleRanges":[],"depth":0},{"inlineStyleRanges":[],"key":"54pkb","depth":0,"type":"ordered-list-item","entityRanges":[],"data":{},"text":"Navigate to Threat management > Policy > Safe Links > click the Global Settings gear."},{"key":"2piid","depth":0,"data":{},"entityRanges":[],"text":"Add the url to the Block the following URLs textbox.","type":"ordered-list-item","inlineStyleRanges":[]},{"key":"7hjpn","data":{},"type":"ordered-list-item","inlineStyleRanges":[],"depth":0,"entityRanges":[],"text":"Click Save."},{"key":"a6dqh","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"text":"https://docs.microsoft.com/en-us/microsoft-365/security/office-365-security/set-up-atp-safe-links-policies?view=o365-worldwide","depth":0,"data":{}}]},"question":{"blocks":[{"key":"b8ar9","inlineStyleRanges":[],"depth":0,"type":"unstyled","data":{},"entityRanges":[],"text":"SIMULATION -"},{"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"You need to ensure that all links to malware.contoso.com within documents stored in Microsoft Office 365 are blocked when the documents are accessed from","entityRanges":[],"depth":0,"key":"fhsu"},{"key":"et8cv","depth":0,"entityRanges":[],"type":"unstyled","text":"Office 365 ProPlus applications.","data":{},"inlineStyleRanges":[]}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
