...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Open Exchange Online admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Open Azure AD admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link."},{"value":"Open Endpoint admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link.","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Open the security and compliance admin center > Threat management > policy > Global settings > Add the url to the Block the following URLs textbox."}],"question":{"blocks":[{"inlineStyleRanges":[],"key":"b8ar9","type":"unstyled","depth":0,"entityRanges":[],"text":"SIMULATION -","data":{}},{"key":"fhsu","data":{},"depth":0,"inlineStyleRanges":[],"text":"You need to ensure that all links to malware.contoso.com within documents stored in Microsoft Office 365 are blocked when the documents are accessed from","entityRanges":[],"type":"unstyled"},{"data":{},"entityRanges":[],"text":"Office 365 ProPlus applications.","inlineStyleRanges":[],"key":"et8cv","type":"unstyled","depth":0}],"entityMap":{}},"id":"fSO8Mosh0","references":{"blocks":[{"data":{},"text":"https://www.iorad.com/player/1797294/MS-500---Ensure-that-all-links-to-malware-contoso-com-within-documents-stored-in-Microsoft-Office-36","key":"9cim8","inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0},{"entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"ordered-list-item","key":"fasks","depth":0,"text":"Open the security and compliance admin center"},{"entityRanges":[],"text":"Navigate to Threat management > Policy > Safe Links > click the Global Settings gear.","data":{},"type":"ordered-list-item","key":"54pkb","depth":0,"inlineStyleRanges":[]},{"data":{},"entityRanges":[],"depth":0,"key":"2piid","text":"Add the url to the Block the following URLs textbox.","type":"ordered-list-item","inlineStyleRanges":[]},{"depth":0,"key":"7hjpn","entityRanges":[],"inlineStyleRanges":[],"type":"ordered-list-item","text":"Click Save.","data":{}},{"text":"https://docs.microsoft.com/en-us/microsoft-365/security/office-365-security/set-up-atp-safe-links-policies?view=o365-worldwide","depth":0,"entityRanges":[],"type":"unstyled","data":{},"key":"a6dqh","inlineStyleRanges":[]}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
