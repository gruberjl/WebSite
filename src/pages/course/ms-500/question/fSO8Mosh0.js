...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"depth":0,"key":"9cim8","inlineStyleRanges":[],"text":"https://www.iorad.com/player/1797294/MS-500---Ensure-that-all-links-to-malware-contoso-com-within-documents-stored-in-Microsoft-Office-36","entityRanges":[],"data":{},"type":"unstyled"},{"key":"fasks","type":"ordered-list-item","inlineStyleRanges":[],"entityRanges":[],"text":"Open the security and compliance admin center","data":{},"depth":0},{"inlineStyleRanges":[],"entityRanges":[],"key":"54pkb","depth":0,"text":"Navigate to Threat management > Policy > Safe Links > click the Global Settings gear.","data":{},"type":"ordered-list-item"},{"key":"2piid","inlineStyleRanges":[],"data":{},"text":"Add the url to the Block the following URLs textbox.","entityRanges":[],"depth":0,"type":"ordered-list-item"},{"depth":0,"key":"7hjpn","inlineStyleRanges":[],"text":"Click Save.","data":{},"entityRanges":[],"type":"ordered-list-item"},{"key":"a6dqh","data":{},"text":"https://docs.microsoft.com/en-us/microsoft-365/security/office-365-security/set-up-atp-safe-links-policies?view=o365-worldwide","type":"unstyled","depth":0,"entityRanges":[],"inlineStyleRanges":[]}],"entityMap":{}},"question":{"entityMap":{},"blocks":[{"data":{},"type":"unstyled","inlineStyleRanges":[],"key":"b8ar9","text":"You need to ensure that all links to malware.contoso.com within documents stored in Microsoft Office 365 are blocked when the documents are accessed from Office 365 ProPlus applications.","depth":0,"entityRanges":[]},{"data":{},"key":"9f4c1","text":"What steps should you take to complete the task? ","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","offset":0,"length":48},{"length":48,"offset":0,"style":"bgcolor-rgb(255,255,255)"},{"style":"fontsize-16","offset":0,"length":48},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":0,"length":48}],"type":"unstyled","depth":0,"entityRanges":[]}]},"answers":[{"isCorrectAnswer":false,"value":"Open Exchange Online admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link."},{"isCorrectAnswer":false,"value":"Open Azure AD admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link."},{"isCorrectAnswer":false,"value":"Open Endpoint admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link."},{"isCorrectAnswer":true,"value":"Open the security and compliance admin center > Threat management > policy > Global settings > Add the url to the Block the following URLs textbox."}],"id":"fSO8Mosh0"},
      previousQuestionId: '',
      nextQuestionId: '',
