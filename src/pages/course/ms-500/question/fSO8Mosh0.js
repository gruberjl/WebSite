...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"entityMap":{},"blocks":[{"entityRanges":[],"data":{},"text":"SIMULATION -","key":"b8ar9","type":"unstyled","inlineStyleRanges":[],"depth":0},{"key":"fhsu","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"You need to ensure that all links to malware.contoso.com within documents stored in Microsoft Office 365 are blocked when the documents are accessed from","type":"unstyled"},{"text":"Office 365 ProPlus applications.","type":"unstyled","key":"et8cv","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}]},"id":"fSO8Mosh0","references":{"blocks":[{"depth":0,"data":{},"text":"https://www.iorad.com/player/1797294/MS-500---Ensure-that-all-links-to-malware-contoso-com-within-documents-stored-in-Microsoft-Office-36","entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"key":"9cim8"},{"depth":0,"text":"Open the security and compliance admin center","data":{},"entityRanges":[],"type":"ordered-list-item","key":"fasks","inlineStyleRanges":[]},{"text":"Navigate to Threat management > Policy > Safe Links > click the Global Settings gear.","inlineStyleRanges":[],"entityRanges":[],"type":"ordered-list-item","data":{},"key":"54pkb","depth":0},{"type":"ordered-list-item","inlineStyleRanges":[],"key":"2piid","depth":0,"entityRanges":[],"text":"Add the url to the Block the following URLs textbox.","data":{}},{"data":{},"entityRanges":[],"type":"ordered-list-item","inlineStyleRanges":[],"key":"7hjpn","depth":0,"text":"Click Save."},{"text":"https://docs.microsoft.com/en-us/microsoft-365/security/office-365-security/set-up-atp-safe-links-policies?view=o365-worldwide","type":"unstyled","data":{},"entityRanges":[],"key":"a6dqh","depth":0,"inlineStyleRanges":[]}],"entityMap":{}},"answers":[{"value":"Open Exchange Online admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Open Azure AD admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link."},{"isCorrectAnswer":false,"value":"Open Endpoint admin center. navigate to Threat management, choose Policy > Safe Links. Edit the default policy. In the block the following URLs section, add the malware.contoso.com link."},{"value":"Open the security and compliance admin center > Threat management > policy > Global settings > Add the url to the Block the following URLs textbox.","isCorrectAnswer":true}]},
      previousQuestionId: '',
      nextQuestionId: '',
