...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"External users can access File1"},{"isCorrectAnswer":false,"value":"The users in contoso.com can access File2"},{"value":"External users can access File3","isCorrectAnswer":false}],"id":"l2v1m_J8Z","question":{"blocks":[{"depth":0,"data":{},"type":"unstyled","text":"You have a Microsoft 365 subscription that uses an Azure Active Directory (Azure AD) tenant named contoso.com.","entityRanges":[],"key":"50gpj","inlineStyleRanges":[]},{"data":{},"text":"OneDrive stores files that are shared with external users. The files are configured as shown in the following table.","key":"260nn","inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unstyled"},{"key":"euhdj","text":" ","entityRanges":[{"length":1,"key":0,"offset":0}],"depth":0,"data":{},"inlineStyleRanges":[],"type":"atomic"},{"type":"unstyled","text":"You create a data loss prevention (DLP) policy that applies to the content stored in OneDrive accounts. The policy contains the following three rules:","data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"a6paf","depth":0},{"entityRanges":[],"key":"6vh9m","data":{},"depth":0,"type":"unstyled","inlineStyleRanges":[{"offset":0,"length":5,"style":"BOLD"}],"text":"Rule1:"},{"key":"1ui6b","text":"Conditions: Label1, Detect content that's shared with people outside my organization","entityRanges":[],"type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"data":{}},{"entityRanges":[],"inlineStyleRanges":[],"text":"Actions: Restrict access to the content for external users","depth":0,"key":"5q0vt","data":{},"type":"unordered-list-item"},{"depth":0,"data":{},"text":"User notifications: Notify the user who last modified the content","type":"unordered-list-item","key":"ervr","inlineStyleRanges":[],"entityRanges":[]},{"data":{},"type":"unordered-list-item","inlineStyleRanges":[],"text":"User overrides: On","depth":0,"entityRanges":[],"key":"cv2dv"},{"inlineStyleRanges":[],"type":"unordered-list-item","key":"av8gm","depth":0,"text":"Priority: 0","entityRanges":[],"data":{}},{"data":{},"key":"og34","inlineStyleRanges":[{"offset":0,"length":5,"style":"BOLD"}],"type":"unstyled","entityRanges":[],"text":"Rule2:","depth":0},{"data":{},"key":"cjeds","inlineStyleRanges":[],"text":"Conditions: Label1 or Label2","entityRanges":[],"depth":0,"type":"unordered-list-item"},{"entityRanges":[],"key":"854sf","text":"Actions: Restrict access to the content","type":"unordered-list-item","inlineStyleRanges":[],"depth":0,"data":{}},{"data":{},"inlineStyleRanges":[],"key":"3s1li","entityRanges":[],"type":"unordered-list-item","depth":0,"text":"Priority: 1"},{"depth":0,"text":"Rule3:","type":"unstyled","entityRanges":[],"key":"5ujn5","data":{},"inlineStyleRanges":[{"offset":0,"style":"BOLD","length":5}]},{"inlineStyleRanges":[],"depth":0,"key":"f2jcf","data":{},"text":"Conditions: Label2, Detect content that's shared with people outside my organization","type":"unordered-list-item","entityRanges":[]},{"type":"unordered-list-item","entityRanges":[],"key":"4rk5n","text":"Actions: Restrict access to the content for external users","depth":0,"data":{},"inlineStyleRanges":[]},{"text":"User notifications: Notify the user who last modified the content","data":{},"entityRanges":[],"type":"unordered-list-item","key":"6lr8c","depth":0,"inlineStyleRanges":[]},{"data":{},"entityRanges":[],"key":"7iado","text":"User overrides: On","inlineStyleRanges":[],"type":"unordered-list-item","depth":0},{"data":{},"entityRanges":[],"depth":0,"text":"Priority: 2","inlineStyleRanges":[],"key":"1mk1m","type":"unordered-list-item"},{"type":"unstyled","inlineStyleRanges":[],"data":{},"key":"4p8lg","text":"For each of the following statements, check the box if the statement is true.","depth":0,"entityRanges":[]}],"entityMap":{"0":{"data":{"src":"https://i.ibb.co/rMYDH1g/file-labels.png","alignment":"left","height":"auto","width":"auto","alt":"Files and labels chart"},"type":"IMAGE","mutability":"MUTABLE"}}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","targetOption":"_blank"},"type":"LINK"}},"blocks":[{"key":"5t3am","inlineStyleRanges":[],"entityRanges":[],"text":"All of them will match Rule2 because it is the most restrictive.","depth":0,"data":{},"type":"unstyled"},{"key":"eu9vf","data":{},"type":"unstyled","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","inlineStyleRanges":[],"entityRanges":[{"length":116,"key":0,"offset":0}]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
