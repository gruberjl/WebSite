...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Admins need to be informed when the Security administrator role is activated: Alerts"},{"isCorrectAnswer":true,"value":"Admins need to be informed when the Security administrator role is activated: Roles"},{"value":"Admins need to be informed when the Security administrator role is activated: Access reviews","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Users assigned the Security Administrator role need to be automatically removed if they don't log in for 30 days: Alerts"},{"isCorrectAnswer":false,"value":"Users assigned the Security Administrator role need to be automatically removed if they don't log in for 30 days: Roles"},{"isCorrectAnswer":true,"value":"Users assigned the Security Administrator role need to be automatically removed if they don't log in for 30 days: Access reviews"}],"id":"W580XiwzO","question":{"entityMap":{},"blocks":[{"text":"Your organization has a Microsoft 365 tenant.","key":"dpurb","inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unstyled","depth":0},{"data":{},"key":"f4ag1","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"Your manager has asked you to re-configure the Microsoft 365 tenant to meet the following security requirements:"},{"inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"Admins need to be informed when the Security administrator role is activated.","type":"unordered-list-item","depth":0,"key":"5sdi4"},{"type":"unordered-list-item","data":{},"depth":0,"text":"Users assigned the Security Administrator role need to be automatically removed if they don't log in for 30 days.","entityRanges":[],"inlineStyleRanges":[],"key":"a2d7n"},{"data":{},"text":"Which Azure AD PIM setting should you re-configure to meet the security requirements.","entityRanges":[],"depth":0,"type":"unstyled","inlineStyleRanges":[],"key":"s219"}]},"references":{"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","targetOption":"_blank"},"mutability":"MUTABLE"},"1":{"type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/bs-latn-ba/azure/active-directory/privileged-identity-management/pim-how-to-configure-security-alerts?tabs=new"},"mutability":"MUTABLE"},"2":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/bs-latn-ba/azure/active-directory/privileged-identity-management/pim-how-to-change-default-settings?tabs=new","targetOption":"_blank"}}},"blocks":[{"inlineStyleRanges":[],"depth":0,"type":"unstyled","key":"3mim0","data":{},"text":"\"Admins need to be informed when the Security administrator role is activated\" is located under the Roles section.","entityRanges":[]},{"data":{},"type":"unstyled","entityRanges":[],"key":"2or5v","depth":0,"inlineStyleRanges":[{"offset":0,"style":"color-rgb(33,37,41)","length":114},{"offset":0,"style":"bgcolor-rgb(255,255,255)","length":114},{"length":114,"offset":0,"style":"fontsize-16"},{"offset":0,"length":114,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"text":"\"Users assigned the Security Administrator role need to be automatically removed if they don't log in for 30 days\" is located in the Access reviews section."},{"inlineStyleRanges":[],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","type":"unstyled","entityRanges":[{"offset":0,"key":0,"length":94}],"data":{},"key":"57ek3"},{"entityRanges":[{"key":1,"offset":0,"length":137}],"type":"unstyled","key":"75s50","depth":0,"data":{},"text":"https://docs.microsoft.com/bs-latn-ba/azure/active-directory/privileged-identity-management/pim-how-to-configure-security-alerts?tabs=new","inlineStyleRanges":[]},{"inlineStyleRanges":[],"data":{},"entityRanges":[{"length":135,"key":2,"offset":0}],"type":"unstyled","key":"5pn4h","depth":0,"text":"https://docs.microsoft.com/bs-latn-ba/azure/active-directory/privileged-identity-management/pim-how-to-change-default-settings?tabs=new"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
