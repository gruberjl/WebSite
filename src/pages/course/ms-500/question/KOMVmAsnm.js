...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the SharePoint admin center > Policies > Sharing > Select More external sharing settings","isCorrectAnswer":true},{"value":"From the Microsoft 365 admin center > Policies > Sharing > Select More external sharing settings","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Azure AD admin center > Sharing > Select More external sharing settings"}],"id":"KOMVmAsnm","question":{"blocks":[{"data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"Your manager discovers that users are sharing Microsoft SharePoint files and content with external people.","depth":0,"key":"8ljgq"},{"inlineStyleRanges":[],"data":{},"depth":0,"key":"7lh6a","text":"He has asked you to block sharing invitations to any external users except users from gitbit.org.","type":"unstyled","entityRanges":[]},{"entityRanges":[],"key":"al911","text":"How do you complete the task?","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":29,"offset":0},{"style":"bgcolor-rgb(255,255,255)","length":29,"offset":0},{"style":"fontsize-16","length":29,"offset":0},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":0,"length":29}],"type":"unstyled","data":{},"depth":0}],"entityMap":{}},"references":{"blocks":[{"inlineStyleRanges":[],"key":"ea82g","text":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI","entityRanges":[{"key":0,"length":128,"offset":0}],"depth":0,"data":{},"type":"unstyled"},{"inlineStyleRanges":[],"data":{},"type":"unstyled","depth":0,"text":"https://www.iorad.com/player/1797740/MS-500---Allow-sharing-invitations-to-be-sent-only-to-users-in-an-email-domain","entityRanges":[{"offset":0,"key":1,"length":115}],"key":"asa84"},{"data":{},"text":"Open the SharePoint admin center > Policies > Sharing > More external sharing settings > Limit external sharing by domain > Add domains > Allow only specific domains > Set the domain you want to allow > Save.","depth":0,"entityRanges":[],"type":"ordered-list-item","inlineStyleRanges":[],"key":"7fj7f"}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI"},"type":"LINK"},"1":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.iorad.com/player/1797740/MS-500---Allow-sharing-invitations-to-be-sent-only-to-users-in-an-email-domain"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
