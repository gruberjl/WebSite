...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the SharePoint admin center > Policies > Sharing > Select More external sharing settings","isCorrectAnswer":true},{"value":"From the Microsoft 365 admin center > Policies > Sharing > Select More external sharing settings","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Azure AD admin center > Sharing > Select More external sharing settings"}],"references":{"blocks":[{"data":{},"depth":0,"key":"ea82g","type":"unstyled","text":"https://www.iorad.com/player/1797740/MS-500---Allow-sharing-invitations-to-be-sent-only-to-users-in-an-email-domain","inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[],"key":"7fj7f","inlineStyleRanges":[],"data":{},"type":"ordered-list-item","text":"Open the SharePoint admin center.","depth":0},{"type":"ordered-list-item","inlineStyleRanges":[],"entityRanges":[],"key":"5jeft","data":{},"depth":0,"text":"Go to Policies > Sharing."},{"depth":0,"text":"Click More external sharing settings > Limit external sharing by domain > Add domains.","key":"9kiri","type":"ordered-list-item","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"key":"31v0b","type":"ordered-list-item","inlineStyleRanges":[],"depth":0,"entityRanges":[],"data":{},"text":"Click Allow only specific domains > enter the domain you want to block. Click Save."}],"entityMap":{}},"id":"KOMVmAsnm","question":{"entityMap":{},"blocks":[{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{},"text":"You discover that Microsoft SharePoint content is shared with users from multiple domains.","key":"8ljgq"},{"text":"You need to allow sharing invitations to be sent only to users in an email domain named contoso.com.","data":{},"key":"b0mqt","depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[]},{"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","offset":0,"length":48},{"offset":0,"length":48,"style":"bgcolor-rgb(255,255,255)"},{"length":48,"style":"fontsize-16","offset":0},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":48,"offset":0}],"text":"What steps should you take to complete the task?","key":"al911","data":{},"type":"unstyled","entityRanges":[],"depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
