...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Policies: 1"},{"isCorrectAnswer":true,"value":"Policies: 2"},{"value":"Policies: 3","isCorrectAnswer":false},{"value":"Rules: 1","isCorrectAnswer":false},{"value":"Rules: 2","isCorrectAnswer":false},{"value":"Rules: 3","isCorrectAnswer":true},{"value":"Rules: 4","isCorrectAnswer":false}],"id":"u4QhevP_z","question":{"blocks":[{"entityRanges":[],"key":"b1abo","depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription.","data":{}},{"key":"7ie60","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"You identify the following data loss prevention (DLP) requirements:","data":{},"type":"unstyled"},{"type":"unordered-list-item","depth":0,"data":{},"inlineStyleRanges":[],"text":"Send notifications to users if they attempt to send attachments that contain EU Social Security Numbers (SSN) or Equivalent ID.","entityRanges":[],"key":"11d6"},{"type":"unordered-list-item","inlineStyleRanges":[],"text":"Prevent any email messages that contain credit card numbers from being sent outside your organization.","entityRanges":[],"data":{},"key":"7421v","depth":0},{"entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"Block the external sharing of Microsoft OneDrive content that contains EU passport numbers.","type":"unordered-list-item","data":{},"key":"d0gr9"},{"text":"Send administrators email alerts if any rule matches occur.","entityRanges":[],"key":"917t","inlineStyleRanges":[],"data":{},"depth":0,"type":"unordered-list-item"},{"inlineStyleRanges":[],"type":"unstyled","key":"ervpb","depth":0,"text":"What is the minimum number of DLP policies and rules you must create to meet the requirements? To answer, select the appropriate options in the answer area.","entityRanges":[],"data":{}}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"data":{},"key":"e3nvr","depth":0,"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"Policy 1 will have Exchange selected as a location."},{"key":"b49sa","data":{},"inlineStyleRanges":[],"text":"Rule 1: Condition contains EU Social Security number. Action Notify the user and admin","type":"unordered-list-item","depth":0,"entityRanges":[]},{"inlineStyleRanges":[],"data":{},"depth":0,"key":"fa55s","text":"Rule 2: Condition contains Credit card numbers. Action Restrict access to the content for external users. Notify admin","type":"unordered-list-item","entityRanges":[]},{"depth":0,"inlineStyleRanges":[],"key":"2365d","data":{},"type":"unstyled","text":"Policy 2 Will have OneDrive selected as a location.","entityRanges":[]},{"depth":0,"data":{},"text":"Rule 3: Condition contains EU passport numbers. Action Restrict access to the content for external users. Notify admin","entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[{"length":91,"offset":27,"style":"color-rgb(33,37,41)"},{"length":91,"style":"bgcolor-rgb(255,255,255)","offset":27},{"offset":27,"style":"fontsize-16","length":91},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":91,"offset":27}],"key":"csbk"},{"type":"unstyled","key":"8g2jb","entityRanges":[{"key":0,"length":116,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","depth":0,"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","offset":0,"length":116},{"style":"bgcolor-rgb(255,255,255)","offset":0,"length":116},{"length":116,"offset":0,"style":"fontsize-16"},{"offset":0,"length":116,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
