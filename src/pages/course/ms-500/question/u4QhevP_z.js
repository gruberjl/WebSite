...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Policies: 1","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Policies: 2"},{"value":"Policies: 3","isCorrectAnswer":false},{"value":"Rules: 1","isCorrectAnswer":false},{"value":"Rules: 2","isCorrectAnswer":false},{"value":"Rules: 3","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Rules: 4"}],"id":"u4QhevP_z","question":{"blocks":[{"depth":0,"text":"You have a Microsoft 365 subscription.","entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unstyled","key":"b1abo"},{"inlineStyleRanges":[],"text":"You identify the following data loss prevention (DLP) requirements:","entityRanges":[],"key":"7ie60","type":"unstyled","data":{},"depth":0},{"data":{},"key":"11d6","type":"unordered-list-item","depth":0,"text":"Send notifications to users if they attempt to send attachments that contain EU Social Security Numbers (SSN) or Equivalent ID.","inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[],"type":"unordered-list-item","data":{},"inlineStyleRanges":[],"depth":0,"key":"7421v","text":"Prevent any email messages that contain credit card numbers from being sent outside your organization."},{"data":{},"entityRanges":[],"key":"d0gr9","depth":0,"inlineStyleRanges":[],"text":"Block the external sharing of Microsoft OneDrive content that contains EU passport numbers.","type":"unordered-list-item"},{"type":"unordered-list-item","entityRanges":[],"depth":0,"key":"917t","inlineStyleRanges":[],"data":{},"text":"Send administrators email alerts if any rule matches occur."},{"depth":0,"type":"unstyled","text":"What is the minimum number of DLP policies and rules you must create to meet the requirements? To answer, select the appropriate options in the answer area.","entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"ervpb"}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"key":"e3nvr","type":"unstyled","text":"Policy 1 will have Exchange selected as a location.","data":{}},{"depth":0,"data":{},"inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"text":"Rule 1: Condition contains EU Social Security number. Action Notify the user and admin","key":"b49sa"},{"entityRanges":[],"depth":0,"key":"fa55s","data":{},"inlineStyleRanges":[],"text":"Rule 2: Condition contains Credit card numbers. Action Restrict access to the content for external users. Notify admin","type":"unordered-list-item"},{"data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"2365d","text":"Policy 2 Will have OneDrive selected as a location.","type":"unstyled"},{"key":"csbk","text":"Rule 3: Condition contains EU passport numbers. Action Restrict access to the content for external users. Notify admin","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","offset":27,"length":91},{"style":"bgcolor-rgb(255,255,255)","length":91,"offset":27},{"style":"fontsize-16","offset":27,"length":91},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":27,"length":91}],"type":"unordered-list-item"},{"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","type":"unstyled","data":{},"inlineStyleRanges":[{"length":116,"style":"color-rgb(33,37,41)","offset":0},{"offset":0,"style":"bgcolor-rgb(255,255,255)","length":116},{"offset":0,"length":116,"style":"fontsize-16"},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":0,"length":116}],"depth":0,"key":"8g2jb","entityRanges":[{"key":0,"length":116,"offset":0}]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
