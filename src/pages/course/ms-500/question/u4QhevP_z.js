...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Policies: 1"},{"value":"Policies: 2","isCorrectAnswer":true},{"value":"Policies: 3","isCorrectAnswer":false},{"value":"Rules: 1","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Rules: 2"},{"value":"Rules: 3","isCorrectAnswer":true},{"value":"Rules: 4","isCorrectAnswer":false}],"id":"u4QhevP_z","question":{"entityMap":{},"blocks":[{"key":"b1abo","data":{},"type":"unstyled","text":"You have a Microsoft 365 subscription.","inlineStyleRanges":[],"depth":0,"entityRanges":[]},{"inlineStyleRanges":[],"text":"You identify the following data loss prevention (DLP) requirements:","entityRanges":[],"key":"7ie60","data":{},"type":"unstyled","depth":0},{"text":"Send notifications to users if they attempt to send attachments that contain EU Social Security Numbers (SSN) or Equivalent ID.","data":{},"key":"11d6","entityRanges":[],"type":"unordered-list-item","depth":0,"inlineStyleRanges":[]},{"key":"7421v","entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"depth":0,"data":{},"text":"Prevent any email messages that contain credit card numbers from being sent outside your organization."},{"entityRanges":[],"depth":0,"key":"d0gr9","inlineStyleRanges":[],"text":"Block the external sharing of Microsoft OneDrive content that contains EU passport numbers.","data":{},"type":"unordered-list-item"},{"key":"917t","data":{},"depth":0,"entityRanges":[],"text":"Send administrators email alerts if any rule matches occur.","inlineStyleRanges":[],"type":"unordered-list-item"},{"entityRanges":[],"data":{},"depth":0,"text":"What is the minimum number of DLP policies and rules you must create to meet the requirements? To answer, select the appropriate options in the answer area.","key":"ervpb","type":"unstyled","inlineStyleRanges":[]}]},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"type":"unstyled","inlineStyleRanges":[],"text":"Policy 1 will have Exchange selected as a location.","key":"e3nvr","entityRanges":[],"data":{},"depth":0},{"data":{},"entityRanges":[],"type":"unordered-list-item","key":"b49sa","text":"Rule 1: Condition contains EU Social Security number. Action Notify the user and admin","inlineStyleRanges":[],"depth":0},{"entityRanges":[],"key":"fa55s","text":"Rule 2: Condition contains Credit card numbers. Action Restrict access to the content for external users. Notify admin","inlineStyleRanges":[],"depth":0,"data":{},"type":"unordered-list-item"},{"data":{},"depth":0,"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"text":"Policy 2 Will have OneDrive selected as a location.","key":"2365d"},{"text":"Rule 3: Condition contains EU passport numbers. Action Restrict access to the content for external users. Notify admin","type":"unordered-list-item","key":"csbk","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[{"offset":27,"style":"color-rgb(33,37,41)","length":91},{"offset":27,"style":"bgcolor-rgb(255,255,255)","length":91},{"offset":27,"length":91,"style":"fontsize-16"},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":91,"offset":27}]},{"depth":0,"type":"unstyled","entityRanges":[{"key":0,"length":116,"offset":0}],"data":{},"key":"8g2jb","inlineStyleRanges":[{"offset":0,"style":"color-rgb(33,37,41)","length":116},{"style":"bgcolor-rgb(255,255,255)","length":116,"offset":0},{"length":116,"style":"fontsize-16","offset":0},{"offset":0,"length":116,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
