...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"CpxByA3QU","references":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[],"key":"2sq8u","type":"unstyled","text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins"}]},"question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[{"offset":0,"style":"BOLD","length":21}],"depth":0,"entityRanges":[],"text":"Security Requirements","data":{},"type":"unstyled","key":"cam7v"},{"inlineStyleRanges":[],"entityRanges":[],"key":"52u0a","data":{},"type":"unstyled","text":"Fabrikam identifies the following security requirements:","depth":0},{"data":{},"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"4t196"},{"depth":0,"inlineStyleRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","key":"boph3","entityRanges":[],"data":{}},{"depth":0,"key":"2avo6","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"7q0rb","type":"unordered-list-item","inlineStyleRanges":[],"depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","entityRanges":[],"data":{}},{"data":{},"key":"a8d4g","type":"unordered-list-item","inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","entityRanges":[],"depth":0},{"inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"f399f","data":{},"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","key":"9sp13","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"key":"a5fvp","depth":0,"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item","inlineStyleRanges":[],"data":{},"entityRanges":[]},{"data":{},"type":"unstyled","text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing.","depth":0,"key":"27dih","inlineStyleRanges":[],"entityRanges":[]},{"depth":0,"key":"fa7go","text":"Which blade should you recommend using from the Azure Active Directory admin center?","type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[]}]},"answers":[{"value":"Sign-ins","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Azure AD Identity Protection"},{"isCorrectAnswer":false,"value":"Authentication methods"},{"value":"Access review","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
