...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Sign-ins","isCorrectAnswer":true},{"value":"Azure AD Identity Protection","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Authentication methods"},{"value":"Access review","isCorrectAnswer":false}],"id":"CpxByA3QU","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[{"offset":0,"length":21,"style":"BOLD"}],"depth":0,"key":"cam7v","type":"unstyled","entityRanges":[],"text":"Security Requirements","data":{}},{"key":"52u0a","data":{},"type":"unstyled","entityRanges":[],"depth":0,"text":"Fabrikam identifies the following security requirements:","inlineStyleRanges":[]},{"data":{},"depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[],"inlineStyleRanges":[],"type":"unordered-list-item","key":"4t196"},{"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","data":{},"depth":0,"key":"boph3","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement"},{"inlineStyleRanges":[],"key":"2avo6","depth":0,"type":"unordered-list-item","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"data":{}},{"data":{},"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","key":"7q0rb","depth":0},{"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"a8d4g","depth":0,"data":{},"type":"unordered-list-item","entityRanges":[]},{"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","depth":0,"key":"f399f","entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unordered-list-item"},{"depth":0,"data":{},"entityRanges":[],"key":"9sp13","text":"Email messages that include attachments containing malware must be delivered without the attachment","type":"unordered-list-item","inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"data":{},"key":"a5fvp","text":"The principle of least privilege must be used whenever possible"},{"type":"unstyled","entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"27dih","text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing.","data":{}},{"type":"unstyled","entityRanges":[],"data":{},"text":"Which blade should you recommend using from the Azure Active Directory admin center?","depth":0,"inlineStyleRanges":[],"key":"fa7go"}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1"}},"1":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins"}}},"blocks":[{"entityRanges":[],"text":"The sign-in logs will tell you where users have logged in from.","data":{},"type":"unstyled","depth":0,"key":"2sq8u","inlineStyleRanges":[]},{"type":"unstyled","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","entityRanges":[{"offset":0,"key":0,"length":105}],"depth":0,"inlineStyleRanges":[],"key":"3ob8v"},{"data":{},"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","key":"fkqml","entityRanges":[{"offset":0,"length":91,"key":1}],"inlineStyleRanges":[],"depth":0,"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
