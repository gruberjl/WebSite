...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"CpxByA3QU","answers":[{"isCorrectAnswer":true,"value":"Sign-ins"},{"isCorrectAnswer":false,"value":"Azure AD Identity Protection"},{"value":"Authentication methods","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Access review"}],"references":{"entityMap":{},"blocks":[{"key":"2sq8u","inlineStyleRanges":[],"type":"unstyled","text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","entityRanges":[],"data":{},"depth":0}]},"question":{"entityMap":{},"blocks":[{"entityRanges":[],"data":{},"key":"cam7v","depth":0,"text":"Security Requirements","type":"unstyled","inlineStyleRanges":[{"offset":0,"style":"BOLD","length":21}]},{"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"Fabrikam identifies the following security requirements:","depth":0,"key":"52u0a","data":{}},{"depth":0,"key":"4t196","entityRanges":[],"type":"unordered-list-item","data":{},"inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"depth":0,"entityRanges":[],"key":"boph3","type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","inlineStyleRanges":[],"data":{}},{"entityRanges":[],"inlineStyleRanges":[],"depth":0,"data":{},"key":"2avo6","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","type":"unordered-list-item"},{"entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","key":"7q0rb","type":"unordered-list-item","inlineStyleRanges":[],"data":{},"depth":0},{"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","depth":0,"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"a8d4g","data":{}},{"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"depth":0,"data":{},"key":"f399f"},{"key":"9sp13","depth":0,"type":"unordered-list-item","data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"key":"a5fvp","depth":0,"data":{}},{"text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing.","key":"27dih","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"depth":0,"data":{}},{"key":"fa7go","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"Which blade should you recommend using from the Azure Active Directory admin center?"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
