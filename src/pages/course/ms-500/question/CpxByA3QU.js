...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Sign-ins"},{"isCorrectAnswer":false,"value":"Azure AD Identity Protection"},{"value":"Authentication methods","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Access review"}],"id":"CpxByA3QU","question":{"entityMap":{},"blocks":[{"data":{},"inlineStyleRanges":[{"length":21,"offset":0,"style":"BOLD"}],"key":"cam7v","entityRanges":[],"depth":0,"text":"Security Requirements","type":"unstyled"},{"depth":0,"type":"unstyled","entityRanges":[],"text":"Fabrikam identifies the following security requirements:","key":"52u0a","inlineStyleRanges":[],"data":{}},{"key":"4t196","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","data":{}},{"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","depth":0,"data":{},"key":"boph3"},{"key":"2avo6","type":"unordered-list-item","inlineStyleRanges":[],"data":{},"depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[]},{"type":"unordered-list-item","key":"7q0rb","inlineStyleRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","entityRanges":[],"data":{},"depth":0},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"a8d4g","entityRanges":[],"data":{},"type":"unordered-list-item","depth":0,"inlineStyleRanges":[]},{"depth":0,"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{},"inlineStyleRanges":[],"key":"f399f","entityRanges":[]},{"key":"9sp13","type":"unordered-list-item","depth":0,"data":{},"entityRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","inlineStyleRanges":[]},{"text":"The principle of least privilege must be used whenever possible","key":"a5fvp","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unordered-list-item"},{"data":{},"entityRanges":[],"type":"unstyled","key":"27dih","inlineStyleRanges":[],"text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing.","depth":0},{"key":"fa7go","type":"unstyled","text":"Which blade should you recommend using from the Azure Active Directory admin center?","inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0}]},"references":{"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1"},"mutability":"MUTABLE"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"text":"The sign-in logs will tell you where users have logged in from.","entityRanges":[],"key":"2sq8u","inlineStyleRanges":[],"type":"unstyled","depth":0,"data":{}},{"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","entityRanges":[{"offset":0,"key":0,"length":105}],"type":"unstyled","key":"3ob8v","data":{},"inlineStyleRanges":[],"depth":0},{"type":"unstyled","entityRanges":[{"key":1,"offset":0,"length":91}],"key":"fkqml","data":{},"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","inlineStyleRanges":[],"depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
