...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Sign-ins"},{"isCorrectAnswer":false,"value":"Azure AD Identity Protection"},{"value":"Authentication methods","isCorrectAnswer":false},{"value":"Access review","isCorrectAnswer":false}],"id":"CpxByA3QU","question":{"blocks":[{"entityRanges":[],"key":"cam7v","type":"unstyled","data":{},"depth":0,"text":"Security Requirements","inlineStyleRanges":[{"style":"BOLD","offset":0,"length":21}]},{"inlineStyleRanges":[],"key":"52u0a","type":"unstyled","entityRanges":[],"data":{},"depth":0,"text":"Fabrikam identifies the following security requirements:"},{"data":{},"type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[],"inlineStyleRanges":[],"key":"4t196","depth":0},{"entityRanges":[],"type":"unordered-list-item","data":{},"depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","key":"boph3","inlineStyleRanges":[]},{"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"data":{},"key":"2avo6","depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations"},{"entityRanges":[],"data":{},"type":"unordered-list-item","depth":0,"key":"7q0rb","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[]},{"inlineStyleRanges":[],"data":{},"key":"a8d4g","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0,"entityRanges":[],"type":"unordered-list-item"},{"depth":0,"key":"f399f","entityRanges":[],"data":{},"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","inlineStyleRanges":[]},{"text":"Email messages that include attachments containing malware must be delivered without the attachment","key":"9sp13","data":{},"type":"unordered-list-item","inlineStyleRanges":[],"depth":0,"entityRanges":[]},{"text":"The principle of least privilege must be used whenever possible","entityRanges":[],"key":"a5fvp","depth":0,"inlineStyleRanges":[],"data":{},"type":"unordered-list-item"},{"key":"27dih","type":"unstyled","data":{},"inlineStyleRanges":[],"text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing.","entityRanges":[],"depth":0},{"entityRanges":[],"key":"fa7go","depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"Which blade should you recommend using from the Azure Active Directory admin center?","data":{}}],"entityMap":{}},"references":{"blocks":[{"text":"The sign-in logs will tell you where users have logged in from.","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unstyled","key":"2sq8u"},{"type":"unstyled","depth":0,"data":{},"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","entityRanges":[{"length":105,"key":0,"offset":0}],"key":"3ob8v"},{"depth":0,"data":{},"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","type":"unstyled","inlineStyleRanges":[],"key":"fkqml","entityRanges":[{"offset":0,"key":1,"length":91}]}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"},"type":"LINK"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
