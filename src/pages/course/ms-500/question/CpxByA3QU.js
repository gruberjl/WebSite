...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"entityMap":{},"blocks":[{"text":"Security Requirements","depth":0,"type":"unstyled","data":{},"inlineStyleRanges":[{"offset":0,"length":21,"style":"BOLD"}],"entityRanges":[],"key":"cam7v"},{"depth":0,"data":{},"type":"unstyled","key":"52u0a","text":"Fabrikam identifies the following security requirements:","inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[],"type":"unordered-list-item","key":"4t196","inlineStyleRanges":[],"data":{},"depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"key":"boph3","inlineStyleRanges":[],"entityRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","data":{},"depth":0},{"data":{},"depth":0,"key":"2avo6","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[]},{"type":"unordered-list-item","key":"7q0rb","entityRanges":[],"inlineStyleRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"depth":0},{"key":"a8d4g","inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","data":{},"depth":0,"type":"unordered-list-item","entityRanges":[]},{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"f399f","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","data":{}},{"entityRanges":[],"depth":0,"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","data":{},"key":"9sp13","inlineStyleRanges":[]},{"entityRanges":[],"key":"a5fvp","inlineStyleRanges":[],"data":{},"depth":0,"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item"},{"entityRanges":[],"depth":0,"key":"27dih","text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing.","data":{},"inlineStyleRanges":[],"type":"unstyled"},{"depth":0,"inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"fa7go","text":"Which blade should you recommend using from the Azure Active Directory admin center?","type":"unstyled"}]},"answers":[{"isCorrectAnswer":true,"value":"Sign-ins"},{"isCorrectAnswer":false,"value":"Azure AD Identity Protection"},{"isCorrectAnswer":false,"value":"Authentication methods"},{"value":"Access review","isCorrectAnswer":false}],"references":{"entityMap":{},"blocks":[{"data":{},"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"key":"2sq8u","text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","depth":0}]},"id":"CpxByA3QU"},
      previousQuestionId: '',
      nextQuestionId: '',
