...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Sign-ins","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Azure AD Identity Protection"},{"value":"Authentication methods","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Access review"}],"id":"CpxByA3QU","question":{"blocks":[{"data":{},"key":"cam7v","type":"unstyled","inlineStyleRanges":[{"length":21,"offset":0,"style":"BOLD"}],"depth":0,"text":"Security Requirements","entityRanges":[]},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"52u0a","type":"unstyled","text":"Fabrikam identifies the following security requirements:","depth":0},{"data":{},"inlineStyleRanges":[],"depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[],"key":"4t196","type":"unordered-list-item"},{"data":{},"depth":0,"inlineStyleRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","entityRanges":[],"type":"unordered-list-item","key":"boph3"},{"key":"2avo6","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unordered-list-item","data":{}},{"entityRanges":[],"depth":0,"key":"7q0rb","type":"unordered-list-item","inlineStyleRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{}},{"inlineStyleRanges":[],"data":{},"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","entityRanges":[],"key":"a8d4g","depth":0,"type":"unordered-list-item"},{"data":{},"type":"unordered-list-item","depth":0,"key":"f399f","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","inlineStyleRanges":[],"entityRanges":[]},{"depth":0,"entityRanges":[],"key":"9sp13","text":"Email messages that include attachments containing malware must be delivered without the attachment","data":{},"inlineStyleRanges":[],"type":"unordered-list-item"},{"data":{},"type":"unordered-list-item","text":"The principle of least privilege must be used whenever possible","entityRanges":[],"depth":0,"key":"a5fvp","inlineStyleRanges":[]},{"entityRanges":[],"key":"27dih","data":{},"type":"unstyled","text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing.","depth":0,"inlineStyleRanges":[]},{"type":"unstyled","text":"Which blade should you recommend using from the Azure Active Directory admin center?","key":"fa7go","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[]}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"key":"2sq8u","text":"The sign-in logs will tell you where users have logged in from.","depth":0,"inlineStyleRanges":[],"data":{},"type":"unstyled"},{"depth":0,"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","entityRanges":[{"offset":0,"length":105,"key":0}],"key":"3ob8v"},{"entityRanges":[{"key":1,"length":91,"offset":0}],"key":"fkqml","inlineStyleRanges":[],"depth":0,"type":"unstyled","data":{},"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
