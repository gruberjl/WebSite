...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"CpxByA3QU","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[{"length":21,"style":"BOLD","offset":0}],"type":"unstyled","depth":0,"key":"cam7v","data":{},"text":"Security Requirements","entityRanges":[]},{"type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"Fabrikam identifies the following security requirements:","key":"52u0a","data":{},"entityRanges":[]},{"depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","key":"4t196"},{"data":{},"key":"boph3","inlineStyleRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","entityRanges":[],"depth":0},{"key":"2avo6","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unordered-list-item","depth":0},{"data":{},"type":"unordered-list-item","key":"7q0rb","depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","entityRanges":[],"inlineStyleRanges":[]},{"depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"a8d4g","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item"},{"type":"unordered-list-item","inlineStyleRanges":[],"depth":0,"entityRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","data":{},"key":"f399f"},{"entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"key":"9sp13","type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"data":{},"text":"The principle of least privilege must be used whenever possible","key":"a5fvp","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[]},{"type":"unstyled","inlineStyleRanges":[],"key":"27dih","depth":0,"entityRanges":[],"data":{},"text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing."},{"depth":0,"entityRanges":[],"key":"fa7go","type":"unstyled","data":{},"inlineStyleRanges":[],"text":"Which blade should you recommend using from the Azure Active Directory admin center?"}]},"answers":[{"value":"Sign-ins","isCorrectAnswer":true},{"value":"Azure AD Identity Protection","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Authentication methods"},{"isCorrectAnswer":false,"value":"Access review"}],"references":{"blocks":[{"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","depth":0,"inlineStyleRanges":[],"key":"2sq8u","type":"unstyled","data":{},"entityRanges":[]}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
