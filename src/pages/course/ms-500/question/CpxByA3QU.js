...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Sign-ins","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Azure AD Identity Protection"},{"value":"Authentication methods","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Access review"}],"id":"CpxByA3QU","question":{"blocks":[{"key":"cam7v","depth":0,"data":{},"inlineStyleRanges":[{"style":"BOLD","offset":0,"length":21}],"text":"Security Requirements","entityRanges":[],"type":"unstyled"},{"entityRanges":[],"data":{},"key":"52u0a","type":"unstyled","inlineStyleRanges":[],"text":"Fabrikam identifies the following security requirements:","depth":0},{"depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"data":{},"key":"4t196","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"entityRanges":[],"key":"boph3","inlineStyleRanges":[],"depth":0,"data":{},"type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement"},{"entityRanges":[],"type":"unordered-list-item","key":"2avo6","depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","inlineStyleRanges":[],"data":{}},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"7q0rb","depth":0,"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory"},{"depth":0,"data":{},"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"a8d4g","entityRanges":[],"inlineStyleRanges":[],"type":"unordered-list-item"},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","key":"f399f","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"depth":0,"entityRanges":[],"key":"9sp13","data":{},"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","inlineStyleRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","key":"a5fvp","data":{},"type":"unordered-list-item","depth":0},{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"key":"27dih","data":{},"text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing.","depth":0},{"inlineStyleRanges":[],"data":{},"text":"Which blade should you recommend using from the Azure Active Directory admin center?","entityRanges":[],"key":"fa7go","depth":0,"type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"key":"2sq8u","type":"unstyled","text":"The sign-in logs will tell you where users have logged in from.","depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[]},{"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","key":"3ob8v","type":"unstyled","inlineStyleRanges":[],"depth":0,"entityRanges":[{"offset":0,"length":105,"key":0}]},{"key":"fkqml","inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","depth":0,"entityRanges":[{"key":1,"offset":0,"length":91}],"type":"unstyled","data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"},"type":"LINK"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
