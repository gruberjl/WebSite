...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Sign-ins","isCorrectAnswer":true},{"value":"Azure AD Identity Protection","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Authentication methods"},{"value":"Access review","isCorrectAnswer":false}],"id":"CpxByA3QU","question":{"entityMap":{},"blocks":[{"entityRanges":[],"data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[{"style":"BOLD","offset":0,"length":21}],"text":"Security Requirements","key":"cam7v"},{"depth":0,"inlineStyleRanges":[],"data":{},"text":"Fabrikam identifies the following security requirements:","key":"52u0a","type":"unstyled","entityRanges":[]},{"key":"4t196","inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[],"data":{}},{"inlineStyleRanges":[],"entityRanges":[],"key":"boph3","depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","data":{},"type":"unordered-list-item"},{"inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"type":"unordered-list-item","key":"2avo6","data":{},"depth":0},{"entityRanges":[],"data":{},"type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","key":"7q0rb","depth":0,"inlineStyleRanges":[]},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item","key":"a8d4g"},{"depth":0,"key":"f399f","inlineStyleRanges":[],"type":"unordered-list-item","data":{},"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","entityRanges":[]},{"entityRanges":[],"key":"9sp13","data":{},"depth":0,"text":"Email messages that include attachments containing malware must be delivered without the attachment","inlineStyleRanges":[],"type":"unordered-list-item"},{"type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"The principle of least privilege must be used whenever possible","key":"a5fvp"},{"entityRanges":[],"text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing.","data":{},"key":"27dih","type":"unstyled","depth":0,"inlineStyleRanges":[]},{"type":"unstyled","depth":0,"text":"Which blade should you recommend using from the Azure Active Directory admin center?","entityRanges":[],"key":"fa7go","inlineStyleRanges":[],"data":{}}]},"references":{"blocks":[{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"The sign-in logs will tell you where users have logged in from.","type":"unstyled","data":{},"key":"2sq8u"},{"inlineStyleRanges":[],"data":{},"key":"3ob8v","entityRanges":[{"key":0,"length":105,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","type":"unstyled","depth":0},{"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[{"length":91,"key":1,"offset":0}],"type":"unstyled","key":"fkqml"}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1"}},"1":{"mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","targetOption":"_blank"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
