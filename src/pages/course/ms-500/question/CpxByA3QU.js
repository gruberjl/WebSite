...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Sign-ins","isCorrectAnswer":true},{"value":"Azure AD Identity Protection","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Authentication methods"},{"value":"Access review","isCorrectAnswer":false}],"id":"CpxByA3QU","question":{"blocks":[{"key":"cam7v","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":0,"length":21,"style":"BOLD"}],"data":{},"text":"Security Requirements","entityRanges":[]},{"text":"Fabrikam identifies the following security requirements:","data":{},"entityRanges":[],"type":"unstyled","depth":0,"key":"52u0a","inlineStyleRanges":[]},{"entityRanges":[],"key":"4t196","type":"unordered-list-item","inlineStyleRanges":[],"data":{},"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","depth":0},{"key":"boph3","type":"unordered-list-item","data":{},"depth":0,"inlineStyleRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","entityRanges":[]},{"key":"2avo6","data":{},"type":"unordered-list-item","inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"depth":0},{"data":{},"depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","key":"7q0rb","inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item"},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"a8d4g","inlineStyleRanges":[],"depth":0,"data":{},"type":"unordered-list-item","entityRanges":[]},{"inlineStyleRanges":[],"data":{},"type":"unordered-list-item","entityRanges":[],"key":"f399f","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","depth":0},{"key":"9sp13","inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0},{"entityRanges":[],"inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item","data":{},"key":"a5fvp","depth":0},{"data":{},"depth":0,"inlineStyleRanges":[],"key":"27dih","text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing.","entityRanges":[],"type":"unstyled"},{"inlineStyleRanges":[],"key":"fa7go","depth":0,"entityRanges":[],"data":{},"type":"unstyled","text":"Which blade should you recommend using from the Azure Active Directory admin center?"}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"}},"1":{"mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","targetOption":"_blank"},"type":"LINK"}},"blocks":[{"text":"The sign-in logs will tell you where users have logged in from.","depth":0,"key":"2sq8u","data":{},"type":"unstyled","inlineStyleRanges":[],"entityRanges":[]},{"type":"unstyled","data":{},"entityRanges":[{"key":0,"offset":0,"length":105}],"key":"3ob8v","text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","depth":0,"inlineStyleRanges":[]},{"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","depth":0,"type":"unstyled","inlineStyleRanges":[],"key":"fkqml","data":{},"entityRanges":[{"key":1,"length":91,"offset":0}]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
