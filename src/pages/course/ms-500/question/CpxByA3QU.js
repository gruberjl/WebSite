...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Sign-ins"},{"isCorrectAnswer":false,"value":"Azure AD Identity Protection"},{"isCorrectAnswer":false,"value":"Authentication methods"},{"value":"Access review","isCorrectAnswer":false}],"id":"CpxByA3QU","question":{"blocks":[{"entityRanges":[],"data":{},"type":"unstyled","text":"Security Requirements","key":"cam7v","inlineStyleRanges":[{"length":21,"offset":0,"style":"BOLD"}],"depth":0},{"entityRanges":[],"key":"52u0a","depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"Fabrikam identifies the following security requirements:"},{"depth":0,"entityRanges":[],"key":"4t196","type":"unordered-list-item","inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","data":{}},{"type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","inlineStyleRanges":[],"depth":0,"key":"boph3","entityRanges":[],"data":{}},{"key":"2avo6","depth":0,"data":{},"type":"unordered-list-item","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"inlineStyleRanges":[]},{"data":{},"entityRanges":[],"key":"7q0rb","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory"},{"inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"a8d4g","data":{},"type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location"},{"entityRanges":[],"data":{},"depth":0,"key":"f399f","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","inlineStyleRanges":[]},{"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"9sp13","data":{}},{"data":{},"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item","depth":0,"key":"a5fvp","entityRanges":[],"inlineStyleRanges":[]},{"type":"unstyled","depth":0,"entityRanges":[],"data":{},"key":"27dih","inlineStyleRanges":[],"text":"You need to recommend a solution for the user administrators that meets the security requirements for auditing."},{"inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"fa7go","entityRanges":[],"data":{},"text":"Which blade should you recommend using from the Azure Active Directory admin center?"}],"entityMap":{}},"references":{"blocks":[{"key":"2sq8u","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"The sign-in logs will tell you where users have logged in from.","type":"unstyled","data":{}},{"key":"3ob8v","depth":0,"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","inlineStyleRanges":[],"entityRanges":[{"offset":0,"key":0,"length":105}],"data":{}},{"entityRanges":[{"length":91,"offset":0,"key":1}],"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","key":"fkqml","type":"unstyled","inlineStyleRanges":[],"depth":0,"data":{}}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
