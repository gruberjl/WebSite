...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Yes","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"No"}],"id":"TO1FKMRg4","question":{"blocks":[{"type":"unstyled","depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription.","key":"7qt30","data":{}},{"data":{},"depth":0,"key":"fi95c","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"You have a user named User1. Several users have full access to the mailbox of User1."},{"type":"unstyled","inlineStyleRanges":[],"key":"cafcm","data":{},"text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them.","entityRanges":[],"depth":0},{"text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank.","key":"1srna","inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[],"depth":0},{"data":{},"inlineStyleRanges":[],"text":"You need to ensure that you can view future sign-ins to the mailbox of User1.","type":"unstyled","entityRanges":[],"depth":0,"key":"47tgb"},{"type":"unstyled","key":"56r3g","depth":0,"entityRanges":[],"text":"You run the Set-AdminAuditLogConfig -AdminAuditLogEnabled $true -AdminAuditLogCmdlets *Mailbox* command.","data":{},"inlineStyleRanges":[{"length":83,"offset":12,"style":"BOLD"}]},{"entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0,"text":"Does that meet the goal?","type":"unstyled","key":"fpjcu"}],"entityMap":{}},"references":{"blocks":[{"text":"To enable Exchange auditing we'll need to use PowerShell.","type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"addi5"},{"text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline.","type":"unstyled","data":{},"key":"c980p","entityRanges":[],"inlineStyleRanges":[],"depth":0},{"type":"unstyled","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"898ib","text":"2. Run the following command \"Set-AdminAuditLogConfig -AdminAuditLogEnabled $true -AdminAuditLogCmdlets * -AdminAuditLogParameters *\""},{"key":"3cjkc","data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"3. Then run the following command \"Set-OrganizationConfig -AuditDisabled $false\""},{"text":"You can also replace step 3 with the following: Set-Mailbox -Identity \"User1 \" -AuditDelegate @{Add=\"MailboxLogin\"}","entityRanges":[],"key":"3s83k","data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"type":"unstyled","entityRanges":[{"key":0,"length":105,"offset":0}],"key":"2qcvr","text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","depth":0,"data":{},"inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[{"length":128,"key":1,"offset":0}],"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/policy-and-compliance-audit/set-adminauditlogconfig?view=exchange-ps","depth":0,"data":{},"key":"cd35f","type":"unstyled"},{"data":{},"entityRanges":[{"key":2,"length":101,"offset":0}],"depth":0,"text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/enable-mailbox-auditing?view=o365-worldwide ","inlineStyleRanges":[],"key":"2eq4a","type":"unstyled"},{"type":"unstyled","entityRanges":[],"key":"bboou","depth":0,"text":"The correct answer is to run the following commands:","inlineStyleRanges":[],"data":{}},{"inlineStyleRanges":[],"key":"5519u","entityRanges":[],"type":"unstyled","depth":0,"data":{},"text":"Set-OrganizationConfig -AuditDisabled $False"},{"key":"76lv","data":{},"entityRanges":[],"type":"unstyled","inlineStyleRanges":[{"offset":23,"length":5,"style":"color-rgb(33,37,41)"},{"style":"bgcolor-rgb(255,255,255)","offset":23,"length":5},{"offset":23,"style":"fontsize-16","length":5},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":5,"offset":23}],"depth":0,"text":"Set-Mailbox -Identity \"User1 \" -AuditDelegate @{Add=\"MailboxLogin\"}"}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","targetOption":"_blank"},"type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/powershell/module/exchange/policy-and-compliance-audit/set-adminauditlogconfig?view=exchange-ps"}},"2":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/microsoft-365/compliance/enable-mailbox-auditing?view=o365-worldwide","targetOption":"_blank"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
