...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User sign-in settings: Password Synchronization with single-sign on","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User sign-in settings: Pass-through authentication with single-sign on"},{"isCorrectAnswer":false,"value":"User sign-in settings: Federation with Active Directory Federation Services (AD FS)"},{"value":"Device options: Hybrid Azure AD Join","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Device options: Enable Device writeback"},{"isCorrectAnswer":false,"value":"Device options: Disable Device writeback"}],"id":"Fc8B7DpEP","question":{"blocks":[{"entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"2eoh4","depth":0,"type":"unstyled","text":"Your organization has a Microsoft 365 tenant and an on-premises Active Directory (AD) domain. Your organization has installed AD Connect but hasn't enabled the syncing of your on-premises AD to Microsoft 365. Your organization is currently using the default authentication settings."},{"type":"unstyled","data":{},"key":"doc92","inlineStyleRanges":[],"entityRanges":[],"text":"Your manager has asked you to perform the following","depth":0},{"entityRanges":[],"type":"unordered-list-item","depth":0,"data":{},"inlineStyleRanges":[],"key":"f92hp","text":"Have all domain joined computers registered in Azure AD."},{"inlineStyleRanges":[],"entityRanges":[],"text":"Configure Microsoft 365 to lock out any user that's currently locked out of the on-premises AD.","type":"unordered-list-item","data":{},"key":"8gce","depth":0},{"entityRanges":[],"text":"What two settings will you need to configure to meet the goals listed above?","data":{},"inlineStyleRanges":[],"key":"51pq4","depth":0,"type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"key":"5ipu7","inlineStyleRanges":[],"depth":0,"entityRanges":[],"text":"To ensure that all domain-joined computers are registered to Azure AD Hybrid Azure AD Join would need to be configured.","type":"unstyled","data":{}},{"key":"2hgvf","text":"To prevent users locked out of Active Directory from signing in to Azure AD and Active Directory pass-through authentication would need to be configured.","data":{},"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"depth":0},{"entityRanges":[{"length":69,"key":0,"offset":0}],"key":"ho77","inlineStyleRanges":[],"type":"unstyled","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","depth":0}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
