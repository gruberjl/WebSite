...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User sign-in settings: Password Synchronization with single-sign on","isCorrectAnswer":false},{"value":"User sign-in settings: Pass-through authentication with single-sign on","isCorrectAnswer":true},{"value":"User sign-in settings: Federation with Active Directory Federation Services (AD FS)","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Device options: Hybrid Azure AD Join"},{"value":"Device options: Enable Device writeback","isCorrectAnswer":false},{"value":"Device options: Disable Device writeback","isCorrectAnswer":false}],"id":"Fc8B7DpEP","question":{"entityMap":{},"blocks":[{"text":"Your organization has a Microsoft 365 tenant and an on-premises Active Directory (AD) domain. Your organization has installed AD Connect but hasn't enabled the syncing of your on-premises AD to Microsoft 365. Your organization is currently using the default authentication settings.","data":{},"inlineStyleRanges":[],"key":"2eoh4","entityRanges":[],"depth":0,"type":"unstyled"},{"type":"unstyled","entityRanges":[],"depth":0,"text":"Your manager has asked you to perform the following","data":{},"inlineStyleRanges":[],"key":"doc92"},{"type":"unordered-list-item","depth":0,"text":"Have all domain joined computers registered in Azure AD.","entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"f92hp"},{"type":"unordered-list-item","key":"8gce","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Configure Microsoft 365 to lock out any user that's currently locked out of the on-premises AD.","data":{}},{"inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"51pq4","data":{},"entityRanges":[],"text":"What two settings will you need to configure to meet the goals listed above?"}]},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"key":"5ipu7","data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"To ensure that all domain-joined computers are registered to Azure AD Hybrid Azure AD Join would need to be configured.","entityRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"To prevent users locked out of Active Directory from signing in to Azure AD and Active Directory pass-through authentication would need to be configured.","type":"unstyled","data":{},"key":"2hgvf"},{"entityRanges":[{"length":69,"offset":0,"key":0}],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","depth":0,"inlineStyleRanges":[],"type":"unstyled","key":"ho77"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
