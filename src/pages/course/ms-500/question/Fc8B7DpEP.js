...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{},"blocks":[{"key":"5ipu7","type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"text":"How should you configure Azure AD Connect?"}]},"question":{"entityMap":{},"blocks":[{"data":{},"depth":0,"text":"Cloud Infrastructure:","type":"unstyled","entityRanges":[],"inlineStyleRanges":[{"length":21,"offset":0,"style":"BOLD"}],"key":"2eoh4"},{"data":{},"type":"unordered-list-item","inlineStyleRanges":[],"text":"Microsoft Azure Active Directory (Azure AD) Connect is installed and uses the default authentication settings. User accounts are not yet synced to Azure AD.","entityRanges":[],"depth":0,"key":"7etia"},{"key":"94rat","type":"unstyled","depth":0,"entityRanges":[],"inlineStyleRanges":[{"length":21,"offset":0,"style":"BOLD"}],"data":{},"text":"Security Requirements:"},{"text":"Use Azure Advanced Threat Protection (ATP) to detect any security threats that target the forest","data":{},"depth":0,"type":"unordered-list-item","entityRanges":[],"key":"emjre","inlineStyleRanges":[]},{"data":{},"text":"Prevent users locked out of Active Directory from signing in to Azure AD and Active Directory","entityRanges":[],"key":"1vqcf","type":"unordered-list-item","inlineStyleRanges":[],"depth":0},{"key":"8kkm9","text":"Configure domain-joined servers to ensure that they report sensor data to Microsoft Defender ATP","type":"unordered-list-item","data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[]},{"depth":0,"type":"unordered-list-item","key":"32kcl","text":"Prevent access to Azure resources for the guest user accounts by default","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"text":"Ensure that all domain-joined computers are registered to Azure AD","data":{},"inlineStyleRanges":[],"key":"890f","depth":0,"type":"unordered-list-item","entityRanges":[]}]},"id":"Fc8B7DpEP","answers":[{"isCorrectAnswer":false,"value":"User sign-in settings: Password Synchronization with single-sign on"},{"isCorrectAnswer":true,"value":"User sign-in settings: Pass-through authentication with single-sign on"},{"value":"User sign-in settings: Federation with Active Directory Federation Services (AD FS)","isCorrectAnswer":false},{"value":"Device options: Hybrid Azure AD Join","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Device options: Enable Device writeback"},{"isCorrectAnswer":false,"value":"Device options: Disable Device writeback"}]},
      previousQuestionId: '',
      nextQuestionId: '',
