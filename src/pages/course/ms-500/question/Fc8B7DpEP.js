...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User sign-in settings: Password Synchronization with single-sign on","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User sign-in settings: Pass-through authentication with single-sign on"},{"value":"User sign-in settings: Federation with Active Directory Federation Services (AD FS)","isCorrectAnswer":false},{"value":"Device options: Hybrid Azure AD Join","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Device options: Enable Device writeback"},{"value":"Device options: Disable Device writeback","isCorrectAnswer":false}],"id":"Fc8B7DpEP","question":{"blocks":[{"data":{},"depth":0,"key":"2eoh4","inlineStyleRanges":[],"text":"Your organization has a Microsoft 365 tenant and an on-premises Active Directory (AD) domain. Your organization has installed AD Connect but hasn't enabled the syncing  of your on-premises AD to Microsoft 365. Your organization is currently using the default authentication settings.","type":"unstyled","entityRanges":[]},{"entityRanges":[],"key":"doc92","data":{},"depth":0,"text":"Your manager has asked you to perform the following","inlineStyleRanges":[],"type":"unstyled"},{"depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"data":{},"key":"f92hp","text":"Have all domain joined computers registered in Azure AD."},{"key":"8gce","entityRanges":[],"type":"unordered-list-item","depth":0,"data":{},"text":"Configure Microsoft 365 to lock out any user that's currently locked out of the on-premises AD.","inlineStyleRanges":[]},{"inlineStyleRanges":[],"key":"51pq4","type":"unstyled","data":{},"entityRanges":[],"depth":0,"text":"What two settings will you need to configure to meet the goals listed above?"}],"entityMap":{}},"references":{"blocks":[{"depth":0,"inlineStyleRanges":[],"key":"5ipu7","entityRanges":[],"text":"To ensure that all domain-joined computers are registered to Azure AD Hybrid Azure AD Join would need to be configured.","type":"unstyled","data":{}},{"depth":0,"text":"To prevent users locked out of Active Directory from signing in to Azure AD and Active Directory pass-through authentication would need to be configured.","data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","key":"2hgvf"},{"entityRanges":[{"key":0,"length":69,"offset":0}],"key":"ho77","text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","type":"unstyled","inlineStyleRanges":[],"depth":0,"data":{}}],"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
