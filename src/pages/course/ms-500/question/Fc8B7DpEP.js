...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User sign-in settings: Password Synchronization with single-sign on"},{"value":"User sign-in settings: Pass-through authentication with single-sign on","isCorrectAnswer":true},{"value":"User sign-in settings: Federation with Active Directory Federation Services (AD FS)","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Device options: Hybrid Azure AD Join"},{"isCorrectAnswer":false,"value":"Device options: Enable Device writeback"},{"value":"Device options: Disable Device writeback","isCorrectAnswer":false}],"id":"Fc8B7DpEP","question":{"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","depth":0,"text":"Your organization has a Microsoft 365 tenant and an on-premises Active Directory (AD) domain. Your organization has installed AD Connect but hasn't enabled the syncing of your on-premises AD to Microsoft 365. Your organization is currently using the default authentication settings.","key":"2eoh4","data":{}},{"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"key":"doc92","data":{},"depth":0,"text":"Your manager has asked you to perform the following"},{"depth":0,"entityRanges":[],"type":"unordered-list-item","data":{},"inlineStyleRanges":[],"text":"Have all domain joined computers registered in Azure AD.","key":"f92hp"},{"type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0,"text":"Configure Microsoft 365 to lock out any user that's currently locked out of the on-premises AD.","key":"8gce"},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"51pq4","type":"unstyled","text":"What two settings will you need to configure to meet the goals listed above?","depth":0}],"entityMap":{}},"references":{"blocks":[{"inlineStyleRanges":[],"data":{},"text":"To ensure that all domain-joined computers are registered to Azure AD Hybrid Azure AD Join would need to be configured.","type":"unstyled","entityRanges":[],"depth":0,"key":"5ipu7"},{"key":"2hgvf","depth":0,"text":"To prevent users locked out of Active Directory from signing in to Azure AD and Active Directory pass-through authentication would need to be configured.","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{}},{"key":"ho77","inlineStyleRanges":[],"data":{},"entityRanges":[{"key":0,"offset":0,"length":69}],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","type":"unstyled","depth":0}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
