...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"User sign-in settings: Password Synchronization with single-sign on","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"User sign-in settings: Pass-through authentication with single-sign on"},{"isCorrectAnswer":false,"value":"User sign-in settings: Federation with Active Directory Federation Services (AD FS)"},{"value":"Device options: Hybrid Azure AD Join","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Device options: Enable Device writeback"},{"value":"Device options: Disable Device writeback","isCorrectAnswer":false}],"id":"Fc8B7DpEP","question":{"blocks":[{"entityRanges":[],"key":"2eoh4","type":"unstyled","data":{},"inlineStyleRanges":[],"depth":0,"text":"Your organization has a Microsoft 365 tenant and an on-premises Active Directory (AD) domain. Your organization has installed AD Connect but hasn't enabled the syncing of your on-premises AD to Microsoft 365. Your organization is currently using the default authentication settings."},{"entityRanges":[],"type":"unstyled","depth":0,"data":{},"key":"doc92","text":"Your manager has asked you to perform the following","inlineStyleRanges":[]},{"type":"unordered-list-item","depth":0,"text":"Have all domain joined computers registered in Azure AD.","data":{},"inlineStyleRanges":[],"key":"f92hp","entityRanges":[]},{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"8gce","text":"Configure Microsoft 365 to lock out any user that's currently locked out of the on-premises AD.","type":"unordered-list-item","data":{}},{"depth":0,"key":"51pq4","text":"What two settings will you need to configure to meet the goals listed above?","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","data":{}}],"entityMap":{}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"}}},"blocks":[{"inlineStyleRanges":[],"data":{},"key":"5ipu7","entityRanges":[],"type":"unstyled","text":"To ensure that all domain-joined computers are registered to Azure AD Hybrid Azure AD Join would need to be configured.","depth":0},{"key":"2hgvf","entityRanges":[],"text":"To prevent users locked out of Active Directory from signing in to Azure AD and Active Directory pass-through authentication would need to be configured.","depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{}},{"key":"ho77","entityRanges":[{"length":69,"key":0,"offset":0}],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","depth":0,"inlineStyleRanges":[],"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
