...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"Fc8B7DpEP","answers":[{"value":"User sign-in settings: Password Synchronization with single-sign on","isCorrectAnswer":false},{"value":"User sign-in settings: Pass-through authentication with single-sign on","isCorrectAnswer":true},{"value":"User sign-in settings: Federation with Active Directory Federation Services (AD FS)","isCorrectAnswer":false},{"value":"Device options: Hybrid Azure AD Join","isCorrectAnswer":true},{"value":"Device options: Enable Device writeback","isCorrectAnswer":false},{"value":"Device options: Disable Device writeback","isCorrectAnswer":false}],"question":{"blocks":[{"inlineStyleRanges":[{"length":21,"style":"BOLD","offset":0}],"text":"Cloud Infrastructure:","entityRanges":[],"key":"2eoh4","data":{},"type":"unstyled","depth":0},{"inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"Microsoft Azure Active Directory (Azure AD) Connect is installed and uses the default authentication settings. User accounts are not yet synced to Azure AD.","key":"7etia","depth":0,"type":"unordered-list-item"},{"entityRanges":[],"data":{},"type":"unstyled","key":"94rat","depth":0,"inlineStyleRanges":[{"style":"BOLD","length":21,"offset":0}],"text":"Security Requirements:"},{"depth":0,"key":"emjre","entityRanges":[],"text":"Use Azure Advanced Threat Protection (ATP) to detect any security threats that target the forest","data":{},"type":"unordered-list-item","inlineStyleRanges":[]},{"text":"Prevent users locked out of Active Directory from signing in to Azure AD and Active Directory","type":"unordered-list-item","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[],"key":"1vqcf"},{"entityRanges":[],"type":"unordered-list-item","data":{},"inlineStyleRanges":[],"text":"Configure domain-joined servers to ensure that they report sensor data to Microsoft Defender ATP","key":"8kkm9","depth":0},{"inlineStyleRanges":[],"depth":0,"text":"Prevent access to Azure resources for the guest user accounts by default","data":{},"entityRanges":[],"key":"32kcl","type":"unordered-list-item"},{"entityRanges":[],"type":"unordered-list-item","data":{},"depth":0,"text":"Ensure that all domain-joined computers are registered to Azure AD","key":"890f","inlineStyleRanges":[]}],"entityMap":{}},"references":{"blocks":[{"data":{},"text":"How should you configure Azure AD Connect?","type":"unstyled","depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"5ipu7"}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
