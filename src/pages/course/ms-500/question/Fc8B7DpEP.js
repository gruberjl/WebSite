...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"User sign-in settings: Password Synchronization with single-sign on"},{"isCorrectAnswer":true,"value":"User sign-in settings: Pass-through authentication with single-sign on"},{"value":"User sign-in settings: Federation with Active Directory Federation Services (AD FS)","isCorrectAnswer":false},{"value":"Device options: Hybrid Azure AD Join","isCorrectAnswer":true},{"value":"Device options: Enable Device writeback","isCorrectAnswer":false},{"value":"Device options: Disable Device writeback","isCorrectAnswer":false}],"id":"Fc8B7DpEP","question":{"blocks":[{"depth":0,"entityRanges":[],"type":"unstyled","data":{},"inlineStyleRanges":[],"key":"2eoh4","text":"Your organization has a Microsoft 365 tenant and an on-premises Active Directory (AD) domain. Your organization has installed AD Connect but hasn't enabled the syncing of your on-premises AD to Microsoft 365. Your organization is currently using the default authentication settings."},{"type":"unstyled","depth":0,"text":"Your manager has asked you to perform the following","inlineStyleRanges":[],"entityRanges":[],"key":"doc92","data":{}},{"entityRanges":[],"data":{},"depth":0,"type":"unordered-list-item","inlineStyleRanges":[],"text":"Have all domain joined computers registered in Azure AD.","key":"f92hp"},{"inlineStyleRanges":[],"key":"8gce","depth":0,"entityRanges":[],"data":{},"text":"Configure Microsoft 365 to lock out any user that's currently locked out of the on-premises AD.","type":"unordered-list-item"},{"entityRanges":[],"text":"What two settings will you need to configure to meet the goals listed above?","type":"unstyled","key":"51pq4","data":{},"depth":0,"inlineStyleRanges":[]}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"}}},"blocks":[{"entityRanges":[],"type":"unstyled","depth":0,"data":{},"inlineStyleRanges":[],"text":"To ensure that all domain-joined computers are registered to Azure AD Hybrid Azure AD Join would need to be configured.","key":"5ipu7"},{"text":"To prevent users locked out of Active Directory from signing in to Azure AD and Active Directory pass-through authentication would need to be configured.","type":"unstyled","key":"2hgvf","data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0},{"type":"unstyled","data":{},"key":"ho77","entityRanges":[{"key":0,"offset":0,"length":69}],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","depth":0,"inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
