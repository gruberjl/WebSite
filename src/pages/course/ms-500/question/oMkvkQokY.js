...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device compliance policy","isCorrectAnswer":false},{"value":"An access review","isCorrectAnswer":false},{"value":"A user risk policy","isCorrectAnswer":false},{"value":"A sign-in risk policy","isCorrectAnswer":true}],"references":{"entityMap":{},"blocks":[{"depth":0,"key":"ffg0d","inlineStyleRanges":[],"data":{},"type":"unstyled","text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","entityRanges":[]}]},"id":"oMkvkQokY","question":{"blocks":[{"entityRanges":[],"text":"Security Requirements - Fabrikam identifies the following security requirements:","key":"fl2fs","type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[{"style":"BOLD","length":80,"offset":0}]},{"key":"et94j","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[],"type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed"},{"depth":0,"key":"el18b","entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement"},{"type":"unordered-list-item","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"43oud","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations"},{"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[],"key":"da2lu","data":{},"type":"unordered-list-item","depth":0,"entityRanges":[]},{"data":{},"depth":0,"entityRanges":[],"key":"1pf2v","inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item"},{"entityRanges":[],"data":{},"key":"4c9k9","inlineStyleRanges":[],"type":"unordered-list-item","depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"type":"unordered-list-item","entityRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","key":"27g0k","data":{},"inlineStyleRanges":[],"depth":0},{"type":"unordered-list-item","key":"a1pub","inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","entityRanges":[],"data":{},"depth":0},{"inlineStyleRanges":[],"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","key":"34cn4","type":"unstyled","entityRanges":[],"data":{},"depth":0},{"depth":0,"inlineStyleRanges":[],"data":{},"text":"What should you include in the recommendation?","entityRanges":[],"key":"49ool","type":"unstyled"}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
