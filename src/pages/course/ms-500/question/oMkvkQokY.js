...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"A device compliance policy"},{"value":"An access review","isCorrectAnswer":false},{"value":"A user risk policy","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"A sign-in risk policy"}],"id":"oMkvkQokY","question":{"entityMap":{},"blocks":[{"text":"Security Requirements - Fabrikam identifies the following security requirements:","depth":0,"type":"unstyled","key":"fl2fs","inlineStyleRanges":[{"style":"BOLD","length":80,"offset":0}],"data":{},"entityRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","key":"et94j","type":"unordered-list-item","data":{}},{"key":"el18b","type":"unordered-list-item","depth":0,"data":{},"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","inlineStyleRanges":[],"entityRanges":[]},{"type":"unordered-list-item","inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"data":{},"key":"43oud","depth":0},{"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"da2lu","data":{}},{"data":{},"type":"unordered-list-item","depth":0,"key":"1pf2v","inlineStyleRanges":[],"entityRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location"},{"entityRanges":[],"depth":0,"data":{},"key":"4c9k9","type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","inlineStyleRanges":[]},{"type":"unordered-list-item","entityRanges":[],"key":"27g0k","data":{},"inlineStyleRanges":[],"depth":0,"text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"entityRanges":[],"depth":0,"key":"a1pub","text":"The principle of least privilege must be used whenever possible","inlineStyleRanges":[],"type":"unordered-list-item","data":{}},{"text":"If an authentication attempt is suspicious, MFA must be used, regardless of the user's location","key":"24lm1","data":{},"depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","type":"unstyled","key":"34cn4","data":{}},{"entityRanges":[],"data":{},"depth":0,"type":"unstyled","key":"49ool","inlineStyleRanges":[],"text":"What should you include in the recommendation?"}]},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","targetOption":"_blank"}}},"blocks":[{"key":"ffg0d","data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"Sign-in risk policies are used to protect authentication from suspicious activity.","type":"unstyled"},{"entityRanges":[{"length":123,"key":0,"offset":0}],"key":"4r2ff","depth":0,"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","data":{},"type":"unstyled"},{"entityRanges":[{"length":98,"key":1,"offset":0}],"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","data":{},"inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"vujr"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
