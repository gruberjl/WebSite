...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"A device compliance policy"},{"value":"An access review","isCorrectAnswer":false},{"value":"A user risk policy","isCorrectAnswer":false},{"value":"A sign-in risk policy","isCorrectAnswer":true}],"id":"oMkvkQokY","question":{"entityMap":{},"blocks":[{"data":{},"key":"fl2fs","text":"Security Requirements - Fabrikam identifies the following security requirements:","type":"unstyled","depth":0,"inlineStyleRanges":[{"style":"BOLD","offset":0,"length":80}],"entityRanges":[]},{"depth":0,"key":"et94j","data":{},"type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[],"inlineStyleRanges":[]},{"inlineStyleRanges":[],"data":{},"key":"el18b","entityRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","depth":0,"type":"unordered-list-item"},{"entityRanges":[],"inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","data":{},"key":"43oud","depth":0,"type":"unordered-list-item"},{"type":"unordered-list-item","key":"da2lu","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0},{"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item","depth":0,"data":{},"key":"1pf2v","entityRanges":[]},{"data":{},"type":"unordered-list-item","depth":0,"entityRanges":[],"key":"4c9k9","inlineStyleRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"key":"27g0k","data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0},{"text":"The principle of least privilege must be used whenever possible","entityRanges":[],"type":"unordered-list-item","depth":0,"data":{},"inlineStyleRanges":[],"key":"a1pub"},{"key":"24lm1","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"If an authentication attempt is suspicious, MFA must be used, regardless of the user's location","type":"unordered-list-item"},{"inlineStyleRanges":[],"depth":0,"data":{},"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","entityRanges":[],"key":"34cn4","type":"unstyled"},{"depth":0,"text":"What should you include in the recommendation?","inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unstyled","key":"49ool"}]},"references":{"blocks":[{"key":"ffg0d","inlineStyleRanges":[],"text":"Sign-in risk policies are used to protect authentication from suspicious activity.","data":{},"type":"unstyled","entityRanges":[],"depth":0},{"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","data":{},"entityRanges":[{"offset":0,"key":0,"length":123}],"depth":0,"key":"4r2ff","type":"unstyled","inlineStyleRanges":[]},{"entityRanges":[{"key":1,"offset":0,"length":98}],"key":"vujr","data":{},"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","depth":0,"type":"unstyled"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
