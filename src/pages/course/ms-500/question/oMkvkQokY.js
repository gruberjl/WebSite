...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"entityRanges":[],"depth":0,"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","data":{},"type":"unstyled","key":"ffg0d","inlineStyleRanges":[]}],"entityMap":{}},"answers":[{"value":"A device compliance policy","isCorrectAnswer":false},{"value":"An access review","isCorrectAnswer":false},{"value":"A user risk policy","isCorrectAnswer":false},{"value":"A sign-in risk policy","isCorrectAnswer":true}],"id":"oMkvkQokY","question":{"blocks":[{"key":"fl2fs","data":{},"entityRanges":[],"text":"Security Requirements - Fabrikam identifies the following security requirements:","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":0,"style":"BOLD","length":80}]},{"entityRanges":[],"data":{},"depth":0,"key":"et94j","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","inlineStyleRanges":[]},{"key":"el18b","type":"unordered-list-item","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"inlineStyleRanges":[],"type":"unordered-list-item","data":{},"depth":0,"entityRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"43oud"},{"data":{},"inlineStyleRanges":[],"depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","type":"unordered-list-item","key":"da2lu","entityRanges":[]},{"depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item","key":"1pf2v"},{"type":"unordered-list-item","depth":0,"entityRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","inlineStyleRanges":[],"key":"4c9k9","data":{}},{"key":"27g0k","entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","type":"unordered-list-item","depth":0},{"text":"The principle of least privilege must be used whenever possible","inlineStyleRanges":[],"entityRanges":[],"key":"a1pub","type":"unordered-list-item","data":{},"depth":0},{"type":"unstyled","entityRanges":[],"key":"34cn4","text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","inlineStyleRanges":[],"data":{},"depth":0},{"depth":0,"data":{},"inlineStyleRanges":[],"text":"What should you include in the recommendation?","key":"49ool","entityRanges":[],"type":"unstyled"}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
