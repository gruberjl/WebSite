...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device compliance policy","isCorrectAnswer":false},{"value":"An access review","isCorrectAnswer":false},{"value":"A user risk policy","isCorrectAnswer":false},{"value":"A sign-in risk policy","isCorrectAnswer":true}],"id":"oMkvkQokY","question":{"blocks":[{"inlineStyleRanges":[{"length":80,"offset":0,"style":"BOLD"}],"text":"Security Requirements - Fabrikam identifies the following security requirements:","data":{},"entityRanges":[],"depth":0,"type":"unstyled","key":"fl2fs"},{"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","entityRanges":[],"key":"et94j","inlineStyleRanges":[],"depth":0,"data":{}},{"depth":0,"key":"el18b","entityRanges":[],"type":"unordered-list-item","data":{},"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","inlineStyleRanges":[]},{"entityRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"43oud","depth":0,"data":{},"type":"unordered-list-item","inlineStyleRanges":[]},{"entityRanges":[],"type":"unordered-list-item","key":"da2lu","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"depth":0,"inlineStyleRanges":[]},{"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","inlineStyleRanges":[],"key":"1pf2v","type":"unordered-list-item","entityRanges":[],"depth":0,"data":{}},{"type":"unordered-list-item","entityRanges":[],"data":{},"key":"4c9k9","depth":0,"inlineStyleRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"entityRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","inlineStyleRanges":[],"data":{},"depth":0,"type":"unordered-list-item","key":"27g0k"},{"data":{},"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item","entityRanges":[],"key":"a1pub","inlineStyleRanges":[],"depth":0},{"entityRanges":[],"data":{},"depth":0,"key":"24lm1","inlineStyleRanges":[],"text":"If an authentication attempt is suspicious, MFA must be used, regardless of the user's location","type":"unordered-list-item"},{"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","key":"34cn4","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled"},{"type":"unstyled","inlineStyleRanges":[],"text":"What should you include in the recommendation?","entityRanges":[],"key":"49ool","depth":0,"data":{}}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"}},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"text":"Sign-in risk policies are used to protect authentication from suspicious activity.","key":"ffg0d","depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled"},{"entityRanges":[{"offset":0,"length":123,"key":0}],"depth":0,"key":"4r2ff","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","type":"unstyled","inlineStyleRanges":[]},{"inlineStyleRanges":[],"depth":0,"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","entityRanges":[{"length":98,"key":1,"offset":0}],"key":"vujr","data":{},"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
