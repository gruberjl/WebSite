...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"A device compliance policy"},{"value":"An access review","isCorrectAnswer":false},{"value":"A user risk policy","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"A sign-in risk policy"}],"id":"oMkvkQokY","question":{"blocks":[{"data":{},"type":"unstyled","entityRanges":[],"key":"fl2fs","inlineStyleRanges":[{"length":80,"offset":0,"style":"BOLD"}],"text":"Security Requirements - Fabrikam identifies the following security requirements:","depth":0},{"inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","data":{},"entityRanges":[],"depth":0,"key":"et94j","type":"unordered-list-item"},{"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"data":{},"key":"el18b","depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement"},{"entityRanges":[],"depth":0,"type":"unordered-list-item","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","data":{},"inlineStyleRanges":[],"key":"43oud"},{"depth":0,"type":"unordered-list-item","entityRanges":[],"key":"da2lu","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","data":{},"key":"1pf2v","type":"unordered-list-item"},{"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","key":"4c9k9","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0},{"depth":0,"text":"Email messages that include attachments containing malware must be delivered without the attachment","data":{},"key":"27g0k","type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[]},{"key":"a1pub","depth":0,"data":{},"text":"The principle of least privilege must be used whenever possible","entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[]},{"depth":0,"type":"unordered-list-item","data":{},"key":"24lm1","entityRanges":[],"inlineStyleRanges":[],"text":"If an authentication attempt is suspicious, MFA must be used, regardless of the user's location"},{"entityRanges":[],"key":"34cn4","inlineStyleRanges":[],"depth":0,"type":"unstyled","data":{},"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2."},{"depth":0,"text":"What should you include in the recommendation?","data":{},"entityRanges":[],"type":"unstyled","key":"49ool","inlineStyleRanges":[]}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"},"mutability":"MUTABLE"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"key":"ffg0d","type":"unstyled","inlineStyleRanges":[],"data":{},"depth":0,"text":"Sign-in risk policies are used to protect authentication from suspicious activity.","entityRanges":[]},{"key":"4r2ff","inlineStyleRanges":[],"depth":0,"entityRanges":[{"key":0,"length":123,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","type":"unstyled","data":{}},{"depth":0,"type":"unstyled","data":{},"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","entityRanges":[{"key":1,"length":98,"offset":0}],"inlineStyleRanges":[],"key":"vujr"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
