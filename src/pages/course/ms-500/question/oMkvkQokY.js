...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{},"blocks":[{"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","inlineStyleRanges":[],"key":"ffg0d","entityRanges":[],"data":{},"type":"unstyled","depth":0}]},"answers":[{"isCorrectAnswer":false,"value":"A device compliance policy"},{"value":"An access review","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"A user risk policy"},{"value":"A sign-in risk policy","isCorrectAnswer":true}],"question":{"blocks":[{"entityRanges":[],"key":"fl2fs","inlineStyleRanges":[{"offset":0,"style":"BOLD","length":80}],"data":{},"type":"unstyled","text":"Security Requirements - Fabrikam identifies the following security requirements:","depth":0},{"inlineStyleRanges":[],"data":{},"key":"et94j","depth":0,"type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[]},{"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","key":"el18b","depth":0,"data":{},"type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[]},{"type":"unordered-list-item","data":{},"key":"43oud","depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations"},{"data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"da2lu","type":"unordered-list-item","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory"},{"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","entityRanges":[],"depth":0,"key":"1pf2v","data":{},"type":"unordered-list-item"},{"inlineStyleRanges":[],"key":"4c9k9","data":{},"depth":0,"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","entityRanges":[]},{"key":"27g0k","entityRanges":[],"data":{},"type":"unordered-list-item","text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0,"inlineStyleRanges":[]},{"inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unordered-list-item","key":"a1pub","depth":0,"text":"The principle of least privilege must be used whenever possible"},{"entityRanges":[],"data":{},"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","type":"unstyled","inlineStyleRanges":[],"key":"34cn4","depth":0},{"text":"What should you include in the recommendation?","entityRanges":[],"depth":0,"key":"49ool","data":{},"type":"unstyled","inlineStyleRanges":[]}],"entityMap":{}},"id":"oMkvkQokY"},
      previousQuestionId: '',
      nextQuestionId: '',
