...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"entityMap":{},"blocks":[{"text":"Security Requirements - Fabrikam identifies the following security requirements:","entityRanges":[],"key":"fl2fs","depth":0,"inlineStyleRanges":[{"style":"BOLD","length":80,"offset":0}],"type":"unstyled","data":{}},{"data":{},"inlineStyleRanges":[],"key":"et94j","depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","entityRanges":[]},{"entityRanges":[],"key":"el18b","type":"unordered-list-item","depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","data":{},"inlineStyleRanges":[]},{"inlineStyleRanges":[],"depth":0,"type":"unordered-list-item","key":"43oud","entityRanges":[],"data":{},"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations"},{"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","type":"unordered-list-item","inlineStyleRanges":[],"data":{},"key":"da2lu","entityRanges":[],"depth":0},{"inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"1pf2v","depth":0,"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item"},{"depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","key":"4c9k9","data":{}},{"text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0,"key":"27g0k","entityRanges":[],"type":"unordered-list-item","data":{},"inlineStyleRanges":[]},{"depth":0,"key":"a1pub","entityRanges":[],"data":{},"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item","inlineStyleRanges":[]},{"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","key":"34cn4","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0},{"data":{},"text":"What should you include in the recommendation?","entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"key":"49ool","depth":0}]},"references":{"blocks":[{"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","data":{},"entityRanges":[],"key":"ffg0d","type":"unstyled","depth":0}],"entityMap":{}},"id":"oMkvkQokY","answers":[{"value":"A device compliance policy","isCorrectAnswer":false},{"value":"An access review","isCorrectAnswer":false},{"value":"A user risk policy","isCorrectAnswer":false},{"value":"A sign-in risk policy","isCorrectAnswer":true}]},
      previousQuestionId: '',
      nextQuestionId: '',
