...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"key":"ffg0d","type":"unstyled","inlineStyleRanges":[],"depth":0,"data":{},"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","entityRanges":[]}],"entityMap":{}},"id":"oMkvkQokY","answers":[{"isCorrectAnswer":false,"value":"A device compliance policy"},{"isCorrectAnswer":false,"value":"An access review"},{"value":"A user risk policy","isCorrectAnswer":false},{"value":"A sign-in risk policy","isCorrectAnswer":true}],"question":{"blocks":[{"data":{},"text":"Security Requirements - Fabrikam identifies the following security requirements:","key":"fl2fs","depth":0,"entityRanges":[],"inlineStyleRanges":[{"offset":0,"length":80,"style":"BOLD"}],"type":"unstyled"},{"key":"et94j","type":"unordered-list-item","text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[]},{"data":{},"type":"unordered-list-item","entityRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","key":"el18b","inlineStyleRanges":[],"depth":0},{"key":"43oud","data":{},"inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"type":"unordered-list-item","depth":0},{"type":"unordered-list-item","depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","entityRanges":[],"key":"da2lu","inlineStyleRanges":[],"data":{}},{"depth":0,"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"1pf2v","data":{}},{"entityRanges":[],"data":{},"key":"4c9k9","depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"key":"27g0k","text":"Email messages that include attachments containing malware must be delivered without the attachment","depth":0,"entityRanges":[],"data":{},"type":"unordered-list-item","inlineStyleRanges":[]},{"text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item","key":"a1pub","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[]},{"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","depth":0,"type":"unstyled","entityRanges":[],"key":"34cn4","inlineStyleRanges":[],"data":{}},{"data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"49ool","type":"unstyled","text":"What should you include in the recommendation?"}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
