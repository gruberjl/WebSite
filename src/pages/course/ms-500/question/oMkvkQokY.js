...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"A device compliance policy"},{"isCorrectAnswer":false,"value":"An access review"},{"value":"A user risk policy","isCorrectAnswer":false},{"value":"A sign-in risk policy","isCorrectAnswer":true}],"id":"oMkvkQokY","question":{"blocks":[{"entityRanges":[],"data":{},"type":"unstyled","text":"Security Requirements - Fabrikam identifies the following security requirements:","inlineStyleRanges":[{"style":"BOLD","offset":0,"length":80}],"key":"fl2fs","depth":0},{"depth":0,"entityRanges":[],"type":"unordered-list-item","data":{},"inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","key":"et94j"},{"inlineStyleRanges":[],"type":"unordered-list-item","data":{},"key":"el18b","depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","entityRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","data":{},"key":"43oud","type":"unordered-list-item"},{"data":{},"depth":0,"type":"unordered-list-item","inlineStyleRanges":[],"key":"da2lu","entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory"},{"data":{},"type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"1pf2v"},{"entityRanges":[],"key":"4c9k9","depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","data":{},"inlineStyleRanges":[]},{"depth":0,"text":"Email messages that include attachments containing malware must be delivered without the attachment","data":{},"key":"27g0k","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[]},{"depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"a1pub","text":"The principle of least privilege must be used whenever possible","type":"unordered-list-item"},{"key":"24lm1","type":"unordered-list-item","data":{},"depth":0,"text":"If an authentication attempt is suspicious, MFA must be used, regardless of the user's location","entityRanges":[],"inlineStyleRanges":[]},{"type":"unstyled","key":"34cn4","inlineStyleRanges":[],"data":{},"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","entityRanges":[],"depth":0},{"key":"49ool","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{},"depth":0,"text":"What should you include in the recommendation?"}],"entityMap":{}},"references":{"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"},"mutability":"MUTABLE"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"Sign-in risk policies are used to protect authentication from suspicious activity.","key":"ffg0d","depth":0,"entityRanges":[]},{"entityRanges":[{"key":0,"length":123,"offset":0}],"data":{},"inlineStyleRanges":[],"depth":0,"key":"4r2ff","type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"},{"key":"vujr","data":{},"depth":0,"type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"length":98,"key":1,"offset":0}],"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
