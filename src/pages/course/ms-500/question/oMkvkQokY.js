...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device compliance policy","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"An access review"},{"isCorrectAnswer":false,"value":"A user risk policy"},{"isCorrectAnswer":true,"value":"A sign-in risk policy"}],"id":"oMkvkQokY","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[{"style":"BOLD","offset":0,"length":80}],"key":"fl2fs","depth":0,"data":{},"type":"unstyled","text":"Security Requirements - Fabrikam identifies the following security requirements:","entityRanges":[]},{"depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","data":{},"key":"et94j","inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item"},{"entityRanges":[],"data":{},"type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","key":"el18b"},{"depth":0,"key":"43oud","inlineStyleRanges":[],"data":{},"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"type":"unordered-list-item"},{"data":{},"inlineStyleRanges":[],"type":"unordered-list-item","key":"da2lu","depth":0,"entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory"},{"entityRanges":[],"data":{},"key":"1pf2v","type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"4c9k9","depth":0,"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"text":"Email messages that include attachments containing malware must be delivered without the attachment","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"27g0k","data":{}},{"type":"unordered-list-item","key":"a1pub","text":"The principle of least privilege must be used whenever possible","entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"key":"24lm1","data":{},"type":"unordered-list-item","text":"If an authentication attempt is suspicious, MFA must be used, regardless of the user's location","inlineStyleRanges":[],"depth":0},{"type":"unstyled","key":"34cn4","entityRanges":[],"data":{},"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","depth":0,"inlineStyleRanges":[]},{"key":"49ool","type":"unstyled","entityRanges":[],"text":"What should you include in the recommendation?","data":{},"inlineStyleRanges":[],"depth":0}]},"references":{"blocks":[{"key":"ffg0d","entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"Sign-in risk policies are used to protect authentication from suspicious activity.","type":"unstyled","depth":0},{"key":"4r2ff","type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"length":123,"key":0,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","depth":0,"data":{}},{"inlineStyleRanges":[],"data":{},"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","type":"unstyled","depth":0,"key":"vujr","entityRanges":[{"length":98,"offset":0,"key":1}]}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
