...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"oMkvkQokY","question":{"blocks":[{"text":"Security Requirements - Fabrikam identifies the following security requirements:","data":{},"depth":0,"inlineStyleRanges":[{"length":80,"style":"BOLD","offset":0}],"type":"unstyled","entityRanges":[],"key":"fl2fs"},{"data":{},"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","inlineStyleRanges":[],"depth":0,"key":"et94j","type":"unordered-list-item","entityRanges":[]},{"inlineStyleRanges":[],"key":"el18b","depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","type":"unordered-list-item","entityRanges":[],"data":{}},{"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0,"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"43oud"},{"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{},"entityRanges":[],"type":"unordered-list-item","depth":0,"key":"da2lu","inlineStyleRanges":[]},{"key":"1pf2v","inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","type":"unordered-list-item","data":{},"depth":0,"entityRanges":[]},{"key":"4c9k9","data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"type":"unordered-list-item","depth":0,"key":"27g0k","text":"Email messages that include attachments containing malware must be delivered without the attachment","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"type":"unordered-list-item","key":"a1pub","depth":0,"inlineStyleRanges":[],"data":{},"text":"The principle of least privilege must be used whenever possible","entityRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","data":{},"depth":0,"key":"34cn4"},{"data":{},"depth":0,"text":"What should you include in the recommendation?","entityRanges":[],"inlineStyleRanges":[],"key":"49ool","type":"unstyled"}],"entityMap":{}},"references":{"entityMap":{},"blocks":[{"depth":0,"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","key":"ffg0d","data":{},"entityRanges":[],"type":"unstyled"}]},"answers":[{"value":"A device compliance policy","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"An access review"},{"isCorrectAnswer":false,"value":"A user risk policy"},{"isCorrectAnswer":true,"value":"A sign-in risk policy"}]},
      previousQuestionId: '',
      nextQuestionId: '',
