...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device compliance policy","isCorrectAnswer":false},{"value":"An access review","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"A user risk policy"},{"value":"A sign-in risk policy","isCorrectAnswer":true}],"id":"oMkvkQokY","question":{"blocks":[{"type":"unstyled","key":"fl2fs","text":"Security Requirements - Fabrikam identifies the following security requirements:","inlineStyleRanges":[{"style":"BOLD","length":80,"offset":0}],"depth":0,"entityRanges":[],"data":{}},{"type":"unordered-list-item","depth":0,"key":"et94j","inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","entityRanges":[],"data":{}},{"inlineStyleRanges":[],"depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","key":"el18b","data":{},"type":"unordered-list-item","entityRanges":[]},{"key":"43oud","inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"depth":0,"type":"unordered-list-item","data":{}},{"inlineStyleRanges":[],"key":"da2lu","type":"unordered-list-item","data":{},"depth":0,"entityRanges":[],"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory"},{"key":"1pf2v","data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location"},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"data":{},"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","key":"4c9k9"},{"entityRanges":[],"data":{},"depth":0,"key":"27g0k","type":"unordered-list-item","inlineStyleRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"inlineStyleRanges":[],"key":"a1pub","type":"unordered-list-item","depth":0,"data":{},"text":"The principle of least privilege must be used whenever possible","entityRanges":[]},{"entityRanges":[],"type":"unordered-list-item","key":"24lm1","inlineStyleRanges":[],"data":{},"text":"If an authentication attempt is suspicious, MFA must be used, regardless of the user's location","depth":0},{"entityRanges":[],"data":{},"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","key":"34cn4"},{"data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"What should you include in the recommendation?","key":"49ool"}],"entityMap":{}},"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"},"type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy"}}},"blocks":[{"data":{},"key":"ffg0d","depth":0,"text":"Sign-in risk policies are used to protect authentication from suspicious activity.","type":"unstyled","inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[{"length":123,"offset":0,"key":0}],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","inlineStyleRanges":[],"key":"4r2ff","data":{},"type":"unstyled"},{"type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[{"key":1,"offset":0,"length":98}],"key":"vujr","text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
