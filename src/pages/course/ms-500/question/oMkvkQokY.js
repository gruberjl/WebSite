...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device compliance policy","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"An access review"},{"value":"A user risk policy","isCorrectAnswer":false},{"value":"A sign-in risk policy","isCorrectAnswer":true}],"references":{"blocks":[{"type":"unstyled","data":{},"entityRanges":[],"key":"ffg0d","text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","depth":0,"inlineStyleRanges":[]}],"entityMap":{}},"id":"oMkvkQokY","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[{"offset":0,"style":"BOLD","length":80}],"key":"fl2fs","type":"unstyled","depth":0,"text":"Security Requirements - Fabrikam identifies the following security requirements:","entityRanges":[],"data":{}},{"type":"unordered-list-item","key":"et94j","entityRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","data":{},"depth":0,"inlineStyleRanges":[]},{"type":"unordered-list-item","key":"el18b","entityRanges":[],"inlineStyleRanges":[],"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","data":{},"depth":0},{"depth":0,"data":{},"type":"unordered-list-item","text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","key":"43oud","entityRanges":[],"inlineStyleRanges":[]},{"data":{},"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","depth":0,"entityRanges":[],"key":"da2lu","type":"unordered-list-item","inlineStyleRanges":[]},{"entityRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0,"type":"unordered-list-item","inlineStyleRanges":[],"data":{},"key":"1pf2v"},{"entityRanges":[],"key":"4c9k9","depth":0,"data":{},"inlineStyleRanges":[],"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"type":"unordered-list-item","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment","key":"27g0k"},{"entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","key":"a1pub","type":"unordered-list-item"},{"data":{},"type":"unstyled","key":"34cn4","depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2."},{"depth":0,"data":{},"inlineStyleRanges":[],"text":"What should you include in the recommendation?","type":"unstyled","key":"49ool","entityRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
