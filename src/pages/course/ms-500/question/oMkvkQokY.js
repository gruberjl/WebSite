...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device compliance policy","isCorrectAnswer":false},{"value":"An access review","isCorrectAnswer":false},{"value":"A user risk policy","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"A sign-in risk policy"}],"id":"oMkvkQokY","question":{"entityMap":{},"blocks":[{"data":{},"inlineStyleRanges":[{"offset":0,"length":80,"style":"BOLD"}],"text":"Security Requirements - Fabrikam identifies the following security requirements:","entityRanges":[],"depth":0,"type":"unstyled","key":"fl2fs"},{"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0,"key":"et94j","type":"unordered-list-item"},{"key":"el18b","inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"data":{},"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","depth":0},{"key":"43oud","data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","depth":0,"type":"unordered-list-item"},{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","key":"da2lu","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","data":{}},{"depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","key":"1pf2v","type":"unordered-list-item","data":{}},{"key":"4c9k9","entityRanges":[],"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","data":{},"inlineStyleRanges":[],"depth":0},{"type":"unordered-list-item","key":"27g0k","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"Email messages that include attachments containing malware must be delivered without the attachment"},{"inlineStyleRanges":[],"type":"unordered-list-item","key":"a1pub","text":"The principle of least privilege must be used whenever possible","entityRanges":[],"depth":0,"data":{}},{"text":"If an authentication attempt is suspicious, MFA must be used, regardless of the user's location","entityRanges":[],"key":"24lm1","data":{},"inlineStyleRanges":[],"type":"unordered-list-item","depth":0},{"type":"unstyled","depth":0,"data":{},"entityRanges":[],"key":"34cn4","text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","inlineStyleRanges":[]},{"key":"49ool","data":{},"entityRanges":[],"depth":0,"text":"What should you include in the recommendation?","type":"unstyled","inlineStyleRanges":[]}]},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{},"key":"ffg0d","text":"Sign-in risk policies are used to protect authentication from suspicious activity.","entityRanges":[]},{"entityRanges":[{"length":123,"key":0,"offset":0}],"key":"4r2ff","text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","inlineStyleRanges":[],"depth":0,"type":"unstyled","data":{}},{"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","entityRanges":[{"length":98,"key":1,"offset":0}],"depth":0,"key":"vujr","inlineStyleRanges":[],"data":{},"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
