...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device compliance policy","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"An access review"},{"value":"A user risk policy","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"A sign-in risk policy"}],"id":"oMkvkQokY","question":{"blocks":[{"entityRanges":[],"type":"unstyled","depth":0,"text":"Security Requirements - Fabrikam identifies the following security requirements:","key":"fl2fs","inlineStyleRanges":[{"offset":0,"length":80,"style":"BOLD"}],"data":{}},{"depth":0,"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","data":{},"type":"unordered-list-item","entityRanges":[],"key":"et94j","inlineStyleRanges":[]},{"type":"unordered-list-item","depth":0,"data":{},"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","entityRanges":[],"key":"el18b","inlineStyleRanges":[]},{"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","entityRanges":[],"data":{},"type":"unordered-list-item","inlineStyleRanges":[],"key":"43oud","depth":0},{"depth":0,"type":"unordered-list-item","key":"da2lu","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","depth":0,"key":"1pf2v","data":{},"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location"},{"depth":0,"entityRanges":[],"data":{},"type":"unordered-list-item","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","key":"4c9k9","inlineStyleRanges":[]},{"inlineStyleRanges":[],"depth":0,"text":"Email messages that include attachments containing malware must be delivered without the attachment","key":"27g0k","data":{},"type":"unordered-list-item","entityRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unordered-list-item","text":"The principle of least privilege must be used whenever possible","key":"a1pub","depth":0},{"key":"24lm1","entityRanges":[],"data":{},"text":"If an authentication attempt is suspicious, MFA must be used, regardless of the user's location","depth":0,"inlineStyleRanges":[],"type":"unordered-list-item"},{"type":"unstyled","depth":0,"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","inlineStyleRanges":[],"entityRanges":[],"key":"34cn4","data":{}},{"text":"What should you include in the recommendation?","inlineStyleRanges":[],"entityRanges":[],"depth":0,"key":"49ool","data":{},"type":"unstyled"}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"depth":0,"data":{},"text":"Sign-in risk policies are used to protect authentication from suspicious activity.","entityRanges":[],"key":"ffg0d","type":"unstyled","inlineStyleRanges":[]},{"key":"4r2ff","entityRanges":[{"length":123,"key":0,"offset":0}],"depth":0,"data":{},"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","type":"unstyled"},{"type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[{"length":98,"offset":0,"key":1}],"key":"vujr","text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
