...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","key":"ffg0d","type":"unstyled"}],"entityMap":{}},"answers":[{"value":"A device compliance policy","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"An access review"},{"value":"A user risk policy","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"A sign-in risk policy"}],"question":{"blocks":[{"entityRanges":[],"type":"unstyled","key":"fl2fs","inlineStyleRanges":[{"style":"BOLD","offset":0,"length":80}],"depth":0,"text":"Security Requirements - Fabrikam identifies the following security requirements:","data":{}},{"entityRanges":[],"key":"et94j","data":{},"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","depth":0,"inlineStyleRanges":[],"type":"unordered-list-item"},{"entityRanges":[],"key":"el18b","text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","data":{},"inlineStyleRanges":[],"depth":0,"type":"unordered-list-item"},{"key":"43oud","depth":0,"entityRanges":[],"data":{},"type":"unordered-list-item","inlineStyleRanges":[],"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations"},{"key":"da2lu","entityRanges":[],"type":"unordered-list-item","depth":0,"text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","inlineStyleRanges":[],"data":{}},{"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0,"key":"1pf2v"},{"inlineStyleRanges":[],"key":"4c9k9","text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD","type":"unordered-list-item","entityRanges":[],"data":{},"depth":0},{"type":"unordered-list-item","depth":0,"data":{},"text":"Email messages that include attachments containing malware must be delivered without the attachment","entityRanges":[],"key":"27g0k","inlineStyleRanges":[]},{"data":{},"type":"unordered-list-item","text":"The principle of least privilege must be used whenever possible","inlineStyleRanges":[],"entityRanges":[],"depth":0,"key":"a1pub"},{"key":"34cn4","data":{},"text":"You need to recommend a solution to protect the sign-ins of Admin1 and Admin2.","inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[]},{"key":"49ool","depth":0,"type":"unstyled","text":"What should you include in the recommendation?","entityRanges":[],"data":{},"inlineStyleRanges":[]}],"entityMap":{}},"id":"oMkvkQokY"},
      previousQuestionId: '',
      nextQuestionId: '',
