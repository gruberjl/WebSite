...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"entityMap":{},"blocks":[{"entityRanges":[],"depth":0,"data":{},"key":"a4cb5","text":"You have a Microsoft 365 E5 subscription.","type":"unstyled","inlineStyleRanges":[]},{"text":"You need to ensure that users who are assigned the Exchange administrator role have time-limited permissions and must use multi-factor authentication (MFA) to request the permissions.","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","data":{},"key":"dpks2","depth":0},{"key":"a87ai","data":{},"text":"What should you use to achieve the goal?","depth":0,"inlineStyleRanges":[],"type":"unstyled","entityRanges":[]}]},"references":{"blocks":[{"type":"unstyled","entityRanges":[],"text":"","inlineStyleRanges":[],"depth":0,"key":"9tu95","data":{}}],"entityMap":{}},"answers":[{"value":"Security & Compliance permissions","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Microsoft Azure Active Directory (Azure AD) Privileged Identity Management"},{"value":"Microsoft Azure AD group management","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Microsoft Office 365 user management"}],"id":"cBoGrr-cI"},
      previousQuestionId: '',
      nextQuestionId: '',
