...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"cBoGrr-cI","question":{"blocks":[{"depth":0,"text":"You have a Microsoft 365 E5 subscription.","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{},"key":"a4cb5"},{"text":"You need to ensure that users who are assigned the Exchange administrator role have time-limited permissions and must use multi-factor authentication (MFA) to request the permissions.","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"dpks2","depth":0},{"inlineStyleRanges":[],"text":"What should you use to achieve the goal?","entityRanges":[],"depth":0,"key":"a87ai","type":"unstyled","data":{}}],"entityMap":{}},"references":{"blocks":[{"key":"9tu95","type":"unstyled","depth":0,"text":"","inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}},"answers":[{"isCorrectAnswer":false,"value":"Security & Compliance permissions"},{"isCorrectAnswer":true,"value":"Microsoft Azure Active Directory (Azure AD) Privileged Identity Management"},{"value":"Microsoft Azure AD group management","isCorrectAnswer":false},{"value":"Microsoft Office 365 user management","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
