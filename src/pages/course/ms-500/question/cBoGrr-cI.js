...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"entityMap":{},"blocks":[{"data":{},"key":"a4cb5","text":"You have a Microsoft 365 E5 subscription.","depth":0,"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled"},{"data":{},"text":"You need to ensure that users who are assigned the Exchange administrator role have time-limited permissions and must use multi-factor authentication (MFA) to request the permissions.","depth":0,"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"key":"dpks2"},{"entityRanges":[],"text":"What should you use to achieve the goal?","inlineStyleRanges":[],"key":"a87ai","type":"unstyled","depth":0,"data":{}}]},"references":{"entityMap":{},"blocks":[{"data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0,"text":"","key":"9tu95"}]},"id":"cBoGrr-cI","answers":[{"isCorrectAnswer":false,"value":"Security & Compliance permissions"},{"isCorrectAnswer":true,"value":"Microsoft Azure Active Directory (Azure AD) Privileged Identity Management"},{"isCorrectAnswer":false,"value":"Microsoft Azure AD group management"},{"value":"Microsoft Office 365 user management","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
