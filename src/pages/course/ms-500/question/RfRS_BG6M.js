...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"entityMap":{"0":{"data":{"width":"auto","alt":"External sharing settings","height":"auto","alignment":"left","src":"https://i.ibb.co/DG2G4V9/external-sharing.png"},"mutability":"MUTABLE","type":"IMAGE"}},"blocks":[{"key":"18nuv","text":"You have a Microsoft 365 subscription that uses a default domain name of litwareinc.com.","data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0},{"type":"unstyled","depth":0,"data":{},"text":"You configure the Sharing settings in Microsoft OneDrive as shown in the following exhibit.","entityRanges":[],"inlineStyleRanges":[],"key":"1uilq"},{"key":"3bmi1","type":"atomic","depth":0,"entityRanges":[{"key":0,"length":1,"offset":0}],"inlineStyleRanges":[],"text":" ","data":{}},{"type":"unstyled","key":"8iqri","inlineStyleRanges":[],"depth":0,"text":"Check the box next to each true statement.","data":{},"entityRanges":[]}]},"references":{"blocks":[{"data":{},"inlineStyleRanges":[],"key":"fp501","depth":0,"type":"unstyled","text":"https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off","entityRanges":[]}],"entityMap":{}},"answers":[{"isCorrectAnswer":true,"value":"A user who has an email address of user1@fabrikam.com cannot access OneDrive content"},{"value":"A user who has an email address of user1@fabrikam.com can access OneDrive content after a link is created","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"A user who has an email address of user1@fabrikam.com must be added to a group before the user can access shared files"},{"isCorrectAnswer":false,"value":"If a new guest user is created for user2@contoso.com, cannot access OneDrive content"},{"value":"If a new guest user is created for user2@contoso.com, can access OneDrive content after a link is created","isCorrectAnswer":true},{"value":"If a new guest user is created for user2@contoso.com, must be added to a group before the user can access shared files","isCorrectAnswer":false}],"id":"RfRS_BG6M"},
      previousQuestionId: '',
      nextQuestionId: '',
