...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"On VPN1: Configure and authentication provider.","isCorrectAnswer":false},{"value":"On VPN1: Configure an accounting provider.","isCorrectAnswer":true},{"value":"On VPN1: Create a connection request policy","isCorrectAnswer":false},{"value":"On VPN1: Create a RADIUS client.","isCorrectAnswer":false},{"value":"One Server1, enabled the following inbound port: 443","isCorrectAnswer":false},{"value":"One Server1, enabled the following inbound port: 1723","isCorrectAnswer":false},{"value":"One Server1, enabled the following inbound port: 1813","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"One Server1, enabled the following inbound port: 8080"},{"value":"One Server1, enabled the following inbound port: 8531","isCorrectAnswer":false}],"question":{"blocks":[{"inlineStyleRanges":[],"text":"Your network contains an Active Directory domain named contoso.com. The domain contains a VPN server named VPN1 that runs Windows Server 2016 and has the Remote Access server role installed.","data":{},"entityRanges":[],"depth":0,"type":"unstyled","key":"ctt8t"},{"key":"1quvv","text":"You have a Microsoft Azure subscription.","entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0,"type":"unstyled"},{"key":"am3ap","entityRanges":[],"type":"unstyled","text":"You are deploying Azure Advanced Threat Protection (ATP).","depth":0,"inlineStyleRanges":[],"data":{}},{"key":"798kf","depth":0,"inlineStyleRanges":[],"data":{},"type":"unstyled","text":"You install an Azure ATP standalone sensor on a server named Server1 that runs Windows Server 2016.","entityRanges":[]},{"entityRanges":[],"text":"You need to integrate the VPN and Azure ATP.","type":"unstyled","key":"df6j8","inlineStyleRanges":[],"depth":0,"data":{}},{"depth":0,"data":{},"inlineStyleRanges":[],"key":"3iban","entityRanges":[],"type":"unstyled","text":"What should you do?"},{"depth":0,"data":{},"text":"NOTE: Each correct selection is worth one point.","inlineStyleRanges":[],"key":"86b0e","type":"unstyled","entityRanges":[]}],"entityMap":{}},"id":"ne1Cl3a38","references":{"entityMap":{},"blocks":[{"key":"d1ihq","type":"unstyled","data":{},"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure-advanced-threat-protection/install-atp-step6-vpn","depth":0,"entityRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
