...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"A sales user who is logging in from the Montreal office will be prompted for MFA."},{"isCorrectAnswer":true,"value":"A sales user who signs in from home with a public IP address of 193.77.140.140 will be prompted for MFA."},{"value":"A sales user who is logging in from the New York office will be prompted for Azure MFA credentials.","isCorrectAnswer":false}],"id":"PUWxVj7lH","question":{"blocks":[{"depth":0,"text":"Your organization has the offices in the following chart. Each office has the following IP addresses.","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"2qdub"},{"text":" ","inlineStyleRanges":[],"data":{},"key":"5llr","type":"atomic","entityRanges":[{"key":0,"offset":0,"length":1}],"depth":0},{"data":{},"type":"unstyled","key":"c07p6","depth":0,"text":"You've configured named locations in Azure AD as below.","inlineStyleRanges":[],"entityRanges":[]},{"data":{},"entityRanges":[{"key":1,"length":1,"offset":0}],"key":"a8u3o","type":"atomic","text":" ","depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"key":"c772p","type":"unstyled","data":{},"inlineStyleRanges":[{"offset":76,"style":"color-rgb(33,37,41)","length":33},{"offset":76,"length":33,"style":"bgcolor-rgb(255,255,255)"},{"offset":76,"length":33,"style":"fontsize-16"},{"offset":76,"length":33,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"depth":0,"text":"An address space of 198.35.3.0/24 is defined in the trusted IPs list on the Multi-Factor Authentication page."},{"inlineStyleRanges":[],"data":{},"entityRanges":[],"depth":0,"text":"MFA is enabled for the users in the sales department.","key":"8d983","type":"unstyled"},{"inlineStyleRanges":[],"text":"You are evaluating which sales department users will be prompted for MFA.","entityRanges":[],"type":"unstyled","data":{},"depth":0,"key":"bcs2k"},{"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"Check the box for each true statement.","entityRanges":[],"depth":0,"key":"99kqm"}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"width":"auto","height":"auto","src":"https://i.ibb.co/tBQ9xgK/location-chart.png","alignment":"left","alt":"Chart of locations and IP addresses"}},"1":{"type":"IMAGE","data":{"src":"https://i.ibb.co/dJnwkFX/trusted-locations-chart.png","alignment":"left","width":"auto","height":"auto","alt":"Trusted Locations Chart"},"mutability":"MUTABLE"}}},"references":{"blocks":[{"data":{},"text":"The only trusted IP address is the New York office. So sales users connecting from the New York office will not be prompted for MFA. All other users will be prompted for MFA.","key":"6icl3","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","depth":0},{"text":"https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh","entityRanges":[{"offset":0,"length":86,"key":0}],"inlineStyleRanges":[],"data":{},"depth":0,"key":"4236g","type":"unstyled"},{"inlineStyleRanges":[],"entityRanges":[{"length":175,"offset":0,"key":1}],"text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block","key":"4al6p","type":"unstyled","depth":0,"data":{}}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh","targetOption":"_blank"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
