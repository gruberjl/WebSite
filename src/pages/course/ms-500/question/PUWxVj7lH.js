...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A sales user who is logging in from the Montreal office will be prompted for MFA.","isCorrectAnswer":true},{"isCorrectAnswer":true,"value":"A sales user who signs in from home with a public IP address of 193.77.140.140 will be prompted for MFA."},{"value":"A sales user who is logging in from the New York office will be prompted for Azure MFA credentials.","isCorrectAnswer":false}],"id":"PUWxVj7lH","question":{"blocks":[{"type":"unstyled","data":{},"key":"2qdub","entityRanges":[],"text":"Your organization has the offices in the following chart. Each office has the following IP addresses.","depth":0,"inlineStyleRanges":[]},{"inlineStyleRanges":[],"depth":0,"type":"atomic","data":{},"text":" ","entityRanges":[{"key":0,"length":1,"offset":0}],"key":"5llr"},{"entityRanges":[],"type":"unstyled","text":"You've configured named locations in Azure AD as below.","key":"c07p6","depth":0,"inlineStyleRanges":[],"data":{}},{"data":{},"type":"atomic","entityRanges":[{"length":1,"offset":0,"key":1}],"inlineStyleRanges":[],"key":"a8u3o","depth":0,"text":" "},{"type":"unstyled","text":"An address space of 198.35.3.0/24 is defined in the trusted IPs list on the Multi-Factor Authentication page.","data":{},"entityRanges":[],"depth":0,"inlineStyleRanges":[{"offset":76,"length":33,"style":"color-rgb(33,37,41)"},{"style":"bgcolor-rgb(255,255,255)","offset":76,"length":33},{"length":33,"style":"fontsize-16","offset":76},{"length":33,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":76}],"key":"c772p"},{"type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"8d983","text":"MFA is enabled for the users in the sales department.","depth":0},{"text":"You are evaluating which sales department users will be prompted for MFA.","key":"bcs2k","type":"unstyled","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[]},{"depth":0,"text":"Check the box for each true statement.","data":{},"type":"unstyled","entityRanges":[],"key":"99kqm","inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"height":"auto","width":"auto","src":"https://i.ibb.co/tBQ9xgK/location-chart.png","alignment":"left","alt":"Chart of locations and IP addresses"},"mutability":"MUTABLE","type":"IMAGE"},"1":{"type":"IMAGE","data":{"alt":"Trusted Locations Chart","width":"auto","src":"https://i.ibb.co/dJnwkFX/trusted-locations-chart.png","height":"auto","alignment":"left"},"mutability":"MUTABLE"}}},"references":{"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh","targetOption":"_blank"},"mutability":"MUTABLE"},"1":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block","targetOption":"_blank"},"mutability":"MUTABLE"}},"blocks":[{"data":{},"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0,"text":"The only trusted IP address is the New York office. So sales users connecting from the New York office will not be prompted for MFA. All other users will be prompted for MFA.","key":"6icl3"},{"entityRanges":[{"key":0,"length":86,"offset":0}],"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"4236g","text":"https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh","depth":0},{"depth":0,"data":{},"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block","type":"unstyled","key":"4al6p","entityRanges":[{"offset":0,"key":1,"length":175}]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
