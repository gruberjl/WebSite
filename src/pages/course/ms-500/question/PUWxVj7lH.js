...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"A sales user who is logging in from the Montreal office will be prompted for MFA."},{"isCorrectAnswer":true,"value":"A sales user who signs in from home with a public IP address of 193.77.140.140 will be prompted for MFA."},{"value":"A sales user who is logging in from the New York office will be prompted for Azure MFA credentials.","isCorrectAnswer":false}],"id":"PUWxVj7lH","question":{"blocks":[{"key":"2qdub","type":"unstyled","data":{},"inlineStyleRanges":[],"text":"Your organization has the offices in the following chart. Each office has the following IP addresses.","entityRanges":[],"depth":0},{"text":" ","inlineStyleRanges":[],"type":"atomic","entityRanges":[{"key":0,"offset":0,"length":1}],"key":"5llr","data":{},"depth":0},{"inlineStyleRanges":[],"key":"c07p6","type":"unstyled","depth":0,"text":"You've configured named locations in Azure AD as below.","data":{},"entityRanges":[]},{"entityRanges":[{"key":1,"offset":0,"length":1}],"inlineStyleRanges":[],"depth":0,"type":"atomic","data":{},"text":" ","key":"a8u3o"},{"data":{},"type":"unstyled","key":"c772p","depth":0,"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":33,"offset":76},{"length":33,"offset":76,"style":"bgcolor-rgb(255,255,255)"},{"length":33,"offset":76,"style":"fontsize-16"},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":33,"offset":76}],"entityRanges":[],"text":"An address space of 198.35.3.0/24 is defined in the trusted IPs list on the Multi-Factor Authentication page."},{"data":{},"key":"8d983","depth":0,"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"text":"MFA is enabled for the users in the sales department."},{"depth":0,"key":"bcs2k","text":"You are evaluating which sales department users will be prompted for MFA.","inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unstyled"},{"text":"Check the box for each true statement.","entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"99kqm","depth":0}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"height":"auto","alignment":"left","width":"auto","alt":"Chart of locations and IP addresses","src":"https://i.ibb.co/tBQ9xgK/location-chart.png"},"type":"IMAGE"},"1":{"type":"IMAGE","mutability":"MUTABLE","data":{"width":"auto","alt":"Trusted Locations Chart","height":"auto","src":"https://i.ibb.co/dJnwkFX/trusted-locations-chart.png","alignment":"left"}}}},"references":{"blocks":[{"data":{},"text":"The only trusted IP address is the New York office. So sales users connecting from the New York office will not be prompted for MFA. All other users will be prompted for MFA.","type":"unstyled","inlineStyleRanges":[],"depth":0,"entityRanges":[],"key":"6icl3"},{"key":"4236g","entityRanges":[{"key":0,"offset":0,"length":86}],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh","depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"key":"4al6p","depth":0,"text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block","entityRanges":[{"offset":0,"length":175,"key":1}],"data":{},"inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh","targetOption":"_blank"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
