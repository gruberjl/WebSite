...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A sales user who is logging in from the Montreal office will be prompted for MFA.","isCorrectAnswer":true},{"isCorrectAnswer":true,"value":"A sales user who signs in from home with a public IP address of 193.77.140.140 will be prompted for MFA."},{"value":"A sales user who is logging in from the New York office will be prompted for Azure MFA credentials.","isCorrectAnswer":false}],"id":"PUWxVj7lH","question":{"blocks":[{"data":{},"inlineStyleRanges":[],"key":"2qdub","entityRanges":[],"depth":0,"type":"unstyled","text":"Your organization has the offices in the following chart. Each office has the following IP addresses."},{"entityRanges":[{"offset":0,"key":0,"length":1}],"data":{},"type":"atomic","key":"5llr","inlineStyleRanges":[],"text":" ","depth":0},{"type":"unstyled","data":{},"depth":0,"entityRanges":[],"key":"c07p6","inlineStyleRanges":[],"text":"You've configured named locations in Azure AD as below."},{"text":" ","inlineStyleRanges":[],"depth":0,"key":"a8u3o","type":"atomic","entityRanges":[{"length":1,"key":1,"offset":0}],"data":{}},{"entityRanges":[],"key":"c772p","data":{},"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","offset":76,"length":33},{"style":"bgcolor-rgb(255,255,255)","length":33,"offset":76},{"length":33,"style":"fontsize-16","offset":76},{"offset":76,"length":33,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"type":"unstyled","depth":0,"text":"An address space of 198.35.3.0/24 is defined in the trusted IPs list on the Multi-Factor Authentication page."},{"data":{},"text":"MFA is enabled for the users in the sales department.","inlineStyleRanges":[],"type":"unstyled","depth":0,"entityRanges":[],"key":"8d983"},{"depth":0,"type":"unstyled","entityRanges":[],"data":{},"text":"You are evaluating which sales department users will be prompted for MFA.","key":"bcs2k","inlineStyleRanges":[]},{"depth":0,"key":"99kqm","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{},"text":"Check the box for each true statement."}],"entityMap":{"0":{"type":"IMAGE","data":{"alignment":"left","src":"https://i.ibb.co/tBQ9xgK/location-chart.png","alt":"Chart of locations and IP addresses","height":"auto","width":"auto"},"mutability":"MUTABLE"},"1":{"data":{"alignment":"left","src":"https://i.ibb.co/dJnwkFX/trusted-locations-chart.png","height":"auto","width":"auto","alt":"Trusted Locations Chart"},"type":"IMAGE","mutability":"MUTABLE"}}},"references":{"blocks":[{"depth":0,"text":"The only trusted IP address is the New York office. So sales users connecting from the New York office will not be prompted for MFA. All other users will be prompted for MFA.","entityRanges":[],"type":"unstyled","key":"6icl3","data":{},"inlineStyleRanges":[]},{"entityRanges":[{"key":0,"offset":0,"length":86}],"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh","type":"unstyled","depth":0,"key":"4236g","data":{}},{"text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block","entityRanges":[{"length":175,"key":1,"offset":0}],"data":{},"key":"4al6p","depth":0,"inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
