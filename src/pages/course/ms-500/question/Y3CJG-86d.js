...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"User1 can run an antivirus scan on Device1"},{"value":"User2 can collect an investigation package from Device2.","isCorrectAnswer":false},{"value":"User3 can isolate Device1","isCorrectAnswer":true}],"id":"Y3CJG-86d","question":{"blocks":[{"inlineStyleRanges":[],"key":"8jqfn","data":{},"entityRanges":[],"depth":0,"text":"Your company has a Microsoft 365 subscription that contains the users shown in the following table:","type":"unstyled"},{"entityRanges":[{"key":0,"length":1,"offset":0}],"data":{},"key":"8d2h0","type":"atomic","depth":0,"inlineStyleRanges":[],"text":" "},{"key":"f8pqb","type":"unstyled","depth":0,"text":"The company implements Microsoft Defender for Endpoint. Microsoft Defender for Endpoint includes the roles shown in the following table:","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"key":"7a50d","type":"atomic","inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[{"length":1,"offset":0,"key":1}],"text":" "},{"data":{},"inlineStyleRanges":[],"key":"cndna","entityRanges":[],"depth":0,"type":"unstyled","text":"Microsoft Defender for Endpoint contains the machine groups shown in the following table:"},{"text":" ","entityRanges":[{"key":2,"length":1,"offset":0}],"depth":0,"inlineStyleRanges":[],"type":"atomic","data":{},"key":"9iprq"},{"depth":0,"text":"Check the box next to each true statement","key":"2gq5l","type":"unstyled","data":{},"entityRanges":[],"inlineStyleRanges":[]}],"entityMap":{"0":{"type":"IMAGE","data":{"width":"auto","src":"https://i.ibb.co/0QbQvMj/user-group-membership.png","alt":"User group membership chart","height":"auto","alignment":"left"},"mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","src":"https://i.ibb.co/59bMxcQ/roles-permissions.png","width":"auto","alt":"Roles and Permissions","alignment":"left"}},"2":{"mutability":"MUTABLE","type":"IMAGE","data":{"alt":"Rank Group Chart","width":"auto","src":"https://i.ibb.co/KqcM2Q0/rank-group-chart.png","height":"auto","alignment":"left"}}}},"references":{"blocks":[{"depth":0,"key":"9lhgi","text":"Alerts investigation gives the user the ability to manage alerts, initiate automated investigations, run anti-virus scans, collect investigation packages, and manage device tags. Since User1 has alerts investigation User1 can run antivirus scans.","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"data":{}},{"inlineStyleRanges":[],"key":"5a555","type":"unstyled","entityRanges":[],"data":{},"text":"User2 does not have the \"alerts investigation\" permission so User2 cannot collect an investigation package.","depth":0},{"text":"User3 has Active remediation actions so User3 can isolate Device1","data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0,"key":"cjlbu"},{"text":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","data":{},"type":"unstyled","entityRanges":[{"offset":0,"key":0,"length":129}],"key":"b6cr6","depth":0,"inlineStyleRanges":[]}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
