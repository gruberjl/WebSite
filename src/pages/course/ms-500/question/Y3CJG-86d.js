...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"User1 can run an antivirus scan on Device1"},{"isCorrectAnswer":false,"value":"User2 can collect an investigation package from Device2."},{"value":"User3 can isolate Device1","isCorrectAnswer":true}],"id":"Y3CJG-86d","question":{"blocks":[{"type":"unstyled","entityRanges":[],"key":"8jqfn","inlineStyleRanges":[],"depth":0,"text":"Your company has a Microsoft 365 subscription that contains the users shown in the following table:","data":{}},{"inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":1,"key":0}],"text":" ","key":"8d2h0","type":"atomic","depth":0,"data":{}},{"key":"f8pqb","text":"The company implements Microsoft Defender for Endpoint. Microsoft Defender for Endpoint includes the roles shown in the following table:","type":"unstyled","inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[]},{"text":" ","data":{},"entityRanges":[{"offset":0,"key":1,"length":1}],"key":"7a50d","inlineStyleRanges":[],"type":"atomic","depth":0},{"data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"depth":0,"key":"cndna","text":"Microsoft Defender for Endpoint contains the machine groups shown in the following table:"},{"key":"9iprq","type":"atomic","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[{"key":2,"offset":0,"length":1}],"text":" "},{"inlineStyleRanges":[],"entityRanges":[],"key":"2gq5l","data":{},"depth":0,"text":"Check the box next to each true statement","type":"unstyled"}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"alignment":"left","width":"auto","alt":"User group membership chart","src":"https://i.ibb.co/0QbQvMj/user-group-membership.png","height":"auto"}},"1":{"type":"IMAGE","data":{"height":"auto","src":"https://i.ibb.co/59bMxcQ/roles-permissions.png","alignment":"left","alt":"Roles and Permissions","width":"auto"},"mutability":"MUTABLE"},"2":{"type":"IMAGE","mutability":"MUTABLE","data":{"alt":"Rank Group Chart","height":"auto","width":"auto","alignment":"left","src":"https://i.ibb.co/KqcM2Q0/rank-group-chart.png"}}}},"references":{"blocks":[{"entityRanges":[],"type":"unstyled","key":"9lhgi","inlineStyleRanges":[],"depth":0,"data":{},"text":"Alerts investigation gives the user the ability to manage alerts, initiate automated investigations, run anti-virus scans, collect investigation packages, and manage device tags. Since User1 has alerts investigation User1 can run antivirus scans."},{"type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{},"text":"User2 does not have the \"alerts investigation\" permission so User2 cannot collect an investigation package.","key":"5a555","entityRanges":[]},{"key":"cjlbu","depth":0,"text":"User3 has Active remediation actions so User3 can isolate Device1","type":"unstyled","inlineStyleRanges":[],"data":{},"entityRanges":[]},{"entityRanges":[{"key":0,"length":129,"offset":0}],"data":{},"inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"b6cr6","text":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T"}],"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","targetOption":"_blank"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
