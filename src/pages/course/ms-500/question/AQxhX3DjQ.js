...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"AQxhX3DjQ","answers":[{"value":"Yes","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"No"}],"references":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"data":{},"depth":0,"key":"bnlir","text":"https://docs.microsoft.com/en-us/exchange/policy-and-compliance/ediscovery/ediscovery?view=exchserver-2019","type":"unstyled","entityRanges":[]}]},"question":{"blocks":[{"key":"4b38j","depth":0,"data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription that contains 1,000 user mailboxes."},{"data":{},"text":"An administrator named Admin1 must be able to search for the name of a competing company in the mailbox of a user named User5.","type":"unstyled","depth":0,"key":"54n8k","entityRanges":[],"inlineStyleRanges":[]},{"data":{},"entityRanges":[],"type":"unstyled","text":"You need to ensure that Admin1 can search the mailbox of User5 successfully. The solution must prevent Admin1 from sending email messages as User5.","inlineStyleRanges":[],"key":"8u0sc","depth":0},{"type":"unstyled","text":"Solution: You assign the eDiscovery Manager role to Admin1, and then create an eDiscovery case.","depth":0,"key":"fiocc","data":{},"entityRanges":[],"inlineStyleRanges":[]},{"type":"unstyled","depth":0,"text":"Does this meet the goal?","entityRanges":[],"inlineStyleRanges":[],"data":{},"key":"b1ohd"}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
