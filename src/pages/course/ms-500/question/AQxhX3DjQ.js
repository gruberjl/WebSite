...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"depth":0,"inlineStyleRanges":[],"key":"bnlir","type":"unstyled","entityRanges":[],"text":"https://docs.microsoft.com/en-us/exchange/policy-and-compliance/ediscovery/ediscovery?view=exchserver-2019","data":{}}],"entityMap":{}},"question":{"blocks":[{"data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"depth":0,"key":"4b38j","text":"You have a Microsoft 365 subscription that contains 1,000 user mailboxes."},{"key":"54n8k","entityRanges":[],"data":{},"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"An administrator named Admin1 must be able to search for the name of a competing company in the mailbox of a user named User5."},{"inlineStyleRanges":[],"key":"8u0sc","depth":0,"text":"You need to ensure that Admin1 can search the mailbox of User5 successfully. The solution must prevent Admin1 from sending email messages as User5.","data":{},"type":"unstyled","entityRanges":[]},{"key":"fiocc","depth":0,"text":"Solution: You assign the eDiscovery Manager role to Admin1, and then create an eDiscovery case.","data":{},"inlineStyleRanges":[],"type":"unstyled","entityRanges":[]},{"key":"b1ohd","depth":0,"text":"Does this meet the goal?","data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled"}],"entityMap":{}},"answers":[{"isCorrectAnswer":true,"value":"Yes"},{"value":"No","isCorrectAnswer":false}],"id":"AQxhX3DjQ"},
      previousQuestionId: '',
      nextQuestionId: '',
