...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"text":"https://docs.microsoft.com/en-us/exchange/policy-and-compliance/ediscovery/ediscovery?view=exchserver-2019","key":"bnlir","data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[]}],"entityMap":{}},"answers":[{"value":"Yes","isCorrectAnswer":true},{"value":"No","isCorrectAnswer":false}],"question":{"entityMap":{},"blocks":[{"type":"unstyled","text":"You have a Microsoft 365 subscription that contains 1,000 user mailboxes.","key":"4b38j","inlineStyleRanges":[],"data":{},"entityRanges":[],"depth":0},{"key":"54n8k","data":{},"text":"An administrator named Admin1 must be able to search for the name of a competing company in the mailbox of a user named User5.","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","depth":0},{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"You need to ensure that Admin1 can search the mailbox of User5 successfully. The solution must prevent Admin1 from sending email messages as User5.","data":{},"key":"8u0sc","type":"unstyled"},{"entityRanges":[],"text":"Solution: You assign the eDiscovery Manager role to Admin1, and then create an eDiscovery case.","depth":0,"data":{},"key":"fiocc","type":"unstyled","inlineStyleRanges":[]},{"type":"unstyled","entityRanges":[],"data":{},"key":"b1ohd","depth":0,"inlineStyleRanges":[],"text":"Does this meet the goal?"}]},"id":"AQxhX3DjQ"},
      previousQuestionId: '',
      nextQuestionId: '',
