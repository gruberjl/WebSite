...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"AQxhX3DjQ","answers":[{"isCorrectAnswer":true,"value":"Yes"},{"value":"No","isCorrectAnswer":false}],"question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"key":"4b38j","text":"You have a Microsoft 365 subscription that contains 1,000 user mailboxes.","data":{},"depth":0,"type":"unstyled","entityRanges":[]},{"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"An administrator named Admin1 must be able to search for the name of a competing company in the mailbox of a user named User5.","key":"54n8k","depth":0},{"entityRanges":[],"key":"8u0sc","depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"You need to ensure that Admin1 can search the mailbox of User5 successfully. The solution must prevent Admin1 from sending email messages as User5."},{"depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"key":"fiocc","text":"Solution: You assign the eDiscovery Manager role to Admin1, and then create an eDiscovery case.","data":{}},{"type":"unstyled","data":{},"inlineStyleRanges":[],"text":"Does this meet the goal?","key":"b1ohd","depth":0,"entityRanges":[]}]},"references":{"blocks":[{"type":"unstyled","text":"https://docs.microsoft.com/en-us/exchange/policy-and-compliance/ediscovery/ediscovery?view=exchserver-2019","key":"bnlir","depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[]}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
