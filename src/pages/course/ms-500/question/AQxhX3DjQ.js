...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"text":"https://docs.microsoft.com/en-us/exchange/policy-and-compliance/ediscovery/ediscovery?view=exchserver-2019","entityRanges":[],"data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"bnlir"}],"entityMap":{}},"answers":[{"value":"Yes","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"No"}],"question":{"entityMap":{},"blocks":[{"key":"4b38j","type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[],"text":"You have a Microsoft 365 subscription that contains 1,000 user mailboxes.","entityRanges":[]},{"entityRanges":[],"key":"54n8k","type":"unstyled","depth":0,"data":{},"inlineStyleRanges":[],"text":"An administrator named Admin1 must be able to search for the name of a competing company in the mailbox of a user named User5."},{"depth":0,"text":"You need to ensure that Admin1 can search the mailbox of User5 successfully. The solution must prevent Admin1 from sending email messages as User5.","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"8u0sc"},{"entityRanges":[],"key":"fiocc","type":"unstyled","depth":0,"data":{},"inlineStyleRanges":[],"text":"Solution: You assign the eDiscovery Manager role to Admin1, and then create an eDiscovery case."},{"inlineStyleRanges":[],"depth":0,"text":"Does this meet the goal?","data":{},"type":"unstyled","key":"b1ohd","entityRanges":[]}]},"id":"AQxhX3DjQ"},
      previousQuestionId: '',
      nextQuestionId: '',
