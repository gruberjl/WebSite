...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Yes","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"No"}],"id":"2aOF5l6UK","question":{"blocks":[{"inlineStyleRanges":[],"depth":0,"type":"unstyled","text":"You have a Microsoft 365 tenant. You create a label named CompanyConfidential in the Microsoft Compliance admin center. You publish CompanyConfidential to a global policy.","entityRanges":[],"key":"7q6b3","data":{}},{"text":"A user protects an email message by using CompanyConfidential and sends the label to several external recipients. The external recipients report that they cannot open the email message.","key":"cmpff","depth":0,"entityRanges":[],"data":{},"type":"unstyled","inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"You need to ensure that the external recipients can open protected email messages sent to them.","key":"ccint"},{"inlineStyleRanges":[],"data":{},"text":"You modify the content expiration settings of the label.","type":"unstyled","entityRanges":[],"depth":0,"key":"3tria"},{"type":"unstyled","inlineStyleRanges":[],"key":"5hsq1","entityRanges":[],"text":"Does that meet the goal?","data":{},"depth":0}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"inlineStyleRanges":[],"key":"coq2j","data":{},"text":"It's most likely the \"Assign permissions\" are set on the label. If the correct answer was content expiration the question would state \"the user sent the email on day X. The recipient attempted to open the email on day Y.\"","entityRanges":[],"depth":0,"type":"unstyled"},{"entityRanges":[{"offset":0,"length":103,"key":0}],"depth":0,"key":"47otm","type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf ","data":{},"inlineStyleRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
