...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Yes","isCorrectAnswer":false},{"value":"No","isCorrectAnswer":true}],"id":"2aOF5l6UK","question":{"blocks":[{"entityRanges":[],"text":"You have a Microsoft 365 tenant. You create a label named CompanyConfidential in the Microsoft Compliance admin center. You publish CompanyConfidential to a global policy.","key":"7q6b3","inlineStyleRanges":[],"type":"unstyled","depth":0,"data":{}},{"depth":0,"data":{},"entityRanges":[],"type":"unstyled","key":"cmpff","inlineStyleRanges":[],"text":"A user protects an email message by using CompanyConfidential and sends the label to several external recipients. The external recipients report that they cannot open the email message."},{"inlineStyleRanges":[],"key":"ccint","depth":0,"text":"You need to ensure that the external recipients can open protected email messages sent to them.","data":{},"type":"unstyled","entityRanges":[]},{"entityRanges":[],"depth":0,"type":"unstyled","data":{},"inlineStyleRanges":[],"text":"You modify the content expiration settings of the label.","key":"3tria"},{"inlineStyleRanges":[],"depth":0,"key":"5hsq1","entityRanges":[],"text":"Does that meet the goal?","data":{},"type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"It's most likely the \"Assign permissions\" are set on the label. If the correct answer was content expiration the question would state \"the user sent the email on day X. The recipient attempted to open the email on day Y.\"","depth":0,"key":"coq2j"},{"type":"unstyled","entityRanges":[{"offset":0,"key":0,"length":103}],"data":{},"inlineStyleRanges":[],"key":"47otm","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf "}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
