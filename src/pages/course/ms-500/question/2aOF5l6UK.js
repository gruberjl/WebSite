...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Yes"},{"isCorrectAnswer":true,"value":"No"}],"id":"2aOF5l6UK","question":{"blocks":[{"key":"7q6b3","entityRanges":[],"data":{},"depth":0,"text":"You have a Microsoft 365 tenant. You create a label named CompanyConfidential in the Microsoft Compliance admin center. You publish CompanyConfidential to a global policy.","type":"unstyled","inlineStyleRanges":[]},{"entityRanges":[],"key":"cmpff","depth":0,"data":{},"type":"unstyled","text":"A user protects an email message by using CompanyConfidential and sends the label to several external recipients. The external recipients report that they cannot open the email message.","inlineStyleRanges":[]},{"key":"ccint","data":{},"text":"You need to ensure that the external recipients can open protected email messages sent to them.","entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"entityRanges":[],"depth":0,"data":{},"key":"3tria","text":"You modify the content expiration settings of the label.","inlineStyleRanges":[],"type":"unstyled"},{"text":"Does that meet the goal?","data":{},"key":"5hsq1","entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"data":{},"type":"unstyled","text":"It's most likely the \"Assign permissions\" are set on the label. If the correct answer was content expiration the question would state \"the user sent the email on day X. The recipient attempted to open the email on day Y.\"","entityRanges":[],"key":"coq2j","depth":0,"inlineStyleRanges":[]},{"depth":0,"entityRanges":[{"length":103,"offset":0,"key":0}],"key":"47otm","inlineStyleRanges":[],"data":{},"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf "}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
