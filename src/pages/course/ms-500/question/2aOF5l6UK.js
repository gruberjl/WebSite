...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":false,"value":"Yes"},{"isCorrectAnswer":true,"value":"No"}],"id":"2aOF5l6UK","question":{"entityMap":{},"blocks":[{"data":{},"key":"7q6b3","inlineStyleRanges":[],"text":"You have a Microsoft 365 tenant. You create a label named CompanyConfidential in the Microsoft Compliance admin center. You publish CompanyConfidential to a global policy.","type":"unstyled","depth":0,"entityRanges":[]},{"data":{},"key":"cmpff","text":"A user protects an email message by using CompanyConfidential and sends the label to several external recipients. The external recipients report that they cannot open the email message.","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","depth":0},{"inlineStyleRanges":[],"key":"ccint","entityRanges":[],"data":{},"type":"unstyled","text":"You need to ensure that the external recipients can open protected email messages sent to them.","depth":0},{"depth":0,"data":{},"type":"unstyled","key":"3tria","entityRanges":[],"inlineStyleRanges":[],"text":"You modify the content expiration settings of the label."},{"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"Does that meet the goal?","data":{},"depth":0,"key":"5hsq1"}]},"references":{"blocks":[{"type":"unstyled","key":"coq2j","depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"It's most likely the \"Assign permissions\" are set on the label. If the correct answer was content expiration the question would state \"the user sent the email on day X. The recipient attempted to open the email on day Y.\"","data":{}},{"data":{},"entityRanges":[{"length":103,"key":0,"offset":0}],"type":"unstyled","inlineStyleRanges":[],"key":"47otm","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf "}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
