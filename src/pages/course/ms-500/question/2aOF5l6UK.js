...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Yes","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"No"}],"id":"2aOF5l6UK","question":{"entityMap":{},"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"text":"You have a Microsoft 365 tenant. You create a label named CompanyConfidential in the Microsoft Compliance admin center. You publish CompanyConfidential to a global policy.","data":{},"depth":0,"key":"7q6b3","type":"unstyled"},{"text":"A user protects an email message by using CompanyConfidential and sends the label to several external recipients. The external recipients report that they cannot open the email message.","data":{},"entityRanges":[],"key":"cmpff","depth":0,"type":"unstyled","inlineStyleRanges":[]},{"data":{},"depth":0,"key":"ccint","inlineStyleRanges":[],"entityRanges":[],"text":"You need to ensure that the external recipients can open protected email messages sent to them.","type":"unstyled"},{"inlineStyleRanges":[],"text":"You modify the content expiration settings of the label.","entityRanges":[],"type":"unstyled","key":"3tria","depth":0,"data":{}},{"entityRanges":[],"key":"5hsq1","depth":0,"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"Does that meet the goal?"}]},"references":{"blocks":[{"entityRanges":[],"key":"coq2j","data":{},"inlineStyleRanges":[],"type":"unstyled","text":"It's most likely the \"Assign permissions\" are set on the label. If the correct answer was content expiration the question would state \"the user sent the email on day X. The recipient attempted to open the email on day Y.\"","depth":0},{"depth":0,"key":"47otm","data":{},"type":"unstyled","entityRanges":[{"key":0,"length":103,"offset":0}],"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf "}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
