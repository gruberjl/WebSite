...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Yes","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"No"}],"id":"2aOF5l6UK","question":{"blocks":[{"key":"7q6b3","inlineStyleRanges":[],"type":"unstyled","text":"You have a Microsoft 365 tenant. You create a label named CompanyConfidential in the Microsoft Compliance admin center. You publish CompanyConfidential to a global policy.","entityRanges":[],"data":{},"depth":0},{"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"A user protects an email message by using CompanyConfidential and sends the label to several external recipients. The external recipients report that they cannot open the email message.","key":"cmpff","entityRanges":[],"data":{}},{"depth":0,"text":"You need to ensure that the external recipients can open protected email messages sent to them.","type":"unstyled","data":{},"entityRanges":[],"key":"ccint","inlineStyleRanges":[]},{"data":{},"type":"unstyled","key":"3tria","depth":0,"inlineStyleRanges":[],"text":"You modify the content expiration settings of the label.","entityRanges":[]},{"inlineStyleRanges":[],"type":"unstyled","text":"Does that meet the goal?","key":"5hsq1","depth":0,"data":{},"entityRanges":[]}],"entityMap":{}},"references":{"blocks":[{"key":"coq2j","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"It's most likely the \"Assign permissions\" are set on the label. If the correct answer was content expiration the question would state \"the user sent the email on day X. The recipient attempted to open the email on day Y.\"","depth":0},{"key":"47otm","type":"unstyled","entityRanges":[{"length":103,"offset":0,"key":0}],"data":{},"depth":0,"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf "}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
