...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Must change their password: User1 only","isCorrectAnswer":true},{"value":"Must change their password: User2 only","isCorrectAnswer":false},{"value":"Must change their password: Both User1 and User2","isCorrectAnswer":false},{"value":"Must change their password: Neither User1 nor User2","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Prompted for MFA: User1 only"},{"isCorrectAnswer":true,"value":"Prompted for MFA: User2 only"},{"value":"Prompted for MFA: Both User1 and User2","isCorrectAnswer":false},{"value":"Prompted for MFA: Neither User1 nor User2","isCorrectAnswer":false}],"id":"EPxtY1Mal","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"alignment":"left","alt":"User, group, MFA status chart","src":"https://i.ibb.co/ctNx9tq/Chart3.png","height":"auto","width":"auto"},"type":"IMAGE"}},"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"data":{},"depth":0,"type":"unstyled","key":"c9a3h","text":"You have a Microsoft Azure Active Directory (Azure AD) tenant named contoso.com that contains the users shown in the following table."},{"text":" ","depth":0,"key":"83o7o","inlineStyleRanges":[],"data":{},"type":"atomic","entityRanges":[{"key":0,"length":1,"offset":0}]},{"data":{},"key":"biqrr","text":"You create and enforce an Azure AD Identity Protection user risk policy that has the following settings:","entityRanges":[],"type":"unstyled","depth":0,"inlineStyleRanges":[]},{"text":"Assignments: Include Group1, Exclude Group2","entityRanges":[],"data":{},"key":"350er","depth":0,"inlineStyleRanges":[],"type":"unordered-list-item"},{"key":"9unnq","text":"Conditions: Sign-in risk of Low and above","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unordered-list-item"},{"data":{},"text":"Access: Allow access, Require password change","depth":0,"key":"g8gt","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[],"data":{},"text":"You need to identify how the policy affects User1 and User2.","type":"unstyled","inlineStyleRanges":[],"depth":0,"key":"90j"},{"depth":0,"text":"What occurs when User1 and User2 sign in from an unfamiliar location?","data":{},"entityRanges":[],"key":"950ob","type":"unstyled","inlineStyleRanges":[]}]},"references":{"blocks":[{"depth":0,"key":"chcdi","entityRanges":[],"data":{},"type":"unstyled","inlineStyleRanges":[],"text":"Unfamiliar location sign-in is considered a low risk so the user risk policy would initiate. Group1 is assigned in the user risk policy and Group2 is excluded so only User1 is affected by the policy so only User1 will be required to change their password."},{"data":{},"entityRanges":[],"key":"da7a5","depth":0,"inlineStyleRanges":[],"text":"User1 isn't configured for MFA but User2 is so only User2 will be prompted for MFA.","type":"unstyled"},{"data":{},"key":"b542b","text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","depth":0,"inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":123,"key":0}],"type":"unstyled"},{"data":{},"inlineStyleRanges":[],"key":"ag5bh","type":"unstyled","entityRanges":[{"key":1,"length":128,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","depth":0},{"depth":0,"key":"f3bq1","data":{},"type":"unstyled","entityRanges":[{"key":2,"offset":0,"length":114}],"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups"}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"}},"1":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk"},"type":"LINK","mutability":"MUTABLE"},"2":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
