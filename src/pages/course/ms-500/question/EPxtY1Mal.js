...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Must change their password: User1 only"},{"value":"Must change their password: User2 only","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Must change their password: Both User1 and User2"},{"value":"Must change their password: Neither User1 nor User2","isCorrectAnswer":false},{"value":"Prompted for MFA: User1 only","isCorrectAnswer":false},{"value":"Prompted for MFA: User2 only","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Prompted for MFA: Both User1 and User2"},{"isCorrectAnswer":false,"value":"Prompted for MFA: Neither User1 nor User2"}],"id":"EPxtY1Mal","question":{"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"key":"c9a3h","data":{},"type":"unstyled","depth":0,"text":"You have a Microsoft Azure Active Directory (Azure AD) tenant named contoso.com that contains the users shown in the following table."},{"depth":0,"entityRanges":[{"length":1,"offset":0,"key":0}],"key":"83o7o","type":"atomic","text":" ","inlineStyleRanges":[],"data":{}},{"depth":0,"entityRanges":[],"text":"You create and enforce an Azure AD Identity Protection user risk policy that has the following settings:","key":"biqrr","data":{},"type":"unstyled","inlineStyleRanges":[]},{"entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"350er","depth":0,"text":"Assignments: Include Group1, Exclude Group2","type":"unordered-list-item"},{"key":"9unnq","depth":0,"inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"text":"Conditions: Sign-in risk of Low and above","data":{}},{"key":"g8gt","inlineStyleRanges":[],"type":"unordered-list-item","data":{},"entityRanges":[],"depth":0,"text":"Access: Allow access, Require password change"},{"key":"90j","data":{},"type":"unstyled","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"You need to identify how the policy affects User1 and User2."},{"data":{},"type":"unstyled","inlineStyleRanges":[],"key":"950ob","text":"What occurs when User1 and User2 sign in from an unfamiliar location?","entityRanges":[],"depth":0}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"alt":"User, group, MFA status chart","height":"auto","alignment":"left","width":"auto","src":"https://i.ibb.co/ctNx9tq/Chart3.png"}}}},"references":{"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"},"mutability":"MUTABLE"},"1":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"},"2":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"depth":0,"inlineStyleRanges":[],"key":"chcdi","type":"unstyled","data":{},"text":"Unfamiliar location sign-in is considered a low risk so the user risk policy would initiate. Group1 is assigned in the user risk policy and Group2 is excluded so only User1 is affected by the policy so only User1 will be required to change their password.","entityRanges":[]},{"depth":0,"entityRanges":[],"key":"da7a5","data":{},"inlineStyleRanges":[],"type":"unstyled","text":"User1 isn't configured for MFA but User2 is so only User2 will be prompted for MFA."},{"depth":0,"key":"b542b","type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","inlineStyleRanges":[],"data":{},"entityRanges":[{"length":123,"offset":0,"key":0}]},{"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","inlineStyleRanges":[],"data":{},"key":"ag5bh","type":"unstyled","entityRanges":[{"key":1,"offset":0,"length":128}]},{"depth":0,"key":"f3bq1","data":{},"entityRanges":[{"length":114,"key":2,"offset":0}],"inlineStyleRanges":[],"type":"unstyled","text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
