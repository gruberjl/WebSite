...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Must change their password: User1 only","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Must change their password: User2 only"},{"isCorrectAnswer":false,"value":"Must change their password: Both User1 and User2"},{"value":"Must change their password: Neither User1 nor User2","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Prompted for MFA: User1 only"},{"value":"Prompted for MFA: User2 only","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Prompted for MFA: Both User1 and User2"},{"isCorrectAnswer":false,"value":"Prompted for MFA: Neither User1 nor User2"}],"id":"EPxtY1Mal","question":{"blocks":[{"entityRanges":[],"text":"You have a Microsoft Azure Active Directory (Azure AD) tenant named contoso.com that contains the users shown in the following table.","data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"c9a3h"},{"inlineStyleRanges":[],"entityRanges":[{"key":0,"length":1,"offset":0}],"text":" ","data":{},"depth":0,"type":"atomic","key":"83o7o"},{"entityRanges":[],"type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{},"key":"biqrr","text":"You create and enforce an Azure AD Identity Protection user risk policy that has the following settings:"},{"key":"350er","inlineStyleRanges":[],"depth":0,"data":{},"text":"Assignments: Include Group1, Exclude Group2","entityRanges":[],"type":"unordered-list-item"},{"key":"9unnq","data":{},"type":"unordered-list-item","inlineStyleRanges":[],"text":"Conditions: Sign-in risk of Low and above","entityRanges":[],"depth":0},{"inlineStyleRanges":[],"data":{},"depth":0,"key":"g8gt","type":"unordered-list-item","text":"Access: Allow access, Require password change","entityRanges":[]},{"type":"unstyled","entityRanges":[],"text":"You need to identify how the policy affects User1 and User2.","key":"90j","data":{},"depth":0,"inlineStyleRanges":[]},{"type":"unstyled","data":{},"depth":0,"entityRanges":[],"text":"What occurs when User1 and User2 sign in from an unfamiliar location?","key":"950ob","inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"alt":"User, group, MFA status chart","width":"auto","src":"https://i.ibb.co/ctNx9tq/Chart3.png","alignment":"left","height":"auto"},"type":"IMAGE"}}},"references":{"blocks":[{"text":"Unfamiliar location sign-in is considered a low risk so the user risk policy would initiate. Group1 is assigned in the user risk policy and Group2 is excluded so only User1 is affected by the policy so only User1 will be required to change their password.","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"key":"chcdi","depth":0,"data":{}},{"type":"unstyled","key":"da7a5","inlineStyleRanges":[],"data":{},"depth":0,"text":"User1 isn't configured for MFA but User2 is so only User2 will be prompted for MFA.","entityRanges":[]},{"entityRanges":[{"length":123,"offset":0,"key":0}],"key":"b542b","type":"unstyled","data":{},"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","inlineStyleRanges":[]},{"entityRanges":[{"key":1,"length":128,"offset":0}],"type":"unstyled","inlineStyleRanges":[],"data":{},"key":"ag5bh","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk "},{"entityRanges":[{"offset":0,"length":114,"key":2}],"depth":0,"key":"f3bq1","data":{},"text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups","inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"},"type":"LINK"},"2":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
