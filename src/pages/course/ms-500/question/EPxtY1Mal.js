...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Must change their password: User1 only","isCorrectAnswer":true},{"value":"Must change their password: User2 only","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Must change their password: Both User1 and User2"},{"value":"Must change their password: Neither User1 nor User2","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Prompted for MFA: User1 only"},{"value":"Prompted for MFA: User2 only","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Prompted for MFA: Both User1 and User2"},{"isCorrectAnswer":false,"value":"Prompted for MFA: Neither User1 nor User2"}],"id":"EPxtY1Mal","question":{"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"src":"https://i.ibb.co/ctNx9tq/Chart3.png","width":"auto","alt":"User, group, MFA status chart","alignment":"left","height":"auto"}}},"blocks":[{"depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"c9a3h","type":"unstyled","text":"You have a Microsoft Azure Active Directory (Azure AD) tenant named contoso.com that contains the users shown in the following table."},{"type":"atomic","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[{"length":1,"offset":0,"key":0}],"text":" ","key":"83o7o"},{"type":"unstyled","text":"You create and enforce an Azure AD Identity Protection user risk policy that has the following settings:","entityRanges":[],"inlineStyleRanges":[],"depth":0,"key":"biqrr","data":{}},{"entityRanges":[],"key":"350er","depth":0,"type":"unordered-list-item","inlineStyleRanges":[],"data":{},"text":"Assignments: Include Group1, Exclude Group2"},{"key":"9unnq","inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[],"type":"unordered-list-item","text":"Conditions: Sign-in risk of Low and above"},{"entityRanges":[],"data":{},"depth":0,"text":"Access: Allow access, Require password change","type":"unordered-list-item","inlineStyleRanges":[],"key":"g8gt"},{"type":"unstyled","text":"You need to identify how the policy affects User1 and User2.","data":{},"key":"90j","depth":0,"entityRanges":[],"inlineStyleRanges":[]},{"key":"950ob","entityRanges":[],"depth":0,"data":{},"text":"What occurs when User1 and User2 sign in from an unfamiliar location?","inlineStyleRanges":[],"type":"unstyled"}]},"references":{"blocks":[{"text":"Unfamiliar location sign-in is considered a low risk so the user risk policy would initiate. Group1 is assigned in the user risk policy and Group2 is excluded so only User1 is affected by the policy so only User1 will be required to change their password.","entityRanges":[],"key":"chcdi","depth":0,"type":"unstyled","inlineStyleRanges":[],"data":{}},{"text":"User1 isn't configured for MFA but User2 is so only User2 will be prompted for MFA.","type":"unstyled","data":{},"key":"da7a5","entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","inlineStyleRanges":[],"depth":0,"data":{},"key":"b542b","entityRanges":[{"key":0,"length":123,"offset":0}],"type":"unstyled"},{"data":{},"entityRanges":[{"offset":0,"length":128,"key":1}],"key":"ag5bh","text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","inlineStyleRanges":[],"type":"unstyled","depth":0},{"depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[{"key":2,"offset":0,"length":114}],"key":"f3bq1","text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups","type":"unstyled"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"}},"1":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"2":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
