...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Must change their password: User1 only"},{"value":"Must change their password: User2 only","isCorrectAnswer":false},{"value":"Must change their password: Both User1 and User2","isCorrectAnswer":false},{"value":"Must change their password: Neither User1 nor User2","isCorrectAnswer":false},{"value":"Prompted for MFA: User1 only","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Prompted for MFA: User2 only"},{"isCorrectAnswer":false,"value":"Prompted for MFA: Both User1 and User2"},{"isCorrectAnswer":false,"value":"Prompted for MFA: Neither User1 nor User2"}],"id":"EPxtY1Mal","question":{"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","width":"auto","alt":"User, group, MFA status chart","src":"https://i.ibb.co/ctNx9tq/Chart3.png","height":"auto"}}},"blocks":[{"depth":0,"data":{},"type":"unstyled","key":"c9a3h","text":"You have a Microsoft Azure Active Directory (Azure AD) tenant named contoso.com that contains the users shown in the following table.","entityRanges":[],"inlineStyleRanges":[]},{"text":" ","inlineStyleRanges":[],"key":"83o7o","data":{},"entityRanges":[{"key":0,"length":1,"offset":0}],"depth":0,"type":"atomic"},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0,"key":"biqrr","type":"unstyled","text":"You create and enforce an Azure AD Identity Protection user risk policy that has the following settings:"},{"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"data":{},"depth":0,"key":"350er","text":"Assignments: Include Group1, Exclude Group2"},{"depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"9unnq","type":"unordered-list-item","text":"Conditions: Sign-in risk of Low and above"},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"g8gt","depth":0,"text":"Access: Allow access, Require password change","type":"unordered-list-item"},{"inlineStyleRanges":[],"entityRanges":[],"text":"You need to identify how the policy affects User1 and User2.","data":{},"type":"unstyled","key":"90j","depth":0},{"data":{},"key":"950ob","inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[],"text":"What occurs when User1 and User2 sign in from an unfamiliar location?"}]},"references":{"blocks":[{"depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled","text":"Unfamiliar location sign-in is considered a low risk so the user risk policy would initiate. Group1 is assigned in the user risk policy and Group2 is excluded so only User1 is affected by the policy so only User1 will be required to change their password.","key":"chcdi"},{"entityRanges":[],"text":"User1 isn't configured for MFA but User2 is so only User2 will be prompted for MFA.","key":"da7a5","inlineStyleRanges":[],"depth":0,"type":"unstyled","data":{}},{"depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":123,"key":0}],"key":"b542b","type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"},{"key":"ag5bh","text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","type":"unstyled","data":{},"depth":0,"entityRanges":[{"key":1,"offset":0,"length":128}],"inlineStyleRanges":[]},{"key":"f3bq1","data":{},"type":"unstyled","text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups","inlineStyleRanges":[],"entityRanges":[{"length":114,"offset":0,"key":2}],"depth":0}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"}},"1":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk"},"type":"LINK","mutability":"MUTABLE"},"2":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
