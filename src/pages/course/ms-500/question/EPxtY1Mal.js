...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Must change their password: User1 only","isCorrectAnswer":true},{"value":"Must change their password: User2 only","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Must change their password: Both User1 and User2"},{"value":"Must change their password: Neither User1 nor User2","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Prompted for MFA: User1 only"},{"value":"Prompted for MFA: User2 only","isCorrectAnswer":true},{"value":"Prompted for MFA: Both User1 and User2","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Prompted for MFA: Neither User1 nor User2"}],"id":"EPxtY1Mal","question":{"entityMap":{"0":{"data":{"alignment":"left","width":"auto","src":"https://i.ibb.co/ctNx9tq/Chart3.png","height":"auto","alt":"User, group, MFA status chart"},"mutability":"MUTABLE","type":"IMAGE"}},"blocks":[{"data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"You have a Microsoft Azure Active Directory (Azure AD) tenant named contoso.com that contains the users shown in the following table.","key":"c9a3h","type":"unstyled"},{"type":"atomic","text":" ","entityRanges":[{"offset":0,"key":0,"length":1}],"data":{},"key":"83o7o","depth":0,"inlineStyleRanges":[]},{"text":"You create and enforce an Azure AD Identity Protection user risk policy that has the following settings:","key":"biqrr","type":"unstyled","entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[]},{"data":{},"depth":0,"key":"350er","inlineStyleRanges":[],"entityRanges":[],"type":"unordered-list-item","text":"Assignments: Include Group1, Exclude Group2"},{"type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"text":"Conditions: Sign-in risk of Low and above","data":{},"key":"9unnq","entityRanges":[]},{"data":{},"text":"Access: Allow access, Require password change","type":"unordered-list-item","depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"g8gt"},{"key":"90j","entityRanges":[],"type":"unstyled","data":{},"inlineStyleRanges":[],"depth":0,"text":"You need to identify how the policy affects User1 and User2."},{"key":"950ob","type":"unstyled","text":"What occurs when User1 and User2 sign in from an unfamiliar location?","inlineStyleRanges":[],"entityRanges":[],"depth":0,"data":{}}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"}},"1":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"2":{"type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups"},"mutability":"MUTABLE"}},"blocks":[{"text":"Unfamiliar location sign-in is considered a low risk so the user risk policy would initiate. Group1 is assigned in the user risk policy and Group2 is excluded so only User1 is affected by the policy so only User1 will be required to change their password.","type":"unstyled","data":{},"key":"chcdi","entityRanges":[],"inlineStyleRanges":[],"depth":0},{"depth":0,"data":{},"type":"unstyled","entityRanges":[],"key":"da7a5","inlineStyleRanges":[],"text":"User1 isn't configured for MFA but User2 is so only User2 will be prompted for MFA."},{"key":"b542b","entityRanges":[{"offset":0,"key":0,"length":123}],"data":{},"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ"},{"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","type":"unstyled","key":"ag5bh","data":{},"entityRanges":[{"offset":0,"key":1,"length":128}],"depth":0,"inlineStyleRanges":[]},{"key":"f3bq1","entityRanges":[{"key":2,"length":114,"offset":0}],"text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups","inlineStyleRanges":[],"data":{},"depth":0,"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
