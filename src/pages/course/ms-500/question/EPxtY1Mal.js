...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Must change their password: User1 only","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Must change their password: User2 only"},{"value":"Must change their password: Both User1 and User2","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Must change their password: Neither User1 nor User2"},{"value":"Prompted for MFA: User1 only","isCorrectAnswer":false},{"value":"Prompted for MFA: User2 only","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Prompted for MFA: Both User1 and User2"},{"value":"Prompted for MFA: Neither User1 nor User2","isCorrectAnswer":false}],"id":"EPxtY1Mal","question":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"alt":"User, group, MFA status chart","height":"auto","width":"auto","alignment":"left","src":"https://i.ibb.co/ctNx9tq/Chart3.png"},"type":"IMAGE"}},"blocks":[{"entityRanges":[],"depth":0,"data":{},"text":"You have a Microsoft Azure Active Directory (Azure AD) tenant named contoso.com that contains the users shown in the following table.","type":"unstyled","inlineStyleRanges":[],"key":"c9a3h"},{"text":" ","key":"83o7o","type":"atomic","depth":0,"inlineStyleRanges":[],"entityRanges":[{"key":0,"offset":0,"length":1}],"data":{}},{"type":"unstyled","data":{},"entityRanges":[],"key":"biqrr","text":"You create and enforce an Azure AD Identity Protection user risk policy that has the following settings:","depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"depth":0,"data":{},"type":"unordered-list-item","inlineStyleRanges":[],"text":"Assignments: Include Group1, Exclude Group2","key":"350er"},{"inlineStyleRanges":[],"key":"9unnq","depth":0,"text":"Conditions: Sign-in risk of Low and above","entityRanges":[],"data":{},"type":"unordered-list-item"},{"entityRanges":[],"type":"unordered-list-item","depth":0,"text":"Access: Allow access, Require password change","data":{},"key":"g8gt","inlineStyleRanges":[]},{"inlineStyleRanges":[],"type":"unstyled","key":"90j","data":{},"entityRanges":[],"text":"You need to identify how the policy affects User1 and User2.","depth":0},{"type":"unstyled","data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"What occurs when User1 and User2 sign in from an unfamiliar location?","key":"950ob"}]},"references":{"blocks":[{"text":"Unfamiliar location sign-in is considered a low risk so the user risk policy would initiate. Group1 is assigned in the user risk policy and Group2 is excluded so only User1 is affected by the policy so only User1 will be required to change their password.","key":"chcdi","depth":0,"data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[]},{"inlineStyleRanges":[],"type":"unstyled","depth":0,"data":{},"text":"User1 isn't configured for MFA but User2 is so only User2 will be prompted for MFA.","key":"da7a5","entityRanges":[]},{"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","entityRanges":[{"length":123,"offset":0,"key":0}],"type":"unstyled","key":"b542b","inlineStyleRanges":[],"depth":0,"data":{}},{"entityRanges":[{"offset":0,"key":1,"length":128}],"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ","data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","key":"ag5bh"},{"inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[{"key":2,"offset":0,"length":114}],"depth":0,"key":"f3bq1","text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"}},"1":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk"},"type":"LINK","mutability":"MUTABLE"},"2":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
