...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Azure Active Directory admin center","isCorrectAnswer":true},{"value":"Cloud App Security admin center","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Security & Compliance admin center"},{"value":"Microsoft 365 admin center","isCorrectAnswer":true}],"id":"To3w-ry36","question":{"entityMap":{},"blocks":[{"data":{},"inlineStyleRanges":[],"text":"Your organization is using a Microsoft 365 tenant. From the Microsoft 365 admin center, you create a new user named John Gruber. You were requested to assign the User Administrator role to John Gruber but before you do your boss wants to know everything the role will give John access to.","depth":0,"type":"unstyled","entityRanges":[],"key":"7c56s"},{"text":"Which admin centers could you use to view the permissions of an administrator role?","key":"aphun","data":{},"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0}]},"references":{"blocks":[{"depth":0,"data":{},"text":"The best place to view the rights of an admin role is Azure Active Directory but some of the details can also be found in the Microsoft 365 admin center","key":"7etnr","inlineStyleRanges":[],"type":"unstyled","entityRanges":[]},{"depth":0,"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","data":{},"key":"2ct22","entityRanges":[{"key":0,"offset":0,"length":95}],"type":"unstyled"},{"key":"dk8qi","entityRanges":[{"key":1,"length":101,"offset":0}],"type":"unstyled","text":"https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RolesAndAdministrators > click on a role.","depth":0,"data":{},"inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RolesAndAdministrators","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
