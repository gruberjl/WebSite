...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Azure Active Directory admin center","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Cloud App Security admin center"},{"isCorrectAnswer":false,"value":"Security & Compliance admin center"},{"value":"Microsoft 365 admin center","isCorrectAnswer":true}],"id":"To3w-ry36","question":{"blocks":[{"text":"Your organization is using a Microsoft 365 tenant. From the Microsoft 365 admin center, you create a new user named John Gruber. You were requested to assign the User Administrator role to John Gruber but before you do your boss wants to know everything the role will give John access to.","type":"unstyled","key":"7c56s","data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[]},{"depth":0,"inlineStyleRanges":[],"key":"aphun","data":{},"entityRanges":[],"text":"Which admin centers could you use to view the permissions of an administrator role?","type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"data":{},"entityRanges":[],"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"The best place to view the rights of an admin role is Azure Active Directory but some of the details can also be found in the Microsoft 365 admin center","key":"7etnr"},{"type":"unstyled","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","depth":0,"data":{},"key":"2ct22","entityRanges":[{"length":95,"offset":0,"key":0}]},{"text":"https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RolesAndAdministrators > click on a role.","key":"dk8qi","type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":101,"key":1}],"depth":0,"data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU"}},"1":{"data":{"targetOption":"_blank","url":"https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RolesAndAdministrators"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
