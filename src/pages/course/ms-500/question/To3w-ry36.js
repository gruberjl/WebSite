...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Azure Active Directory admin center","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Cloud App Security admin center"},{"isCorrectAnswer":false,"value":"Security & Compliance admin center"},{"isCorrectAnswer":true,"value":"Microsoft 365 admin center"}],"id":"To3w-ry36","question":{"blocks":[{"entityRanges":[],"depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"Your organization is using a Microsoft 365 tenant. From the Microsoft 365 admin center, you create a new user named John Gruber. You were requested to assign the User Administrator role to John Gruber but before you do your boss wants to know everything the role will give John access to.","data":{},"key":"7c56s"},{"type":"unstyled","depth":0,"entityRanges":[],"text":"Which admin centers could you use to view the permissions of an administrator role?","key":"aphun","data":{},"inlineStyleRanges":[]}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","data":{"url":"https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RolesAndAdministrators","targetOption":"_blank"},"mutability":"MUTABLE"}},"blocks":[{"type":"unstyled","entityRanges":[],"depth":0,"key":"7etnr","text":"The best place to view the rights of an admin role is Azure Active Directory but some of the details can also be found in the Microsoft 365 admin center","data":{},"inlineStyleRanges":[]},{"entityRanges":[{"offset":0,"key":0,"length":95}],"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","depth":0,"data":{},"type":"unstyled","key":"2ct22","inlineStyleRanges":[]},{"text":"https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RolesAndAdministrators > click on a role.","type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"key":1,"length":101,"offset":0}],"key":"dk8qi","depth":0,"data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
