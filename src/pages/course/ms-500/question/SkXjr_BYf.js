...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"From the Azure AD admin center, register AppA. Then create a conditional access policy. From the Cloud App Security admin center, create an access policy."},{"value":"From the Azure AD admin center, register AppA. Then from the Cloud App Security admin center, create an access policy. Then create an app discovery policy.","isCorrectAnswer":false},{"value":"From the Cloud App Security admin center, create an access policy. Then from the Endpoint Management admin center, create an app configuration policy. Finally, from the Azure AD admin center, create a conditional access policy.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Endpoint Management admin center, add AppA. Then from the Azure AD admin center, create a conditional access policy. Finally from the Endpoint Management admin center, create an app configuration policy."}],"id":"SkXjr_BYf","question":{"blocks":[{"depth":0,"text":"All the devices in the Microsoft 365 tenant are managed by using Microsoft Intune.","key":"8rhoa","type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"Your organization has purchased an app named AppA.","key":"7kn79"},{"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"AppA that supports Microsoft's session controls.","key":"3feh","data":{}},{"entityRanges":[],"type":"unstyled","key":"bnqig","text":"Your manager asks you to configure AppA so it can be reviewed in real-time.","depth":0,"inlineStyleRanges":[],"data":{}},{"inlineStyleRanges":[],"key":"9k3bk","depth":0,"entityRanges":[],"type":"unstyled","data":{},"text":"What do you need to do?"}],"entityMap":{}},"references":{"blocks":[{"text":"You'll need to perform three steps to manage a device:","entityRanges":[],"data":{},"depth":0,"key":"2cg64","type":"unstyled","inlineStyleRanges":[]},{"text":"From the Azure AD admin center, register AppA.","entityRanges":[],"key":"dgocv","depth":0,"data":{},"type":"ordered-list-item","inlineStyleRanges":[]},{"entityRanges":[],"inlineStyleRanges":[],"text":"From the Azure AD admin center, create a conditional access policy.","key":"3bh87","type":"ordered-list-item","depth":0,"data":{}},{"key":"59ba8","entityRanges":[],"data":{},"inlineStyleRanges":[],"text":"From the Cloud App Security admin center, create an access policy.","depth":0,"type":"ordered-list-item"},{"entityRanges":[{"key":0,"length":69,"offset":0}],"type":"unstyled","depth":0,"text":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad","inlineStyleRanges":[],"key":"16k6h","data":{}}],"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
