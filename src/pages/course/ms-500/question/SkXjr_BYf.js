...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Azure AD admin center, register AppA. Then create a conditional access policy. From the Cloud App Security admin center, create an access policy.","isCorrectAnswer":true},{"value":"From the Azure AD admin center, register AppA. Then from the Cloud App Security admin center, create an access policy. Then create an app discovery policy.","isCorrectAnswer":false},{"value":"From the Cloud App Security admin center, create an access policy. Then from the Endpoint Management admin center, create an app configuration policy. Finally, from the Azure AD admin center, create a conditional access policy.","isCorrectAnswer":false},{"value":"From the Endpoint Management admin center, add AppA. Then from the Azure AD admin center, create a conditional access policy. Finally from the Endpoint Management admin center, create an app configuration policy.","isCorrectAnswer":false}],"id":"SkXjr_BYf","question":{"entityMap":{},"blocks":[{"key":"8rhoa","entityRanges":[],"type":"unstyled","text":"All the devices in the Microsoft 365 tenant are managed by using Microsoft Intune.","depth":0,"inlineStyleRanges":[],"data":{}},{"data":{},"text":"Your organization has purchased an app named AppA.","type":"unstyled","depth":0,"entityRanges":[],"key":"7kn79","inlineStyleRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"data":{},"type":"unstyled","key":"3feh","text":"AppA that supports Microsoft's session controls."},{"key":"bnqig","depth":0,"type":"unstyled","inlineStyleRanges":[],"text":"Your manager asks you to configure AppA so it can be reviewed in real-time.","data":{},"entityRanges":[]},{"key":"9k3bk","depth":0,"data":{},"type":"unstyled","text":"What do you need to do?","entityRanges":[],"inlineStyleRanges":[]}]},"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad"}}},"blocks":[{"depth":0,"text":"You'll need to perform three steps to manage a device:","data":{},"key":"2cg64","inlineStyleRanges":[],"type":"unstyled","entityRanges":[]},{"key":"dgocv","depth":0,"data":{},"type":"ordered-list-item","text":"From the Azure AD admin center, register AppA.","entityRanges":[],"inlineStyleRanges":[]},{"key":"3bh87","inlineStyleRanges":[],"depth":0,"entityRanges":[],"text":"From the Azure AD admin center, create a conditional access policy.","data":{},"type":"ordered-list-item"},{"entityRanges":[],"inlineStyleRanges":[],"depth":0,"data":{},"text":"From the Cloud App Security admin center, create an access policy.","key":"59ba8","type":"ordered-list-item"},{"inlineStyleRanges":[],"data":{},"text":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad","entityRanges":[{"key":0,"offset":0,"length":69}],"depth":0,"key":"16k6h","type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
