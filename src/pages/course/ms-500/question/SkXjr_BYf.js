...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"From the Azure AD admin center, register AppA. Then create a conditional access policy. From the Cloud App Security admin center, create an access policy."},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, register AppA. Then from the Cloud App Security admin center, create an access policy. Then create an app discovery policy."},{"isCorrectAnswer":false,"value":"From the Cloud App Security admin center, create an access policy. Then from the Endpoint Management admin center, create an app configuration policy. Finally, from the Azure AD admin center, create a conditional access policy."},{"value":"From the Endpoint Management admin center, add AppA. Then from the Azure AD admin center, create a conditional access policy. Finally from the Endpoint Management admin center, create an app configuration policy.","isCorrectAnswer":false}],"id":"SkXjr_BYf","question":{"blocks":[{"inlineStyleRanges":[],"text":"All the devices in the Microsoft 365 tenant are managed by using Microsoft Intune.","type":"unstyled","data":{},"depth":0,"entityRanges":[],"key":"8rhoa"},{"depth":0,"type":"unstyled","key":"7kn79","data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"Your organization has purchased an app named AppA."},{"type":"unstyled","entityRanges":[],"key":"3feh","text":"AppA that supports Microsoft's session controls.","data":{},"depth":0,"inlineStyleRanges":[]},{"text":"Your manager asks you to configure AppA so it can be reviewed in real-time.","type":"unstyled","depth":0,"key":"bnqig","data":{},"inlineStyleRanges":[],"entityRanges":[]},{"data":{},"depth":0,"type":"unstyled","key":"9k3bk","inlineStyleRanges":[],"text":"What do you need to do?","entityRanges":[]}],"entityMap":{}},"references":{"blocks":[{"entityRanges":[],"depth":0,"key":"2cg64","inlineStyleRanges":[],"type":"unstyled","data":{},"text":"You'll need to perform three steps to manage a device:"},{"depth":0,"type":"ordered-list-item","data":{},"text":"From the Azure AD admin center, register AppA.","entityRanges":[],"key":"dgocv","inlineStyleRanges":[]},{"inlineStyleRanges":[],"text":"From the Azure AD admin center, create a conditional access policy.","depth":0,"type":"ordered-list-item","entityRanges":[],"key":"3bh87","data":{}},{"entityRanges":[],"key":"59ba8","depth":0,"inlineStyleRanges":[],"data":{},"type":"ordered-list-item","text":"From the Cloud App Security admin center, create an access policy."},{"key":"16k6h","type":"unstyled","depth":0,"entityRanges":[{"length":69,"offset":0,"key":0}],"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad","data":{}}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
