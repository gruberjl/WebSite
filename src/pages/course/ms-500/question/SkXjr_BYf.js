...
class EditQuestionPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Azure AD admin center, register AppA. Then create a conditional access policy. From the Cloud App Security admin center, create an access policy.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, register AppA. Then from the Cloud App Security admin center, create an access policy. Then create an app discovery policy."},{"isCorrectAnswer":false,"value":"From the Cloud App Security admin center, create an access policy. Then from the Endpoint Management admin center, create an app configuration policy. Finally, from the Azure AD admin center, create a conditional access policy."},{"value":"From the Endpoint Management admin center, add AppA. Then from the Azure AD admin center, create a conditional access policy. Finally from the Endpoint Management admin center, create an app configuration policy.","isCorrectAnswer":false}],"id":"SkXjr_BYf","question":{"entityMap":{},"blocks":[{"text":"All the devices in the Microsoft 365 tenant are managed by using Microsoft Intune.","data":{},"entityRanges":[],"key":"8rhoa","depth":0,"type":"unstyled","inlineStyleRanges":[]},{"inlineStyleRanges":[],"key":"7kn79","depth":0,"text":"Your organization has purchased an app named AppA.","data":{},"entityRanges":[],"type":"unstyled"},{"type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"AppA that supports Microsoft's session controls.","key":"3feh"},{"data":{},"inlineStyleRanges":[],"type":"unstyled","depth":0,"entityRanges":[],"key":"bnqig","text":"Your manager asks you to configure AppA so it can be reviewed in real-time."},{"inlineStyleRanges":[],"entityRanges":[],"text":"What do you need to do?","key":"9k3bk","type":"unstyled","data":{},"depth":0}]},"references":{"blocks":[{"key":"2cg64","data":{},"type":"unstyled","depth":0,"entityRanges":[],"text":"You'll need to perform three steps to manage a device:","inlineStyleRanges":[]},{"key":"dgocv","inlineStyleRanges":[],"type":"ordered-list-item","entityRanges":[],"depth":0,"data":{},"text":"From the Azure AD admin center, register AppA."},{"depth":0,"entityRanges":[],"key":"3bh87","text":"From the Azure AD admin center, create a conditional access policy.","type":"ordered-list-item","data":{},"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"text":"From the Cloud App Security admin center, create an access policy.","key":"59ba8","depth":0,"type":"ordered-list-item","inlineStyleRanges":[]},{"depth":0,"inlineStyleRanges":[],"data":{},"type":"unstyled","text":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad","entityRanges":[{"length":69,"offset":0,"key":0}],"key":"16k6h"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
