...
class ArticlePage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      article: {"article":{"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","alignment":"none","src":"https://i.ibb.co/7nDqr9x/Whats-AD-Connect.png","width":"auto","url":"https://www.microsoft.com/en-us/download/details.aspx?id=47594","targetOption":"_blank","alt":"What's AD Connect"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.microsoft.com/en-us/download/details.aspx?id=47594","targetOption":"_blank"}},"2":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/hybrid/how-to-connect-install-roadmap"},"type":"LINK","mutability":"MUTABLE"},"3":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/hybrid/how-to-connect-install-express","targetOption":"_blank"}},"4":{"type":"IMAGE","mutability":"MUTABLE","data":{"height":"auto","targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/concept-registration-mfa-sspr-combined","src":"https://i.ibb.co/Vw4Y5TN/Unhealthy-identity-synchronization-notification.png","alignment":"none","width":"auto","alt":"Unhealthy identity synchronization notification"}},"5":{"data":{"alt":"AD Connect Error","alignment":"none","height":"auto","src":"https://i.ibb.co/3CS1K7m/AD-Connect-error.png","width":"auto","targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/concept-registration-mfa-sspr-combined"},"mutability":"MUTABLE","type":"IMAGE"},"6":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/concept-registration-mfa-sspr-combined","targetOption":"_blank"}},"7":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/tutorial-enable-sspr-writeback"}}},"blocks":[{"text":"Now, if you've been around Microsoft technology for a while you've heard of user accounts. It's the term they've been using for decades but recently things have become a bit more complicated. A person can have a user account in your on-premises Active Directory. They can have a user account in Microsoft 365. They can have a user account in other cloud providers as well. So now Microsoft, and the technology industry, have started separating user accounts and identities. User accounts may contain an email address, name, and other information about the person. The identity controls the authentication, for example, the username, and password.","entityRanges":[],"data":{},"key":"dj096","depth":0,"type":"unstyled","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","offset":0,"length":646},{"style":"bgcolor-rgb(255,255,255)","offset":0,"length":646},{"offset":0,"length":646,"style":"fontsize-16"},{"length":646,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":0}]},{"data":{},"text":" ","inlineStyleRanges":[],"depth":0,"key":"78bc2","type":"atomic","entityRanges":[{"key":0,"length":1,"offset":0}]},{"data":{},"type":"header-two","text":"Synchronizing your on-premises Active Directory (AD) to Microsoft 365","depth":0,"key":"72igr","inlineStyleRanges":[],"entityRanges":[]},{"entityRanges":[],"text":"AD Connect Is a Microsoft application that can be installed on a domain-joined Windows Server 2016 or later server that will sync your on-premises Active Directory to Microsoft 365’s Azure Active Directory. Every time you create, update, disable, or delete a user account in your on-premises AD, AD Connect will automatically sync that change to Microsoft 365.","inlineStyleRanges":[],"key":"4u7te","data":{},"depth":0,"type":"unstyled"},{"inlineStyleRanges":[],"key":"9asia","depth":0,"type":"header-three","data":{},"text":"Why use Azure AD Connect?","entityRanges":[]},{"text":"Azure AD Connect makes managing users ten times easier. By allowing you and your admins to update a user account once and then have that information sync to Microsoft 365 it reduces duplicating work. When a user is terminated, you will only need to remember to disable the account in your on-premise AD and then allow that change to sync to Microsoft 365 locking the user out of your on-premise AD, as well as, Microsoft 365 and anywhere else that identity information is being used.","key":"b4qvi","entityRanges":[],"depth":0,"inlineStyleRanges":[],"data":{},"type":"unstyled"},{"entityRanges":[],"depth":0,"text":"Synced vs cloud-only accounts","inlineStyleRanges":[],"data":{},"key":"gq9h","type":"header-three"},{"key":"3ur5q","depth":0,"text":"You may see me or other admins refer to Microsoft 365 accounts as synced or cloud-only. A synced account is a user account that is being synchronized from the on-premises AD. A cloud-only user account is a user account that is not synced from the on-premises AD. If you aren't using AD Connect, all your accounts are cloud-only. If you have installed AD Connect and have user accounts that are on-premises and being synced to the Microsoft 365 tenant then those accounts are synced.","type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"data":{}},{"depth":0,"text":"Installing AD Connect","entityRanges":[],"data":{},"type":"header-three","key":"36cgb","inlineStyleRanges":[]},{"entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[],"text":"Let us not waste any time discussing how to install AD Connect because it isn’t covered in the MS-500 test. Instead, I will point you to a couple of useful articles from Microsoft about installing AD Connect. Although, if you haven't installed AD Connect before I'd recommend hiring a consultant. There's a lot to consider when installing AD Connect including the user principal name, the source anchor, whether you have an on-premise Exchange server, and a slew of other requirements.","key":"62j5j","type":"unstyled"},{"key":"f9gn1","depth":0,"text":"Azure AD Connect Download: https://www.microsoft.com/en-us/download/details.aspx?id=47594 ","entityRanges":[{"key":1,"length":62,"offset":27}],"data":{},"type":"unstyled","inlineStyleRanges":[]},{"entityRanges":[{"offset":26,"key":2,"length":93}],"key":"c7dsg","type":"unstyled","inlineStyleRanges":[],"depth":0,"text":"AD Connect How-to guides: https://docs.microsoft.com/en-us/azure/active-directory/hybrid/how-to-connect-install-roadmap ","data":{}},{"key":"ve3g","type":"unstyled","depth":0,"entityRanges":[{"key":3,"length":93,"offset":35}],"inlineStyleRanges":[],"text":"How to express install AD Connect: https://docs.microsoft.com/en-us/azure/active-directory/hybrid/how-to-connect-install-express ","data":{}},{"entityRanges":[],"key":"ahpru","text":"User Sign-in Methods","inlineStyleRanges":[],"type":"header-three","depth":0,"data":{}},{"entityRanges":[],"depth":0,"key":"4e80a","inlineStyleRanges":[],"data":{},"text":"One part of AD connect that Microsoft does cover under the MS-500 test is the sign-in method, also known as, the sign-in options. The sign-in options dictate how your on-premises synced users will authenticate when signing into a Microsoft 365 app. For example, you can configure AD Connect to synchronize a hash of the passwords. When a user is signing into Microsoft 365 Microsoft can manage the authentication by comparing the username and password supplied by the user with the username and password hash that is synced to Microsoft 365. This is known as password hash synchronization.","type":"unstyled"},{"inlineStyleRanges":[],"text":"What’s Password Hash Synchronization","data":{},"type":"header-four","depth":0,"entityRanges":[],"key":"3ojl0"},{"text":"As mentioned above, password hash synchronization will configure AD Connect to synchronize a hash of your user's passwords to Microsoft 365. It's important to note, that the password is not synchronized across your Internet and Azure is not storing your passwords. It's an encrypted hash of the password.","depth":0,"key":"82p4n","inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unstyled"},{"entityRanges":[],"depth":0,"type":"unstyled","key":"2iu31","data":{},"text":"Password hash synchronization is also known as \"same sign-on\". It's known as same sign-on because a user will use the same credentials to sign in to your on-premise Active Directory, as well as, your Microsoft 365 environment.","inlineStyleRanges":[]},{"data":{},"entityRanges":[],"text":"A couple of noteworthy points on password hash synchronization:","type":"unstyled","depth":0,"key":"5d7ir","inlineStyleRanges":[]},{"data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"key":"6s37j","text":"Password hash synchronization is the easiest sign-in method to support.","type":"unordered-list-item"},{"data":{},"entityRanges":[],"key":"djhq","depth":0,"inlineStyleRanges":[],"text":"Password hash synchronization can be disabled in AD Connect.","type":"unordered-list-item"},{"text":"Password hash synchronization doesn’t take any other servers or software. It works through AD Connect.","depth":0,"type":"unordered-list-item","entityRanges":[],"inlineStyleRanges":[],"key":"b449h","data":{}},{"inlineStyleRanges":[],"depth":0,"text":"Limitations of password hash synchronization","key":"5m9cb","data":{},"type":"header-five","entityRanges":[]},{"data":{},"depth":0,"entityRanges":[],"key":"de0mn","inlineStyleRanges":[],"text":"By default, Password hash synchronization doesn’t support the password expiration policy. if a user's password expires on-premise the user can continue to sign in to Microsoft 365 without changing their password. By default, the cloud account password is set to never expire.","type":"unstyled"},{"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"data":{},"key":"bu4va","depth":0,"text":"Out of the box AD Connect does not support “user must change password at next logon”. You can however and able it but you'll also want to enable password writeback. More on password write back later in the article."},{"data":{},"key":"7e0d9","inlineStyleRanges":[],"entityRanges":[],"text":"AD Connect does not support account expiration. If you use account expirations in your on-premises AD, you'll need to create a PowerShell script that disables the user account in Azure AD or use Pass-through authentication.","depth":0,"type":"unstyled"},{"type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[],"key":"5u7cp","entityRanges":[],"text":"When you reset a password in Azure AD of a synchronized user the password will be overwritten by the on-premises AD password during the next password sync cycle. "},{"data":{},"inlineStyleRanges":[],"text":"Leaked credential detection","type":"header-five","entityRanges":[],"depth":0,"key":"8grtl"},{"key":"eok56","data":{},"inlineStyleRanges":[],"text":"A quick side note, for Microsoft 365 to perform leaked credential detection you'll need to have password hash synchronization enabled even if your sign-in method has users signing in to your on-premises Active Directory.","type":"unstyled","depth":0,"entityRanges":[]},{"text":"Active Directory Federation Services (ADFS)","entityRanges":[],"type":"header-four","depth":0,"data":{},"key":"4loin","inlineStyleRanges":[]},{"type":"unstyled","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[],"text":"ADFS is a software application developed by Microsoft two provide single sign-on (SSO). With ADFS users that are authenticating to Microsoft 365 will be redirected to your ADFS servers. NDFS uses claims-based access control authorization which is a process where the user is identified by a set of claims related to their identity. The claims are packaged into a secure token by ADFS and then sent to Microsoft 365.","key":"9obhb"},{"key":"cagtp","text":"Your ADFS servers will have requests sent to them every time a user authenticates to Microsoft 365. Because of this, it's typically recommended to have a minimum of Two ADFS servers. Since authentication can happen at the ADFS servers it's also recommended to implement ADFS proxy servers. Two ADFS proxy servers are also recommended.","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled"},{"text":"A couple of quick notes on ADFS:","entityRanges":[],"data":{},"key":"27v0k","type":"unstyled","inlineStyleRanges":[],"depth":0},{"key":"dqhii","type":"unordered-list-item","entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"text":"ADFS is one of the most complicated authentication systems available as a sign-in option for Microsoft 365."},{"data":{},"key":"8hjcc","text":"Since your users will be authenticating to the ADFS it’s recommended to have redundant servers.","inlineStyleRanges":[],"entityRanges":[],"depth":0,"type":"unordered-list-item"},{"key":"7brpc","text":"ADFS is one of the most expensive sign-in options for Microsoft 365.","type":"unordered-list-item","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[]},{"depth":0,"text":"Pass-through authentication","inlineStyleRanges":[],"data":{},"type":"header-four","key":"9tgu8","entityRanges":[]},{"depth":0,"entityRanges":[],"key":"a617l","data":{},"text":"Pass-through authentication (PTA) works like ADFS. With pass-through authentication users that are trying to access your Microsoft 365 environment will be passed to an on-premises server that has the PTA agent installed. Just like ADFS when a user signs in the username and password will be validated directly against your on-premises Active Directory.","inlineStyleRanges":[],"type":"unstyled"},{"text":"Pass-through authentication does not affect cloud-only users. When a user with a cloud-only account (an account that isn't synced from your on-premises AD) the users will still be able to log in. It's good to have at least one global admin that's a cloud-only account in case of PTA failure.","inlineStyleRanges":[],"key":"3nnds","data":{},"depth":0,"entityRanges":[],"type":"unstyled"},{"key":"85t92","entityRanges":[],"inlineStyleRanges":[],"text":"Troubleshooting AD Connect","type":"header-three","depth":0,"data":{}},{"data":{},"text":"Troubleshooting AD Connect can be a bit complicated Because there are four places that you may need to check to view the errors (although the data is usually redundant)","entityRanges":[],"inlineStyleRanges":[],"depth":0,"type":"unstyled","key":"5hq98"},{"type":"ordered-list-item","depth":0,"key":"a5uth","entityRanges":[],"inlineStyleRanges":[],"text":"Directory Sync status in the Microsoft 365 admin center.","data":{}},{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"ordered-list-item","key":"54ev4","text":"Sync errors in the Azure AD admin center (found under Azure Active Directory Connect health)","data":{}},{"entityRanges":[],"inlineStyleRanges":[],"type":"ordered-list-item","text":"The synchronization service app on the AD Connect server","data":{},"key":"87jkg","depth":0},{"key":"e4rhg","inlineStyleRanges":[],"depth":0,"data":{},"text":"The application event logs on the AD Connect server","type":"ordered-list-item","entityRanges":[]},{"text":"The errors you'll receive","depth":0,"inlineStyleRanges":[],"data":{},"type":"header-four","entityRanges":[],"key":"ak2q"},{"type":"unstyled","text":"The first thing you'll receive is an email with the subject line \"Unhealthy identity synchronization notification\".","key":"fkj86","entityRanges":[],"depth":0,"inlineStyleRanges":[],"data":{}},{"entityRanges":[{"length":1,"offset":0,"key":4}],"key":"f9b7n","data":{},"type":"atomic","text":" ","depth":0,"inlineStyleRanges":[]},{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"c1fi0","data":{},"text":"How to review the error","type":"header-four"},{"data":{},"key":"8jmhv","text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","inlineStyleRanges":[{"style":"BOLD","length":22,"offset":214},{"style":"BOLD","offset":266,"length":6},{"style":"BOLD","length":6,"offset":307}],"type":"unstyled","depth":0,"entityRanges":[]},{"key":"28a4n","data":{},"text":" ","entityRanges":[{"offset":0,"length":1,"key":5}],"depth":0,"type":"atomic","inlineStyleRanges":[]},{"data":{},"entityRanges":[],"depth":0,"key":"6qui","text":"Password Writeback","inlineStyleRanges":[],"type":"header-three"},{"text":"Remember when I said AD Connect synchronizes your on-premises Active Directory to Microsoft 365, that it's a one-way sync? Now we're getting into the exceptions. Password writeback allows admins, as well as, users to update their password in Microsoft 365 and have that password synchronized back to the on-premises Active Directory. Let's say all your users are working from home. And occasionally, a user forgets their password. Currently, they call into your IT helpdesk and the IT staff must reset the password in Active Directory manually. With password writeback those calls are history. Users can go to the Microsoft 365 portal And through their username authenticate using text messages, phone calls, or another MFA authorization and reset their passwords.","inlineStyleRanges":[],"key":"7n113","entityRanges":[],"type":"unstyled","data":{},"depth":0},{"entityRanges":[],"depth":0,"text":"Note: Azure AD P1 licenses are needed to configure password writeback.","type":"unstyled","inlineStyleRanges":[],"key":"4738e","data":{}},{"depth":0,"text":"Configuring password writeback is out of scope for the MS-500 but here are two Microsoft articles to help you get started: ","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","key":"d20f1","data":{}},{"type":"unordered-list-item","depth":0,"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/concept-registration-mfa-sspr-combined ","data":{},"entityRanges":[{"offset":0,"key":6,"length":109}],"key":"ba1mc","inlineStyleRanges":[]},{"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/tutorial-enable-sspr-writeback ","inlineStyleRanges":[],"type":"unordered-list-item","depth":0,"key":"7bc2u","data":{},"entityRanges":[{"key":7,"length":101,"offset":0}]},{"text":"Other writeback options","entityRanges":[],"key":"4vd79","data":{},"depth":0,"inlineStyleRanges":[],"type":"header-three"},{"entityRanges":[],"text":"For a while, Microsoft did allow organizations to configure user writeback where an admin could change a user's attributes in Microsoft 365 and have the attributes writeback to an on-premises environment. Today, Microsoft doesn't allow user writeback. As mentioned above, they do allow password writeback.","type":"unstyled","key":"oan","data":{},"depth":0,"inlineStyleRanges":[]},{"data":{},"key":"67jkm","inlineStyleRanges":[],"text":"Microsoft also allows group writeback Where users can create and manage Microsoft 365 groups in Microsoft 365 and have those groups write back to the on-premises Active Directory.","type":"unstyled","entityRanges":[],"depth":0},{"entityRanges":[],"depth":0,"type":"unstyled","key":"dcg83","data":{},"inlineStyleRanges":[],"text":"Microsoft also allows device writeback. Device writeback will create a device object in the on-premises Active Directory for every Azure AD-managed device. The devices will be located in an OU called RegisteredDevices."},{"key":"buj1i","text":"Hybrid Azure AD Joined devices","entityRanges":[],"type":"header-three","depth":0,"data":{},"inlineStyleRanges":[]},{"entityRanges":[],"type":"unstyled","text":"Hybrid Azure AD joined devices are devices that are joined to your on-premises AD and registered with Azure AD through AD Connect. Configuring a hybrid Azure AD join will ensure that all domain-joined computers are registered in Azure AD. It’s also an important step if you want to manage your domain-joined computers using Intune.","key":"1sg80","depth":0,"inlineStyleRanges":[],"data":{}}]},"title":"What's AD Connect","images":["https://i.ibb.co/7nDqr9x/Whats-AD-Connect.png","https://i.ibb.co/Vw4Y5TN/Unhealthy-identity-synchronization-notification.png","https://i.ibb.co/3CS1K7m/AD-Connect-error.png"],"id":"ky5W0Lz5P","slug":"Whats-AD-Connect-ky5W0Lz5P","datePublished":"2022/5/26","type":"article","publish":true,"sectionId":"AFV_acckJ","featuredImage":"https://i.ibb.co/7nDqr9x/Whats-AD-Connect.png","description":"Sync your on-premise Active Directory users to Microsoft 365. Quickly create users in Microsoft 365 and continue to sync your users from on-premise AD to Microsoft Azure Active Directory."},
