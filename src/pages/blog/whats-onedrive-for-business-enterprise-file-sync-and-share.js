        ...
        <main>
          <div>
            <Container className="blog-article">
              <Row>
                <Col>
                <h1>What’s OneDrive for Business</h1>
                <p>The world is changing. Data is growing at a rapid pace. By 2020 the world will have accumulated 44 zettabytes or 44,000,000,000,000 GB of data. The rapid expansion of data has become a challenge for people and organization a like.</p>
                <figure>
                ...
                <p>The traditional methods of data storage on personal devices and servers are falling short. Lost and stolen devices, server outages, and the inability to access data while on the road have all caused a loss of productivity, missed deadlines, and decrease the customer experience.</p>
                ...
                <blockquote>
                   <p>Save your files and photos to OneDrive and get them from any device, anywhere</p>
                </blockquote>
                ...
                <p>Co-authoring allows the team to work in the same document at the same time. Seeing changes, chatting, and collaborating in real time.</p>
                <p>The simplicity and rich features of OneDrive is why 85% of Fortune 500 companies use it today.</p>
                <figure>
                   <div role="button" tabIndex="0">
                      <div>
                         <div>
                            <div>
                               <div></div>
                               <img alt="OneDrive for business customers" width="700" height="394" role="presentation" src="https://miro.medium.com/max/700/1*DV47UMGh6IhZmvolijUmcQ.png" sizes="700px" srcSet="https://miro.medium.com/max/276/1*DV47UMGh6IhZmvolijUmcQ.png 276w, https://miro.medium.com/max/552/1*DV47UMGh6IhZmvolijUmcQ.png 552w, https://miro.medium.com/max/640/1*DV47UMGh6IhZmvolijUmcQ.png 640w, https://miro.medium.com/max/700/1*DV47UMGh6IhZmvolijUmcQ.png 700w"/>
                            </div>
                         </div>
                      </div>
                   </div>
                ...
                <h2>Features</h2>
                <blockquote>
                   <p>“Only solution that enables you to edit and co-author Office documents across browser, mobile, and desktop apps.”</p>
                </blockquote>
                <ul>
                ...
                <h2>Licensing</h2>
                <p>OneDrive for Business is part of Microsoft Office 365’s package. Microsoft does offer OneDrive for free for personal use as well. OneDrive for Business is available with the following Office 365 packages:</p>
                <p>Office 365 Business / Business Premium / Business Essentials<br/>Office 365 ProPlus<br/>Office 365 Enterprise E1 / E3 / E3<br/>Office 365 A1 / A3 / A5<br/>Office 365 F1<br/>Office 365 G1 / G3 /G5<br/>Office 365 Nonprofit Business Premium / Business Essentials</p>
                <h2>Competition</h2>
                <blockquote>
                   <p>Forrester recognized OneDrive as a leader in the Enterprise File Sync and Share (EFSS) Platforms category.</p>
                </blockquote>
                <p>Microsoft isn’t the only business offering cloud storage. Google, DropBox, and Box each have their own offering. They’re all fantastic apps and certainly making it difficult to chose the right one for your business.</p>
                </Col>
              </Row>
            </Container>
          </div>
